...
declare function bswap<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64 | isize | usize>(
  value: T,
): T;
...
declare namespace Atomics {
  export function load<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
  ): T;
  export function store<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): void;
  export function add<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function sub<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function and<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function or<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function xor<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function exchange<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    value: T,
  ): T;
  export function compareExchange<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    expectedValue: T,
    replacementValue: T,
  ): T;
  export function wait<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    value: T,
    timeout?: i64,
  ): AtomicWaitResult;
  export function notify<T = i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64>(
    array: TypedArray<T>,
    index: i32,
    count?: i32,
  ): i32;
