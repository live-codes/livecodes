...
declare module 'solid-js' {
  ...
  export * from 'solid-js/reactive/observable';
  export * from 'solid-js/reactive/scheduler';
  export * from 'solid-js/reactive/array';
  export * from 'solid-js/render';
  import type { JSX } from 'solid-js/jsx';
  type JSXElement = JSX.Element;
  export type { JSXElement, JSX };
  export function awaitSuspense(): void;
  import { writeSignal, serializeGraph, registerGraph, hashValue } from 'solid-js/reactive/signal';
  let DEV: {
...
declare module 'solid-js/reactive/signal' {
  import type { JSX } from 'solid-js/jsx';
  export type Accessor<T> = () => T;
  export const equalFn: <T>(a: T, b: T) => boolean;
  export const $PROXY: unique symbol;
  ...
  export type ResourceReturn<T> = [
    ...
    {
      mutate: (
        v: (T extends Function ? never : T) | ((prev?: T) => T | undefined),
      ) => T | undefined;
      refetch: () => void;
    },
  ];
  ...
  export function runWithOwner(o: Owner, fn: () => any): any;
  export function useTransition(): [Accessor<boolean>, (fn: () => void, cb?: () => void) => void];
  export function resumeEffects(e: Computation<any>[]): void;
  export function devComponent<T>(Comp: (props: T) => JSX.Element, props: T): JSX.Element;
  ...
  export function getSuspenseContext(): Context<SuspenseContextType> & {
    active?(): boolean;
    increment?(): void;
    decrement?(): void;
  };
  export function readSignal(this: Signal<any> | Memo<any>): any;
  export function writeSignal(node: Signal<any> | Memo<any>, value: any, isComp?: boolean): any;
  export {};
}

declare module 'solid-js/reactive/observable' {
  import { Accessor } from 'solid-js/reactive/signal';
...
declare module 'solid-js/reactive/scheduler' {
...
declare module 'solid-js/reactive/array' {
  import { Accessor } from 'solid-js/reactive/signal';
...
declare module 'solid-js/render' {
  export * from 'solid-js/render/component';
  export * from 'solid-js/render/flow';
  export * from 'solid-js/render/Suspense';
  export { sharedConfig } from 'solid-js/render/hydration';
}
...
declare module 'solid-js/render/component' {
  import type { JSX } from 'solid-js/jsx';
...
declare module 'solid-js/render/flow' {
  import { Accessor } from 'solid-js/reactive/signal';
  import type { JSX } from 'solid-js/jsx';
...
declare module 'solid-js/render/Suspense' {
  import type { JSX } from 'solid-js/jsx';
...
declare module 'solid-js/render/hydration' {
...
declare module 'solid-js/web' {
  ...
  export * from 'solid-js/web/client';
  export {
    For,
    Show,
    Suspense,
  ...
  export * from 'solid-js/web/server-mock';
...
declare module 'solid-js/web/client' {
  import { JSX } from 'solid-js/web/jsx';
...
declare module 'solid-js/web/server-mock' {
...
declare module 'solid-js/web/jsx' {
...
declare module 'solid-js/h' {
  const _default: import('hyper-dom-expressions').HyperScript;
...
declare module 'solid-js/html' {
  const _default: import('lit-dom-expressions').HTMLTag;
  export default _default;
}
...
declare module 'solid-js/store' {
  export { createStore, unwrap, $RAW } from 'solid-js/store/store';
  export type {
    Store,
    SetStoreFunction,
    NotWrappable,
    ...
    Readonly,
    DeepReadonly,
  } from 'solid-js/store/store';
  export * from 'solid-js/store/mutable';
  export * from 'solid-js/store/modifiers';
}

declare module 'solid-js/store/store' {
  import { $PROXY, Accessor } from 'solid-js';
  export const $RAW: unique symbol, $NODE: unique symbol, $NAME: unique symbol;
  ...
  type AddSymbolToPrimitive<T> = T extends {
    ...
    : {};
  type AddSymbolIterator<T> = T extends {
    ...
    : {};
  type AddSymbolToStringTag<T> = T extends {
  ...
  export function unwrap<T extends StoreNode>(item: any, set?: Set<unknown>): T;
  export function getDataNodes(target: StoreNode): any;
  export function proxyDescriptor(
    target: StoreNode,
    property: string | number | symbol,
  ): PropertyDescriptor | undefined;
  export function createDataNode(): Accessor<void> & {
    $: () => void;
  };
  export function setProperty(state: StoreNode, property: string | number, value: any): void;
  ...
  export type Part<T> = keyof T | Array<keyof T> | StorePathRange | ArrayFilterFn<T>;
...
declare module 'solid-js/store/mutable' {
  import { StoreNode, Store } from 'solid-js/store/store';
...
declare module 'solid-js/store/modifiers' {
  import { Store, NotWrappable, DeepReadonly } from 'solid-js/store/store';
