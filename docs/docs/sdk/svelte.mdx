...
The [JS/TS SDK](js-ts.mdx) can be used directly in Svelte components without the need for any wrappers.
...
Alternatively, the SDK function [`createPlayground`](./js-ts.mdx#createplayground) can be used as an [action](https://learn.svelte.dev/tutorial/actions).
