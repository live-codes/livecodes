...
However, if you do need to provide them, you may wish to use the included [docker setup](../advanced/docker.mdx) (for VPS) or [PHP setup](../advanced/php.mdx) (for shared hosting) which provide a self-hosted implementation for these services, very similar to the official [hosted app](https://livecodes.io).
