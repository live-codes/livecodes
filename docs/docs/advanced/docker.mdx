...
For continuous deployment, you can use the included [GitHub Actions workflow](https://github.com/live-codes/livecodes/blob/develop/.github/workflows/deploy-docker.yml) to deploy to a VPS when a new commit is pushed (e.g. to the `main` branch).
