...
This is an example of a self-hosted instance, that was deployed to a VPS using the included docker setup:

https://vps.livecodes.io/

This can be as easy as running the following command:
