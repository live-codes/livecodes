...
- `title`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#title)  
  Default: `""`  
...
- `content`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#content)  
  Default: `""`  
  The initial content of the code editor.

- `contentUrl`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#contenturl)  
  Default: `undefined`  
...
- `hiddenContent`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#hiddencontent)  
  Default: `undefined`  
...
- `hiddenContentUrl`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#hiddencontenturl)  
  Default: `undefined`  
...
- `selector`:
  Type: [`string | undefined`](../api/interfaces/internal.Editor.md#selector)  
  Default: `undefined`  
  A CSS selector to load `content` from [DOM import](../features/import.md#import-code-from-dom).

- `position`:
  Type: [`{lineNumber: number, column?: number} | undefined`](../api/interfaces/internal.Editor.md#position)  
  Default: `undefined`  
