...
In the standalone app, these can be provided in [custom settings](../advanced/custom-settings.md) using the `types` property. This takes an object with the key representing the module name and the value representing the URL of the file.
...
For embedded playgrounds, these can be provided in the [configuration object](../configuration/configuration-object.md) using the [`types`](../configuration/configuration-object.md#types) property.

This can be combined with the [`imports`](../configuration/configuration-object.md#imports) property to provide [importmap](./module-resolution.md#custom-module-resolution) for runtime implementation of your custom modules.
...
The JavaScript output (Greeter.js) and the data definition file (Greeter.d.ts) should be hosted online or converted to data URLs (see [assets](./assets.md) and [data URLs](./data-urls.md)).
...
- [Data Urls](./data-urls.md)
- [Assets](./assets.md)
- [Custom Settings](../advanced/custom-settings.md)
- [Configuration Object](../configuration/configuration-object.md)
