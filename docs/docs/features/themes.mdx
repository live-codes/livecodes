...
- [Query params](../configuration/query-params.mdx): `?theme=dark` or `?theme=light`.
  e.g. https://livecodes.io/?theme=light

- [Configuration object](../configuration/configuration-object.mdx): [`theme`](../configuration/configuration-object.mdx#theme) property.
...
- [Query params](../configuration/query-params.mdx): `?themeColor={color}`.
  e.g. https://livecodes.io/?themeColor=lightblue

- [Configuration object](../configuration/configuration-object.mdx): [`themeColor`](../configuration/configuration-object.mdx#themecolor) property.
...
:::info Note
Please note that editor themes can be set in the [editor settings](./editor-settings.mdx) or using the [`editorTheme`](../configuration/configuration-object.mdx#editortheme) configuration option.
