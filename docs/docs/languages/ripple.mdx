...
export const demo = {
  ...
  script: {
    language: 'ripple',
    content: ` export default component Counter() {
   let \$count = 0;
   let \$doubled = \$count * 2;
...
`,
  ...
  script: {
    language: 'ripple',
    content: `export default component App() {
  let \$name = 'Ripple';
...
export const importsDemo = {
  ripple: `import { effect } from "ripple";
...
export const tailwindDemo = {
  ...
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">{'Ripple + Tailwind CSS'}</h1>
