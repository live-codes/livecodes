...
This is the documentation for LiveCodes language support for Vue [Single-File Component (SFC)](https://vuejs.org/api/sfc-spec.html). The support for Vue 2 SFC is [documented separately](./vue2.mdx).
...
<div style={{ marginBottom: '2em' }}>
  <RunInLiveCodes params={{ x: 'id/2af5rqradrs' }} style={{ display: 'inline' }}></RunInLiveCodes> {
    ' - '
  } <a
...
<div style={{ marginBottom: '2em' }}>
  <RunInLiveCodes params={{ x: 'id/d72xp4wbinp' }} style={{ display: 'inline' }}></RunInLiveCodes> {
    ' - '
  } <a href="https://github.com/hatemhosny/vue3-samples" target="_blank" rel="noopener noreferrer">
    <>view source on GitHub</>
  </a>
</div>
