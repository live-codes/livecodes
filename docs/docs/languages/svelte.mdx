...
[CSS Frameworks](../features/css.mdx#css-processors) supported in LiveCodes (e.g. [Tailwind CSS](./tailwindcss.mdx), [UnoCSS](./unocss.mdx), [WindiCSS](./windicss.mdx)) can detect class names added in Svelte components.
...
but currently is not processed by [CSS processors](../features/css.mdx#css-processors) (e.g. Tailwind CSS, Autoprefixer, etc).
...
Svelte is supported in both [markup](../features/projects.mdx#markup-editor) and [script](../features/projects.mdx#script-editor) editors.
...
Code in style blocks are not currently processed by enabled [CSS processors](../features/css.mdx#css-processors). This is already [discouraged by Tailwind CSS](https://tailwindcss.com/docs/compatibility#vue-svelte-and-astro).
