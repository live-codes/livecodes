...
Then, these files are [aggressively cached](../../../src/_headers) (for 1 year).

So, any file that has not changed will continue to be served from cach even for later releases.
