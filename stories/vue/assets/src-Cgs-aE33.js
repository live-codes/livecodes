import{n as e,t}from"./chunk-BneVvdWh.js";import{n,t as r}from"./preload-helper-CV6hqhE5.js";import{_ as i,d as a,f as o,g as s,h as c,m as l,p as u}from"./iframe-DJaUid7x.js";async function d(e,t={}){typeof e==`object`&&!(e instanceof HTMLElement)&&(e.headless||e.view===`headless`)&&(t=e,e=null);let n=6e4,{config:r={},headless:i,loading:a=`lazy`,view:o}=t,s=i||o===`headless`,c=null,l=null,u=e=>{e.style.position=`absolute`,e.style.top=`0`,e.style.visibility=`hidden`,e.style.opacity=`0`};if(typeof e==`string`)c=document.querySelector(e);else if(e instanceof HTMLElement)c=e;else if(!(s&&typeof e==`object`))throw Error(`A valid container element is required.`);if(!c)if(s)c=document.createElement(`div`),u(c),document.body.appendChild(c);else throw Error(`Cannot find element: "${e}"`);let d=new URL(f(t)),p=d.origin;d.searchParams.set(`embed`,`true`),d.searchParams.set(`loading`,s?`eager`:a),d.searchParams.set(`sdkVersion`,`0.14.0`),typeof r==`object`&&Object.keys(r).length>0&&d.searchParams.set(`config`,`sdk`);let m=t.params;typeof m==`object`&&Object.keys(m).length>0&&JSON.stringify(m).length<1800&&Object.keys(m).forEach(e=>{d.searchParams.set(e,encodeURIComponent(String(m[e])))});let h=!1,g="Cannot call API methods after calling `destroy()`.",_=[],v=(e,t=`message`)=>{addEventListener(t,e),_.push(e)},y=(e,t=`message`)=>{removeEventListener(t,e);let n=_.indexOf(e);n>-1&&_.splice(n,1)},b=await new Promise(e=>{var t,n,i,o,f,m,h,g,_;if(!c)return;let b=c.dataset.height||c.style.height;if(b&&!s){let e=isNaN(Number(b))?b:b+`px`;c.style.height=e}c.dataset.defaultStyles!==`false`&&!s&&((t=c.style).backgroundColor||(t.backgroundColor=`#fff`),(n=c.style).border||(n.border=`1px solid black`),(i=c.style).borderRadius||(i.borderRadius=`8px`),(o=c.style).boxSizing||(o.boxSizing=`border-box`),(f=c.style).padding||(f.padding=`0`),(m=c.style).width||(m.width=`100%`),(h=c.style).height||(h.height=c.style.height||`300px`),c.style.minHeight=`200px`,c.style.flexGrow=`1`,(g=c.style).overflow||(g.overflow=`hidden`),(_=c.style).resize||(_.resize=`vertical`),getComputedStyle(c).getPropertyValue(`display`)===`inline`&&(c.style.display=`block`));let x=`livecodes`,S=c.querySelector(`iframe.${x}`),C=S||document.createElement(`iframe`);C.classList.add(x),C.setAttribute(`allow`,te()),C.setAttribute(`allowtransparency`,`true`),C.setAttribute(`allowpaymentrequest`,`true`),C.setAttribute(`allowfullscreen`,`true`),C.setAttribute(`sandbox`,`allow-same-origin allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-presentation allow-scripts`);let w=a===`eager`?`eager`:`lazy`;C.setAttribute(`loading`,w),s?u(C):(C.style.height=`100%`,C.style.minHeight=`200px`,C.style.width=`100%`,C.style.margin=`0`,C.style.border=`0`,C.style.borderRadius=c.style.borderRadius),v(function e(t){t.source!==C.contentWindow||t.origin!==p||t.data?.type!==`livecodes-init`||(y(e),l=Number(t.data.payload.appVersion.replace(/^v/,``)))}),(!l||l<46)&&v(function e(t){var n;t.source!==C.contentWindow||t.origin!==p||t.data?.type!==`livecodes-get-config`||(y(e),(n=C.contentWindow)==null||n.postMessage({type:`livecodes-config`,payload:r},p))}),C.onload=()=>{e(C)},C.src=d.href,S||c.appendChild(C)}),x=new Promise(e=>{v(function t(n){n.source!==b.contentWindow||n.origin!==p||n.data?.type!==`livecodes-ready`||(y(t),e(),x.settled=!0)})}),S=()=>h?Promise.reject(g):new Promise(async e=>{var t;x.settled&&e(),(t=b.contentWindow)==null||t.postMessage({type:`livecodes-load`},p),await x,e()}),C=(e,t)=>new Promise(async(r,i)=>{var a;if(h)return i(g);await S();let o=ie(),s=setTimeout(()=>{y(c),i(Error(`SDK call "${e}" timed out after ${n}ms.`))},n);function c(t){if(!(t.source!==b.contentWindow||t.origin!==p||t.data?.type!==`livecodes-api-response`||t.data?.id!==o)&&t.data.method===e){clearTimeout(s),y(c);let e=t.data.payload;e!=null&&e.error?i(e.error):r(e)}}v(c),(a=b.contentWindow)==null||a.postMessage({method:e,id:o,args:t},p)}),w={},ee=[`load`,`ready`,`code`,`console`,`tests`,`destroy`],ne=(e,t)=>{var n;if(h)throw Error(g);return ee.includes(e)?(C(`watch`,[e]),w[e]||(w[e]=[]),(n=w[e])==null||n.push(t),{remove:()=>{w[e]=w[e]?.filter(e=>e!==t),w[e]?.length===0&&C(`watch`,[e,`unsubscribe`])}}):{remove:()=>{}}},T=e=>({"livecodes-app-loaded":`load`,"livecodes-ready":`ready`,"livecodes-change":`code`,"livecodes-console":`console`,"livecodes-test-results":`tests`,"livecodes-destroy":`destroy`})[e];v(async function(e){var t;let n=T(e.data?.type??``);if(e.source!==b.contentWindow||e.origin!==p||!n||!w[n])return;let r=e.data?.payload;(t=w[n])==null||t.forEach(e=>{e(r)})});let re=()=>{var e;(e=b?.remove)==null||e.call(b),Object.values(w).forEach(e=>{e.length=0}),_.forEach(e=>removeEventListener(`message`,e)),_.length=0,E&&c&&E.unobserve(c),h=!0},E;a===`lazy`&&`IntersectionObserver`in window&&(E=new IntersectionObserver((e,t)=>{e.forEach(async e=>{e.isIntersecting&&(await S(),t.unobserve(c))})},{rootMargin:`150px`}),E.observe(c));let ie=()=>(String(Math.random())+Date.now().toFixed()).replace(`0.`,``);return{load:()=>S(),run:()=>C(`run`),format:e=>C(`format`,[e]),getShareUrl:e=>C(`getShareUrl`,[e]),getConfig:e=>C(`getConfig`,[e]),setConfig:e=>C(`setConfig`,[e]),getCode:()=>C(`getCode`),show:(e,t)=>C(`show`,[e,t]),runTests:()=>C(`runTests`),onChange:e=>ne(`code`,e),watch:ne,exec:(e,...t)=>C(`exec`,[e,...t]),destroy:()=>h?Promise.reject(g):(re(),Promise.resolve())}}function f(e={}){let{appUrl:t=`https://livecodes.io`,params:n={},config:r={},headless:i,import:a,lite:o,view:s,...c}=e,l;try{l=new URL(t)}catch{throw Error(`${t} is not a valid URL.`)}let u=new URLSearchParams;Object.entries(c).forEach(([e,t])=>{t!==void 0&&l.searchParams.set(e,String(t))});let d=e.view===`headless`||i;if(o&&(console.warn(`Deprecation notice: "lite" option is deprecated. Use "config: { mode: 'lite' }" instead.`),typeof r==`object`&&r.mode==null?r.mode=`lite`:l.searchParams.set(`lite`,`true`)),s&&(console.warn(`Deprecation notice: The "view" option has been moved to "config.view". For headless mode use "headless: true".`),typeof r==`object`&&r.view==null&&s!==`headless`?r.view=s:l.searchParams.set(`view`,s)),typeof r==`string`)try{new URL(r),l.searchParams.set(`config`,encodeURIComponent(r))}catch{throw Error(`"config" is not a valid URL or configuration object.`)}else r&&typeof r==`object`&&Object.keys(r).length>0&&(r.title&&r.title!==`Untitled Project`&&l.searchParams.set(`title`,r.title),r.description&&r.description.length>0&&l.searchParams.set(`description`,r.description),u.set(`config`,`code/`+(0,C.compressToEncodedURIComponent)(JSON.stringify(r))));if(n&&typeof n==`object`&&Object.keys(n).length>0)try{u.set(`params`,(0,C.compressToEncodedURIComponent)(JSON.stringify(n)))}catch{Object.keys(n).forEach(e=>{l.searchParams.set(e,encodeURIComponent(String(n[e])))})}return a&&l.searchParams.set(`x`,encodeURIComponent(a)),d&&l.searchParams.set(`headless`,`true`),u.toString().length>0&&(l.hash=u.toString()),l.href}var p,m,h,g,_,v,y,b,x,S,C,w,ee,te,ne,T,re,E=e((()=>{a(),p=Object.create,m=Object.defineProperty,h=Object.getOwnPropertyDescriptor,g=Object.getOwnPropertyNames,_=Object.getPrototypeOf,v=Object.prototype.hasOwnProperty,y=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),b=(e,t,n,r)=>{if(t&&typeof t==`object`||typeof t==`function`)for(let i of g(t))!v.call(e,i)&&i!==n&&m(e,i,{get:()=>t[i],enumerable:!(r=h(t,i))||r.enumerable});return e},x=(e,t,n)=>(n=e==null?{}:p(_(e)),b(t||!e||!e.__esModule?m(n,`default`,{value:e,enumerable:!0}):n,e)),S=y((e,t)=>{var n=function(){var e=String.fromCharCode,t=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=`,n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$`,r={};function i(e,t){if(!r[e]){r[e]={};for(var n=0;n<e.length;n++)r[e][e.charAt(n)]=n}return r[e][t]}var a={compressToBase64:function(e){if(e==null)return``;var n=a._compress(e,6,function(e){return t.charAt(e)});switch(n.length%4){default:case 0:return n;case 1:return n+`===`;case 2:return n+`==`;case 3:return n+`=`}},decompressFromBase64:function(e){return e==null?``:e==``?null:a._decompress(e.length,32,function(n){return i(t,e.charAt(n))})},compressToUTF16:function(t){return t==null?``:a._compress(t,15,function(t){return e(t+32)})+` `},decompressFromUTF16:function(e){return e==null?``:e==``?null:a._decompress(e.length,16384,function(t){return e.charCodeAt(t)-32})},compressToUint8Array:function(e){for(var t=a.compress(e),n=new Uint8Array(t.length*2),r=0,i=t.length;r<i;r++){var o=t.charCodeAt(r);n[r*2]=o>>>8,n[r*2+1]=o%256}return n},decompressFromUint8Array:function(t){if(t==null)return a.decompress(t);for(var n=Array(t.length/2),r=0,i=n.length;r<i;r++)n[r]=t[r*2]*256+t[r*2+1];var o=[];return n.forEach(function(t){o.push(e(t))}),a.decompress(o.join(``))},compressToEncodedURIComponent:function(e){return e==null?``:a._compress(e,6,function(e){return n.charAt(e)})},decompressFromEncodedURIComponent:function(e){return e==null?``:e==``?null:(e=e.replace(/ /g,`+`),a._decompress(e.length,32,function(t){return i(n,e.charAt(t))}))},compress:function(t){return a._compress(t,16,function(t){return e(t)})},_compress:function(e,t,n){if(e==null)return``;var r,i,a={},o={},s=``,c=``,l=``,u=2,d=3,f=2,p=[],m=0,h=0,g;for(g=0;g<e.length;g+=1)if(s=e.charAt(g),Object.prototype.hasOwnProperty.call(a,s)||(a[s]=d++,o[s]=!0),c=l+s,Object.prototype.hasOwnProperty.call(a,c))l=c;else{if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++),a[c]=d++,l=String(s)}if(l!==``){if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++)}for(i=2,r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;for(;;)if(m<<=1,h==t-1){p.push(n(m));break}else h++;return p.join(``)},decompress:function(e){return e==null?``:e==``?null:a._decompress(e.length,32768,function(t){return e.charCodeAt(t)})},_decompress:function(t,n,r){var i=[],a=4,o=4,s=3,c=``,l=[],u,d,f,p,m,h,g,_={val:r(0),position:n,index:1};for(u=0;u<3;u+=1)i[u]=u;for(f=0,m=2**2,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 2:return``}for(i[3]=g,d=g,l.push(g);;){if(_.index>t)return``;for(f=0,m=2**s,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(g=f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 2:return l.join(``)}if(a==0&&(a=2**s,s++),i[g])c=i[g];else if(g===o)c=d+d.charAt(0);else return null;l.push(c),i[o++]=d+c.charAt(0),a--,d=c,a==0&&(a=2**s,s++)}}};return a}();t!==void 0&&t!=null&&(t.exports=n)}),C=x(S()),w={chrome:[`accelerometer`,`bluetooth`,`camera`,`clipboard-read`,`clipboard-write`,`display-capture`,`encrypted-media`,`geolocation`,`gyroscope`,`language-detector`,`language-model`,`local-network-access`,`microphone`,`midi`,`proofreader`,`rewriter`,`serial`,`summarizer`,`translator`,`web-share`,`writer`,`window-placement`,`xr-spatial-tracking`],firefox:[`camera`,`display-capture`,`geolocation`,`microphone`,`web-share`],default:[`accelerometer`,`ambient-light-sensor`,`camera`,`display-capture`,`encrypted-media`,`geolocation`,`gyroscope`,`microphone`,`midi`,`payment`,`serial`,`vr`,`web-share`,`xr-spatial-tracking`]},ee=()=>{if(typeof navigator>`u`)return`default`;let e=navigator.userAgent;return/Firefox\//i.test(e)?`firefox`:/Chrome\//i.test(e)?`chrome`:`default`},te=()=>w[ee()].filter(e=>{var t;let n=((t=globalThis.document?.featurePolicy)?.features)?.call(t);return n?n.includes(e):!0}).join(`; `),ne={appUrl:String,config:[Object,String],headless:Boolean,import:String,lite:Boolean,loading:String,params:Object,template:String,view:String,height:String},T=e=>JSON.parse(JSON.stringify(e)),re={props:ne,emits:[`sdkReady`],setup(e,t){let{height:n,...r}=e,a=i(),o=i(n||``),f=i(),{config:p,...m}=r,h=JSON.stringify(p),g=JSON.stringify(m),_=0,v=e=>e!==_;return l(()=>{if(!a.value)return;let e=++_;d(a.value,T(r)).then(n=>{if(v(e)){n.destroy();return}f.value=n,t.emit(`sdkReady`,n)})}),s(e,async e=>{var n;if(!a.value)return;let{height:r,...i}=e,s=++_;r&&(o.value=r);let{config:c,...l}=i;!f.value||JSON.stringify(l)!==g?(g=JSON.stringify(l),h=JSON.stringify(c),(n=f.value)==null||n.destroy(),f.value=void 0,d(a.value,T(i)).then(e=>{if(v(s)){e.destroy();return}f.value=e,t.emit(`sdkReady`,e)})):JSON.stringify(c)!==h&&(h=JSON.stringify(c),c&&f.value.setConfig(T(c)||{}))}),c(()=>{var e;++_,(e=f.value)==null||e.destroy()}),()=>{var e;return u(`div`,{ref:a,style:o.value?{height:Number(o.value)?`${o.value}px`:o.value}:void 0},(e=t.slots).default?.call(e)||``)}}}})),ie=e((()=>{E()}));function ae(e){return e&&e.constructor&&typeof e.constructor.isBuffer==`function`&&e.constructor.isBuffer(e)}function oe(e){return e}function se(e,t){t||={};let n=t.delimiter||`.`,r=t.maxDepth,i=t.transformKey||oe,a={};function o(e,s,c){c||=1,Object.keys(e).forEach(function(l){let u=e[l],d=t.safe&&Array.isArray(u),f=Object.prototype.toString.call(u),p=ae(u),m=f===`[object Object]`||f===`[object Array]`,h=s?s+n+i(l):i(l);if(!d&&!p&&m&&Object.keys(u).length&&(!t.maxDepth||c<r))return o(u,h,c+1);a[h]=u})}return o(e),a}function ce(e,t){t||={};let n=t.delimiter||`.`,r=t.overwrite||!1,i=t.transformKey||oe,a={};if(ae(e)||Object.prototype.toString.call(e)!==`[object Object]`)return e;function o(e){let n=Number(e);return isNaN(n)||e.indexOf(`.`)!==-1||t.object?e:n}function s(e,t,r){return Object.keys(r).reduce(function(t,i){return t[e+n+i]=r[i],t},t)}function c(e){let t=Object.prototype.toString.call(e),n=t===`[object Array]`,r=t===`[object Object]`;if(!e)return!0;if(n)return!e.length;if(r)return!Object.keys(e).length}return e=Object.keys(e).reduce(function(n,r){let i=Object.prototype.toString.call(e[r]);return!(i===`[object Object]`||i===`[object Array]`)||c(e[r])?(n[r]=e[r],n):s(r,n,se(e[r],t))},{}),Object.keys(e).forEach(function(s){let c=s.split(n).map(i),l=o(c.shift()),u=o(c[0]),d=a;for(;u!==void 0;){if(l===`__proto__`)return;let e=Object.prototype.toString.call(d[l]),n=e===`[object Object]`||e===`[object Array]`;if(!r&&!n&&d[l]!==void 0)return;(r&&!n||!r&&d[l]==null)&&(d[l]=typeof u==`number`&&!t.object?[]:{}),d=d[l],c.length>0&&(l=o(c.shift()),u=o(c[0]))}d[l]=ce(e[s],t)}),a}var le=e((()=>{})),ue,de,fe,D,pe,me,he,ge=e((()=>{ue=[`esm.sh`,`skypack`,`esm.run`,`jsdelivr.esm`,`fastly.jsdelivr.esm`,`gcore.jsdelivr.esm`,`testingcf.jsdelivr.esm`,`jsdelivr.b-cdn.esm`,`jspm`],de=[`jsdelivr`,`fastly.jsdelivr`,`unpkg`,`gcore.jsdelivr`,`testingcf.jsdelivr`,`jsdelivr.b-cdn`,`npmcdn`],fe=[`jsdelivr.gh`,`fastly.jsdelivr.gh`,`statically`,`gcore.jsdelivr.gh`,`testingcf.jsdelivr.gh`,`jsdelivr.b-cdn.gh`],D={getModuleUrl:(e,{isModule:t=!0,defaultCDN:n=`esm.sh`,external:r}={})=>{e=e.replace(/#nobundle/g,``);let i=e=>!r||!e.includes(`https://esm.sh`)?e:e.includes(`?`)?`${e}&external=${r}`:`${e}?external=${r}`,a=me(e,t,n);return a?i(a):t?i(`https://esm.sh/`+e):`https://cdn.jsdelivr.net/npm/`+e},getUrl:(e,t)=>e.startsWith(`http`)||e.startsWith(`data:`)?e:me(e,!1,t||pe())||e,cdnLists:{npm:de,module:ue,gh:fe},checkCDNs:async(e,t)=>{let n=[t,...D.cdnLists.npm].filter(Boolean);for(let t of n)try{if((await fetch(D.getUrl(e,t),{method:`HEAD`})).ok)return t}catch{}return D.cdnLists.npm[0]}},pe=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get(`appCDN`)||D.cdnLists.npm[0]}catch{return D.cdnLists.npm[0]}},me=(e,t,n)=>{let r=t&&e.startsWith(`unpkg:`)?`?module`:``;e.startsWith(`gh:`)?e=e.replace(`gh`,fe[0]):e.includes(`:`)||(e=(n||(t?ue[0]:de[0]))+`:`+e);for(let t of he){let[n,i]=t;if(n.test(e))return e.replace(n,i)+r}return null},he=[[/^(esm\.sh:)(.+)/i,`https://esm.sh/$2`],[/^(npm:)(.+)/i,`https://esm.sh/$2`],[/^(node:)(.+)/i,`https://esm.sh/$2`],[/^(jsr:)(.+)/i,`https://esm.sh/jsr/$2`],[/^(pr:)(.+)/i,`https://esm.sh/pr/$2`],[/^(pkg\.pr\.new:)(.+)/i,`https://esm.sh/pkg.pr.new/$2`],[/^(skypack:)(.+)/i,`https://cdn.skypack.dev/$2`],[/^(jsdelivr:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2`],[/^(fastly\.jsdelivr:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2`],[/^(gcore\.jsdelivr:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2`],[/^(testingcf\.jsdelivr:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2`],[/^(jsdelivr\.b-cdn:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2`],[/^(jsdelivr\.gh:)(.+)/i,`https://cdn.jsdelivr.net/gh/$2`],[/^(fastly\.jsdelivr\.gh:)(.+)/i,`https://fastly.jsdelivr.net/gh/$2`],[/^(gcore\.jsdelivr\.gh:)(.+)/i,`https://gcore.jsdelivr.net/gh/$2`],[/^(testingcf\.jsdelivr\.gh:)(.+)/i,`https://testingcf.jsdelivr.net/gh/$2`],[/^(jsdelivr\.b-cdn\.gh:)(.+)/i,`https://jsdelivr.b-cdn.net/gh/$2`],[/^(statically:)(.+)/i,`https://cdn.statically.io/gh/$2`],[/^(esm\.run:)(.+)/i,`https://esm.run/$2`],[/^(jsdelivr\.esm:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2/+esm`],[/^(fastly\.jsdelivr\.esm:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2/+esm`],[/^(gcore\.jsdelivr\.esm:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2/+esm`],[/^(testingcf\.jsdelivr\.esm:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2/+esm`],[/^(jsdelivr\.b-cdn\.esm:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2/+esm`],[/^(jspm:)(.+)/i,`https://jspm.dev/$2`],[/^(esbuild:)(.+)/i,`https://esbuild.vercel.app/$2`],[/^(bundle\.run:)(.+)/i,`https://bundle.run/$2`],[/^(unpkg:)(.+)/i,`https://unpkg.com/$2`],[/^(npmcdn:)(.+)/i,`https://npmcdn.com/$2`],[/^(bundlejs:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(bundle:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(deno:)(.+)/i,`https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts`],[/^(https:\/\/deno\.land\/.+)/i,`https://deno.bundlejs.com/?file&q=$1`],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,`https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4`],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3`],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3`],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,`https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3`]]})),O,_e,k,ve,ye,be,xe,Se,Ce,we,Te,Ee,De,Oe,A,ke,Ae,je,Me,Ne,j,Pe,Fe,Ie,Le,M,Re,ze,N,Be,Ve,P,He,Ue,F,We,Ge,Ke,qe,Je,Ye,Xe,I,Ze,Qe,L,R,$e,et,tt,nt,rt,it,at,ot,st,ct,z=e((()=>{ge(),{getUrl:O,getModuleUrl:_e}=D,k=O(`@live-codes/browser-compilers@0.22.10/dist/`),ve=O(`art-template@4.13.2/lib/template-web.js`),ye=O(`@asciidoctor/core@2.2.8/dist/browser/asciidoctor.js`),be=O(`@assemblyscript/loader@0.27.29/umd/index.js`),xe=O(`@hatemhosny/astro-internal@0.0.4/`),Se=O(`@babel/standalone@7.26.4/babel.js`),Ce=O(`@bbob/html@4.3.1/dist/index.min.js`),we=O(`@bbob/preset-html5@4.3.1/dist/index.min.js`),Te=O(`biwascheme@0.8.0/release/biwascheme.js`),Ee=O(`brython@3.12.4/`),De=O(`cherry-cljs@0.2.19/`),Oe=O(`@live-codes/clio-browser-compiler@0.0.3/public/build/`),A=O(`@live-codes/codemirror@0.3.4/build/`),ke=O(`coffeescript@2.7.0/lib/coffeescript-browser-compiler-legacy/coffeescript.js`),Ae=O(`dot@1.1.3/doT.js`),je=O(`ejs@4.0.1/ejs.js`),Me=O(`eta@3.4.0/dist/eta.umd.js`),Ne=O(`gh:live-codes/gleam-precompiled@v0.5.0/`),j=O(`@live-codes/go2js@0.5.0/build/`),Pe=O(`handlebars@4.7.8/dist/`),Fe=O(`imba@2.0.0-alpha.229/dist/`),Ie=O(`gh:jscl-project/jscl-project.github.io@058adc599f0d012718ef3ad28e704a92c4dd741e/jscl.js`),Le=O(`liquidjs@10.14.0/dist/liquid.browser.min.js`),M=O(`fengari-web@0.1.4/dist/fengari-web.js`),Re=O(`malinajs@0.7.19/`),ze=O(`mjml-browser@4.15.3/lib/index.js`),N=O(`@live-codes/monaco-languages@0.2.0/dist/`),Be=O(`mustache@4.2.0/mustache.js`),Ve=O(`nunjucks@3.2.4/browser/`),P=O(`https://cdn.opalrb.com/opal/1.8.2/`),He=O(`parinfer@3.13.1/parinfer.js`),Ue=O(`@live-codes/postcss-import-url@0.1.2/dist/postcss-import-url.js`),F=O(`prettier@3.3.2/`),We=O(`@live-codes/prettier-plugin-minizinc@0.2.0/dist/standalone.js`),Ge=O(`@prettier/plugin-php@0.22.2/standalone.js`),Ke=O(`requirejs@2.3.6/require.js`),qe=O(`riot@9.2.2/`),Je=O(`@ruby/wasm-wasi@2.7.2/dist/browser.umd.js`),Ye=O(`sql-formatter@12.2.1/dist/sql-formatter.min.js`),Xe=O(`sql.js@1.10.3/dist/`),I=O(`squint-cljs@0.4.81/`),Ze=O(`@stencil/core@3.2.2/compiler/stencil.js`),Qe=O(`stylis@4.3.6/dist/umd/stylis.js`),L=O(`svelte@5.39.12/`),R=O(`tau-prolog@0.3.4/modules/`),$e=O(`twig@1.17.1/twig.min.js`),et=`5.9.3`,tt=O(`typescript@${et}/lib/typescript.js`),nt=O(`uniter@2.18.0/dist/uniter.js`),rt=O(`vue@2`),it=O(`vue@3/dist/vue.runtime.esm-browser.prod.js`),at=O(`livecodes@${{}.SDK_VERSION}/vue.js`),ot=O(`vue3-sfc-loader@0.9.5/dist/`),st=O(`wabt@1.0.35/index.js`),ct=O(`wasmoon@1.16.0/dist/index.js`)})),B,V=e((()=>{z(),F+``,B={babel:F+`plugins/babel.js`,estree:F+`plugins/estree.js`,glimmer:F+`plugins/glimmer.js`,html:F+`plugins/html.js`,markdown:F+`plugins/markdown.js`,postcss:F+`plugins/postcss.js`,php:Ge,minizinc:We,pug:k+`prettier/parser-pug.js`,java:k+`prettier/parser-java.js`}})),lt,ut=e((()=>{z(),V(),lt={name:`art-template`,title:`art`,longTitle:`art-template`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:ve,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-art-template-compiler.js}}`),self.createArtTemplateCompiler())},extensions:[`art`,`art-template`],editor:`markup`,editorLanguage:`html`}})),dt=e((()=>{ut()})),ft,H,U=e((()=>{ft=(e,t=!0)=>e.replace(/\\/g,t?`\\\\`:`\\`).replace(/`/g,"\\`").replace(/<\/script>/g,`<\\/script>`),H=(e,t)=>({...t.customSettings[e]}),{}.VERSION,{}.SDK_VERSION,{}.GIT_COMMIT,{}.REPO_URL,{}.DOCS_BASE_URL})),W=e((()=>{U(),z()})),pt,mt=e((()=>{z(),W(),pt={name:`asciidoc`,title:`AsciiDoc`,compiler:{url:ye,factory:()=>{let e=window.Asciidoctor();return async(t,{config:n})=>e.convert(t,{standalone:!0,attributes:{nofooter:!0},...H(`asciidoc`,n)})}},extensions:[`adoc`,`asciidoc`,`asc`],editor:`markup`}})),ht=e((()=>{mt()})),gt,_t,vt=e((()=>{z(),V(),gt=k+`assemblyscript/assemblyscript.js`,_t={name:`assemblyscript`,title:`AS`,longTitle:`AssemblyScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel]}},compiler:{url:gt,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-assemblyscript-compiler.js}}`),self.createAssemblyscriptCompiler()),scripts:({baseUrl:e})=>[be,e+`{{hash:lang-assemblyscript-script.js}}`],scriptType:`application/wasm-uint8`,compiledCodeLanguage:`wat`,types:{assemblyscript:{url:k+`types/assemblyscript.d.ts`,declareAsModule:!1,autoload:!0}}},extensions:[`as`,`ts`],editor:`script`,editorLanguage:`typescript`}})),yt=e((()=>{vt()})),bt,xt,St=e((()=>{z(),V(),bt=xe+`compiler.min.js`,xt={name:`astro`,title:`Astro`,formatter:{prettier:{name:`html`,pluginUrls:[B.html,B.babel]}},compiler:{url:bt,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-astro-compiler.js}}`),self.createAstroCompiler())},extensions:[`astro`],editor:`markup`}})),Ct=e((()=>{St()})),wt=e((()=>{})),G=e((()=>{wt(),U()})),Tt,Et=e((()=>{G(),z(),V(),Tt={name:`babel`,title:`Babel`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{url:Se,factory:()=>async(e,{config:t})=>{let n=H(`babel`,t),r=H(`@babel/preset-env`,t),i=H(`@babel/preset-typescript`,t),a=H(`@babel/preset-react`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...r}],[`typescript`,i],[`react`,a]],...n}).code}},extensions:[`es`,`babel`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),Dt=e((()=>{Et()})),Ot,kt=e((()=>{z(),Ot={name:`bbcode`,title:`BBCode`,compiler:{url:Ce,factory:()=>(self.importScripts(we),async e=>self.BbobHtml.default(e,self.BbobPresetHTML5.default()))},extensions:[`bbcode`,`bb`],editor:`markup`}})),At=e((()=>{kt()})),jt,Mt=e((()=>{jt={name:`blockly`,title:`Blockly`,compiler:{factory:()=>async(e,{options:t})=>t?.blockly?.js||``},extensions:[`blockly.xml`,`xml`],editor:`script`,editorLanguage:`xml`}})),Nt=e((()=>{Mt()})),Pt,Ft,It=e((()=>{z(),Pt=k+`civet/civet.js`,Ft={name:`civet`,title:`Civet`,compiler:{url:Pt,factory:()=>async e=>window.civet.compile(e,{js:!0})},extensions:[`civet`],editor:`script`,editorLanguage:`coffeescript`}})),Lt=e((()=>{It()})),Rt,zt=e((()=>{z(),Rt={name:`clio`,title:`Clio`,compiler:{url:Oe+`compile.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-clio-compiler.js}}`),self.createClioCompiler()),scripts:[Oe+`exec.js`]},extensions:[`clio`],editor:`script`,editorLanguage:`coffeescript`}})),Bt=e((()=>{zt()})),Vt,Ht=e((()=>{Vt=e=>typeof e==`string`?{code:e,info:{}}:e})),Ut,Wt=e((()=>{Ht(),Ut=async(e,t,n,r={},i=self)=>new Promise(a=>{if(!e||!t||!n)return a(Vt(``));let o=async function(n){let r=n.data.payload;n.data.trigger===`compileInCompiler`&&r?.content===e&&r?.language===t&&(i.removeEventListener(`message`,o),a(Vt(r.compiled)))};i.addEventListener(`message`,o),i.postMessage({type:`compileInCompiler`,payload:{content:e,language:t,config:n,options:r}})})})),Gt=e((()=>{U()})),Kt=e((()=>{W(),U(),Gt()})),qt=e((()=>{z()})),Jt,Yt,Xt,Zt,Qt,$t,en,tn=e((()=>{G(),z(),Jt={name:`autoprefixer`,title:`Autoprefixer`,isPostcssPlugin:!0,compiler:{url:k+`autoprefixer/autoprefixer.js`,factory:e=>self.autoprefixer.autoprefixer({...H(`autoprefixer`,e)})},editor:`style`},Yt={name:`cssnano`,title:`cssnano`,isPostcssPlugin:!0,compiler:{url:k+`cssnano/cssnano.js`,factory:()=>{let e=self.cssnano.cssnanoPresetDefault().plugins,t=[];for(let n of e){let[e,r]=n;(r===void 0||typeof r==`object`&&!r.exclude||typeof r==`boolean`&&r===!0)&&t.push(e(r))}return t}},editor:`style`},Xt={name:`postcssImportUrl`,title:`Import Url`,isPostcssPlugin:!0,compiler:{url:Ue,factory:e=>self.postcssImportUrl({...H(`postcssImportUrl`,e)})},editor:`style`},Zt={name:`postcssPresetEnv`,title:`Preset Env`,isPostcssPlugin:!0,compiler:{url:k+`postcss-preset-env/postcss-preset-env.js`,factory:e=>self.postcssPresetEnv.postcssPresetEnv({autoprefixer:!1,...H(`postcssPresetEnv`,e)})},editor:`style`},Qt={name:`purgecss`,title:`PurgeCSS`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:k+`purgecss/purgecss.js`,factory:(e,t,n)=>self.purgecss.purgecss({...H(`purgecss`,e),content:[{raw:`<template>${n.html}\n<script>${e.script.content}<\/script></template>`,extension:`html`}]})},editor:`style`},$t={name:`tokencss`,title:`Token CSS`,isPostcssPlugin:!0,compiler:{url:k+`tokencss/tokencss.js`,factory:e=>{let t=H(`tokencss`,e);Object.keys(t).length===0&&(t.$schema=`https://tokencss.com/schema@0.0.1`,t.extends=`@tokencss/core/preset`);let n=t.extends?.includes(`@tokencss/core/preset`)?((e,t)=>{let n=JSON.parse(JSON.stringify(e));return Object.keys(t).forEach(e=>{n[e]=typeof t[e]!=`object`||Array.isArray(t[e])?t[e]:{...n[e],...t[e]}}),n})(self.tokencss.preset,t):t;return self.tokencss.tokencss({config:n})}},editor:`style`},en={name:`cssmodules`,title:`CSS Modules`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:k+`postcss-modules/postcss-modules.js`,factory:(e,t,n)=>{let r=H(`cssmodules`,e);return self.postcssModules.postcssModules({localsConvention:`camelCase`,...r,getJSON(e,t,i){let a=r.addClassesToHTML!==!1,o=r.removeOriginalClasses===!0;a&&(n.html=self.postcssModules.addClassesToHtml(n.html,t,o)),n.compileInfo={...n.compileInfo,cssModules:t,...a?{modifiedHTML:n.html}:{}}}})}},editor:`style`}})),nn,rn=e((()=>{z(),nn={name:`postcss`,title:`Processors:`,isPostcssPlugin:!1,compiler:{url:k+`postcss/postcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-postcss-compiler.js}}`),self.createPostcssCompiler())},editor:`style`,hidden:!0}})),an=e((()=>{tn(),rn()})),on,sn=e((()=>{z(),on={name:`lightningcss`,title:`Lightning CSS`,isPostcssPlugin:!1,compiler:{url:k+`lightningcss/lightningcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-lightningcss-compiler.js}}`),self.createLightningcssCompiler())},editor:`style`}})),cn=e((()=>{sn()})),ln,un=e((()=>{z(),ln={name:`tailwindcss`,title:`Tailwind CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:k+`tailwindcss/tailwindcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-tailwindcss-compiler.js}}`),self.createTailwindcssCompiler())},editor:`style`}})),dn=e((()=>{un()})),fn,pn=e((()=>{z(),fn={name:`unocss`,title:`UnoCSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:k+`unocss/unocss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-unocss-compiler.js}}`),self.createUnocssCompiler())},editor:`style`}})),mn=e((()=>{pn()})),hn,gn=e((()=>{z(),hn={name:`windicss`,title:`Windi CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:k+`windicss/windicss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-windicss-compiler.js}}`),self.createWindicssCompiler())},editor:`style`}})),_n=e((()=>{gn()})),vn,yn=e((()=>{cn(),an(),dn(),mn(),_n(),vn=[...[ln,hn,fn,$t,Qt,Xt,Jt,Zt,on,Yt,en],nn]})),bn=e((()=>{qt(),ks(),an(),V(),yn(),W()})),xn=e((()=>{bn(),G()})),Sn,Cn=e((()=>{Sn=(e=location.origin)=>!!(e&&(e.endsWith(`livecodes.io`)||e.endsWith(`livecodes.pages.dev`)||e.endsWith(`localpen.pages.dev`)||e.includes(`127.0.0.1`)||e.includes(`localhost:`)||e.endsWith(`localhost`)||e.endsWith(`.test`)))})),wn=t(((e,t)=>{var n=(function(){var e=String.fromCharCode,t=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=`,n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$`,r={};function i(e,t){if(!r[e]){r[e]={};for(var n=0;n<e.length;n++)r[e][e.charAt(n)]=n}return r[e][t]}var a={compressToBase64:function(e){if(e==null)return``;var n=a._compress(e,6,function(e){return t.charAt(e)});switch(n.length%4){default:case 0:return n;case 1:return n+`===`;case 2:return n+`==`;case 3:return n+`=`}},decompressFromBase64:function(e){return e==null?``:e==``?null:a._decompress(e.length,32,function(n){return i(t,e.charAt(n))})},compressToUTF16:function(t){return t==null?``:a._compress(t,15,function(t){return e(t+32)})+` `},decompressFromUTF16:function(e){return e==null?``:e==``?null:a._decompress(e.length,16384,function(t){return e.charCodeAt(t)-32})},compressToUint8Array:function(e){for(var t=a.compress(e),n=new Uint8Array(t.length*2),r=0,i=t.length;r<i;r++){var o=t.charCodeAt(r);n[r*2]=o>>>8,n[r*2+1]=o%256}return n},decompressFromUint8Array:function(t){if(t==null)return a.decompress(t);for(var n=Array(t.length/2),r=0,i=n.length;r<i;r++)n[r]=t[r*2]*256+t[r*2+1];var o=[];return n.forEach(function(t){o.push(e(t))}),a.decompress(o.join(``))},compressToEncodedURIComponent:function(e){return e==null?``:a._compress(e,6,function(e){return n.charAt(e)})},decompressFromEncodedURIComponent:function(e){return e==null?``:e==``?null:(e=e.replace(/ /g,`+`),a._decompress(e.length,32,function(t){return i(n,e.charAt(t))}))},compress:function(t){return a._compress(t,16,function(t){return e(t)})},_compress:function(e,t,n){if(e==null)return``;var r,i,a={},o={},s=``,c=``,l=``,u=2,d=3,f=2,p=[],m=0,h=0,g;for(g=0;g<e.length;g+=1)if(s=e.charAt(g),Object.prototype.hasOwnProperty.call(a,s)||(a[s]=d++,o[s]=!0),c=l+s,Object.prototype.hasOwnProperty.call(a,c))l=c;else{if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++),a[c]=d++,l=String(s)}if(l!==``){if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++)}for(i=2,r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;for(;;)if(m<<=1,h==t-1){p.push(n(m));break}else h++;return p.join(``)},decompress:function(e){return e==null?``:e==``?null:a._decompress(e.length,32768,function(t){return e.charCodeAt(t)})},_decompress:function(t,n,r){var i=[],a=4,o=4,s=3,c=``,l=[],u,d,f,p,m,h,g,_={val:r(0),position:n,index:1};for(u=0;u<3;u+=1)i[u]=u;for(f=0,m=2**2,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 2:return``}for(i[3]=g,d=g,l.push(g);;){if(_.index>t)return``;for(f=0,m=2**s,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(g=f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 2:return l.join(``)}if(a==0&&(a=2**s,s++),i[g])c=i[g];else if(g===o)c=d+d.charAt(0);else return null;l.push(c),i[o++]=d+c.charAt(0),a--,d=c,a==0&&(a=2**s,s++)}}};return a})();typeof define==`function`&&define.amd?define(function(){return n}):t!==void 0&&t!=null&&(t.exports=n)})),Tn=e((()=>{wn()})),En=e((()=>{})),Dn=e((()=>{})),On=e((()=>{})),kn=e((()=>{En(),Dn(),On()})),An=e((()=>{})),jn=e((()=>{kn(),U(),z()})),Mn=e((()=>{Tn(),jn()})),Nn=e((()=>{jn()})),Pn=e((()=>{kn()})),Fn=e((()=>{U(),Nn(),Pn(),jn()})),In=e((()=>{Mn(),An(),Nn(),Pn(),jn(),Fn()})),Ln=e((()=>{In(),G()})),Rn=e((()=>{})),zn=e((()=>{G()})),Bn=e((()=>{`${{}.SANDBOX_HOST_NAME}${{}.SANDBOX_PORT}`,location.hostname===`localhost`||location.hostname===`127.0.0.1`||{}.SELF_HOSTED===`true`||{}.CI})),Vn=e((()=>{Cn(),{}.SELF_HOSTED===`true`?{}.SELF_HOSTED_SHARE:Sn()})),Hn=e((()=>{Gt()})),Un=e((()=>{Cn(),Ln(),Rn(),zn(),ge(),Bn(),Vn(),Hn()})),Wn=e((()=>{bn(),Un(),G(),xn(),Gt()})),Gn=e((()=>{Wn()})),Kn=e((()=>{Kt(),Wt(),xn(),Gn(),Gt(),Ht()})),K,q,J=e((()=>{n(),K=async e=>{let{LanguageSupport:t,StreamLanguage:n}=await r(async()=>{let{LanguageSupport:e,StreamLanguage:t}=await import(q.language);return{LanguageSupport:e,StreamLanguage:t}},[],import.meta.url);return new t(n.define(e))},q={html:`@codemirror/lang-html`,css:`@codemirror/lang-css`,javascript:`@codemirror/lang-javascript`,json:`@codemirror/lang-json`,language:`@codemirror/language`}})),Y,qn,Jn=e((()=>{z(),Y=()=>{let e=He;return self.importScripts(e),async e=>({formatted:window.parinfer.parenMode(e).text,cursorOffset:0})},qn={name:`commonlisp`,title:`Lisp`,longTitle:`Common Lisp`,formatter:{factory:Y},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Ie,e+`{{hash:lang-commonlisp-script.js}}`],scriptType:`text/commonlisp`,compiledCodeLanguage:`commonlisp`},extensions:[`lisp`,`common-lisp`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`commonlisp.js`},codemirror:{language:`scheme`},codejar:{language:`scheme`}}}})),Yn=e((()=>{Jn()})),Xn,Zn=e((()=>{Kn(),J(),z(),Yn(),n(),Xn={name:`clojurescript`,title:`CLJS (cherry)`,longTitle:`ClojureScript (cherry)`,formatter:{factory:Y},compiler:{url:De+`lib/cherry.umd.js`,factory:()=>async(e,{config:t,options:n})=>{let r=self.CherryCljs.compileString(e);return e.includes(`#jsx`)?(await Ut(r,`jsx`,t,n)).code:r},imports:{"cherry-cljs":De+`index.js`,"cherry-cljs/cljs.core.js":De+`cljs.core.js`,"cherry-cljs/lib/clojure.string.js":`lib/clojure.string.js`,"cherry-cljs/lib/clojure.set.js":`lib/clojure.set.js`,"cherry-cljs/lib/clojure.walk.js":`lib/clojure.walk.js`,"squint-cljs":I+`index.js`,"squint-cljs/core.js":I+`core.js`,"squint-cljs/string.js":I+`string.js`,"squint-cljs/src/squint/string.js":I+`src/squint/string.js`,"squint-cljs/src/squint/set.js":I+`src/squint/set.js`}},extensions:[`cljs`,`clj`,`cljc`,`edn`,`clojure`],editor:`script`,editorLanguage:`clojure`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{clojure:e}=await import(A+`codemirror-lang-clojure.js`);return{clojure:e}},[],import.meta.url)).clojure)}}}})),Qn=e((()=>{Zn()})),$n,er=e((()=>{J(),G(),z(),n(),$n={name:`coffeescript`,title:`Coffee`,longTitle:`CoffeeScript`,compiler:{url:ke,factory:()=>async(e,{config:t})=>window.CoffeeScript.compile(e,{bare:!0,...H(`coffeescript`,t)})},extensions:[`coffee`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{coffeescript:e}=await import(A+`codemirror-lang-coffeescript.js`);return{coffeescript:e}},[],import.meta.url)).coffeescript)}}}})),tr=e((()=>{er()})),nr,rr,ir=e((()=>{z(),n(),nr=k+`jscpp/JSCPP.es5.min.js`,rr={name:`cpp`,title:`C++`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[nr,e+`{{hash:lang-cpp-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`},extensions:[`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`cpp.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{cpp:e}=await import(A+`codemirror-lang-cpp.js`);return{cpp:e}},[],import.meta.url)).cpp()}}}})),ar=e((()=>{ir()})),or,sr=e((()=>{or={name:`cpp-wasm`,title:`C++ (Wasm)`,longTitle:`C/C++ (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-cpp-wasm-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`,liveReload:!0},extensions:[`wasm.cpp`,`cppwasm`,`cwasm`,`clang.cpp`,`clang`,`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorLanguage:`cpp`,largeDownload:!0}})),cr=e((()=>{sr()})),lr,ur=e((()=>{J(),z(),V(),n(),lr={name:`csharp-wasm`,title:`C# (Wasm)`,formatter:{prettier:{name:`java`,pluginUrls:[B.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-csharp-wasm-script.js}}`],scriptType:`text/csharp-wasm`,compiledCodeLanguage:`csharp-wasm`,liveReload:!0},extensions:[`cs`,`csharp`,`wasm.cs`,`cs-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`csharp.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{csharp:e}=await import(A+`codemirror-lang-clike.js`);return{csharp:e}},[],import.meta.url)).csharp)},codejar:{language:`csharp`}},largeDownload:!0}})),dr=e((()=>{ur()})),fr,pr=e((()=>{J(),V(),n(),fr={name:`css`,title:`CSS`,info:!1,formatter:{prettier:{name:`css`,pluginUrls:[B.postcss]}},compiler:{factory:()=>async e=>e},extensions:[`css`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>{let{css:e}=await r(async()=>{let{css:e}=await import(q.css);return{css:e}},[],import.meta.url);return e()}}}}})),mr=e((()=>{pr()})),hr,gr,_r=e((()=>{V(),n(),hr=async(e,{baseUrl:t,config:n})=>{let{diagramsCompiler:i}=await r(async()=>{let{diagramsCompiler:e}=await import(t+`{{hash:lang-diagrams-compiler-esm.js}}`);return{diagramsCompiler:e}},[],import.meta.url);return i(e,{config:n})},gr={name:`diagrams`,title:`Diagrams`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{factory:()=>async e=>e||``,runOutsideWorker:hr},extensions:[`diagrams`,`diagram`,`graph`,`plt`],editor:`markup`,editorLanguage:`html`}})),vr=e((()=>{_r()})),yr,br=e((()=>{z(),V(),yr={name:`dot`,title:`doT`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:Ae,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-dot-compiler.js}}`),self.createDotCompiler())},extensions:[`dot`],editor:`markup`,editorLanguage:`html`}})),xr=e((()=>{br()})),Sr,Cr=e((()=>{z(),V(),Sr={name:`ejs`,title:`EJS`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:je,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-ejs-compiler.js}}`),self.createEjsCompiler())},extensions:[`ejs`],editor:`markup`,editorLanguage:`html`}})),wr=e((()=>{Cr()})),Tr,Er=e((()=>{z(),V(),Tr={name:`eta`,title:`Eta`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:Me,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-eta-compiler.js}}`),self.createEtaCompiler())},extensions:[`eta`],editor:`markup`,editorLanguage:`html`}})),Dr=e((()=>{Er()})),Or,kr=e((()=>{z(),Yn(),Or={name:`fennel`,title:`Fennel`,formatter:{factory:Y},compiler:{url:M,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-fennel-compiler.js}}`),self.createFennelCompiler()),scripts:[M],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`fnl`],editor:`script`,editorLanguage:`scheme`}})),Ar=e((()=>{kr()})),jr,Mr=e((()=>{G(),z(),V(),jr={name:`flow`,title:`Flow`,formatter:{prettier:{name:`babel-flow`,pluginUrls:[B.babel,B.html]}},compiler:{url:k+`flow-remove-types/flow-remove-types.js`,factory:()=>async(e,{config:t})=>window.flowRemoveTypes.transpile(e,{all:!0,...H(`flow`,t)}).toString()},extensions:[`flow`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),Nr=e((()=>{Mr()})),Pr,Fr=e((()=>{J(),z(),n(),Pr={name:`gleam`,title:`Gleam`,compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-gleam-compiler.js}}`),self.createGleamCompiler()),loadAsExternalModule:!0,inlineModule:`(async() => {
      const main = (await import('./script')).main;
      if (typeof main === "function") main();
    })();
`},extensions:[`gleam`],editor:`script`,editorSupport:{monaco:{language:`swift`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{swift:e}=await import(A+`codemirror-lang-swift.js`);return{swift:e}},[],import.meta.url)).swift)},codejar:{language:`swift`}}}})),Ir=e((()=>{Fr()})),Lr,Rr=e((()=>{z(),n(),Lr={name:`go`,title:`Go`,formatter:{factory:()=>(importScripts(j+`go2js-format.js`),async e=>{if(!e)return{formatted:``,cursorOffset:0};let[t,n]=globalThis.go2jsFormat(e);return n?(console.error(n),{formatted:e,cursorOffset:0}):{formatted:t,cursorOffset:0}})},compiler:{url:j+`go2js-compile.js`,factory:()=>e=>new Promise(t=>{if(!e){t(``);return}let n=j.endsWith(`/`)?j.slice(0,-1):j;globalThis.go2jsCompile(e,n,(e,n)=>{e?(console.error(e),t(``)):t(n)})})},extensions:[`go`,`golang`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`go.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{go:e}=await import(A+`codemirror-lang-go.js`);return{go:e}},[],import.meta.url)).go()}}}})),zr=e((()=>{Rr()})),Br,Vr=e((()=>{Rr(),Br={name:`go-wasm`,title:`Go (Wasm)`,formatter:Lr.formatter,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-go-wasm-script.js}}`],liveReload:!0,scriptType:`text/go-wasm`,compiledCodeLanguage:`go`},extensions:[`wasm.go`,`go-wasm`,`gowasm`],editor:`script`,editorLanguage:`go`,largeDownload:!0}})),Hr=e((()=>{Vr()})),Ur,Wr=e((()=>{z(),Ur={name:`haml`,title:`Haml`,compiler:{url:k+`clientside-haml-js/haml.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-haml-compiler.js}}`),self.createHamlCompiler())},extensions:[`haml`],editor:`markup`}})),Gr=e((()=>{Wr()})),Kr,qr,Jr=e((()=>{z(),V(),Kr=Pe+`handlebars.min.js`,Pe+``,qr={name:`handlebars`,title:`Handlebars`,formatter:{prettier:{name:`glimmer`,pluginUrls:[B.glimmer]}},compiler:{url:Kr,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-handlebars-compiler.js}}`),self.createHandlebarsCompiler())},extensions:[`hbs`,`handlebars`],editor:`markup`,editorLanguage:`html`}})),Yr=e((()=>{Jr()})),Xr,Zr=e((()=>{J(),V(),n(),Xr={name:`html`,title:`HTML`,info:!1,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{factory:()=>async e=>e},extensions:[`html`,`htm`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>{let{html:e}=await r(async()=>{let{html:e}=await import(q.html);return{html:e}},[],import.meta.url);return e()}}}}})),Qr=e((()=>{Zr()})),$r,ei=e((()=>{z(),$r={name:`imba`,title:`Imba`,compiler:{url:Fe+`compiler.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-imba-compiler.js}}`),self.createImbaCompiler()),imports:{imba:Fe+`imba.mjs`}},extensions:[`imba`],editor:`script`}})),ti=e((()=>{ei()})),ni,ri=e((()=>{z(),V(),n(),ni={name:`java`,title:`Java`,formatter:{prettier:{name:`java`,pluginUrls:[B.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-java-script.js}}`],scriptType:`text/java`,compiledCodeLanguage:`java`,liveReload:!0},extensions:[`java`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`java.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{java:e}=await import(A+`codemirror-lang-java.js`);return{java:e}},[],import.meta.url)).java()}},largeDownload:!0}})),ii=e((()=>{ri()})),ai,oi=e((()=>{J(),V(),n(),ai={name:`javascript`,title:`JS`,longTitle:`JavaScript`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{factory:()=>async e=>e},extensions:[`js`,`mjs`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e()}}}}})),si=e((()=>{oi()})),ci,li,ui=e((()=>{z(),ci=`${k}jinja/jinja.js`,li={name:`jinja`,title:`Jinja`,formatter:{factory:()=>(self.importScripts(ci),async(e,t,n)=>({formatted:new self.Jinja.Template(e).format({indent:n?.tabSize||2}),cursorOffset:t}))},compiler:{url:ci,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-jinja-compiler.js}}`),self.createJinjaCompiler())},extensions:[`jinja`],editor:`markup`,editorLanguage:`html`}})),di=e((()=>{ui()})),fi,pi=e((()=>{J(),V(),n(),fi={name:`jsx`,title:`JSX`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:`typescript`,extensions:[`jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0})}},compilerOptions:{jsx:4}}}})),mi,hi=e((()=>{J(),V(),n(),mi={name:`tsx`,title:`TSX`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:`typescript`,extensions:[`tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0,typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),gi=e((()=>{pi(),hi()})),_i,vi=e((()=>{J(),z(),n(),_i={name:`julia`,title:`Julia`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-julia-script.js}}`],liveReload:!0,scriptType:`text/julia`,compiledCodeLanguage:`julia`},extensions:[`jl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{julia:e}=await import(A+`codemirror-lang-julia.js`);return{julia:e}},[],import.meta.url)).julia)}},largeDownload:!0}})),yi=e((()=>{vi()})),bi,xi=e((()=>{J(),G(),z(),V(),n(),bi={name:`less`,title:`Less`,formatter:{prettier:{name:`less`,pluginUrls:[B.postcss]}},compiler:{url:k+`less/less.js`,factory:()=>async(e,{config:t})=>(await window.less.render(e,{...H(`less`,t)})).css},extensions:[`less`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{less:e}=await import(A+`codemirror-lang-less.js`);return{less:e}},[],import.meta.url)).less)}}}})),Si=e((()=>{xi()})),Ci,wi=e((()=>{z(),V(),n(),Ci={name:`liquid`,title:`Liquid`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:Le,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-liquid-compiler.js}}`),self.createLiquidCompiler())},extensions:[`liquid`,`liquidjs`],editor:`markup`,editorLanguage:`html`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{liquid:e}=await import(A+`codemirror-lang-liquid.js`);return{liquid:e}},[],import.meta.url)).liquid()}}}})),Ti=e((()=>{wi()})),Ei,Di=e((()=>{J(),G(),z(),n(),Ei={name:`livescript`,title:`LiveScript`,compiler:{url:k+`livescript/livescript-min.js`,factory:()=>async(e,{config:t})=>window.require(`livescript`).compile(e,{bare:!0,...H(`livescript`,t)}),scripts:[k+`livescript/prelude-browser-min.js`]},extensions:[`ls`],editor:`script`,editorSupport:{monaco:{language:`coffeescript`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{livescript:e}=await import(A+`codemirror-lang-livescript.js`);return{livescript:e}},[],import.meta.url)).livescript)}}}})),Oi=e((()=>{Di()})),ki,Ai,ji,Mi=e((()=>{J(),z(),n(),ki=k+`lua-fmt/lua-fmt.js`,Ai={factory:()=>(self.importScripts(ki),async(e,t)=>({formatted:self.luaFmt.formatText(e),cursorOffset:t}))},ji={name:`lua`,title:`Lua`,formatter:Ai,compiler:{factory:()=>async e=>e,scripts:[M],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`lua`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`lua.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{lua:e}=await import(A+`codemirror-lang-lua.js`);return{lua:e}},[],import.meta.url)).lua)}}}})),Ni=e((()=>{Mi()})),Pi,Fi=e((()=>{z(),Mi(),Pi={name:`lua-wasm`,title:`Lua (Wasm)`,formatter:Ai,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[ct,e+`{{hash:lang-lua-wasm-script.js}}`],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`wasm.lua`,`luawasm`],editor:`script`,editorLanguage:`lua`}})),Ii=e((()=>{Fi()})),Li,Ri=e((()=>{z(),V(),Li={name:`malina`,title:`Malina.js`,formatter:{prettier:{name:`html`,pluginUrls:[B.html,B.babel]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-malina-compiler.js}}`),self.createMalinaCompiler()),imports:{"malinajs/runtime.js":`${Re}runtime.js`}},extensions:[`xht`],editor:`script`,editorLanguage:`html`}})),zi=e((()=>{Ri()})),Bi,Vi=e((()=>{z(),V(),n(),Bi={name:`markdown`,title:`Markdown`,formatter:{prettier:{name:`markdown`,pluginUrls:[B.markdown,B.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-markdown-compiler.js}}`),self.createMarkdownCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-markdown-script.js}}`]},extensions:[`md`,`markdown`,`mdown`,`mkdn`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{markdown:e}=await import(A+`codemirror-lang-markdown.js`);return{markdown:e}},[],import.meta.url)).markdown()}}}})),Hi=e((()=>{Vi()})),Ui,Wi,Gi=e((()=>{Wt(),G(),z(),V(),n(),Ui=async(e,{config:t,worker:n})=>new Promise(async i=>{if(!e)return i(``);let[a,{default:o}]=await Promise.all([r(()=>import(k+`mdx/mdx.js`),[],import.meta.url),r(()=>import(k+`remark-gfm/remark-gfm.js`),[],import.meta.url)]),s=(await a.compile(e,{remarkPlugins:[o],...H(`mdx`,t)})).value,c=(await Ut(`import React from "react";
import { createRoot } from "react-dom/client";
${ft((e=>e.replace(/, {[^}]*} = _components/g,``).replace(/const {[^:]*} = props.components[^;]*;/g,``))(s),!1)}
createRoot(document.querySelector('#__livecodes_mdx_root__')).render(<MDXContent />,);
`,`jsx`,t,{},n)).code;i(`<div id="__livecodes_mdx_root__"></div><script type="module">${c}<\/script>`)}),Wi={name:`mdx`,title:`MDX`,formatter:{prettier:{name:`markdown`,pluginUrls:[B.markdown,B.html]}},compiler:{factory:()=>async e=>e,runOutsideWorker:Ui,compiledCodeLanguage:`javascript`},extensions:[`mdx`],editor:`markup`,editorLanguage:`markdown`}})),Ki=e((()=>{Gi()})),qi,Ji=e((()=>{z(),V(),n(),qi={name:`minizinc`,title:`MiniZinc`,formatter:{prettier:{name:`minizinc`,pluginUrls:[B.minizinc]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-minizinc-script.js}}`],scriptType:`text/minizinc`,compiledCodeLanguage:`minizinc`},extensions:[`mzn`,`dzn`,`minizinc`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`minizinc.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{MiniZinc:e}=await import(A+`codemirror-lang-minizinc.js`);return{MiniZinc:e}},[],import.meta.url)).MiniZinc()}}}})),Yi=e((()=>{Ji()})),Xi,Zi=e((()=>{G(),z(),V(),Xi={name:`mjml`,title:`MJML`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:ze,factory:()=>async(e,{config:t})=>{if(!e.trim())return``;let{html:n,errors:r}=self.mjml(e,H(`mjml`,t));return r?.forEach(e=>{console.warn(e.formattedMessage)}),n}},extensions:[`mjml`],editor:`markup`,editorLanguage:`xml`}})),Qi=e((()=>{Zi()})),$i,ea=e((()=>{z(),V(),$i={name:`mustache`,title:`Mustache`,formatter:{prettier:{name:`glimmer`,pluginUrls:[B.glimmer]}},compiler:{url:Be,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-mustache-compiler.js}}`),self.createMustacheCompiler())},extensions:[`mustache`],editor:`markup`,editorLanguage:`html`}})),ta=e((()=>{ea()})),na,ra,ia=e((()=>{z(),V(),na=Ve+`nunjucks.min.js`,Ve+``,ra={name:`nunjucks`,title:`Nunjucks`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:na,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-nunjucks-compiler.js}}`),self.createNunjucksCompiler())},extensions:[`njk`,`nunjucks`],editor:`markup`,editorLanguage:`html`}})),aa=e((()=>{ia()})),oa,sa=e((()=>{J(),z(),n(),oa={name:`ocaml`,title:`OCaml`,compiler:`rescript`,extensions:[`ml`,`mli`],editor:`script`,editorSupport:{monaco:{language:`csharp`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{oCaml:e}=await import(A+`codemirror-lang-mllike.js`);return{oCaml:e}},[],import.meta.url)).oCaml)}}}})),ca=e((()=>{sa()})),la,ua=e((()=>{J(),z(),n(),la={name:`perl`,title:`Perl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[k+`perlito/perlito5.min.js`,e+`{{hash:lang-perl-script.js}}`],scriptType:`text/perl`},extensions:[`pl`,`pm`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{perl:e}=await import(A+`codemirror-lang-perl.js`);return{perl:e}},[],import.meta.url)).perl)}}}})),da=e((()=>{ua()})),fa,pa=e((()=>{z(),V(),n(),fa={name:`php`,title:`PHP`,formatter:{prettier:{name:`php`,pluginUrls:[B.php]}},compiler:{factory:()=>async e=>(e=e.trim(),e.startsWith(`<?php`)&&(e=e.replace(`<?php`,`/* <?php */`),e.endsWith(`?>`)&&(e=e.replace(`?>`,`/* ?> */`))),e),scripts:[nt],deferScripts:!0,scriptType:`text/x-uniter-php`,compiledCodeLanguage:`php`},extensions:[`php`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`php.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{php:e}=await import(A+`codemirror-lang-php.js`);return{php:e}},[],import.meta.url)).php()}}}})),ma=e((()=>{pa()})),ha,ga=e((()=>{z(),V(),ha={name:`php-wasm`,title:`PHP (Wasm)`,formatter:{prettier:{name:`php`,pluginUrls:[B.php]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[k+`php-wasm/php-wasm.js`,e+`{{hash:lang-php-wasm-script.js}}`],scriptType:`text/php-wasm`,compiledCodeLanguage:`php`},extensions:[`wasm.php`,`phpwasm`],editor:`script`,editorLanguage:`php`}})),_a=e((()=>{ga()})),va,ya,ba=e((()=>{z(),n(),va=async(e,{baseUrl:t,config:n})=>{let{pgSqlCompiler:i}=await r(async()=>{let{pgSqlCompiler:e}=await import(t+`{{hash:lang-postgresql-compiler-esm.js}}`);return{pgSqlCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,config:n})},ya={name:`postgresql`,title:`PostgreSQL`,formatter:{factory:()=>(importScripts(Ye),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{factory:()=>async e=>e,runOutsideWorker:va,scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:`application/json`,compiledCodeLanguage:`json`},extensions:[`pg.sql`,`pgsql`,`pgsql.sql`,`pgsql`,`pg`,`pglite`,`pglite.sql`,`postgresql`,`postgres`,`postgre.sql`,`postgresql.sql`],editor:`script`,editorLanguage:`sql`}})),xa=e((()=>{ba()})),Sa,Ca=e((()=>{z(),n(),Sa={name:`prolog`,title:`Prolog`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[R+`core.js`,R+`charsio.js`,R+`dom.js`,R+`format.js`,R+`js.js`,R+`lists.js`,R+`os.js`,R+`promises.js`,R+`random.js`,R+`statistics.js`,e+`{{hash:lang-prolog-script.js}}`],scriptType:`text/prolog`,compiledCodeLanguage:`prolog`},extensions:[`prolog.pl`,`prolog`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`prolog.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{prolog:e}=await import(A+`codemirror-lang-prolog.js`);return{prolog:e}},[],import.meta.url)).prolog()}}}})),wa=e((()=>{Ca()})),Ta,Ea=e((()=>{z(),Ta={name:`pug`,title:`Pug`,compiler:{url:k+`pug/pug.min.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-pug-compiler.js}}`),self.createPugCompiler())},extensions:[`pug`,`jade`],editor:`markup`}})),Da=e((()=>{Ea()})),Oa,ka,Aa,ja=e((()=>{U(),z(),n(),Oa=Ee+`brython.min.js`,ka=Ee+`brython_stdlib.js`,Aa={name:`python`,title:`Python`,compiler:{factory:()=>async e=>e,scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n}=H(`python`,t);return[Oa,...n!==!1&&e.match(/^(?:from[ ]+(\S+)[ ]+)?import[ ]+(\S+)(?:[ ]+as[ ]+\S+)?[ ]*$/gm)?[ka]:[]]},scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`py`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`python.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{python:e}=await import(A+`codemirror-lang-python.js`);return{python:e}},[],import.meta.url)).python()}}}})),Ma=e((()=>{ja()})),Na,Pa=e((()=>{Na={name:`python-wasm`,title:`Py (Wasm)`,longTitle:`Python (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-python-wasm-script.js}}`],liveReload:!0,scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`wasm.py`,`py3`,`pyodide`,`py-wasm`,`pythonwasm`,`pywasm`],editor:`script`,editorLanguage:`python`,largeDownload:!0}})),Fa=e((()=>{Pa()})),Ia,La=e((()=>{J(),z(),n(),Ia={name:`r`,title:`R`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-r-script-esm.js}}`],inlineScript:`
    ...
    `,liveReload:!0,scriptType:`text/r`,compiledCodeLanguage:`r`},extensions:[`r`,`rlang`,`rstats`,`r-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`r.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{r:e}=await import(A+`codemirror-lang-r.js`);return{r:e}},[],import.meta.url)).r)}},largeDownload:!0}})),Ra=e((()=>{La()})),za,Ba=e((()=>{z(),V(),W(),za={name:`react`,title:`React`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{dependencies:[`babel`],url:k+`babel-plugin-react-compiler/babel-plugin-react-compiler.js`,factory:()=>async(e,{config:t,language:n})=>{let r=H(`babel`,t),i=H(`@babel/preset-env`,t),a=H(`@babel/preset-typescript`,t),o=H(`@babel/preset-react`,t),s=H(`babel-plugin-react-compiler`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...i}],...n===`react-tsx`?[`typescript`,a]:[],[`react`,{runtime:`automatic`,...o}]],plugins:[[window.reactCompiler.reactCompiler,s]],...r}).code}},extensions:[`react.jsx`,`react-jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),Va,Ha=e((()=>{V(),Va={name:`react-tsx`,title:`React (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:`react`,extensions:[`react.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),Ua=e((()=>{Ba(),Ha()})),Wa,Ga,Ka,qa=e((()=>{J(),G(),z(),V(),n(),Wa=(e,t)=>{let n={...H(`typescript`,t),...H(t.script.language,t)};return!!(n.jsx||n.jsxFactory||new RegExp(/\/\*\*[\s\*]*((@jsx)|(@jsxImportSource))\s/g).test(e))},Ga={target:`es2020`,jsx:`react`,allowUmdGlobalAccess:!0,esModuleInterop:!0},Ka={name:`typescript`,title:`TS`,longTitle:`TypeScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:{url:tt,factory:()=>async(e,{config:t})=>window.ts.transpile(e,{...Ga,...[`jsx`,`tsx`].includes(t.script.language)&&!Wa(e,t)?{jsx:`react-jsx`}:{},...H(`typescript`,t),...H(t.script.language,t)})},extensions:[`ts`,`mts`,`typescript`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0}}}})),Ja=e((()=>{qa()})),Ya,Xa,Za=e((()=>{z(),V(),Ja(),W(),Ya=k+`react-native-web/react-native-web.js`,Xa={name:`react-native`,title:`RN`,longTitle:`React Native`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{dependencies:[`typescript`],factory:()=>async(e,{config:t,language:n})=>window.ts.transpile(e,{...Ga,jsx:`react-jsx`,...H(`typescript`,t),...H(n,t)}),imports:{react:Ya,"react-native":Ya}},extensions:[`react-native.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),Qa,$a=e((()=>{V(),Qa={name:`react-native-tsx`,title:`RN (TSX)`,longTitle:`React Native (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:`react-native`,extensions:[`react-native.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),eo=e((()=>{Za(),$a()})),to,no,ro,io=e((()=>{n(),to=async(e,{baseUrl:t,language:n})=>{let{rescriptCompiler:i}=await r(async()=>{let{rescriptCompiler:e}=await import(t+`{{hash:lang-rescript-compiler-esm.js}}`);return{rescriptCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,language:n})},no=(e,t)=>(importScripts(e+`{{hash:lang-rescript-formatter.js}}`),self.createRescriptFormatter(e,t)),ro={name:`rescript`,title:`ReScript`,formatter:{factory:no},compiler:{factory:()=>async e=>e,runOutsideWorker:to,scriptType:`module`},extensions:[`res`,`resi`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),ao=e((()=>{io()})),oo,so=e((()=>{ao(),oo={name:`reason`,title:`Reason`,formatter:{factory:no},compiler:`rescript`,extensions:[`re`,`rei`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),co=e((()=>{so()})),lo,uo=e((()=>{lo={name:`richtext`,title:`Rich Text`,longTitle:`Rich Text Editor`,compiler:{factory:()=>async(e,{config:t})=>t.markup.content||``,styles:[`{{hash:quill.css}}`]},extensions:[`rte`,`rte.html`,`rich`],editor:`markup`,editorLanguage:`html`}})),fo=e((()=>{uo()})),po,mo,ho,go=e((()=>{z(),V(),po=qe+`riot+compiler.min.js`,mo=qe+`riot.min.js`,ho={name:`riot`,title:`Riot.js`,formatter:{prettier:{name:`html`,pluginUrls:[B.html,B.babel]}},compiler:{url:po,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-riot-compiler.js}}`),self.createRiotCompiler()),scripts:[mo],scriptType:`module`},extensions:[`riot`,`riotjs`],editor:`script`,editorLanguage:`html`}})),_o=e((()=>{go()})),vo,yo,bo=e((()=>{J(),G(),z(),n(),vo=(e,t={})=>Array.from(new Set([...e.matchAll(new RegExp(/^\s*self\.\$require\("(\S+)"\);/gm))].map(e=>e[1]).map(e=>e.split(`/`)[0]).filter(e=>t.hasOwnProperty(e)||e!==`opal`).map(e=>t[e]||`${P+e}.min.js`))),yo={name:`ruby`,title:`Ruby`,compiler:{url:P+`opal.min.js`,factory:()=>(importScripts(P+`opal-parser.min.js`),self.Opal.config.unsupported_features_severity=`ignore`,self.Opal.load(`opal-parser`),async(e,{config:t})=>{let{autoloadStdlib:n,requireMap:r,...i}=H(`ruby`,t),a=e.includes(`$0`)?`$0 = __FILE__
`:``;return self.Opal.compile(a+e,i)}),scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n,requireMap:r}=H(`ruby`,t),i=vo(e,r),a=n===!1?[]:i;return[P+`opal.min.js`,...a]}},extensions:[`rb`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`ruby.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{ruby:e}=await import(A+`codemirror-lang-ruby.js`);return{ruby:e}},[],import.meta.url)).ruby)}}}})),xo=e((()=>{bo()})),So,Co=e((()=>{z(),So={name:`ruby-wasm`,title:`Ruby (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Je,e+`{{hash:lang-ruby-wasm-script.js}}`],liveReload:!0,scriptType:`text/ruby-wasm`,compiledCodeLanguage:`ruby`},extensions:[`wasm.rb`,`rubywasm`],editor:`script`,editorLanguage:`ruby`,largeDownload:!0}})),wo=e((()=>{Co()})),To,Eo=e((()=>{J(),z(),Yn(),n(),To={name:`scheme`,title:`Scheme`,formatter:{factory:Y},compiler:{factory:()=>async e=>e,scripts:[Te],scriptType:`text/biwascheme`,compiledCodeLanguage:`scheme`},extensions:[`scm`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`scheme.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{scheme:e}=await import(A+`codemirror-lang-scheme.js`);return{scheme:e}},[],import.meta.url)).scheme)}}}})),Do=e((()=>{Eo()})),Oo,ko=e((()=>{z(),n(),Oo={name:`sass`,title:`Sass`,compiler:`scss`,extensions:[`sass`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(A+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass({indented:!0})}}}})),Ao,jo=e((()=>{z(),V(),n(),Ao={name:`scss`,title:`SCSS`,formatter:{prettier:{name:`scss`,pluginUrls:[B.postcss]}},compiler:{url:k+`sass/sass.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-scss-compiler.js}}`),self.createScssCompiler())},extensions:[`scss`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(A+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass()}}}})),Mo=e((()=>{ko(),jo()})),No,Po=e((()=>{ge(),z(),V(),No={name:`solid`,title:`Solid`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{dependencies:[`babel`],url:k+`babel-preset-solid/babel-preset-solid.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-solid-compiler.js}}`),self.createSolidCompiler()),imports:{"solid-js":D.getModuleUrl(`solid-js`),"solid-js/web":D.getModuleUrl(`solid-js/web`)}},extensions:[`solid.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),Fo,Io=e((()=>{V(),Fo={name:`solid.tsx`,title:`Solid (TS)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:`solid`,extensions:[`solid.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),Lo=e((()=>{Po(),Io()})),Ro,zo,Bo=e((()=>{z(),n(),Ro=`application/json`,zo={name:`sql`,title:`SQL`,formatter:{factory:()=>(importScripts(Ye),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{url:Xe+`sql-wasm.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-sql-compiler.js}}`),self.createSqlCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:Ro,compiledCodeLanguage:`json`},extensions:[`sql`,`sqlite`,`sqlite3`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`sql.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{sql:e}=await import(A+`codemirror-lang-sql.js`);return{sql:e}},[],import.meta.url)).sql()}}}})),Vo=e((()=>{Bo()})),Ho,Uo=e((()=>{G(),z(),V(),Ho={name:`stencil`,title:`Stencil`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[B.babel,B.html]}},compiler:{url:Ze,factory:()=>async(e,{config:t})=>(await window.stencil.transpile(e,{sourceMap:!1,target:`es2019`,...H(`stencil`,t)})).code,types:{"@stencil/core":{url:k+`types/stencil-core.d.ts`,declareAsModule:!1}}},extensions:[`stencil.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}}})),Wo=e((()=>{Uo()})),Go,Ko=e((()=>{z(),Go={name:`stylis`,title:`Stylis`,compiler:{url:Qe,factory:()=>async e=>{let{compile:t,serialize:n,stringify:r,middleware:i,prefixer:a}=window.stylis;return n(t(e),i([a,r]))}},extensions:[`stylis`],editor:`style`,editorLanguage:`scss`}})),qo=e((()=>{Ko()})),Jo,Yo=e((()=>{J(),z(),n(),Jo={name:`stylus`,title:`Stylus`,compiler:{url:k+`stylus/stylus.min.js`,factory:()=>async e=>window.stylus.render(e)},extensions:[`styl`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{stylus:e}=await import(A+`codemirror-lang-stylus.js`);return{stylus:e}},[],import.meta.url)).stylus)}}}})),Xo=e((()=>{Yo()})),Zo,Qo=e((()=>{G(),z(),V(),Zo={name:`sucrase`,title:`Sucrase`,formatter:{prettier:{name:`babel`,pluginUrls:[B.babel,B.html]}},compiler:{url:k+`sucrase/sucrase.js`,factory:()=>async(e,{config:t})=>window.sucrase.transform(e,{transforms:[`jsx`,`typescript`],...H(`sucrase`,t)}).code},extensions:[`sucrase`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),$o=e((()=>{Qo()})),es,X,ts,ns=e((()=>{z(),V(),n(),es=k+`vue-compiler-sfc/vue-compiler-sfc.js`,X={name:`vue`,title:`Vue`,longTitle:`Vue SFC`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:es,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue-compiler.js}}`),self.createVueCompiler()),imports:{vue:it,"livecodes/vue":at}},extensions:[`vue`,`vue3`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`vue.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{vue:e}=await import(A+`codemirror-lang-vue.js`);return{vue:e}},[],import.meta.url)).vue()},codejar:{language:`html`},compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}},ts={...X,name:`vue-app`,compiler:`vue`,extensions:[`app.vue`],editor:`markup`,editorSupport:{...X.editorSupport,monaco:{language:`vue`}}}})),rs,is,as=e((()=>{Un(),z(),V(),ns(),n(),rs={name:`svelte`,title:`Svelte`,formatter:{prettier:{name:`html`,pluginUrls:[B.html,B.babel]}},compiler:{url:L+`compiler/index.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-svelte-compiler.js}}`),self.createSvelteCompiler()),imports:{"#client/constants":L+`src/internal/client/constants.js`,"#compiler/builders":L+`src/compiler/utils/builders.js`,svelte:L+`src/index-client.js`,"svelte/animate":L+`src/animate/index.js`,"svelte/attachments":L+`src/attachments/index.js`,"svelte/easing":L+`src/easing/index.js`,"svelte/internal":L+`src/internal/index.js`,"svelte/internal/client":L+`src/internal/client/index.js`,"svelte/internal/disclose-version":L+`src/internal/disclose-version.js`,"svelte/internal/flags/legacy":L+`src/internal/flags/legacy.js`,"svelte/internal/flags/tracing":L+`src/internal/flags/tracing.js`,"svelte/internal/server":L+`src/internal/server/index.js`,"svelte/legacy":L+`src/legacy/legacy-client.js`,"svelte/motion":L+`src/motion/index.js`,"svelte/reactivity":L+`src/reactivity/index-client.js`,"svelte/reactivity/window":L+`src/reactivity/window/index.js`,"svelte/server":L+`src/server/index.js`,"svelte/store":L+`src/store/index-client.js`,"svelte/transition":L+`src/transition/index.js`,"svelte/events":L+`src/events/index.js`,clsx:D.getModuleUrl(`clsx`),"esm-env":D.getModuleUrl(`esm-env`)},inlineScript:`globalThis.process = { env: { NODE_ENV: "production" } };`},extensions:[`svelte`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`svelte.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{svelte:e}=await import(A+`codemirror-lang-svelte.js`);return{svelte:e}},[],import.meta.url)).svelte()},codejar:{language:`html`}}},is={...rs,name:`svelte-app`,compiler:`svelte`,extensions:[`app.svelte`],editor:`markup`,editorSupport:{...X.editorSupport,monaco:{language:`svelte`}}}})),os=e((()=>{as()})),ss,cs=e((()=>{J(),z(),n(),ss={name:`tcl`,title:`Tcl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Ke,e+`{{hash:lang-tcl-script.js}}`],scriptType:`text/tcl`,compiledCodeLanguage:`tcl`},extensions:[`tcl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{tcl:e}=await import(A+`codemirror-lang-tcl.js`);return{tcl:e}},[],import.meta.url)).tcl)}}}})),ls=e((()=>{cs()})),us,ds=e((()=>{z(),Ni(),us={name:`teal`,title:`Teal`,formatter:Ai,compiler:{url:M,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-teal-compiler.js}}`),self.createTealCompiler()),scripts:[M],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`tl`],editor:`script`,editorLanguage:`lua`}})),fs=e((()=>{ds()})),ps,ms=e((()=>{z(),V(),ps={name:`twig`,title:`Twig`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:$e,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-twig-compiler.js}}`),self.createTwigCompiler())},extensions:[`twig`],editor:`markup`,editorLanguage:`html`}})),hs=e((()=>{ms()})),gs,_s=e((()=>{z(),V(),gs={name:`vento`,title:`Vento`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{url:k+`vento/vento.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vento-compiler.js}}`),self.createVentoCompiler())},extensions:[`vto`,`vento`],editor:`markup`,editorLanguage:`html`}})),vs=e((()=>{_s()})),ys=e((()=>{ns()})),bs,xs,Ss=e((()=>{z(),V(),bs=ot+`vue2-sfc-loader.js`,xs={name:`vue2`,title:`Vue 2`,longTitle:`Vue 2 SFC`,formatter:{prettier:{name:`html`,pluginUrls:[B.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue2-compiler.js}}`),self.createVue2Compiler()),scripts:[rt,bs],imports:{vue:rt+`/dist/vue.runtime.esm-browser.prod.js`}},extensions:[`vue2`],editor:`script`,editorLanguage:`html`}})),Cs=e((()=>{Ss()})),ws,Ts,Es,Ds=e((()=>{z(),n(),ws=k+`wast-refmt/wast-refmt.js`,Ts=`application/wasm-uint8`,Es={name:`wat`,title:`WAT`,longTitle:`WebAssembly Text`,formatter:{factory:()=>(importScripts(ws),async e=>{let t=e;try{t=self.wastRefmt.format(e)}catch(e){console.warn(`failed parsing WAT`,e)}return{formatted:t,cursorOffset:0}})},compiler:{url:st,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-wat-compiler.js}}`),self.createWatCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-wat-script.js}}`],scriptType:Ts,compiledCodeLanguage:`Binary`},extensions:[`wat`,`wast`,`webassembly`,`wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:N+`wat.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{wast:e}=await import(A+`codemirror-lang-wast.js`);return{wast:e}},[],import.meta.url)).wast()},codejar:{language:`wasm`}}}})),Os=e((()=>{Ds()})),Z,ks=e((()=>{dt(),ht(),yt(),Ct(),Dt(),At(),Nt(),Lt(),Bt(),Qn(),tr(),Yn(),ar(),cr(),dr(),mr(),vr(),xr(),wr(),Dr(),Ar(),Nr(),Ir(),zr(),Hr(),Gr(),Yr(),Qr(),ti(),ii(),si(),di(),gi(),yi(),Si(),Ti(),Oi(),Ni(),Ii(),zi(),Hi(),Ki(),Yi(),Qi(),ta(),aa(),ca(),da(),ma(),_a(),xa(),wa(),Da(),Ma(),Fa(),Ra(),Ua(),eo(),co(),ao(),fo(),_o(),xo(),wo(),Do(),Mo(),Lo(),Vo(),Wo(),qo(),Xo(),$o(),os(),ls(),fs(),hs(),Ja(),vs(),ys(),Cs(),Os(),Z=[Xr,Bi,Wi,xt,Ta,pt,Ur,$i,qr,Sr,Tr,ra,Ci,yr,ps,gs,lt,li,Ot,Xi,gr,lo,fr,Ao,Oo,bi,Jo,Go,ai,Ka,jr,Tt,Zo,fi,mi,za,Va,Xa,Qa,X,xs,ts,rs,is,Ho,No,Fo,ho,Li,$n,Ei,Ft,Rt,$r,ro,oo,oa,Aa,Na,Ia,yo,So,Lr,Br,fa,ha,rr,or,ni,lr,la,ji,Pi,us,Or,_i,To,qn,Xn,Pr,ss,_t,Es,zo,ya,Sa,qi,jt]})),As=e((()=>{ks(),yn(),window.deps={translateString:(e,t)=>t,languages:Z,processors:vn}})),js,Ms=e((()=>{js={title:`Untitled Project`,description:``,head:`<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />`,htmlAttrs:`lang="en" class=""`,tags:[],autoupdate:!0,autosave:!1,autotest:!1,delay:1500,formatOnsave:!1,view:`split`,mode:`full`,theme:`dark`,themeColor:void 0,layout:`responsive`,editorTheme:void 0,appLanguage:void 0,recoverUnsaved:!0,showSpacing:!1,welcome:!0,readonly:!1,allowLangChange:!0,activeEditor:void 0,languages:void 0,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{},tests:{language:`typescript`,content:``},tools:{enabled:`all`,active:``,status:``},zoom:1,processors:[],customSettings:{},editor:void 0,fontFamily:void 0,fontSize:void 0,useTabs:!1,tabSize:2,lineNumbers:!0,wordWrap:!1,closeBrackets:!0,foldRegions:!1,semicolons:!0,singleQuote:!1,trailingComma:!0,minimap:!1,emmet:!0,editorMode:void 0,version:{}.VERSION}})),Ns,Ps=e((()=>{Ns={ar:`العربية`,bn:`বাংলা`,de:`Deutsch`,en:`English`,es:`Español`,fa:`فارسی`,fr:`Français`,hi:`हिंदी`,id:`Bahasa Indonesia`,it:`Italiano`,ja:`日本語`,nl:`Nederlands`,pt:`Português`,ru:`Ру́сский`,tr:`Türkçe`,ur:`اردو`,"zh-CN":`中文（简体）`}})),Fs,Is=e((()=>{Fs={name:`angular`,aliases:[`ng`],title:window.deps.translateString(`templates.starter.angular`,`Angular Starter`),thumbnail:`assets/templates/angular.svg`,activeEditor:`script`,markup:{language:`html`,content:`<app>Loading...</app>
...
`},customSettings:{typescript:{experimentalDecorators:!0}}}})),Ls,Rs=e((()=>{Ls={name:`assemblyscript`,aliases:[`as`],title:window.deps.translateString(`templates.starter.assemblyscript`,`AssemblyScript Starter`),thumbnail:`assets/templates/assemblyscript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),zs,Bs=e((()=>{zs={name:`astro`,title:window.deps.translateString(`templates.starter.astro`,`Astro Starter`),thumbnail:`assets/templates/astro.svg`,activeEditor:`markup`,markup:{language:`astro`,content:`---
...
`},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Vs,Hs=e((()=>{Vs={name:`backbone`,title:window.deps.translateString(`templates.starter.backbone`,`Backbone Starter`),thumbnail:`assets/templates/backbone.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[`https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js`,`https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js`,`https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.3.3/backbone-min.js`],cssPreset:``,imports:{},types:{}}})),Us,Ws=e((()=>{Us={name:`blank`,title:window.deps.translateString(`templates.starter.blank`,`Blank Project`),thumbnail:`assets/templates/blank.svg`,activeEditor:`markup`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Gs,Ks=e((()=>{Gs={name:`blockly`,title:window.deps.translateString(`templates.starter.blockly`,`Blockly Starter`),thumbnail:`assets/templates/blockly.svg`,activeEditor:`script`,markup:{language:`html`,content:`<xml
...
`},script:{language:`javascript`,content:``},stylesheets:[`{{ __CDN_URL__ }}bootstrap@5.3.0/dist/css/bootstrap.min.css`],scripts:[`{{ __CDN_URL__ }}bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js`],cssPreset:``,imports:{},types:{}}})),Ys,Xs=e((()=>{Ys={name:`civet`,title:window.deps.translateString(`templates.starter.civet`,`Civet Starter`),thumbnail:`assets/templates/civet.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Zs,Qs=e((()=>{Zs={name:`clio`,title:window.deps.translateString(`templates.starter.clio`,`Clio Starter`),thumbnail:`assets/templates/clio.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),$s,ec=e((()=>{$s={name:`clojurescript`,aliases:[`cljs`],title:window.deps.translateString(`templates.starter.clojurescript`,`ClojureScript Starter`),thumbnail:`assets/templates/cljs.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`}}})),tc,nc=e((()=>{tc={name:`coffeescript`,aliases:[`coffee`],title:window.deps.translateString(`templates.starter.coffeescript`,`CoffeeScript Starter`),thumbnail:`assets/templates/coffeescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),rc,ic=e((()=>{rc={name:`commonlisp`,aliases:[`lisp`],title:window.deps.translateString(`templates.starter.commonlisp`,`Common Lisp Starter`),thumbnail:`assets/templates/commonlisp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ac,oc=e((()=>{ac={name:`cpp`,aliases:[`c++`],title:window.deps.translateString(`templates.starter.cpp`,`C++ Starter`),thumbnail:`assets/templates/cpp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),sc,cc=e((()=>{sc={name:`cpp-wasm`,aliases:[`clang`,`c++-wasm`],title:window.deps.translateString(`templates.starter.cpp-wasm`,`C++ (Wasm) Starter`),thumbnail:`assets/templates/cpp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/cpp.svg" />
  <p>You clicked <span id="counter">0</span> times.</p>
  <button id="counter-button" disabled>Loading...</button>
...
`}}})),lc,uc=e((()=>{lc={name:`csharp-wasm`,aliases:[`c#-wasm`],title:window.deps.translateString(`templates.starter.csharp-wasm`,`C# (Wasm) Starter`),thumbnail:`assets/templates/csharp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`}}})),dc,fc=e((()=>{dc={name:`d3`,title:window.deps.translateString(`templates.starter.d3`,`D3 Starter`),thumbnail:`assets/templates/d3.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="chart">Loading...</div>
...
svg
  ...
  .attr("y", (d, i) => i * 50 + 10)
  .attr("x", 10);
`}}})),pc,mc=e((()=>{pc={name:`daisyui`,title:window.deps.translateString(`templates.starter.daisyui`,`daisyUI Starter`),thumbnail:`assets/templates/daisyui.svg`,activeEditor:`markup`,markup:{language:`html`,content:`<!-- based on https://daisyui.com/tailwindplay/ -->
...
`},script:{language:`javascript`,content:``},processors:[`tailwindcss`]}})),hc,gc=e((()=>{hc={name:`diagrams`,title:window.deps.translateString(`templates.starter.diagrams`,`Diagrams Starter`),thumbnail:`assets/templates/diagrams.svg`,activeEditor:`markup`,markup:{language:`diagrams`,contentUrl:`{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html`},style:{language:`css`,content:`.container {
  display: flex;
...
`},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),_c,vc=e((()=>{_c={name:`fennel`,title:window.deps.translateString(`templates.starter.fennel`,`Fennel Starter`),thumbnail:`assets/templates/fennel.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),yc,bc,xc,Sc=e((()=>{z(),yc=Ne+`build/packages/plinth/src/plinth/`,bc=Ne+`build/dev/javascript/plinth/plinth/`,xc={name:`gleam`,title:window.deps.translateString(`templates.starter.gleam`,`Gleam Starter`),thumbnail:`assets/templates/gleam.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`},customSettings:{imports:{"my_pkg/greet.js":Ne+`demo/greet.js`},gleam:{modules:{"plinth/browser/document":{srcUrl:yc+`browser/document.gleam`,compiledUrl:bc+`browser/document.mjs`},"plinth/browser/element":{srcUrl:yc+`browser/element.gleam`,compiledUrl:bc+`browser/element.mjs`},"plinth/browser/event":{srcUrl:yc+`browser/event.gleam`,compiledUrl:bc+`browser/event.mjs`}}}}}})),Cc,wc=e((()=>{Cc={name:`go`,aliases:[`golang`],title:window.deps.translateString(`templates.starter.go`,`Go Starter`),thumbnail:`assets/templates/go.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Tc,Ec=e((()=>{Tc={name:`go-wasm`,aliases:[`golang-wasm`],title:window.deps.translateString(`templates.starter.go-wasm`,`Go (Wasm) Starter`),thumbnail:`assets/templates/go.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Go (Wasm)</h1>
...
`}}})),Dc,Oc=e((()=>{Dc={name:`imba`,title:window.deps.translateString(`templates.starter.imba`,`Imba Starter`),thumbnail:`assets/templates/imba.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`imba`,content:`tag app-counter
	prop name = "Imba"
	prop count = 0
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),kc,Ac=e((()=>{kc={name:`java`,title:window.deps.translateString(`templates.starter.java`,`Java Starter`),thumbnail:`assets/templates/java.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`}}})),jc,Mc=e((()=>{jc={name:`javascript`,aliases:[`js`],title:window.deps.translateString(`templates.starter.javascript`,`JavaScript Starter`),thumbnail:`assets/templates/javascript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Nc,Pc=e((()=>{Nc={name:`jest-react`,title:window.deps.translateString(`templates.starter.jest-react`,`Jest/React Starter`),thumbnail:`assets/templates/jest.svg`,activeEditor:`script`,autotest:!0,markup:{language:`html`,content:``},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
}
...
`},tools:{enabled:`all`,active:`tests`,status:`open`}}})),Fc,Ic=e((()=>{Fc={name:`jest`,title:window.deps.translateString(`templates.starter.jest`,`Jest Starter`),thumbnail:`assets/templates/jest.svg`,autotest:!0,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},tools:{enabled:`all`,active:`tests`,status:`open`}}})),Lc,Rc=e((()=>{Lc={name:`jquery`,title:window.deps.translateString(`templates.starter.jquery`,`jQuery Starter`),thumbnail:`assets/templates/jquery.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),zc,Bc=e((()=>{zc={name:`julia`,title:window.deps.translateString(`templates.starter.julia`,`Julia Starter`),thumbnail:`assets/templates/julia.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Vc,Hc=e((()=>{Vc={name:`knockout`,title:window.deps.translateString(`templates.starter.knockout`,`Knockout Starter`),thumbnail:`assets/templates/knockout.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Uc,Wc=e((()=>{Uc={name:`lit`,title:window.deps.translateString(`templates.starter.lit`,`Lit Starter`),thumbnail:`assets/templates/lit.svg`,activeEditor:`script`,markup:{language:`html`,content:`<my-counter name="Lit"></my-counter>
...
`},customSettings:{typescript:{experimentalDecorators:!0,useDefineForClassFields:!1}}}})),Gc,Kc=e((()=>{Gc={name:`livescript`,aliases:[`ls`],title:window.deps.translateString(`templates.starter.livescript`,`LiveScript Starter`),thumbnail:`assets/templates/livescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),qc,Jc=e((()=>{qc={name:`lua`,title:window.deps.translateString(`templates.starter.lua`,`Lua Starter`),thumbnail:`assets/templates/lua.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),Yc,Xc=e((()=>{Yc={name:`lua-wasm`,title:window.deps.translateString(`templates.starter.lua-wasm`,`Lua (Wasm) Starter`),thumbnail:`assets/templates/lua.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/lua.svg" />
  <p id="counter">You clicked 0 times.</p>
  <button id="counter-button">Click me</button>
...
`}}})),Zc,Qc=e((()=>{Zc={name:`malina`,title:window.deps.translateString(`templates.starter.malina`,`Malina.js Starter`),thumbnail:`assets/templates/malina.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`malina`,content:`<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
    counter += 1;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),$c,el=e((()=>{$c={name:`markdown`,aliases:[`md`],title:window.deps.translateString(`templates.starter.markdown`,`Markdown Starter`),thumbnail:`assets/templates/markdown.svg`,activeEditor:`markup`,markup:{language:`markdown`,content:`# Project Title
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),tl,nl=e((()=>{tl={name:`mdx`,title:window.deps.translateString(`templates.starter.mdx`,`MDX Starter`),thumbnail:`assets/templates/mdx.svg`,activeEditor:`markup`,markup:{language:`mdx`,content:`import { Greeting, Counter } from './script';
...
`}}})),rl,il=e((()=>{rl={name:`minizinc`,aliases:[`mzn`],title:window.deps.translateString(`templates.starter.minizinc`,`MiniZinc Starter`),thumbnail:`assets/templates/minizinc.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`.trimStart()}}})),al,ol=e((()=>{al={name:`ocaml`,title:window.deps.translateString(`templates.starter.ocaml`,`Ocaml Starter`),thumbnail:`assets/templates/ocaml.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ll,ul=e((()=>{ll={name:`phaser`,title:window.deps.translateString(`templates.starter.phaser`,`Phaser Starter`),thumbnail:`assets/templates/phaser.png`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">
...
`}}})),dl,fl=e((()=>{dl={name:`php`,title:window.deps.translateString(`templates.starter.php`,`PHP Starter`),thumbnail:`assets/templates/php.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">world</span>!</h1>
...
`}}})),pl,ml=e((()=>{pl={name:`php-wasm`,title:window.deps.translateString(`templates.starter.php-wasm`,`PHP (Wasm) Starter`),thumbnail:`assets/templates/php.svg`,activeEditor:`script`,markup:{language:`html`,content:`<p>
  <h1>Hello, <span id="title">world</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/php.svg" />
</p>
`},style:{language:`css`,content:`body {
...
`}}})),hl,gl=e((()=>{hl={name:`postgresql`,aliases:[`pg`,`postgres`,`pgsql`],title:window.deps.translateString(`templates.starter.postgresql`,`PostgreSQL Starter`),thumbnail:`assets/templates/postgresql.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">
  <details open>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`}}})),_l,vl=e((()=>{_l={name:`preact`,title:window.deps.translateString(`templates.starter.preact`,`Preact Starter`),thumbnail:`assets/templates/preact.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app"></div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`}}})),yl,bl=e((()=>{yl={name:`prolog`,title:window.deps.translateString(`templates.starter.prolog`,`Prolog Starter`),thumbnail:`assets/templates/tau-prolog.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
ancestor(X, Y):- parent(X, Z),
    ancestor(Z, Y).
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),xl,Sl=e((()=>{xl={name:`python`,aliases:[`py`],title:window.deps.translateString(`templates.starter.python`,`Python Starter`),thumbnail:`assets/templates/python.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
if current_time < 12 :
      ...
      print('Good evening')
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Cl,wl=e((()=>{Cl={name:`python-wasm`,aliases:[`pyodide`,`py-wasm`],title:window.deps.translateString(`templates.starter.python-wasm`,`Python (Wasm) Starter`),thumbnail:`assets/templates/python.svg`,activeEditor:`script`,markup:{language:`html`,content:`<h1 id="title">Hello, World!</h1>
...
plt.close("all")
`}}})),Tl,El=e((()=>{Tl={name:`r`,aliases:[`r-lang`,`rlang`],title:window.deps.translateString(`templates.starter.r`,`R Starter`),thumbnail:`assets/templates/r.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">Loading...</div>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Dl,Ol=e((()=>{Dl={name:`react-native`,title:window.deps.translateString(`templates.starter.react-native`,`React Native Starter`),thumbnail:`assets/templates/react.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`react-native`,content:`import { useState } from "react";
...
`}}})),kl,Al=e((()=>{kl={name:`react`,title:window.deps.translateString(`templates.starter.react`,`React Starter`),thumbnail:`assets/templates/react.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
}
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),jl,Ml=e((()=>{jl={name:`reason`,title:window.deps.translateString(`templates.starter.reason`,`Reason Starter`),thumbnail:`assets/templates/reason.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
Js.log("Hello, Reason!");
`},customSettings:{imports:{react:`https://esm.sh/react@18.3.1`,"react/":`https://esm.sh/react@18.3.1/`,"react-dom":`https://esm.sh/react-dom@18.3.1`}}}})),Nl,Pl=e((()=>{Nl={name:`rescript`,title:window.deps.translateString(`templates.starter.rescript`,`ReScript Starter`),thumbnail:`assets/templates/rescript.png`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Fl,Il=e((()=>{Fl={name:`riot`,title:window.deps.translateString(`templates.starter.riot`,`Riot.js Starter`),thumbnail:`assets/templates/riot.svg`,activeEditor:`script`,markup:{language:`html`,content:`<counter title="Riot.js"></counter>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Ll,Rl=e((()=>{Ll={name:`ruby`,aliases:[`rb`],title:window.deps.translateString(`templates.starter.ruby`,`Ruby Starter`),thumbnail:`assets/templates/ruby.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),zl,Bl=e((()=>{zl={name:`ruby-wasm`,aliases:[`rb-wasm`],title:window.deps.translateString(`templates.starter.ruby-wasm`,`Ruby (Wasm) Starter`),thumbnail:`assets/templates/ruby.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/ruby.svg" />
  <p id="counter">You clicked 0 times.</p>
  <button id="counter-button">Click me</button>
...
`}}})),Vl,Hl=e((()=>{Vl={name:`scheme`,title:window.deps.translateString(`templates.starter.scheme`,`Scheme Starter`),thumbnail:`assets/templates/scheme.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ql,Jl=e((()=>{ql={name:`sql`,title:window.deps.translateString(`templates.starter.sql`,`SQL Starter`),thumbnail:`assets/templates/sqlite.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">
  <details open>
    <summary>Tables</summary>
    <div id="tables"></div>
  </details>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`}}})),Yl,Xl=e((()=>{Yl={name:`stencil`,title:window.deps.translateString(`templates.starter.stencil`,`Stencil Starter`),thumbnail:`assets/templates/stencil.png`,activeEditor:`script`,markup:{language:`html`,content:`<my-app title="Stencil"></my-app>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Zl,Ql=e((()=>{Zl={name:`svelte`,title:window.deps.translateString(`templates.starter.svelte`,`Svelte Starter`),thumbnail:`assets/templates/svelte.svg`,activeEditor:`script`,markup:{language:`svelte`,content:`<script>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),$l,eu=e((()=>{$l={name:`tailwindcss`,aliases:[`tw`,`tailwind`],title:window.deps.translateString(`templates.starter.tailwindcss`,`Tailwind CSS Starter`),thumbnail:`assets/templates/tailwindcss.svg`,activeEditor:`markup`,markup:{language:`html`,content:`<div class="relative grid min-h-screen grid-cols-[1fr_2.5rem_auto_2.5rem_1fr] grid-rows-[1fr_1px_auto_1px_1fr] bg-white [--pattern-fg:var(--color-gray-950)]/5 dark:bg-gray-950 dark:[--pattern-fg:var(--color-white)]/10">
...
`},script:{language:`javascript`,content:``},processors:[`tailwindcss`]}})),tu,nu=e((()=>{tu={name:`tcl`,title:window.deps.translateString(`templates.starter.tcl`,`Tcl Starter`),thumbnail:`assets/templates/tcl.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
puts $count
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ru,iu=e((()=>{ru={name:`teal`,title:window.deps.translateString(`templates.starter.teal`,`Teal Starter`),thumbnail:`assets/templates/teal.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),au,ou=e((()=>{au={name:`typescript`,aliases:[`ts`],title:window.deps.translateString(`templates.starter.typescript`,`TypeScript Starter`),thumbnail:`assets/templates/typescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),su,cu=e((()=>{su={name:`vue`,title:window.deps.translateString(`templates.starter.vue`,`Vue SFC Starter`),thumbnail:`assets/templates/vue.svg`,activeEditor:`script`,markup:{language:`vue`,content:`<script setup lang="tsx">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),lu,uu=e((()=>{lu={name:`vue2`,title:window.deps.translateString(`templates.starter.vue2`,`Vue 2 Starter`),thumbnail:`assets/templates/vue.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">
  <h1>Hello, Vue!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/vue.svg" />
  <p>You clicked {{ counter }} times.</p>
  <button @click="increment()">Click me</button>
...
`},stylesheets:[],scripts:[`{{ __CDN_URL__ }}vue@2`],cssPreset:``,imports:{},types:{}}})),du,fu=e((()=>{du={name:`wat`,title:window.deps.translateString(`templates.starter.wat`,`WebAssembly Text Starter`),thumbnail:`assets/templates/webassembly.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
"click": The playground does not load automatically. Instead, a "Click-to-load" screen is shown.`}}},params:{control:`object`,description:`An object that represents [URL Query parameters](https://livecodes.io/docs/configuration/query-params), that can be used to configure the playground.`,type:{name:`object`,value:{}},required:!1,table:{category:`Embed Options`}},template:{control:`select`,description:`A [starter template](https://livecodes.io/docs/features/templates) to load.`,type:`string`,required:!1,table:{category:`Embed Options`},options:pu.map(e=>e.name)},config:{table:{disable:!0}},...Object.keys(js).filter(e=>!e.includes(`version`)).reduce((e,t)=>{let n=js[t];return n&&typeof n==`object`&&[`markup`,`style`,`script`].includes(t)&&(n={contentUrl:void 0,hiddenContent:void 0,hiddenContentUrl:void 0,title:void 0,hideTitle:void 0,foldedLines:void 0,order:void 0,position:void 0,selector:void 0,...n}),`config__${t}`in vu?e[`config__${t}`]=vu[`config__${t}`]:n&&typeof n==`object`&&!Array.isArray(n)?Object.keys(n).forEach(n=>{e[`config__${t}__${n}`]=vu[`config__${t}__${n}`]||$(`config__${t}__${n}`)}):e[`config__${t}`]=$(`config__${t}`),e},{}),props:{control:`object`,required:!1,table:{readonly:!0,category:`Props`}},class:{control:`text`,type:`string`,required:!1,table:{category:`Styles`}},style:{control:`object`,required:!1,table:{category:`Styles`}},height:{control:`text`,type:`string`,required:!1,table:{category:`Styles`,defaultValue:{summary:`300px`}}}}})),xu,Su=e((()=>{xu=location.hostname.startsWith(`localhost`)||location.hostname.startsWith(`127.0.0.1`)?`http://127.0.0.1:8080`:location.origin})),Cu=e((()=>{As(),bu(),hu(),_u(),Su()})),wu,Tu,Eu,Du=e((()=>{le(),a(),Cu(),ie(),wu={component:re,parameters:{layout:`fullscreen`},argTypes:yu},Tu=e=>{let t=(e=>({components:{LiveCodes:re},setup(){return{props:o(()=>ce(e,{delimiter:`__`}))}},template:`<LiveCodes v-bind="props" />`})).bind({});t.argTypes=yu;let{params:n,height:r,class:i,style:a,...s}=e;return t.args={appUrl:xu,...se(s,{delimiter:`__`}),...n?{params:n}:{},height:r,class:i,style:a,props:e},t.parameters={docs:{source:{code:Eu(e),language:`html`,type:`auto`,format:!0}}},t},Eu=e=>`
<script setup>
...
`.trimStart()})),Ou=e((()=>{ie(),Du()}));export{wu as n,Tu as r,Ou as t};