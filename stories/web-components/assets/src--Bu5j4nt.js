...
`)},h=e=>{let t;if(e instanceof HTMLTemplateElement){let n=e.ownerDocument.createElement(`div`);n.appendChild(e.content.cloneNode(!0)),t=n.innerHTML}else t=e.textContent??``;return m(t)},g=e=>{let t=e.split(`.`);if(!(t.length<2))return t[t.length-1]},_=e=>{let t=Array.from(e.children).find(e=>e instanceof HTMLTemplateElement&&!e.hasAttribute(`lang`)&&!e.hasAttribute(`filename`));if(!t)return;let n=t.content,r=Array.from(n.children).filter(e=>e.tagName===`TEMPLATE`||e.tagName===`STYLE`||e.tagName===`SCRIPT`);return r.length===0?void 0:r.some(e=>e.hasAttribute(`filename`))?y(r):v(r)},v=e=>{let t={},n=new Set;for(let r of e){let e=f[r.tagName.toLowerCase()];!e||n.has(e)||(n.add(e),t[e]={language:r.getAttribute(`lang`)||p[e],content:h(r)},r.hasAttribute(`active`)&&(t.activeEditor=e))}return Object.keys(t).length>0?t:void 0},y=e=>{let t=[],n;for(let r of e){let e=r.getAttribute(`filename`);if(!e)continue;let i=h(r),a=r.getAttribute(`lang`)||g(e),o={filename:e,content:i};a&&(o.language=a),t.push(o),r.hasAttribute(`active`)&&(n=e)}if(t.length===0)return;let r={files:t};return n&&(r.activeEditor=n),r};async function b(e,t={}){typeof e==`object`&&!(e instanceof HTMLElement)&&(e.headless||e.view===`headless`)&&(t=e,e=null);let n=6e4,{config:r={},headless:i,loading:a=`lazy`,view:o}=t,s=i||o===`headless`,c=null,l=null,u=e=>{e.style.position=`absolute`,e.style.top=`0`,e.style.visibility=`hidden`,e.style.opacity=`0`};if(typeof e==`string`)c=document.querySelector(e);else if(e instanceof HTMLElement)c=e;else if(!(s&&typeof e==`object`))throw Error(`A valid container element is required.`);if(!c)if(s)c=document.createElement(`div`),u(c),document.body.appendChild(c);else throw Error(`Cannot find element: "${e}"`);let f=new URL(x(t)),p=f.origin;f.searchParams.set(`embed`,`true`),f.searchParams.set(`loading`,s?`eager`:a),f.searchParams.set(`sdkVersion`,`0.14.1`),typeof r==`object`&&Object.keys(r).length>0&&f.searchParams.set(`config`,`sdk`);let m=t.params;typeof m==`object`&&Object.keys(m).length>0&&JSON.stringify(m).length<1800&&Object.keys(m).forEach(e=>{f.searchParams.set(e,encodeURIComponent(String(m[e])))});let h=!1,g="Cannot call API methods after calling `destroy()`.",_=[],v=(e,t=`message`)=>{addEventListener(t,e),_.push(e)},y=(e,t=`message`)=>{removeEventListener(t,e);let n=_.indexOf(e);n>-1&&_.splice(n,1)},b=await new Promise(e=>{var t,n,i,o,m,h,g,_,b;if(!c)return;let x=c.dataset.height||c.style.height;if(x&&!s){let e=isNaN(Number(x))?x:x+`px`;c.style.height=e}c.dataset.defaultStyles!==`false`&&!s&&((t=c.style).backgroundColor||(t.backgroundColor=`#fff`),(n=c.style).border||(n.border=`1px solid black`),(i=c.style).borderRadius||(i.borderRadius=`8px`),(o=c.style).boxSizing||(o.boxSizing=`border-box`),(m=c.style).padding||(m.padding=`0`),(h=c.style).width||(h.width=`100%`),(g=c.style).height||(g.height=c.style.height||`300px`),c.style.minHeight=`200px`,c.style.flexGrow=`1`,(_=c.style).overflow||(_.overflow=`hidden`),(b=c.style).resize||(b.resize=`vertical`),getComputedStyle(c).getPropertyValue(`display`)===`inline`&&(c.style.display=`block`));let S=`livecodes`,C=c.querySelector(`iframe.${S}`),w=C||document.createElement(`iframe`);w.classList.add(S),w.setAttribute(`allow`,d()),w.setAttribute(`allowtransparency`,`true`),w.setAttribute(`allowpaymentrequest`,`true`),w.setAttribute(`allowfullscreen`,`true`),w.setAttribute(`sandbox`,`allow-same-origin allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-presentation allow-scripts`);let T=a===`eager`?`eager`:`lazy`;w.setAttribute(`loading`,T),s?u(w):(w.style.height=`100%`,w.style.minHeight=`200px`,w.style.width=`100%`,w.style.margin=`0`,w.style.border=`0`,w.style.borderRadius=c.style.borderRadius),v(function e(t){t.source!==w.contentWindow||t.origin!==p||t.data?.type!==`livecodes-init`||(y(e),l=Number(t.data.payload.appVersion.replace(/^v/,``)))}),(!l||l<46)&&v(function e(t){var n;t.source!==w.contentWindow||t.origin!==p||t.data?.type!==`livecodes-get-config`||(y(e),(n=w.contentWindow)==null||n.postMessage({type:`livecodes-config`,payload:r},p))}),w.onload=()=>{e(w)},w.src=f.href,C||c.appendChild(w)}),S=new Promise(e=>{v(function t(n){n.source!==b.contentWindow||n.origin!==p||n.data?.type!==`livecodes-ready`||(y(t),e(),S.settled=!0)})}),C=()=>h?Promise.reject(g):new Promise(async e=>{var t;S.settled&&e(),(t=b.contentWindow)==null||t.postMessage({type:`livecodes-load`},p),await S,e()}),w=(e,t)=>new Promise(async(r,i)=>{var a;if(h)return i(g);await C();let o=ie(),s=setTimeout(()=>{y(c),i(Error(`SDK call "${e}" timed out after ${n}ms.`))},n);function c(t){if(!(t.source!==b.contentWindow||t.origin!==p||t.data?.type!==`livecodes-api-response`||t.data?.id!==o)&&t.data.method===e){clearTimeout(s),y(c);let e=t.data.payload;e!=null&&e.error?i(e.error):r(e)}}v(c),(a=b.contentWindow)==null||a.postMessage({method:e,id:o,args:t},p)}),T={},ee=[`load`,`ready`,`code`,`console`,`tests`,`destroy`],te=(e,t)=>{var n;if(h)throw Error(g);return ee.includes(e)?(w(`watch`,[e]),T[e]||(T[e]=[]),(n=T[e])==null||n.push(t),{remove:()=>{T[e]=T[e]?.filter(e=>e!==t),T[e]?.length===0&&w(`watch`,[e,`unsubscribe`])}}):{remove:()=>{}}},ne=e=>({"livecodes-app-loaded":`load`,"livecodes-ready":`ready`,"livecodes-change":`code`,"livecodes-console":`console`,"livecodes-test-results":`tests`,"livecodes-destroy":`destroy`})[e];v(async function(e){var t;let n=ne(e.data?.type??``);if(e.source!==b.contentWindow||e.origin!==p||!n||!T[n])return;let r=e.data?.payload;(t=T[n])==null||t.forEach(e=>{e(r)})});let re=()=>{var e;(e=b?.remove)==null||e.call(b),Object.values(T).forEach(e=>{e.length=0}),_.forEach(e=>removeEventListener(`message`,e)),_.length=0,E&&c&&E.unobserve(c),h=!0},E;a===`lazy`&&`IntersectionObserver`in window&&(E=new IntersectionObserver((e,t)=>{e.forEach(async e=>{e.isIntersecting&&(await C(),t.unobserve(c))})},{rootMargin:`150px`}),E.observe(c));let ie=()=>(String(Math.random())+Date.now().toFixed()).replace(`0.`,``);return{load:()=>C(),run:()=>w(`run`),format:e=>w(`format`,[e]),getShareUrl:e=>w(`getShareUrl`,[e]),getConfig:e=>w(`getConfig`,[e]),setConfig:e=>w(`setConfig`,[e]),getCode:()=>w(`getCode`),show:(e,t)=>w(`show`,[e,t]),runTests:()=>w(`runTests`),onChange:e=>te(`code`,e),watch:te,exec:(e,...t)=>w(`exec`,[e,...t]),destroy:()=>h?Promise.reject(g):(re(),Promise.resolve())}}function x(e={}){let{appUrl:t=`https://livecodes.io`,params:n={},config:r={},headless:i,import:a,lite:o,view:s,...l}=e,u;try{u=new URL(t)}catch{throw Error(`${t} is not a valid URL.`)}let d=new URLSearchParams;Object.entries(l).forEach(([e,t])=>{t!==void 0&&u.searchParams.set(e,String(t))});let f=e.view===`headless`||i;if(o&&(console.warn(`Deprecation notice: "lite" option is deprecated. Use "config: { mode: 'lite' }" instead.`),typeof r==`object`&&r.mode==null?r.mode=`lite`:u.searchParams.set(`lite`,`true`)),s&&(console.warn(`Deprecation notice: The "view" option has been moved to "config.view". For headless mode use "headless: true".`),typeof r==`object`&&r.view==null&&s!==`headless`?r.view=s:u.searchParams.set(`view`,s)),typeof r==`string`)try{new URL(r),u.searchParams.set(`config`,encodeURIComponent(r))}catch{throw Error(`"config" is not a valid URL or configuration object.`)}else r&&typeof r==`object`&&Object.keys(r).length>0&&(r.title&&r.title!==`Untitled Project`&&u.searchParams.set(`title`,r.title),r.description&&r.description.length>0&&u.searchParams.set(`description`,r.description),d.set(`config`,`code/`+(0,c.compressToEncodedURIComponent)(JSON.stringify(r))));if(n&&typeof n==`object`&&Object.keys(n).length>0)try{d.set(`params`,(0,c.compressToEncodedURIComponent)(JSON.stringify(n)))}catch{Object.keys(n).forEach(e=>{u.searchParams.set(e,encodeURIComponent(String(n[e])))})}return a&&u.searchParams.set(`x`,encodeURIComponent(a)),f&&u.searchParams.set(`headless`,`true`),d.toString().length>0&&(u.hash=d.toString()),u.href}var S=class extends HTMLElement{constructor(){super(...arguments),this._configCache=``,this._otherOptionsCache=``,this._connected=!1,this._updateScheduled=!1,this._generation=0}static get observedAttributes(){return[`app-url`,`config`,`import`,`loading`,`params`,`template`,`view`,`height`,`headless`,`lite`]}connectedCallback(){this._connected=!0,this._observeChildren(),this._scheduleUpdate(),this.style.display=`block`}disconnectedCallback(){var e,t;this._connected=!1,(e=this._childrenObserver)==null||e.disconnect(),this._childrenObserver=void 0,++this._generation,(t=this._playground)==null||t.destroy(),this._playground=void 0}attributeChangedCallback(e,t,n){t!==n&&this._connected&&this._scheduleUpdate()}get config(){return this._config}set config(e){this._config=e,this._connected&&this._scheduleUpdate()}get params(){return this._params}set params(e){this._params=e,this._connected&&this._scheduleUpdate()}get sdk(){return this._playground}destroy(){var e;++this._generation,(e=this._playground)==null||e.destroy(),this._playground=void 0}_observeChildren(){var e;(e=this._childrenObserver)==null||e.disconnect();let t=Array.from(this.children).find(e=>e instanceof HTMLTemplateElement&&!e.hasAttribute(`lang`)&&!e.hasAttribute(`filename`));t&&(this._childrenObserver=new MutationObserver(()=>{if(!this._connected||!this._playground)return;let e=_(this);e&&this._playground.setConfig(e)}),this._childrenObserver.observe(t.content,{childList:!0,subtree:!0,characterData:!0}))}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,queueMicrotask(()=>{this._updateScheduled=!1,this._connected&&this._update()}))}_getConfigAttribute(){let e=this.getAttribute(`config`);if(e!=null)try{return JSON.parse(e)}catch{return}}_getParamsAttribute(){let e=this.getAttribute(`params`);if(e!=null)try{return JSON.parse(e)}catch{return}}_getEmbedOptions(){let e={},t=this.getAttribute(`app-url`);t!=null&&(e.appUrl=t);let n=this.getAttribute(`import`);n!=null&&(e.import=n);let r=this.getAttribute(`loading`);r!=null&&(e.loading=r);let i=this.getAttribute(`template`);i!=null&&(e.template=i);let a=this.getAttribute(`view`);a!=null&&(e.view=a),this.hasAttribute(`headless`)&&(e.headless=!0),this.hasAttribute(`lite`)&&(e.lite=!0);let o=_(this),s=this._getConfigAttribute(),c=this._config;(o||s||c!==void 0)&&(typeof c==`string`?e.config=c:e.config={...s||{},...o||{},...c||{}});let l=this._getParamsAttribute(),u=this._params;return(l||u!==void 0)&&(e.params={...l||{},...u||{}}),e}_update(){var e;let{config:t,...n}=this._getEmbedOptions(),r=JSON.stringify(n),i=JSON.stringify(t||``),a=this.getAttribute(`height`);if(a!=null){let e=Number(a)?`${a}px`:a;this.dataset.height=e,this.style.height=e}if(!this._playground||this._otherOptionsCache!==r){let a=++this._generation;this._otherOptionsCache=r,this._configCache=i,(e=this._playground)==null||e.destroy(),this._playground=void 0,b(this,{config:t,...n}).then(e=>{if(this._generation!==a){e.destroy();return}this._playground=e,this.dispatchEvent(new CustomEvent(`sdkready`,{detail:{sdk:e},bubbles:!0,composed:!0}))})}else{if(this._configCache===i)return;this._configCache=i,t&&this._playground.setConfig(t)}}};customElements.get(`live-codes`)||customElements.define(`live-codes`,S)})()})),p,m,h,g,_,v,y,b=e((()=>{p=[`esm.sh`,`skypack`,`esm.run`,`jsdelivr.esm`,`fastly.jsdelivr.esm`,`gcore.jsdelivr.esm`,`testingcf.jsdelivr.esm`,`jsdelivr.b-cdn.esm`,`jspm`],m=[`jsdelivr`,`fastly.jsdelivr`,`unpkg`,`gcore.jsdelivr`,`testingcf.jsdelivr`,`jsdelivr.b-cdn`,`npmcdn`],h=[`jsdelivr.gh`,`fastly.jsdelivr.gh`,`statically`,`gcore.jsdelivr.gh`,`testingcf.jsdelivr.gh`,`jsdelivr.b-cdn.gh`],g={getModuleUrl:(e,{isModule:t=!0,defaultCDN:n=`esm.sh`,external:r}={})=>{e=e.replace(/#nobundle/g,``);let i=e=>!r||!e.includes(`https://esm.sh`)?e:e.includes(`?`)?`${e}&external=${r}`:`${e}?external=${r}`,a=v(e,t,n);return a?i(a):t?i(`https://esm.sh/`+e):`https://cdn.jsdelivr.net/npm/`+e},getUrl:(e,t)=>e.startsWith(`http`)||e.startsWith(`data:`)?e:v(e,!1,t||_())||e,cdnLists:{npm:m,module:p,gh:h},checkCDNs:async(e,t)=>{let n=[t,...g.cdnLists.npm].filter(Boolean);for(let t of n)try{if((await fetch(g.getUrl(e,t),{method:`HEAD`})).ok)return t}catch{}return g.cdnLists.npm[0]}},_=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get(`appCDN`)||g.cdnLists.npm[0]}catch{return g.cdnLists.npm[0]}},v=(e,t,n)=>{let r=t&&e.startsWith(`unpkg:`)?`?module`:``;e.startsWith(`gh:`)?e=e.replace(`gh`,h[0]):e.includes(`:`)||(e=(n||(t?p[0]:m[0]))+`:`+e);for(let t of y){let[n,i]=t;if(n.test(e))return e.replace(n,i)+r}return null},y=[[/^(esm\.sh:)(.+)/i,`https://esm.sh/$2`],[/^(npm:)(.+)/i,`https://esm.sh/$2`],[/^(node:)(.+)/i,`https://esm.sh/$2`],[/^(jsr:)(.+)/i,`https://esm.sh/jsr/$2`],[/^(pr:)(.+)/i,`https://esm.sh/pr/$2`],[/^(pkg\.pr\.new:)(.+)/i,`https://esm.sh/pkg.pr.new/$2`],[/^(skypack:)(.+)/i,`https://cdn.skypack.dev/$2`],[/^(jsdelivr:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2`],[/^(fastly\.jsdelivr:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2`],[/^(gcore\.jsdelivr:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2`],[/^(testingcf\.jsdelivr:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2`],[/^(jsdelivr\.b-cdn:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2`],[/^(jsdelivr\.gh:)(.+)/i,`https://cdn.jsdelivr.net/gh/$2`],[/^(fastly\.jsdelivr\.gh:)(.+)/i,`https://fastly.jsdelivr.net/gh/$2`],[/^(gcore\.jsdelivr\.gh:)(.+)/i,`https://gcore.jsdelivr.net/gh/$2`],[/^(testingcf\.jsdelivr\.gh:)(.+)/i,`https://testingcf.jsdelivr.net/gh/$2`],[/^(jsdelivr\.b-cdn\.gh:)(.+)/i,`https://jsdelivr.b-cdn.net/gh/$2`],[/^(statically:)(.+)/i,`https://cdn.statically.io/gh/$2`],[/^(esm\.run:)(.+)/i,`https://esm.run/$2`],[/^(jsdelivr\.esm:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2/+esm`],[/^(fastly\.jsdelivr\.esm:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2/+esm`],[/^(gcore\.jsdelivr\.esm:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2/+esm`],[/^(testingcf\.jsdelivr\.esm:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2/+esm`],[/^(jsdelivr\.b-cdn\.esm:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2/+esm`],[/^(jspm:)(.+)/i,`https://jspm.dev/$2`],[/^(esbuild:)(.+)/i,`https://esbuild.vercel.app/$2`],[/^(bundle\.run:)(.+)/i,`https://bundle.run/$2`],[/^(unpkg:)(.+)/i,`https://unpkg.com/$2`],[/^(npmcdn:)(.+)/i,`https://npmcdn.com/$2`],[/^(bundlejs:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(bundle:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(deno:)(.+)/i,`https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts`],[/^(https:\/\/deno\.land\/.+)/i,`https://deno.bundlejs.com/?file&q=$1`],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,`https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4`],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3`],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3`],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,`https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3`]]})),x,S,C,w,T,ee,te,ne,re,E,ie,ae,oe,se,D,ce,le,ue,de,fe,O,pe,me,he,ge,k,_e,ve,A,ye,be,j,xe,Se,M,Ce,we,Te,Ee,De,Oe,ke,N,Ae,je,P,F,Me,Ne,Pe,Fe,Ie,Le,Re,ze,Be,Ve,I=e((()=>{b(),{getUrl:x,getModuleUrl:S}=g,C=x(`@live-codes/browser-compilers@0.22.10/dist/`),w=x(`art-template@4.13.2/lib/template-web.js`),T=x(`@asciidoctor/core@2.2.8/dist/browser/asciidoctor.js`),ee=x(`@assemblyscript/loader@0.27.29/umd/index.js`),te=x(`@hatemhosny/astro-internal@0.0.4/`),ne=x(`@babel/standalone@7.26.4/babel.js`),re=x(`@bbob/html@4.3.1/dist/index.min.js`),E=x(`@bbob/preset-html5@4.3.1/dist/index.min.js`),ie=x(`biwascheme@0.8.0/release/biwascheme.js`),ae=x(`brython@3.12.4/`),oe=x(`cherry-cljs@0.2.19/`),se=x(`@live-codes/clio-browser-compiler@0.0.3/public/build/`),D=x(`@live-codes/codemirror@0.3.4/build/`),ce=x(`coffeescript@2.7.0/lib/coffeescript-browser-compiler-legacy/coffeescript.js`),le=x(`dot@1.1.3/doT.js`),ue=x(`ejs@4.0.1/ejs.js`),de=x(`eta@3.4.0/dist/eta.umd.js`),fe=x(`gh:live-codes/gleam-precompiled@v0.5.0/`),O=x(`@live-codes/go2js@0.5.0/build/`),pe=x(`handlebars@4.7.8/dist/`),me=x(`imba@2.0.0-alpha.229/dist/`),he=x(`gh:jscl-project/jscl-project.github.io@058adc599f0d012718ef3ad28e704a92c4dd741e/jscl.js`),ge=x(`liquidjs@10.14.0/dist/liquid.browser.min.js`),k=x(`fengari-web@0.1.4/dist/fengari-web.js`),_e=x(`malinajs@0.7.19/`),ve=x(`mjml-browser@4.15.3/lib/index.js`),A=x(`@live-codes/monaco-languages@0.2.0/dist/`),ye=x(`mustache@4.2.0/mustache.js`),be=x(`nunjucks@3.2.4/browser/`),j=x(`https://cdn.opalrb.com/opal/1.8.2/`),xe=x(`parinfer@3.13.1/parinfer.js`),Se=x(`@live-codes/postcss-import-url@0.1.2/dist/postcss-import-url.js`),M=x(`prettier@3.3.2/`),Ce=x(`@live-codes/prettier-plugin-minizinc@0.2.0/dist/standalone.js`),we=x(`@prettier/plugin-php@0.22.2/standalone.js`),Te=x(`requirejs@2.3.6/require.js`),Ee=x(`riot@9.2.2/`),De=x(`@ruby/wasm-wasi@2.7.2/dist/browser.umd.js`),Oe=x(`sql-formatter@12.2.1/dist/sql-formatter.min.js`),ke=x(`sql.js@1.10.3/dist/`),N=x(`squint-cljs@0.4.81/`),Ae=x(`@stencil/core@3.2.2/compiler/stencil.js`),je=x(`stylis@4.3.6/dist/umd/stylis.js`),P=x(`svelte@5.39.12/`),F=x(`tau-prolog@0.3.4/modules/`),Me=x(`twig@1.17.1/twig.min.js`),Ne=`5.9.3`,Pe=x(`typescript@${Ne}/lib/typescript.js`),Fe=x(`uniter@2.18.0/dist/uniter.js`),Ie=x(`vue@2`),Le=x(`vue@3/dist/vue.runtime.esm-browser.prod.js`),Re=x(`livecodes@${{}.SDK_VERSION}/vue.js`),ze=x(`vue3-sfc-loader@0.9.5/dist/`),Be=x(`wabt@1.0.35/index.js`),Ve=x(`wasmoon@1.16.0/dist/index.js`)})),L,R=e((()=>{I(),M+``,L={babel:M+`plugins/babel.js`,estree:M+`plugins/estree.js`,glimmer:M+`plugins/glimmer.js`,html:M+`plugins/html.js`,markdown:M+`plugins/markdown.js`,postcss:M+`plugins/postcss.js`,php:we,minizinc:Ce,pug:C+`prettier/parser-pug.js`,java:C+`prettier/parser-java.js`}})),He,Ue=e((()=>{I(),R(),He={name:`art-template`,title:`art`,longTitle:`art-template`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:w,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-art-template-compiler.js}}`),self.createArtTemplateCompiler())},extensions:[`art`,`art-template`],editor:`markup`,editorLanguage:`html`}})),We=e((()=>{Ue()})),Ge,z,B=e((()=>{Ge=(e,t=!0)=>e.replace(/\\/g,t?`\\\\`:`\\`).replace(/`/g,"\\`").replace(/<\/script>/g,`<\\/script>`),z=(e,t)=>({...t.customSettings[e]}),{}.VERSION,{}.SDK_VERSION,{}.GIT_COMMIT,{}.REPO_URL,{}.DOCS_BASE_URL})),V=e((()=>{B(),I()})),Ke,qe=e((()=>{I(),V(),Ke={name:`asciidoc`,title:`AsciiDoc`,compiler:{url:T,factory:()=>{let e=window.Asciidoctor();return async(t,{config:n})=>e.convert(t,{standalone:!0,attributes:{nofooter:!0},...z(`asciidoc`,n)})}},extensions:[`adoc`,`asciidoc`,`asc`],editor:`markup`}})),Je=e((()=>{qe()})),Ye,Xe,Ze=e((()=>{I(),R(),Ye=C+`assemblyscript/assemblyscript.js`,Xe={name:`assemblyscript`,title:`AS`,longTitle:`AssemblyScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel]}},compiler:{url:Ye,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-assemblyscript-compiler.js}}`),self.createAssemblyscriptCompiler()),scripts:({baseUrl:e})=>[ee,e+`{{hash:lang-assemblyscript-script.js}}`],scriptType:`application/wasm-uint8`,compiledCodeLanguage:`wat`,types:{assemblyscript:{url:C+`types/assemblyscript.d.ts`,declareAsModule:!1,autoload:!0}}},extensions:[`as`,`ts`],editor:`script`,editorLanguage:`typescript`}})),Qe=e((()=>{Ze()})),$e,et,tt=e((()=>{I(),R(),$e=te+`compiler.min.js`,et={name:`astro`,title:`Astro`,formatter:{prettier:{name:`html`,pluginUrls:[L.html,L.babel]}},compiler:{url:$e,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-astro-compiler.js}}`),self.createAstroCompiler())},extensions:[`astro`],editor:`markup`}})),nt=e((()=>{tt()})),rt=e((()=>{})),H=e((()=>{rt(),B()})),it,at=e((()=>{H(),I(),R(),it={name:`babel`,title:`Babel`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{url:ne,factory:()=>async(e,{config:t})=>{let n=z(`babel`,t),r=z(`@babel/preset-env`,t),i=z(`@babel/preset-typescript`,t),a=z(`@babel/preset-react`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...r}],[`typescript`,i],[`react`,a]],...n}).code}},extensions:[`es`,`babel`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),ot=e((()=>{at()})),st,ct=e((()=>{I(),st={name:`bbcode`,title:`BBCode`,compiler:{url:re,factory:()=>(self.importScripts(E),async e=>self.BbobHtml.default(e,self.BbobPresetHTML5.default()))},extensions:[`bbcode`,`bb`],editor:`markup`}})),lt=e((()=>{ct()})),ut,dt=e((()=>{ut={name:`blockly`,title:`Blockly`,compiler:{factory:()=>async(e,{options:t})=>t?.blockly?.js||``},extensions:[`blockly.xml`,`xml`],editor:`script`,editorLanguage:`xml`}})),ft=e((()=>{dt()})),pt,mt,ht=e((()=>{I(),pt=C+`civet/civet.js`,mt={name:`civet`,title:`Civet`,compiler:{url:pt,factory:()=>async e=>window.civet.compile(e,{js:!0})},extensions:[`civet`],editor:`script`,editorLanguage:`coffeescript`}})),gt=e((()=>{ht()})),_t,vt=e((()=>{I(),_t={name:`clio`,title:`Clio`,compiler:{url:se+`compile.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-clio-compiler.js}}`),self.createClioCompiler()),scripts:[se+`exec.js`]},extensions:[`clio`],editor:`script`,editorLanguage:`coffeescript`}})),yt=e((()=>{vt()})),bt,xt=e((()=>{bt=e=>typeof e==`string`?{code:e,info:{}}:e})),St,Ct=e((()=>{xt(),St=async(e,t,n,r={},i=self)=>new Promise(a=>{if(!e||!t||!n)return a(bt(``));let o=async function(n){let r=n.data.payload;n.data.trigger===`compileInCompiler`&&r?.content===e&&r?.language===t&&(i.removeEventListener(`message`,o),a(bt(r.compiled)))};i.addEventListener(`message`,o),i.postMessage({type:`compileInCompiler`,payload:{content:e,language:t,config:n,options:r}})})})),wt=e((()=>{B()})),Tt=e((()=>{V(),B(),wt()})),Et=e((()=>{I()})),Dt,Ot,kt,At,jt,Mt,Nt,Pt=e((()=>{H(),I(),Dt={name:`autoprefixer`,title:`Autoprefixer`,isPostcssPlugin:!0,compiler:{url:C+`autoprefixer/autoprefixer.js`,factory:e=>self.autoprefixer.autoprefixer({...z(`autoprefixer`,e)})},editor:`style`},Ot={name:`cssnano`,title:`cssnano`,isPostcssPlugin:!0,compiler:{url:C+`cssnano/cssnano.js`,factory:()=>{let e=self.cssnano.cssnanoPresetDefault().plugins,t=[];for(let n of e){let[e,r]=n;(r===void 0||typeof r==`object`&&!r.exclude||typeof r==`boolean`&&r===!0)&&t.push(e(r))}return t}},editor:`style`},kt={name:`postcssImportUrl`,title:`Import Url`,isPostcssPlugin:!0,compiler:{url:Se,factory:e=>self.postcssImportUrl({...z(`postcssImportUrl`,e)})},editor:`style`},At={name:`postcssPresetEnv`,title:`Preset Env`,isPostcssPlugin:!0,compiler:{url:C+`postcss-preset-env/postcss-preset-env.js`,factory:e=>self.postcssPresetEnv.postcssPresetEnv({autoprefixer:!1,...z(`postcssPresetEnv`,e)})},editor:`style`},jt={name:`purgecss`,title:`PurgeCSS`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:C+`purgecss/purgecss.js`,factory:(e,t,n)=>self.purgecss.purgecss({...z(`purgecss`,e),content:[{raw:`<template>${n.html}\n<script>${e.script.content}<\/script></template>`,extension:`html`}]})},editor:`style`},Mt={name:`tokencss`,title:`Token CSS`,isPostcssPlugin:!0,compiler:{url:C+`tokencss/tokencss.js`,factory:e=>{let t=z(`tokencss`,e);Object.keys(t).length===0&&(t.$schema=`https://tokencss.com/schema@0.0.1`,t.extends=`@tokencss/core/preset`);let n=t.extends?.includes(`@tokencss/core/preset`)?((e,t)=>{let n=JSON.parse(JSON.stringify(e));return Object.keys(t).forEach(e=>{n[e]=typeof t[e]!=`object`||Array.isArray(t[e])?t[e]:{...n[e],...t[e]}}),n})(self.tokencss.preset,t):t;return self.tokencss.tokencss({config:n})}},editor:`style`},Nt={name:`cssmodules`,title:`CSS Modules`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:C+`postcss-modules/postcss-modules.js`,factory:(e,t,n)=>{let r=z(`cssmodules`,e);return self.postcssModules.postcssModules({localsConvention:`camelCase`,...r,getJSON(e,t,i){let a=r.addClassesToHTML!==!1,o=r.removeOriginalClasses===!0;a&&(n.html=self.postcssModules.addClassesToHtml(n.html,t,o)),n.compileInfo={...n.compileInfo,cssModules:t,...a?{modifiedHTML:n.html}:{}}}})}},editor:`style`}})),Ft,It=e((()=>{I(),Ft={name:`postcss`,title:`Processors:`,isPostcssPlugin:!1,compiler:{url:C+`postcss/postcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-postcss-compiler.js}}`),self.createPostcssCompiler())},editor:`style`,hidden:!0}})),Lt=e((()=>{Pt(),It()})),Rt,zt=e((()=>{I(),Rt={name:`lightningcss`,title:`Lightning CSS`,isPostcssPlugin:!1,compiler:{url:C+`lightningcss/lightningcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-lightningcss-compiler.js}}`),self.createLightningcssCompiler())},editor:`style`}})),Bt=e((()=>{zt()})),Vt,Ht=e((()=>{I(),Vt={name:`tailwindcss`,title:`Tailwind CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:C+`tailwindcss/tailwindcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-tailwindcss-compiler.js}}`),self.createTailwindcssCompiler())},editor:`style`}})),Ut=e((()=>{Ht()})),Wt,Gt=e((()=>{I(),Wt={name:`unocss`,title:`UnoCSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:C+`unocss/unocss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-unocss-compiler.js}}`),self.createUnocssCompiler())},editor:`style`}})),Kt=e((()=>{Gt()})),qt,Jt=e((()=>{I(),qt={name:`windicss`,title:`Windi CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:C+`windicss/windicss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-windicss-compiler.js}}`),self.createWindicssCompiler())},editor:`style`}})),Yt=e((()=>{Jt()})),Xt,Zt=e((()=>{Bt(),Lt(),Ut(),Kt(),Yt(),Xt=[...[Vt,qt,Wt,Mt,jt,kt,Dt,At,Rt,Ot,Nt],Ft]})),Qt=e((()=>{Et(),ls(),Lt(),R(),Zt(),V()})),$t=e((()=>{Qt(),H()})),en,U,tn,nn=e((()=>{en=e=>{try{return new URL(e).hostname}catch{return``}},U=(e,t)=>e===t||e.endsWith(`.`+t),tn=(e=location.origin)=>{let t=en(e);return!!(t&&(U(t,`livecodes.io`)||U(t,`livecodes.pages.dev`)||U(t,`localpen.pages.dev`)||U(t,`localhost`)||t===`127.0.0.1`||t.endsWith(`.test`)))}})),rn=t(((e,t)=>{var n=(function(){var e=String.fromCharCode,t=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=`,n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$`,r={};function i(e,t){if(!r[e]){r[e]={};for(var n=0;n<e.length;n++)r[e][e.charAt(n)]=n}return r[e][t]}var a={compressToBase64:function(e){if(e==null)return``;var n=a._compress(e,6,function(e){return t.charAt(e)});switch(n.length%4){default:case 0:return n;case 1:return n+`===`;case 2:return n+`==`;case 3:return n+`=`}},decompressFromBase64:function(e){return e==null?``:e==``?null:a._decompress(e.length,32,function(n){return i(t,e.charAt(n))})},compressToUTF16:function(t){return t==null?``:a._compress(t,15,function(t){return e(t+32)})+` `},decompressFromUTF16:function(e){return e==null?``:e==``?null:a._decompress(e.length,16384,function(t){return e.charCodeAt(t)-32})},compressToUint8Array:function(e){for(var t=a.compress(e),n=new Uint8Array(t.length*2),r=0,i=t.length;r<i;r++){var o=t.charCodeAt(r);n[r*2]=o>>>8,n[r*2+1]=o%256}return n},decompressFromUint8Array:function(t){if(t==null)return a.decompress(t);for(var n=Array(t.length/2),r=0,i=n.length;r<i;r++)n[r]=t[r*2]*256+t[r*2+1];var o=[];return n.forEach(function(t){o.push(e(t))}),a.decompress(o.join(``))},compressToEncodedURIComponent:function(e){return e==null?``:a._compress(e,6,function(e){return n.charAt(e)})},decompressFromEncodedURIComponent:function(e){return e==null?``:e==``?null:(e=e.replace(/ /g,`+`),a._decompress(e.length,32,function(t){return i(n,e.charAt(t))}))},compress:function(t){return a._compress(t,16,function(t){return e(t)})},_compress:function(e,t,n){if(e==null)return``;var r,i,a={},o={},s=``,c=``,l=``,u=2,d=3,f=2,p=[],m=0,h=0,g;for(g=0;g<e.length;g+=1)if(s=e.charAt(g),Object.prototype.hasOwnProperty.call(a,s)||(a[s]=d++,o[s]=!0),c=l+s,Object.prototype.hasOwnProperty.call(a,c))l=c;else{if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++),a[c]=d++,l=String(s)}if(l!==``){if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++)}for(i=2,r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;for(;;)if(m<<=1,h==t-1){p.push(n(m));break}else h++;return p.join(``)},decompress:function(e){return e==null?``:e==``?null:a._decompress(e.length,32768,function(t){return e.charCodeAt(t)})},_decompress:function(t,n,r){var i=[],a=4,o=4,s=3,c=``,l=[],u,d,f,p,m,h,g,_={val:r(0),position:n,index:1};for(u=0;u<3;u+=1)i[u]=u;for(f=0,m=2**2,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 2:return``}for(i[3]=g,d=g,l.push(g);;){if(_.index>t)return``;for(f=0,m=2**s,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(g=f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 2:return l.join(``)}if(a==0&&(a=2**s,s++),i[g])c=i[g];else if(g===o)c=d+d.charAt(0);else return null;l.push(c),i[o++]=d+c.charAt(0),a--,d=c,a==0&&(a=2**s,s++)}}};return a})();typeof define==`function`&&define.amd?define(function(){return n}):t!==void 0&&t!=null&&(t.exports=n)})),an=e((()=>{rn()})),on=e((()=>{})),sn=e((()=>{})),cn=e((()=>{})),ln=e((()=>{on(),sn(),cn()})),un=e((()=>{})),dn=e((()=>{ln(),B(),I()})),fn=e((()=>{an(),dn()})),pn=e((()=>{dn()})),mn=e((()=>{ln()})),hn=e((()=>{B(),pn(),mn(),dn()})),gn=e((()=>{fn(),un(),pn(),mn(),dn(),hn()})),_n=e((()=>{gn(),H()})),vn=e((()=>{})),yn=e((()=>{H()})),bn=e((()=>{`${{}.SANDBOX_HOST_NAME}${{}.SANDBOX_PORT}`,location.hostname===`localhost`||location.hostname===`127.0.0.1`||{}.SELF_HOSTED===`true`||{}.CI})),xn=e((()=>{nn(),{}.SELF_HOSTED===`true`?{}.SELF_HOSTED_SHARE:tn()})),Sn=e((()=>{wt()})),Cn=e((()=>{nn(),_n(),vn(),yn(),b(),bn(),xn(),Sn()})),wn=e((()=>{Qt(),Cn(),H(),$t(),wt()})),Tn=e((()=>{wn()})),En=e((()=>{Tt(),Ct(),$t(),Tn(),wt(),xt()})),W,G,K=e((()=>{n(),W=async e=>{let{LanguageSupport:t,StreamLanguage:n}=await r(async()=>{let{LanguageSupport:e,StreamLanguage:t}=await import(G.language);return{LanguageSupport:e,StreamLanguage:t}},[],import.meta.url);return new t(n.define(e))},G={html:`@codemirror/lang-html`,css:`@codemirror/lang-css`,javascript:`@codemirror/lang-javascript`,json:`@codemirror/lang-json`,language:`@codemirror/language`}})),q,Dn,On=e((()=>{I(),q=()=>{let e=xe;return self.importScripts(e),async e=>({formatted:window.parinfer.parenMode(e).text,cursorOffset:0})},Dn={name:`commonlisp`,title:`Lisp`,longTitle:`Common Lisp`,formatter:{factory:q},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[he,e+`{{hash:lang-commonlisp-script.js}}`],scriptType:`text/commonlisp`,compiledCodeLanguage:`commonlisp`},extensions:[`lisp`,`common-lisp`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`commonlisp.js`},codemirror:{language:`scheme`},codejar:{language:`scheme`}}}})),kn=e((()=>{On()})),An,jn=e((()=>{En(),K(),I(),kn(),n(),An={name:`clojurescript`,title:`CLJS (cherry)`,longTitle:`ClojureScript (cherry)`,formatter:{factory:q},compiler:{url:oe+`lib/cherry.umd.js`,factory:()=>async(e,{config:t,options:n})=>{let r=self.CherryCljs.compileString(e);return e.includes(`#jsx`)?(await St(r,`jsx`,t,n)).code:r},imports:{"cherry-cljs":oe+`index.js`,"cherry-cljs/cljs.core.js":oe+`cljs.core.js`,"cherry-cljs/lib/clojure.string.js":`lib/clojure.string.js`,"cherry-cljs/lib/clojure.set.js":`lib/clojure.set.js`,"cherry-cljs/lib/clojure.walk.js":`lib/clojure.walk.js`,"squint-cljs":N+`index.js`,"squint-cljs/core.js":N+`core.js`,"squint-cljs/string.js":N+`string.js`,"squint-cljs/src/squint/string.js":N+`src/squint/string.js`,"squint-cljs/src/squint/set.js":N+`src/squint/set.js`}},extensions:[`cljs`,`clj`,`cljc`,`edn`,`clojure`],editor:`script`,editorLanguage:`clojure`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{clojure:e}=await import(D+`codemirror-lang-clojure.js`);return{clojure:e}},[],import.meta.url)).clojure)}}}})),Mn=e((()=>{jn()})),Nn,Pn=e((()=>{K(),H(),I(),n(),Nn={name:`coffeescript`,title:`Coffee`,longTitle:`CoffeeScript`,compiler:{url:ce,factory:()=>async(e,{config:t})=>window.CoffeeScript.compile(e,{bare:!0,...z(`coffeescript`,t)})},extensions:[`coffee`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{coffeescript:e}=await import(D+`codemirror-lang-coffeescript.js`);return{coffeescript:e}},[],import.meta.url)).coffeescript)}}}})),Fn=e((()=>{Pn()})),In,Ln,Rn=e((()=>{I(),n(),In=C+`jscpp/JSCPP.es5.min.js`,Ln={name:`cpp`,title:`C++`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[In,e+`{{hash:lang-cpp-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`},extensions:[`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`cpp.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{cpp:e}=await import(D+`codemirror-lang-cpp.js`);return{cpp:e}},[],import.meta.url)).cpp()}}}})),zn=e((()=>{Rn()})),Bn,Vn=e((()=>{Bn={name:`cpp-wasm`,title:`C++ (Wasm)`,longTitle:`C/C++ (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-cpp-wasm-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`,liveReload:!0},extensions:[`wasm.cpp`,`cppwasm`,`cwasm`,`clang.cpp`,`clang`,`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorLanguage:`cpp`,largeDownload:!0}})),Hn=e((()=>{Vn()})),Un,Wn=e((()=>{K(),I(),R(),n(),Un={name:`csharp-wasm`,title:`C# (Wasm)`,formatter:{prettier:{name:`java`,pluginUrls:[L.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-csharp-wasm-script.js}}`],scriptType:`text/csharp-wasm`,compiledCodeLanguage:`csharp-wasm`,liveReload:!0},extensions:[`cs`,`csharp`,`wasm.cs`,`cs-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`csharp.js`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{csharp:e}=await import(D+`codemirror-lang-clike.js`);return{csharp:e}},[],import.meta.url)).csharp)},codejar:{language:`csharp`}},largeDownload:!0}})),Gn=e((()=>{Wn()})),Kn,qn=e((()=>{K(),R(),n(),Kn={name:`css`,title:`CSS`,info:!1,formatter:{prettier:{name:`css`,pluginUrls:[L.postcss]}},compiler:{factory:()=>async e=>e},extensions:[`css`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>{let{css:e}=await r(async()=>{let{css:e}=await import(G.css);return{css:e}},[],import.meta.url);return e()}}}}})),Jn=e((()=>{qn()})),Yn,Xn,Zn=e((()=>{R(),n(),Yn=async(e,{baseUrl:t,config:n})=>{let{diagramsCompiler:i}=await r(async()=>{let{diagramsCompiler:e}=await import(t+`{{hash:lang-diagrams-compiler-esm.js}}`);return{diagramsCompiler:e}},[],import.meta.url);return i(e,{config:n})},Xn={name:`diagrams`,title:`Diagrams`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{factory:()=>async e=>e||``,runOutsideWorker:Yn},extensions:[`diagrams`,`diagram`,`graph`,`plt`],editor:`markup`,editorLanguage:`html`}})),Qn=e((()=>{Zn()})),$n,er=e((()=>{I(),R(),$n={name:`dot`,title:`doT`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:le,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-dot-compiler.js}}`),self.createDotCompiler())},extensions:[`dot`],editor:`markup`,editorLanguage:`html`}})),tr=e((()=>{er()})),nr,rr=e((()=>{I(),R(),nr={name:`ejs`,title:`EJS`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:ue,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-ejs-compiler.js}}`),self.createEjsCompiler())},extensions:[`ejs`],editor:`markup`,editorLanguage:`html`}})),ir=e((()=>{rr()})),ar,or=e((()=>{I(),R(),ar={name:`eta`,title:`Eta`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:de,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-eta-compiler.js}}`),self.createEtaCompiler())},extensions:[`eta`],editor:`markup`,editorLanguage:`html`}})),sr=e((()=>{or()})),cr,lr=e((()=>{I(),kn(),cr={name:`fennel`,title:`Fennel`,formatter:{factory:q},compiler:{url:k,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-fennel-compiler.js}}`),self.createFennelCompiler()),scripts:[k],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`fnl`],editor:`script`,editorLanguage:`scheme`}})),ur=e((()=>{lr()})),dr,fr=e((()=>{H(),I(),R(),dr={name:`flow`,title:`Flow`,formatter:{prettier:{name:`babel-flow`,pluginUrls:[L.babel,L.html]}},compiler:{url:C+`flow-remove-types/flow-remove-types.js`,factory:()=>async(e,{config:t})=>window.flowRemoveTypes.transpile(e,{all:!0,...z(`flow`,t)}).toString()},extensions:[`flow`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),pr=e((()=>{fr()})),mr,hr=e((()=>{K(),I(),n(),mr={name:`gleam`,title:`Gleam`,compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-gleam-compiler.js}}`),self.createGleamCompiler()),loadAsExternalModule:!0,inlineModule:`(async() => {
      const main = (await import('./script')).main;
      if (typeof main === "function") main();
    })();
`},extensions:[`gleam`],editor:`script`,editorSupport:{monaco:{language:`swift`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{swift:e}=await import(D+`codemirror-lang-swift.js`);return{swift:e}},[],import.meta.url)).swift)},codejar:{language:`swift`}}}})),gr=e((()=>{hr()})),_r,vr=e((()=>{I(),n(),_r={name:`go`,title:`Go`,formatter:{factory:()=>(importScripts(O+`go2js-format.js`),async e=>{if(!e)return{formatted:``,cursorOffset:0};let[t,n]=globalThis.go2jsFormat(e);return n?(console.error(n),{formatted:e,cursorOffset:0}):{formatted:t,cursorOffset:0}})},compiler:{url:O+`go2js-compile.js`,factory:()=>e=>new Promise(t=>{if(!e){t(``);return}let n=O.endsWith(`/`)?O.slice(0,-1):O;globalThis.go2jsCompile(e,n,(e,n)=>{e?(console.error(e),t(``)):t(n)})})},extensions:[`go`,`golang`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`go.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{go:e}=await import(D+`codemirror-lang-go.js`);return{go:e}},[],import.meta.url)).go()}}}})),yr=e((()=>{vr()})),br,xr=e((()=>{vr(),br={name:`go-wasm`,title:`Go (Wasm)`,formatter:_r.formatter,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-go-wasm-script.js}}`],liveReload:!0,scriptType:`text/go-wasm`,compiledCodeLanguage:`go`},extensions:[`wasm.go`,`go-wasm`,`gowasm`],editor:`script`,editorLanguage:`go`,largeDownload:!0}})),Sr=e((()=>{xr()})),Cr,wr=e((()=>{I(),Cr={name:`haml`,title:`Haml`,compiler:{url:C+`clientside-haml-js/haml.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-haml-compiler.js}}`),self.createHamlCompiler())},extensions:[`haml`],editor:`markup`}})),Tr=e((()=>{wr()})),Er,Dr,Or=e((()=>{I(),R(),Er=pe+`handlebars.min.js`,pe+``,Dr={name:`handlebars`,title:`Handlebars`,formatter:{prettier:{name:`glimmer`,pluginUrls:[L.glimmer]}},compiler:{url:Er,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-handlebars-compiler.js}}`),self.createHandlebarsCompiler())},extensions:[`hbs`,`handlebars`],editor:`markup`,editorLanguage:`html`}})),kr=e((()=>{Or()})),Ar,jr=e((()=>{K(),R(),n(),Ar={name:`html`,title:`HTML`,info:!1,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{factory:()=>async e=>e},extensions:[`html`,`htm`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>{let{html:e}=await r(async()=>{let{html:e}=await import(G.html);return{html:e}},[],import.meta.url);return e()}}}}})),Mr=e((()=>{jr()})),Nr,Pr=e((()=>{I(),Nr={name:`imba`,title:`Imba`,compiler:{url:me+`compiler.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-imba-compiler.js}}`),self.createImbaCompiler()),imports:{imba:me+`imba.mjs`}},extensions:[`imba`],editor:`script`}})),Fr=e((()=>{Pr()})),Ir,Lr=e((()=>{I(),R(),n(),Ir={name:`java`,title:`Java`,formatter:{prettier:{name:`java`,pluginUrls:[L.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-java-script.js}}`],scriptType:`text/java`,compiledCodeLanguage:`java`,liveReload:!0},extensions:[`java`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`java.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{java:e}=await import(D+`codemirror-lang-java.js`);return{java:e}},[],import.meta.url)).java()}},largeDownload:!0}})),Rr=e((()=>{Lr()})),zr,Br=e((()=>{K(),R(),n(),zr={name:`javascript`,title:`JS`,longTitle:`JavaScript`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{factory:()=>async e=>e},extensions:[`js`,`mjs`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(G.javascript);return{javascript:e}},[],import.meta.url);return e()}}}}})),Vr=e((()=>{Br()})),Hr,Ur,Wr=e((()=>{I(),Hr=`${C}jinja/jinja.js`,Ur={name:`jinja`,title:`Jinja`,formatter:{factory:()=>(self.importScripts(Hr),async(e,t,n)=>({formatted:new self.Jinja.Template(e).format({indent:n?.tabSize||2}),cursorOffset:t}))},compiler:{url:Hr,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-jinja-compiler.js}}`),self.createJinjaCompiler())},extensions:[`jinja`],editor:`markup`,editorLanguage:`html`}})),Gr=e((()=>{Wr()})),Kr,qr=e((()=>{K(),R(),n(),Kr={name:`jsx`,title:`JSX`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:`typescript`,extensions:[`jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(G.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0})}},compilerOptions:{jsx:4}}}})),Jr,Yr=e((()=>{K(),R(),n(),Jr={name:`tsx`,title:`TSX`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:`typescript`,extensions:[`tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(G.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0,typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),Xr=e((()=>{qr(),Yr()})),Zr,Qr=e((()=>{K(),I(),n(),Zr={name:`julia`,title:`Julia`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-julia-script.js}}`],liveReload:!0,scriptType:`text/julia`,compiledCodeLanguage:`julia`},extensions:[`jl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{julia:e}=await import(D+`codemirror-lang-julia.js`);return{julia:e}},[],import.meta.url)).julia)}},largeDownload:!0}})),$r=e((()=>{Qr()})),ei,ti=e((()=>{K(),H(),I(),R(),n(),ei={name:`less`,title:`Less`,formatter:{prettier:{name:`less`,pluginUrls:[L.postcss]}},compiler:{url:C+`less/less.js`,factory:()=>async(e,{config:t})=>(await window.less.render(e,{...z(`less`,t)})).css},extensions:[`less`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{less:e}=await import(D+`codemirror-lang-less.js`);return{less:e}},[],import.meta.url)).less)}}}})),ni=e((()=>{ti()})),ri,ii=e((()=>{I(),R(),n(),ri={name:`liquid`,title:`Liquid`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:ge,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-liquid-compiler.js}}`),self.createLiquidCompiler())},extensions:[`liquid`,`liquidjs`],editor:`markup`,editorLanguage:`html`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{liquid:e}=await import(D+`codemirror-lang-liquid.js`);return{liquid:e}},[],import.meta.url)).liquid()}}}})),ai=e((()=>{ii()})),oi,si=e((()=>{K(),H(),I(),n(),oi={name:`livescript`,title:`LiveScript`,compiler:{url:C+`livescript/livescript-min.js`,factory:()=>async(e,{config:t})=>window.require(`livescript`).compile(e,{bare:!0,...z(`livescript`,t)}),scripts:[C+`livescript/prelude-browser-min.js`]},extensions:[`ls`],editor:`script`,editorSupport:{monaco:{language:`coffeescript`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{livescript:e}=await import(D+`codemirror-lang-livescript.js`);return{livescript:e}},[],import.meta.url)).livescript)}}}})),ci=e((()=>{si()})),li,ui,di,fi=e((()=>{K(),I(),n(),li=C+`lua-fmt/lua-fmt.js`,ui={factory:()=>(self.importScripts(li),async(e,t)=>({formatted:self.luaFmt.formatText(e),cursorOffset:t}))},di={name:`lua`,title:`Lua`,formatter:ui,compiler:{factory:()=>async e=>e,scripts:[k],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`lua`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`lua.js`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{lua:e}=await import(D+`codemirror-lang-lua.js`);return{lua:e}},[],import.meta.url)).lua)}}}})),pi=e((()=>{fi()})),mi,hi=e((()=>{I(),fi(),mi={name:`lua-wasm`,title:`Lua (Wasm)`,formatter:ui,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Ve,e+`{{hash:lang-lua-wasm-script.js}}`],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`wasm.lua`,`luawasm`],editor:`script`,editorLanguage:`lua`}})),gi=e((()=>{hi()})),_i,vi=e((()=>{I(),R(),_i={name:`malina`,title:`Malina.js`,formatter:{prettier:{name:`html`,pluginUrls:[L.html,L.babel]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-malina-compiler.js}}`),self.createMalinaCompiler()),imports:{"malinajs/runtime.js":`${_e}runtime.js`}},extensions:[`xht`],editor:`script`,editorLanguage:`html`}})),yi=e((()=>{vi()})),bi,xi=e((()=>{I(),R(),n(),bi={name:`markdown`,title:`Markdown`,formatter:{prettier:{name:`markdown`,pluginUrls:[L.markdown,L.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-markdown-compiler.js}}`),self.createMarkdownCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-markdown-script.js}}`]},extensions:[`md`,`markdown`,`mdown`,`mkdn`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{markdown:e}=await import(D+`codemirror-lang-markdown.js`);return{markdown:e}},[],import.meta.url)).markdown()}}}})),Si=e((()=>{xi()})),Ci,wi,Ti=e((()=>{Ct(),H(),I(),R(),n(),Ci=async(e,{config:t,worker:n})=>new Promise(async i=>{if(!e)return i(``);let[a,{default:o}]=await Promise.all([r(()=>import(C+`mdx/mdx.js`),[],import.meta.url),r(()=>import(C+`remark-gfm/remark-gfm.js`),[],import.meta.url)]),s=(await a.compile(e,{remarkPlugins:[o],...z(`mdx`,t)})).value,c=(await St(`import React from "react";
import { createRoot } from "react-dom/client";
${Ge((e=>e.replace(/, {[^}]*} = _components/g,``).replace(/const {[^:]*} = props.components[^;]*;/g,``))(s),!1)}
createRoot(document.querySelector('#__livecodes_mdx_root__')).render(<MDXContent />,);
`,`jsx`,t,{},n)).code;i(`<div id="__livecodes_mdx_root__"></div><script type="module">${c}<\/script>`)}),wi={name:`mdx`,title:`MDX`,formatter:{prettier:{name:`markdown`,pluginUrls:[L.markdown,L.html]}},compiler:{factory:()=>async e=>e,runOutsideWorker:Ci,compiledCodeLanguage:`javascript`},extensions:[`mdx`],editor:`markup`,editorLanguage:`markdown`}})),Ei=e((()=>{Ti()})),Di,Oi=e((()=>{I(),R(),n(),Di={name:`minizinc`,title:`MiniZinc`,formatter:{prettier:{name:`minizinc`,pluginUrls:[L.minizinc]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-minizinc-script.js}}`],scriptType:`text/minizinc`,compiledCodeLanguage:`minizinc`},extensions:[`mzn`,`dzn`,`minizinc`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`minizinc.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{MiniZinc:e}=await import(D+`codemirror-lang-minizinc.js`);return{MiniZinc:e}},[],import.meta.url)).MiniZinc()}}}})),ki=e((()=>{Oi()})),Ai,ji=e((()=>{H(),I(),R(),Ai={name:`mjml`,title:`MJML`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:ve,factory:()=>async(e,{config:t})=>{if(!e.trim())return``;let{html:n,errors:r}=self.mjml(e,z(`mjml`,t));return r?.forEach(e=>{console.warn(e.formattedMessage)}),n}},extensions:[`mjml`],editor:`markup`,editorLanguage:`xml`}})),Mi=e((()=>{ji()})),Ni,Pi=e((()=>{I(),R(),Ni={name:`mustache`,title:`Mustache`,formatter:{prettier:{name:`glimmer`,pluginUrls:[L.glimmer]}},compiler:{url:ye,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-mustache-compiler.js}}`),self.createMustacheCompiler())},extensions:[`mustache`],editor:`markup`,editorLanguage:`html`}})),Fi=e((()=>{Pi()})),Ii,Li,Ri=e((()=>{I(),R(),Ii=be+`nunjucks.min.js`,be+``,Li={name:`nunjucks`,title:`Nunjucks`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:Ii,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-nunjucks-compiler.js}}`),self.createNunjucksCompiler())},extensions:[`njk`,`nunjucks`],editor:`markup`,editorLanguage:`html`}})),zi=e((()=>{Ri()})),Bi,Vi=e((()=>{K(),I(),n(),Bi={name:`ocaml`,title:`OCaml`,compiler:`rescript`,extensions:[`ml`,`mli`],editor:`script`,editorSupport:{monaco:{language:`csharp`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{oCaml:e}=await import(D+`codemirror-lang-mllike.js`);return{oCaml:e}},[],import.meta.url)).oCaml)}}}})),Hi=e((()=>{Vi()})),Ui,Wi=e((()=>{K(),I(),n(),Ui={name:`perl`,title:`Perl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[C+`perlito/perlito5.min.js`,e+`{{hash:lang-perl-script.js}}`],scriptType:`text/perl`},extensions:[`pl`,`pm`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{perl:e}=await import(D+`codemirror-lang-perl.js`);return{perl:e}},[],import.meta.url)).perl)}}}})),Gi=e((()=>{Wi()})),Ki,qi=e((()=>{I(),R(),n(),Ki={name:`php`,title:`PHP`,formatter:{prettier:{name:`php`,pluginUrls:[L.php]}},compiler:{factory:()=>async e=>(e=e.trim(),e.startsWith(`<?php`)&&(e=e.replace(`<?php`,`/* <?php */`),e.endsWith(`?>`)&&(e=e.replace(`?>`,`/* ?> */`))),e),scripts:[Fe],deferScripts:!0,scriptType:`text/x-uniter-php`,compiledCodeLanguage:`php`},extensions:[`php`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`php.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{php:e}=await import(D+`codemirror-lang-php.js`);return{php:e}},[],import.meta.url)).php()}}}})),Ji=e((()=>{qi()})),Yi,Xi=e((()=>{I(),R(),Yi={name:`php-wasm`,title:`PHP (Wasm)`,formatter:{prettier:{name:`php`,pluginUrls:[L.php]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[C+`php-wasm/php-wasm.js`,e+`{{hash:lang-php-wasm-script.js}}`],scriptType:`text/php-wasm`,compiledCodeLanguage:`php`},extensions:[`wasm.php`,`phpwasm`],editor:`script`,editorLanguage:`php`}})),Zi=e((()=>{Xi()})),Qi,$i,ea=e((()=>{I(),n(),Qi=async(e,{baseUrl:t,config:n})=>{let{pgSqlCompiler:i}=await r(async()=>{let{pgSqlCompiler:e}=await import(t+`{{hash:lang-postgresql-compiler-esm.js}}`);return{pgSqlCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,config:n})},$i={name:`postgresql`,title:`PostgreSQL`,formatter:{factory:()=>(importScripts(Oe),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{factory:()=>async e=>e,runOutsideWorker:Qi,scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:`application/json`,compiledCodeLanguage:`json`},extensions:[`pg.sql`,`pgsql`,`pgsql.sql`,`pgsql`,`pg`,`pglite`,`pglite.sql`,`postgresql`,`postgres`,`postgre.sql`,`postgresql.sql`],editor:`script`,editorLanguage:`sql`}})),ta=e((()=>{ea()})),na,ra=e((()=>{I(),n(),na={name:`prolog`,title:`Prolog`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[F+`core.js`,F+`charsio.js`,F+`dom.js`,F+`format.js`,F+`js.js`,F+`lists.js`,F+`os.js`,F+`promises.js`,F+`random.js`,F+`statistics.js`,e+`{{hash:lang-prolog-script.js}}`],scriptType:`text/prolog`,compiledCodeLanguage:`prolog`},extensions:[`prolog.pl`,`prolog`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`prolog.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{prolog:e}=await import(D+`codemirror-lang-prolog.js`);return{prolog:e}},[],import.meta.url)).prolog()}}}})),ia=e((()=>{ra()})),aa,oa=e((()=>{I(),aa={name:`pug`,title:`Pug`,compiler:{url:C+`pug/pug.min.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-pug-compiler.js}}`),self.createPugCompiler())},extensions:[`pug`,`jade`],editor:`markup`}})),sa=e((()=>{oa()})),ca,la,ua,da=e((()=>{B(),I(),n(),ca=ae+`brython.min.js`,la=ae+`brython_stdlib.js`,ua={name:`python`,title:`Python`,compiler:{factory:()=>async e=>e,scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n}=z(`python`,t);return[ca,...n!==!1&&e.match(/^(?:from[ ]+(\S+)[ ]+)?import[ ]+(\S+)(?:[ ]+as[ ]+\S+)?[ ]*$/gm)?[la]:[]]},scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`py`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`python.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{python:e}=await import(D+`codemirror-lang-python.js`);return{python:e}},[],import.meta.url)).python()}}}})),fa=e((()=>{da()})),pa,ma=e((()=>{pa={name:`python-wasm`,title:`Py (Wasm)`,longTitle:`Python (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-python-wasm-script.js}}`],liveReload:!0,scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`wasm.py`,`py3`,`pyodide`,`py-wasm`,`pythonwasm`,`pywasm`],editor:`script`,editorLanguage:`python`,largeDownload:!0}})),ha=e((()=>{ma()})),ga,_a=e((()=>{K(),I(),n(),ga={name:`r`,title:`R`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-r-script-esm.js}}`],inlineScript:`
    ...
    `,liveReload:!0,scriptType:`text/r`,compiledCodeLanguage:`r`},extensions:[`r`,`rlang`,`rstats`,`r-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`r.js`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{r:e}=await import(D+`codemirror-lang-r.js`);return{r:e}},[],import.meta.url)).r)}},largeDownload:!0}})),va=e((()=>{_a()})),ya,ba=e((()=>{I(),R(),V(),ya={name:`react`,title:`React`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{dependencies:[`babel`],url:C+`babel-plugin-react-compiler/babel-plugin-react-compiler.js`,factory:()=>async(e,{config:t,language:n})=>{let r=z(`babel`,t),i=z(`@babel/preset-env`,t),a=z(`@babel/preset-typescript`,t),o=z(`@babel/preset-react`,t),s=z(`babel-plugin-react-compiler`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...i}],...n===`react-tsx`?[`typescript`,a]:[],[`react`,{runtime:`automatic`,...o}]],plugins:[[window.reactCompiler.reactCompiler,s]],...r}).code}},extensions:[`react.jsx`,`react-jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),xa,Sa=e((()=>{R(),xa={name:`react-tsx`,title:`React (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:`react`,extensions:[`react.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),Ca=e((()=>{ba(),Sa()})),wa,Ta,Ea,Da=e((()=>{K(),H(),I(),R(),n(),wa=(e,t)=>{let n={...z(`typescript`,t),...z(t.script.language,t)};return!!(n.jsx||n.jsxFactory||new RegExp(/\/\*\*[\s\*]*((@jsx)|(@jsxImportSource))\s/g).test(e))},Ta={target:`es2020`,jsx:`react`,allowUmdGlobalAccess:!0,esModuleInterop:!0},Ea={name:`typescript`,title:`TS`,longTitle:`TypeScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:{url:Pe,factory:()=>async(e,{config:t})=>window.ts.transpile(e,{...Ta,...[`jsx`,`tsx`].includes(t.script.language)&&!wa(e,t)?{jsx:`react-jsx`}:{},...z(`typescript`,t),...z(t.script.language,t)})},extensions:[`ts`,`mts`,`typescript`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(G.javascript);return{javascript:e}},[],import.meta.url);return e({typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0}}}})),Oa=e((()=>{Da()})),ka,Aa,ja=e((()=>{I(),R(),Oa(),V(),ka=C+`react-native-web/react-native-web.js`,Aa={name:`react-native`,title:`RN`,longTitle:`React Native`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{dependencies:[`typescript`],factory:()=>async(e,{config:t,language:n})=>window.ts.transpile(e,{...Ta,jsx:`react-jsx`,...z(`typescript`,t),...z(n,t)}),imports:{react:ka,"react-native":ka}},extensions:[`react-native.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),Ma,Na=e((()=>{R(),Ma={name:`react-native-tsx`,title:`RN (TSX)`,longTitle:`React Native (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:`react-native`,extensions:[`react-native.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),Pa=e((()=>{ja(),Na()})),Fa,Ia,La,Ra=e((()=>{n(),Fa=async(e,{baseUrl:t,language:n})=>{let{rescriptCompiler:i}=await r(async()=>{let{rescriptCompiler:e}=await import(t+`{{hash:lang-rescript-compiler-esm.js}}`);return{rescriptCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,language:n})},Ia=(e,t)=>(importScripts(e+`{{hash:lang-rescript-formatter.js}}`),self.createRescriptFormatter(e,t)),La={name:`rescript`,title:`ReScript`,formatter:{factory:Ia},compiler:{factory:()=>async e=>e,runOutsideWorker:Fa,scriptType:`module`},extensions:[`res`,`resi`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),za=e((()=>{Ra()})),Ba,Va=e((()=>{za(),Ba={name:`reason`,title:`Reason`,formatter:{factory:Ia},compiler:`rescript`,extensions:[`re`,`rei`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),Ha=e((()=>{Va()})),Ua,Wa=e((()=>{Ua={name:`richtext`,title:`Rich Text`,longTitle:`Rich Text Editor`,compiler:{factory:()=>async(e,{config:t})=>t.markup.content||``,styles:[`{{hash:quill.css}}`]},extensions:[`rte`,`rte.html`,`rich`],editor:`markup`,editorLanguage:`html`}})),Ga=e((()=>{Wa()})),Ka,qa,Ja,Ya=e((()=>{I(),R(),Ka=Ee+`riot+compiler.min.js`,qa=Ee+`riot.min.js`,Ja={name:`riot`,title:`Riot.js`,formatter:{prettier:{name:`html`,pluginUrls:[L.html,L.babel]}},compiler:{url:Ka,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-riot-compiler.js}}`),self.createRiotCompiler()),scripts:[qa],scriptType:`module`},extensions:[`riot`,`riotjs`],editor:`script`,editorLanguage:`html`}})),Xa=e((()=>{Ya()})),Za,Qa,$a=e((()=>{K(),H(),I(),n(),Za=(e,t={})=>Array.from(new Set([...e.matchAll(new RegExp(/^\s*self\.\$require\("(\S+)"\);/gm))].map(e=>e[1]).map(e=>e.split(`/`)[0]).filter(e=>t.hasOwnProperty(e)||e!==`opal`).map(e=>t[e]||`${j+e}.min.js`))),Qa={name:`ruby`,title:`Ruby`,compiler:{url:j+`opal.min.js`,factory:()=>(importScripts(j+`opal-parser.min.js`),self.Opal.config.unsupported_features_severity=`ignore`,self.Opal.load(`opal-parser`),async(e,{config:t})=>{let{autoloadStdlib:n,requireMap:r,...i}=z(`ruby`,t),a=e.includes(`$0`)?`$0 = __FILE__
`:``;return self.Opal.compile(a+e,i)}),scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n,requireMap:r}=z(`ruby`,t),i=Za(e,r),a=n===!1?[]:i;return[j+`opal.min.js`,...a]}},extensions:[`rb`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`ruby.js`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{ruby:e}=await import(D+`codemirror-lang-ruby.js`);return{ruby:e}},[],import.meta.url)).ruby)}}}})),eo=e((()=>{$a()})),to,no=e((()=>{I(),to={name:`ruby-wasm`,title:`Ruby (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[De,e+`{{hash:lang-ruby-wasm-script.js}}`],liveReload:!0,scriptType:`text/ruby-wasm`,compiledCodeLanguage:`ruby`},extensions:[`wasm.rb`,`rubywasm`],editor:`script`,editorLanguage:`ruby`,largeDownload:!0}})),ro=e((()=>{no()})),io,ao=e((()=>{K(),I(),kn(),n(),io={name:`scheme`,title:`Scheme`,formatter:{factory:q},compiler:{factory:()=>async e=>e,scripts:[ie],scriptType:`text/biwascheme`,compiledCodeLanguage:`scheme`},extensions:[`scm`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`scheme.js`},codemirror:{languageSupport:async()=>W((await r(async()=>{let{scheme:e}=await import(D+`codemirror-lang-scheme.js`);return{scheme:e}},[],import.meta.url)).scheme)}}}})),oo=e((()=>{ao()})),so,co=e((()=>{I(),n(),so={name:`sass`,title:`Sass`,compiler:`scss`,extensions:[`sass`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(D+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass({indented:!0})}}}})),lo,uo=e((()=>{I(),R(),n(),lo={name:`scss`,title:`SCSS`,formatter:{prettier:{name:`scss`,pluginUrls:[L.postcss]}},compiler:{url:C+`sass/sass.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-scss-compiler.js}}`),self.createScssCompiler())},extensions:[`scss`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(D+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass()}}}})),fo=e((()=>{co(),uo()})),po,mo=e((()=>{b(),I(),R(),po={name:`solid`,title:`Solid`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{dependencies:[`babel`],url:C+`babel-preset-solid/babel-preset-solid.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-solid-compiler.js}}`),self.createSolidCompiler()),imports:{"solid-js":g.getModuleUrl(`solid-js`),"solid-js/web":g.getModuleUrl(`solid-js/web`)}},extensions:[`solid.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),ho,go=e((()=>{R(),ho={name:`solid.tsx`,title:`Solid (TS)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:`solid`,extensions:[`solid.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),_o=e((()=>{mo(),go()})),vo,yo,bo=e((()=>{I(),n(),vo=`application/json`,yo={name:`sql`,title:`SQL`,formatter:{factory:()=>(importScripts(Oe),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{url:ke+`sql-wasm.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-sql-compiler.js}}`),self.createSqlCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:vo,compiledCodeLanguage:`json`},extensions:[`sql`,`sqlite`,`sqlite3`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`sql.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{sql:e}=await import(D+`codemirror-lang-sql.js`);return{sql:e}},[],import.meta.url)).sql()}}}})),xo=e((()=>{bo()})),So,Co=e((()=>{H(),I(),R(),So={name:`stencil`,title:`Stencil`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[L.babel,L.html]}},compiler:{url:Ae,factory:()=>async(e,{config:t})=>(await window.stencil.transpile(e,{sourceMap:!1,target:`es2019`,...z(`stencil`,t)})).code,types:{"@stencil/core":{url:C+`types/stencil-core.d.ts`,declareAsModule:!1}}},extensions:[`stencil.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}}})),wo=e((()=>{Co()})),To,Eo=e((()=>{I(),To={name:`stylis`,title:`Stylis`,compiler:{url:je,factory:()=>async e=>{let{compile:t,serialize:n,stringify:r,middleware:i,prefixer:a}=window.stylis;return n(t(e),i([a,r]))}},extensions:[`stylis`],editor:`style`,editorLanguage:`scss`}})),Do=e((()=>{Eo()})),Oo,ko=e((()=>{K(),I(),n(),Oo={name:`stylus`,title:`Stylus`,compiler:{url:C+`stylus/stylus.min.js`,factory:()=>async e=>window.stylus.render(e)},extensions:[`styl`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{stylus:e}=await import(D+`codemirror-lang-stylus.js`);return{stylus:e}},[],import.meta.url)).stylus)}}}})),Ao=e((()=>{ko()})),jo,Mo=e((()=>{H(),I(),R(),jo={name:`sucrase`,title:`Sucrase`,formatter:{prettier:{name:`babel`,pluginUrls:[L.babel,L.html]}},compiler:{url:C+`sucrase/sucrase.js`,factory:()=>async(e,{config:t})=>window.sucrase.transform(e,{transforms:[`jsx`,`typescript`],...z(`sucrase`,t)}).code},extensions:[`sucrase`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),No=e((()=>{Mo()})),Po,J,Fo,Io=e((()=>{I(),R(),n(),Po=C+`vue-compiler-sfc/vue-compiler-sfc.js`,J={name:`vue`,title:`Vue`,longTitle:`Vue SFC`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:Po,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue-compiler.js}}`),self.createVueCompiler()),imports:{vue:Le,"livecodes/vue":Re}},extensions:[`vue`,`vue3`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`vue.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{vue:e}=await import(D+`codemirror-lang-vue.js`);return{vue:e}},[],import.meta.url)).vue()},codejar:{language:`html`},compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}},Fo={...J,name:`vue-app`,compiler:`vue`,extensions:[`app.vue`],editor:`markup`,editorSupport:{...J.editorSupport,monaco:{language:`vue`}}}})),Lo,Ro,zo=e((()=>{Cn(),I(),R(),Io(),n(),Lo={name:`svelte`,title:`Svelte`,formatter:{prettier:{name:`html`,pluginUrls:[L.html,L.babel]}},compiler:{url:P+`compiler/index.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-svelte-compiler.js}}`),self.createSvelteCompiler()),imports:{"#client/constants":P+`src/internal/client/constants.js`,"#compiler/builders":P+`src/compiler/utils/builders.js`,svelte:P+`src/index-client.js`,"svelte/animate":P+`src/animate/index.js`,"svelte/attachments":P+`src/attachments/index.js`,"svelte/easing":P+`src/easing/index.js`,"svelte/internal":P+`src/internal/index.js`,"svelte/internal/client":P+`src/internal/client/index.js`,"svelte/internal/disclose-version":P+`src/internal/disclose-version.js`,"svelte/internal/flags/legacy":P+`src/internal/flags/legacy.js`,"svelte/internal/flags/tracing":P+`src/internal/flags/tracing.js`,"svelte/internal/server":P+`src/internal/server/index.js`,"svelte/legacy":P+`src/legacy/legacy-client.js`,"svelte/motion":P+`src/motion/index.js`,"svelte/reactivity":P+`src/reactivity/index-client.js`,"svelte/reactivity/window":P+`src/reactivity/window/index.js`,"svelte/server":P+`src/server/index.js`,"svelte/store":P+`src/store/index-client.js`,"svelte/transition":P+`src/transition/index.js`,"svelte/events":P+`src/events/index.js`,clsx:g.getModuleUrl(`clsx`),"esm-env":g.getModuleUrl(`esm-env`)},inlineScript:`globalThis.process = { env: { NODE_ENV: "production" } };`},extensions:[`svelte`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`svelte.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{svelte:e}=await import(D+`codemirror-lang-svelte.js`);return{svelte:e}},[],import.meta.url)).svelte()},codejar:{language:`html`}}},Ro={...Lo,name:`svelte-app`,compiler:`svelte`,extensions:[`app.svelte`],editor:`markup`,editorSupport:{...J.editorSupport,monaco:{language:`svelte`}}}})),Bo=e((()=>{zo()})),Vo,Ho=e((()=>{K(),I(),n(),Vo={name:`tcl`,title:`Tcl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Te,e+`{{hash:lang-tcl-script.js}}`],scriptType:`text/tcl`,compiledCodeLanguage:`tcl`},extensions:[`tcl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>W((await r(async()=>{let{tcl:e}=await import(D+`codemirror-lang-tcl.js`);return{tcl:e}},[],import.meta.url)).tcl)}}}})),Uo=e((()=>{Ho()})),Wo,Go=e((()=>{I(),pi(),Wo={name:`teal`,title:`Teal`,formatter:ui,compiler:{url:k,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-teal-compiler.js}}`),self.createTealCompiler()),scripts:[k],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`tl`],editor:`script`,editorLanguage:`lua`}})),Ko=e((()=>{Go()})),qo,Jo=e((()=>{I(),R(),qo={name:`twig`,title:`Twig`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:Me,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-twig-compiler.js}}`),self.createTwigCompiler())},extensions:[`twig`],editor:`markup`,editorLanguage:`html`}})),Yo=e((()=>{Jo()})),Xo,Zo=e((()=>{I(),R(),Xo={name:`vento`,title:`Vento`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{url:C+`vento/vento.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vento-compiler.js}}`),self.createVentoCompiler())},extensions:[`vto`,`vento`],editor:`markup`,editorLanguage:`html`}})),Qo=e((()=>{Zo()})),$o=e((()=>{Io()})),es,ts,ns=e((()=>{I(),R(),es=ze+`vue2-sfc-loader.js`,ts={name:`vue2`,title:`Vue 2`,longTitle:`Vue 2 SFC`,formatter:{prettier:{name:`html`,pluginUrls:[L.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue2-compiler.js}}`),self.createVue2Compiler()),scripts:[Ie,es],imports:{vue:Ie+`/dist/vue.runtime.esm-browser.prod.js`}},extensions:[`vue2`],editor:`script`,editorLanguage:`html`}})),rs=e((()=>{ns()})),is,as,os,ss=e((()=>{I(),n(),is=C+`wast-refmt/wast-refmt.js`,as=`application/wasm-uint8`,os={name:`wat`,title:`WAT`,longTitle:`WebAssembly Text`,formatter:{factory:()=>(importScripts(is),async e=>{let t=e;try{t=self.wastRefmt.format(e)}catch(e){console.warn(`failed parsing WAT`,e)}return{formatted:t,cursorOffset:0}})},compiler:{url:Be,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-wat-compiler.js}}`),self.createWatCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-wat-script.js}}`],scriptType:as,compiledCodeLanguage:`Binary`},extensions:[`wat`,`wast`,`webassembly`,`wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:A+`wat.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{wast:e}=await import(D+`codemirror-lang-wast.js`);return{wast:e}},[],import.meta.url)).wast()},codejar:{language:`wasm`}}}})),cs=e((()=>{ss()})),Y,ls=e((()=>{We(),Je(),Qe(),nt(),ot(),lt(),ft(),gt(),yt(),Mn(),Fn(),kn(),zn(),Hn(),Gn(),Jn(),Qn(),tr(),ir(),sr(),ur(),pr(),gr(),yr(),Sr(),Tr(),kr(),Mr(),Fr(),Rr(),Vr(),Gr(),Xr(),$r(),ni(),ai(),ci(),pi(),gi(),yi(),Si(),Ei(),ki(),Mi(),Fi(),zi(),Hi(),Gi(),Ji(),Zi(),ta(),ia(),sa(),fa(),ha(),va(),Ca(),Pa(),Ha(),za(),Ga(),Xa(),eo(),ro(),oo(),fo(),_o(),xo(),wo(),Do(),Ao(),No(),Bo(),Uo(),Ko(),Yo(),Oa(),Qo(),$o(),rs(),cs(),Y=[Ar,bi,wi,et,aa,Ke,Cr,Ni,Dr,nr,ar,Li,ri,$n,qo,Xo,He,Ur,st,Ai,Xn,Ua,Kn,lo,so,ei,Oo,To,zr,Ea,dr,it,jo,Kr,Jr,ya,xa,Aa,Ma,J,ts,Fo,Lo,Ro,So,po,ho,Ja,_i,Nn,oi,mt,_t,Nr,La,Ba,Bi,ua,pa,ga,Qa,to,_r,br,Ki,Yi,Ln,Bn,Ir,Un,Ui,di,mi,Wo,cr,Zr,io,Dn,An,mr,Vo,Xe,os,yo,$i,na,Di,ut]})),us=e((()=>{ls(),Zt(),window.deps={translateString:(e,t)=>t,languages:Y,processors:Xt}})),ds,fs=e((()=>{ds={title:`Untitled Project`,description:``,head:`<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />`,htmlAttrs:`lang="en" class=""`,tags:[],autoupdate:!0,autosave:!1,autotest:!1,delay:1500,formatOnsave:!1,view:`split`,mode:`full`,theme:`dark`,themeColor:void 0,layout:`responsive`,editorTheme:void 0,appLanguage:void 0,recoverUnsaved:!0,showSpacing:!1,welcome:!0,readonly:!1,allowLangChange:!0,activeEditor:void 0,languages:void 0,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{},tests:{language:`typescript`,content:``},tools:{enabled:`all`,active:``,status:``},zoom:1,processors:[],customSettings:{},editor:void 0,fontFamily:void 0,fontSize:void 0,useTabs:!1,tabSize:2,lineNumbers:!0,wordWrap:!1,closeBrackets:!0,foldRegions:!1,semicolons:!0,singleQuote:!1,trailingComma:!0,minimap:!1,emmet:!0,editorMode:void 0,version:{}.VERSION}})),X,ps=e((()=>{X={ar:`العربية`,bn:`বাংলা`,de:`Deutsch`,en:`English`,es:`Español`,fa:`فارسی`,fr:`Français`,hi:`हिंदी`,id:`Bahasa Indonesia`,it:`Italiano`,ja:`日本語`,nl:`Nederlands`,pt:`Português`,ru:`Ру́сский`,tr:`Türkçe`,ur:`اردو`,"zh-CN":`中文（简体）`}})),ms,hs=e((()=>{ms={name:`angular`,aliases:[`ng`],title:window.deps.translateString(`templates.starter.angular`,`Angular Starter`),thumbnail:`assets/templates/angular.svg`,activeEditor:`script`,markup:{language:`html`,content:`<app>Loading...</app>
...
`},customSettings:{typescript:{experimentalDecorators:!0}}}})),gs,_s=e((()=>{gs={name:`assemblyscript`,aliases:[`as`],title:window.deps.translateString(`templates.starter.assemblyscript`,`AssemblyScript Starter`),thumbnail:`assets/templates/assemblyscript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),vs,ys=e((()=>{vs={name:`astro`,title:window.deps.translateString(`templates.starter.astro`,`Astro Starter`),thumbnail:`assets/templates/astro.svg`,activeEditor:`markup`,markup:{language:`astro`,content:`---
...
`},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),bs,xs=e((()=>{bs={name:`backbone`,title:window.deps.translateString(`templates.starter.backbone`,`Backbone Starter`),thumbnail:`assets/templates/backbone.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[`https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js`,`https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js`,`https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.3.3/backbone-min.js`],cssPreset:``,imports:{},types:{}}})),Ss,Cs=e((()=>{Ss={name:`blank`,title:window.deps.translateString(`templates.starter.blank`,`Blank Project`),thumbnail:`assets/templates/blank.svg`,activeEditor:`markup`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ws,Ts=e((()=>{ws={name:`blockly`,title:window.deps.translateString(`templates.starter.blockly`,`Blockly Starter`),thumbnail:`assets/templates/blockly.svg`,activeEditor:`script`,markup:{language:`html`,content:`<xml
...
`},script:{language:`javascript`,content:``},stylesheets:[`{{ __CDN_URL__ }}bootstrap@5.3.0/dist/css/bootstrap.min.css`],scripts:[`{{ __CDN_URL__ }}bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js`],cssPreset:``,imports:{},types:{}}})),Os,ks=e((()=>{Os={name:`civet`,title:window.deps.translateString(`templates.starter.civet`,`Civet Starter`),thumbnail:`assets/templates/civet.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),As,js=e((()=>{As={name:`clio`,title:window.deps.translateString(`templates.starter.clio`,`Clio Starter`),thumbnail:`assets/templates/clio.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Ms,Ns=e((()=>{Ms={name:`clojurescript`,aliases:[`cljs`],title:window.deps.translateString(`templates.starter.clojurescript`,`ClojureScript Starter`),thumbnail:`assets/templates/cljs.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`}}})),Ps,Fs=e((()=>{Ps={name:`coffeescript`,aliases:[`coffee`],title:window.deps.translateString(`templates.starter.coffeescript`,`CoffeeScript Starter`),thumbnail:`assets/templates/coffeescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Is,Ls=e((()=>{Is={name:`commonlisp`,aliases:[`lisp`],title:window.deps.translateString(`templates.starter.commonlisp`,`Common Lisp Starter`),thumbnail:`assets/templates/commonlisp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Rs,zs=e((()=>{Rs={name:`cpp`,aliases:[`c++`],title:window.deps.translateString(`templates.starter.cpp`,`C++ Starter`),thumbnail:`assets/templates/cpp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Bs,Vs=e((()=>{Bs={name:`cpp-wasm`,aliases:[`clang`,`c++-wasm`],title:window.deps.translateString(`templates.starter.cpp-wasm`,`C++ (Wasm) Starter`),thumbnail:`assets/templates/cpp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/cpp.svg" />
  <p>You clicked <span id="counter">0</span> times.</p>
  <button id="counter-button" disabled>Loading...</button>
...
`}}})),Hs,Us=e((()=>{Hs={name:`csharp-wasm`,aliases:[`c#-wasm`],title:window.deps.translateString(`templates.starter.csharp-wasm`,`C# (Wasm) Starter`),thumbnail:`assets/templates/csharp.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`}}})),Ws,Gs=e((()=>{Ws={name:`d3`,title:window.deps.translateString(`templates.starter.d3`,`D3 Starter`),thumbnail:`assets/templates/d3.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="chart">Loading...</div>
...
svg
  ...
  .attr("y", (d, i) => i * 50 + 10)
  .attr("x", 10);
`}}})),Ks,qs=e((()=>{Ks={name:`daisyui`,title:window.deps.translateString(`templates.starter.daisyui`,`daisyUI Starter`),thumbnail:`assets/templates/daisyui.svg`,activeEditor:`markup`,markup:{language:`html`,content:`<!-- based on https://daisyui.com/tailwindplay/ -->
...
`},script:{language:`javascript`,content:``},processors:[`tailwindcss`]}})),Js,Ys=e((()=>{Js={name:`diagrams`,title:window.deps.translateString(`templates.starter.diagrams`,`Diagrams Starter`),thumbnail:`assets/templates/diagrams.svg`,activeEditor:`markup`,markup:{language:`diagrams`,contentUrl:`{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html`},style:{language:`css`,content:`.container {
  display: flex;
...
`},script:{language:`javascript`,content:``},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Xs,Zs=e((()=>{Xs={name:`fennel`,title:window.deps.translateString(`templates.starter.fennel`,`Fennel Starter`),thumbnail:`assets/templates/fennel.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),Qs,$s,ec,tc=e((()=>{I(),Qs=fe+`build/packages/plinth/src/plinth/`,$s=fe+`build/dev/javascript/plinth/plinth/`,ec={name:`gleam`,title:window.deps.translateString(`templates.starter.gleam`,`Gleam Starter`),thumbnail:`assets/templates/gleam.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`},customSettings:{imports:{"my_pkg/greet.js":fe+`demo/greet.js`},gleam:{modules:{"plinth/browser/document":{srcUrl:Qs+`browser/document.gleam`,compiledUrl:$s+`browser/document.mjs`},"plinth/browser/element":{srcUrl:Qs+`browser/element.gleam`,compiledUrl:$s+`browser/element.mjs`},"plinth/browser/event":{srcUrl:Qs+`browser/event.gleam`,compiledUrl:$s+`browser/event.mjs`}}}}}})),nc,rc=e((()=>{nc={name:`go`,aliases:[`golang`],title:window.deps.translateString(`templates.starter.go`,`Go Starter`),thumbnail:`assets/templates/go.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ic,ac=e((()=>{ic={name:`go-wasm`,aliases:[`golang-wasm`],title:window.deps.translateString(`templates.starter.go-wasm`,`Go (Wasm) Starter`),thumbnail:`assets/templates/go.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Go (Wasm)</h1>
...
`}}})),oc,sc=e((()=>{oc={name:`imba`,title:window.deps.translateString(`templates.starter.imba`,`Imba Starter`),thumbnail:`assets/templates/imba.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`imba`,content:`tag app-counter
	prop name = "Imba"
	prop count = 0
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),cc,lc=e((()=>{cc={name:`java`,title:window.deps.translateString(`templates.starter.java`,`Java Starter`),thumbnail:`assets/templates/java.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`}}})),uc,dc=e((()=>{uc={name:`javascript`,aliases:[`js`],title:window.deps.translateString(`templates.starter.javascript`,`JavaScript Starter`),thumbnail:`assets/templates/javascript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),fc,pc=e((()=>{fc={name:`jest-react`,title:window.deps.translateString(`templates.starter.jest-react`,`Jest/React Starter`),thumbnail:`assets/templates/jest.svg`,activeEditor:`script`,autotest:!0,markup:{language:`html`,content:``},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
}
...
`},tools:{enabled:`all`,active:`tests`,status:`open`}}})),mc,hc=e((()=>{mc={name:`jest`,title:window.deps.translateString(`templates.starter.jest`,`Jest Starter`),thumbnail:`assets/templates/jest.svg`,autotest:!0,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},tools:{enabled:`all`,active:`tests`,status:`open`}}})),gc,_c=e((()=>{gc={name:`jquery`,title:window.deps.translateString(`templates.starter.jquery`,`jQuery Starter`),thumbnail:`assets/templates/jquery.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),vc,yc=e((()=>{vc={name:`julia`,title:window.deps.translateString(`templates.starter.julia`,`Julia Starter`),thumbnail:`assets/templates/julia.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),bc,xc=e((()=>{bc={name:`knockout`,title:window.deps.translateString(`templates.starter.knockout`,`Knockout Starter`),thumbnail:`assets/templates/knockout.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Sc,Cc=e((()=>{Sc={name:`lit`,title:window.deps.translateString(`templates.starter.lit`,`Lit Starter`),thumbnail:`assets/templates/lit.svg`,activeEditor:`script`,markup:{language:`html`,content:`<my-counter name="Lit"></my-counter>
...
`},customSettings:{typescript:{experimentalDecorators:!0,useDefineForClassFields:!1}}}})),wc,Tc=e((()=>{wc={name:`livescript`,aliases:[`ls`],title:window.deps.translateString(`templates.starter.livescript`,`LiveScript Starter`),thumbnail:`assets/templates/livescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Ec,Dc=e((()=>{Ec={name:`lua`,title:window.deps.translateString(`templates.starter.lua`,`Lua Starter`),thumbnail:`assets/templates/lua.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),Oc,kc=e((()=>{Oc={name:`lua-wasm`,title:window.deps.translateString(`templates.starter.lua-wasm`,`Lua (Wasm) Starter`),thumbnail:`assets/templates/lua.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/lua.svg" />
  <p id="counter">You clicked 0 times.</p>
  <button id="counter-button">Click me</button>
...
`}}})),Ac,jc=e((()=>{Ac={name:`malina`,title:window.deps.translateString(`templates.starter.malina`,`Malina.js Starter`),thumbnail:`assets/templates/malina.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`malina`,content:`<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
    counter += 1;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Mc,Nc=e((()=>{Mc={name:`markdown`,aliases:[`md`],title:window.deps.translateString(`templates.starter.markdown`,`Markdown Starter`),thumbnail:`assets/templates/markdown.svg`,activeEditor:`markup`,markup:{language:`markdown`,content:`# Project Title
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Pc,Fc=e((()=>{Pc={name:`mdx`,title:window.deps.translateString(`templates.starter.mdx`,`MDX Starter`),thumbnail:`assets/templates/mdx.svg`,activeEditor:`markup`,markup:{language:`mdx`,content:`import { Greeting, Counter } from './script';
...
`}}})),Ic,Lc=e((()=>{Ic={name:`minizinc`,aliases:[`mzn`],title:window.deps.translateString(`templates.starter.minizinc`,`MiniZinc Starter`),thumbnail:`assets/templates/minizinc.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
`.trimStart()}}})),Rc,zc=e((()=>{Rc={name:`ocaml`,title:window.deps.translateString(`templates.starter.ocaml`,`Ocaml Starter`),thumbnail:`assets/templates/ocaml.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Hc,Uc=e((()=>{Hc={name:`phaser`,title:window.deps.translateString(`templates.starter.phaser`,`Phaser Starter`),thumbnail:`assets/templates/phaser.png`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">
...
`}}})),Wc,Gc=e((()=>{Wc={name:`php`,title:window.deps.translateString(`templates.starter.php`,`PHP Starter`),thumbnail:`assets/templates/php.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">world</span>!</h1>
...
`}}})),Kc,qc=e((()=>{Kc={name:`php-wasm`,title:window.deps.translateString(`templates.starter.php-wasm`,`PHP (Wasm) Starter`),thumbnail:`assets/templates/php.svg`,activeEditor:`script`,markup:{language:`html`,content:`<p>
  <h1>Hello, <span id="title">world</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/php.svg" />
</p>
`},style:{language:`css`,content:`body {
...
`}}})),Jc,Yc=e((()=>{Jc={name:`postgresql`,aliases:[`pg`,`postgres`,`pgsql`],title:window.deps.translateString(`templates.starter.postgresql`,`PostgreSQL Starter`),thumbnail:`assets/templates/postgresql.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">
  <details open>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`}}})),Xc,Zc=e((()=>{Xc={name:`preact`,title:window.deps.translateString(`templates.starter.preact`,`Preact Starter`),thumbnail:`assets/templates/preact.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app"></div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`}}})),Qc,$c=e((()=>{Qc={name:`prolog`,title:window.deps.translateString(`templates.starter.prolog`,`Prolog Starter`),thumbnail:`assets/templates/tau-prolog.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
ancestor(X, Y):- parent(X, Z),
    ancestor(Z, Y).
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),el,tl=e((()=>{el={name:`python`,aliases:[`py`],title:window.deps.translateString(`templates.starter.python`,`Python Starter`),thumbnail:`assets/templates/python.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
...
if current_time < 12 :
      ...
      print('Good evening')
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),nl,rl=e((()=>{nl={name:`python-wasm`,aliases:[`pyodide`,`py-wasm`],title:window.deps.translateString(`templates.starter.python-wasm`,`Python (Wasm) Starter`),thumbnail:`assets/templates/python.svg`,activeEditor:`script`,markup:{language:`html`,content:`<h1 id="title">Hello, World!</h1>
...
plt.close("all")
`}}})),il,al=e((()=>{il={name:`r`,aliases:[`r-lang`,`rlang`],title:window.deps.translateString(`templates.starter.r`,`R Starter`),thumbnail:`assets/templates/r.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">Loading...</div>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ol,sl=e((()=>{ol={name:`react-native`,title:window.deps.translateString(`templates.starter.react-native`,`React Native Starter`),thumbnail:`assets/templates/react.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:``},script:{language:`react-native`,content:`import { useState } from "react";
...
`}}})),cl,ll=e((()=>{cl={name:`react`,title:window.deps.translateString(`templates.starter.react`,`React Starter`),thumbnail:`assets/templates/react.svg`,activeEditor:`script`,markup:{language:`html`,content:``},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
}
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ul,dl=e((()=>{ul={name:`reason`,title:window.deps.translateString(`templates.starter.reason`,`Reason Starter`),thumbnail:`assets/templates/reason.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
Js.log("Hello, Reason!");
`},customSettings:{imports:{react:`https://esm.sh/react@18.3.1`,"react/":`https://esm.sh/react@18.3.1/`,"react-dom":`https://esm.sh/react-dom@18.3.1`}}}})),fl,pl=e((()=>{fl={name:`rescript`,title:window.deps.translateString(`templates.starter.rescript`,`ReScript Starter`),thumbnail:`assets/templates/rescript.png`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">Loading...</div>
`},style:{language:`css`,content:`.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),ml,hl=e((()=>{ml={name:`riot`,title:window.deps.translateString(`templates.starter.riot`,`Riot.js Starter`),thumbnail:`assets/templates/riot.svg`,activeEditor:`script`,markup:{language:`html`,content:`<counter title="Riot.js"></counter>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),gl,_l=e((()=>{gl={name:`ruby`,aliases:[`rb`],title:window.deps.translateString(`templates.starter.ruby`,`Ruby Starter`),thumbnail:`assets/templates/ruby.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),vl,yl=e((()=>{vl={name:`ruby-wasm`,aliases:[`rb-wasm`],title:window.deps.translateString(`templates.starter.ruby-wasm`,`Ruby (Wasm) Starter`),thumbnail:`assets/templates/ruby.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/ruby.svg" />
  <p id="counter">You clicked 0 times.</p>
  <button id="counter-button">Click me</button>
...
`}}})),bl,xl=e((()=>{bl={name:`scheme`,title:window.deps.translateString(`templates.starter.scheme`,`Scheme Starter`),thumbnail:`assets/templates/scheme.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
(let ((time-now (date-hour (current-date))))
  (console-log
    (cond ((< time-now 12) "Good morning")
          ...
          (else "Good evening"))))
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Z,Sl,Cl=e((()=>{Z=`https://cdn.jsdelivr.net/npm/@hatemhosny/shadcdn@0.0.14/build/`,Sl={name:`shadcn-ui`,title:window.deps.translateString(`templates.starter.shadcnui`,`shadcn/ui Starter`),thumbnail:`assets/templates/shadcn-ui.svg`,activeEditor:`script`,markup:{language:`html`,content:`
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),El,Dl=e((()=>{El={name:`sql`,title:window.deps.translateString(`templates.starter.sql`,`SQL Starter`),thumbnail:`assets/templates/sqlite.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="output">
  <details open>
    <summary>Tables</summary>
    <div id="tables"></div>
  </details>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`}}})),Ol,kl=e((()=>{Ol={name:`stencil`,title:window.deps.translateString(`templates.starter.stencil`,`Stencil Starter`),thumbnail:`assets/templates/stencil.png`,activeEditor:`script`,markup:{language:`html`,content:`<my-app title="Stencil"></my-app>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Al,jl=e((()=>{Al={name:`svelte`,title:window.deps.translateString(`templates.starter.svelte`,`Svelte Starter`),thumbnail:`assets/templates/svelte.svg`,activeEditor:`script`,markup:{language:`svelte`,content:`<script>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Ml,Nl=e((()=>{Ml={name:`tailwindcss`,aliases:[`tw`,`tailwind`],title:window.deps.translateString(`templates.starter.tailwindcss`,`Tailwind CSS Starter`),thumbnail:`assets/templates/tailwindcss.svg`,activeEditor:`markup`,markup:{language:`html`,content:`<div class="relative grid min-h-screen grid-cols-[1fr_2.5rem_auto_2.5rem_1fr] grid-rows-[1fr_1px_auto_1px_1fr] bg-white [--pattern-fg:var(--color-gray-950)]/5 dark:bg-gray-950 dark:[--pattern-fg:var(--color-white)]/10">
...
`},script:{language:`javascript`,content:``},processors:[`tailwindcss`]}})),Pl,Fl=e((()=>{Pl={name:`tcl`,title:window.deps.translateString(`templates.starter.tcl`,`Tcl Starter`),thumbnail:`assets/templates/tcl.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
puts $count
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Il,Ll=e((()=>{Il={name:`teal`,title:window.deps.translateString(`templates.starter.teal`,`Teal Starter`),thumbnail:`assets/templates/teal.png`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`}}})),Rl,zl=e((()=>{Rl={name:`typescript`,aliases:[`ts`],title:window.deps.translateString(`templates.starter.typescript`,`TypeScript Starter`),thumbnail:`assets/templates/typescript.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Bl,Vl=e((()=>{Bl={name:`vue`,title:window.deps.translateString(`templates.starter.vue`,`Vue SFC Starter`),thumbnail:`assets/templates/vue.svg`,activeEditor:`script`,markup:{language:`vue`,content:`<script setup lang="tsx">
...
`},stylesheets:[],scripts:[],cssPreset:``,imports:{},types:{}}})),Hl,Ul=e((()=>{Hl={name:`vue2`,title:window.deps.translateString(`templates.starter.vue2`,`Vue 2 Starter`),thumbnail:`assets/templates/vue.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div id="app">
  <h1>Hello, Vue!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/vue.svg" />
  <p>You clicked {{ counter }} times.</p>
  <button @click="increment()">Click me</button>
...
`},stylesheets:[],scripts:[`{{ __CDN_URL__ }}vue@2`],cssPreset:``,imports:{},types:{}}})),Wl,Gl=e((()=>{Wl={name:`wat`,title:window.deps.translateString(`templates.starter.wat`,`WebAssembly Text Starter`),thumbnail:`assets/templates/webassembly.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
"click": The playground does not load automatically. Instead, a "Click-to-load" screen is shown.`}}},params:{control:`object`,description:`An object that represents [URL Query parameters](https://livecodes.io/docs/configuration/query-params), that can be used to configure the playground.`,type:{name:`object`,value:{}},required:!1,table:{category:`Embed Options`}},template:{control:`select`,description:`A [starter template](https://livecodes.io/docs/features/templates) to load.`,type:`string`,required:!1,table:{category:`Embed Options`},options:Kl.map(e=>e.name)},config:{table:{disable:!0}},...Object.keys(ds).filter(e=>!e.includes(`version`)).reduce((e,t)=>{let n=ds[t];return n&&typeof n==`object`&&[`markup`,`style`,`script`].includes(t)&&(n={contentUrl:void 0,hiddenContent:void 0,hiddenContentUrl:void 0,title:void 0,hideTitle:void 0,foldedLines:void 0,order:void 0,position:void 0,selector:void 0,...n}),`config__${t}`in Zl?e[`config__${t}`]=Zl[`config__${t}`]:n&&typeof n==`object`&&!Array.isArray(n)?Object.keys(n).forEach(n=>{e[`config__${t}__${n}`]=Zl[`config__${t}__${n}`]||Q(`config__${t}__${n}`)}):e[`config__${t}`]=Q(`config__${t}`),e},{}),props:{control:`object`,required:!1,table:{readonly:!0,category:`Props`}},class:{control:`text`,type:`string`,required:!1,table:{category:`Styles`}},style:{control:`object`,required:!1,table:{category:`Styles`}},height:{control:`text`,type:`string`,required:!1,table:{category:`Styles`,defaultValue:{summary:`300px`}}}}})),$l,eu=e((()=>{$l=location.hostname.startsWith(`localhost`)||location.hostname.startsWith(`127.0.0.1`)?`http://127.0.0.1:8080`:location.origin})),tu=e((()=>{us(),Ql(),Jl(),Xl(),eu()})),nu,ru,iu,au=e((()=>{d(),i(),f(),tu(),delete $.class,delete $.style,nu={component:`live-codes`,parameters:{layout:`fullscreen`},argTypes:$},ru=e=>{let{params:t,height:n,class:r,style:i,...s}=e;return{args:{appUrl:$l,...l(s,{delimiter:`__`}),...t?{params:t}:{},height:n,props:e},render:e=>{let t=u(e,{delimiter:`__`});return o`
        <live-codes
          ...
          .params=${t.params||a}
        ></live-codes>
      `},parameters:{docs:{source:{code:iu(e),language:`html`,type:`auto`,format:!0}}}}},iu=e=>{let{config:t,params:n,...r}=e,i=Object.entries(r).filter(([,e])=>e!=null).map(([e,t])=>{let n=e.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`);return typeof t==`boolean`?t?n:null:`${n}="${t}"`}).filter(Boolean),a=i.length>0?`
  `+i.join(`
...
<script type="module">
  ...
  `)}`:``}
<\/script>
`.trimStart()}})),ou=e((()=>{au()}));export{nu as n,ru as r,ou as t};