import{n as e,t}from"./chunk-BneVvdWh.js";import{n,t as r}from"./preload-helper-nVtPd9zc.js";import{C as i,S as a,_ as o,b as s,d as c,f as l,g as u,h as d,m as f,p,v as m,w as h,x as g,y as _}from"./iframe-CAK6urLN.js";var v,y,b=e((()=>{l(),s(),v=d(`<div>`),y=e=>t=>{let n,r,o=JSON.stringify(t.config||``),s=``,l=0,d=()=>{let e={};return t.appUrl!==void 0&&(e.appUrl=t.appUrl),t.import!==void 0&&(e.import=t.import),t.headless!==void 0&&(e.headless=t.headless),t.lite!==void 0&&(e.lite=t.lite),t.loading!==void 0&&(e.loading=t.loading),t.params!==void 0&&(e.params=t.params),t.template!==void 0&&(e.template=t.template),t.view!==void 0&&(e.view=t.view),e},g=()=>{if(!n)return;let i=t.config,a=t.sdkReady,c=d(),u=JSON.stringify(c),f=++l,p=()=>f!==l;if(!r||s!==u)s=u,o=JSON.stringify(i||``),r?.destroy(),r=void 0,e(n,{config:i,...c}).then(e=>{if(p()){e.destroy();return}r=e,typeof a==`function`&&a(e)});else{let e=JSON.stringify(i);if(o===e)return;o=e,typeof i==`string`?fetch(i).then(e=>e.json()).then(e=>{p()||r?.setConfig(e)}):i&&r.setConfig(i)}};return h(()=>{g()}),m(a(()=>[t.config,t.appUrl,t.import,t.headless,t.lite,t.loading,t.params,t.template,t.view,t.sdkReady],()=>{g()},{defer:!0})),i(()=>{++l,r?.destroy()}),(()=>{var e=v(),r=n;return typeof r==`function`?u(r,e):n=e,_(n=>{var r=t.class,i={...t.style,...t.height?{height:Number(t.height)?`${t.height}px`:t.height}:{}},a=t.height;return r!==n.e&&c(e,n.e=r),n.t=f(e,i,n.t),a!==n.a&&p(e,`data-height`,n.a=a),n},{e:void 0,t:void 0,a:void 0}),e})()}}));async function x(e,t={}){typeof e==`object`&&!(e instanceof HTMLElement)&&(e.headless||e.view===`headless`)&&(t=e,e=null);let n=6e4,{config:r={},headless:i,loading:a=`lazy`,view:o}=t,s=i||o===`headless`,c=null,l=null,u=e=>{e.style.position=`absolute`,e.style.top=`0`,e.style.visibility=`hidden`,e.style.opacity=`0`};if(typeof e==`string`)c=document.querySelector(e);else if(e instanceof HTMLElement)c=e;else if(!(s&&typeof e==`object`))throw Error(`A valid container element is required.`);if(!c)if(s)c=document.createElement(`div`),u(c),document.body.appendChild(c);else throw Error(`Cannot find element: "${e}"`);let d=new URL(ee(t)),f=d.origin;d.searchParams.set(`embed`,`true`),d.searchParams.set(`loading`,s?`eager`:a),d.searchParams.set(`sdkVersion`,`0.14.1`),typeof r==`object`&&Object.keys(r).length>0&&d.searchParams.set(`config`,`sdk`);let p=t.params;typeof p==`object`&&Object.keys(p).length>0&&JSON.stringify(p).length<1800&&Object.keys(p).forEach(e=>{d.searchParams.set(e,encodeURIComponent(String(p[e])))});let m=!1,h="Cannot call API methods after calling `destroy()`.",g=[],_=(e,t=`message`)=>{addEventListener(t,e),g.push(e)},v=(e,t=`message`)=>{removeEventListener(t,e);let n=g.indexOf(e);n>-1&&g.splice(n,1)},y=await new Promise(e=>{var t,n,i,o,p,m,h,g,y;if(!c)return;let b=c.dataset.height||c.style.height;if(b&&!s){let e=isNaN(Number(b))?b:b+`px`;c.style.height=e}c.dataset.defaultStyles!==`false`&&!s&&((t=c.style).backgroundColor||(t.backgroundColor=`#fff`),(n=c.style).border||(n.border=`1px solid black`),(i=c.style).borderRadius||(i.borderRadius=`8px`),(o=c.style).boxSizing||(o.boxSizing=`border-box`),(p=c.style).padding||(p.padding=`0`),(m=c.style).width||(m.width=`100%`),(h=c.style).height||(h.height=c.style.height||`300px`),c.style.minHeight=`200px`,c.style.flexGrow=`1`,(g=c.style).overflow||(g.overflow=`hidden`),(y=c.style).resize||(y.resize=`vertical`),getComputedStyle(c).getPropertyValue(`display`)===`inline`&&(c.style.display=`block`));let x=`livecodes`,ee=c.querySelector(`iframe.${x}`),S=ee||document.createElement(`iframe`);S.classList.add(x),S.setAttribute(`allow`,le()),S.setAttribute(`allowtransparency`,`true`),S.setAttribute(`allowpaymentrequest`,`true`),S.setAttribute(`allowfullscreen`,`true`),S.setAttribute(`sandbox`,`allow-same-origin allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-presentation allow-scripts`);let C=a===`eager`?`eager`:`lazy`;S.setAttribute(`loading`,C),s?u(S):(S.style.height=`100%`,S.style.minHeight=`200px`,S.style.width=`100%`,S.style.margin=`0`,S.style.border=`0`,S.style.borderRadius=c.style.borderRadius),_(function e(t){t.source!==S.contentWindow||t.origin!==f||t.data?.type!==`livecodes-init`||(v(e),l=Number(t.data.payload.appVersion.replace(/^v/,``)))}),(!l||l<46)&&_(function e(t){var n;t.source!==S.contentWindow||t.origin!==f||t.data?.type!==`livecodes-get-config`||(v(e),(n=S.contentWindow)==null||n.postMessage({type:`livecodes-config`,payload:r},f))}),S.onload=()=>{e(S)},S.src=d.href,ee||c.appendChild(S)}),b=new Promise(e=>{_(function t(n){n.source!==y.contentWindow||n.origin!==f||n.data?.type!==`livecodes-ready`||(v(t),e(),b.settled=!0)})}),x=()=>m?Promise.reject(h):new Promise(async e=>{var t;b.settled&&e(),(t=y.contentWindow)==null||t.postMessage({type:`livecodes-load`},f),await b,e()}),S=(e,t)=>new Promise(async(r,i)=>{var a;if(m)return i(h);await x();let o=ae(),s=setTimeout(()=>{v(c),i(Error(`SDK call "${e}" timed out after ${n}ms.`))},n);function c(t){if(!(t.source!==y.contentWindow||t.origin!==f||t.data?.type!==`livecodes-api-response`||t.data?.id!==o)&&t.data.method===e){clearTimeout(s),v(c);let e=t.data.payload;e!=null&&e.error?i(e.error):r(e)}}_(c),(a=y.contentWindow)==null||a.postMessage({method:e,id:o,args:t},f)}),C={},te=[`load`,`ready`,`code`,`console`,`tests`,`destroy`],ne=(e,t)=>{var n;if(m)throw Error(h);return te.includes(e)?(S(`watch`,[e]),C[e]||(C[e]=[]),(n=C[e])==null||n.push(t),{remove:()=>{C[e]=C[e]?.filter(e=>e!==t),C[e]?.length===0&&S(`watch`,[e,`unsubscribe`])}}):{remove:()=>{}}},re=e=>({"livecodes-app-loaded":`load`,"livecodes-ready":`ready`,"livecodes-change":`code`,"livecodes-console":`console`,"livecodes-test-results":`tests`,"livecodes-destroy":`destroy`})[e];_(async function(e){var t;let n=re(e.data?.type??``);if(e.source!==y.contentWindow||e.origin!==f||!n||!C[n])return;let r=e.data?.payload;(t=C[n])==null||t.forEach(e=>{e(r)})});let ie=()=>{var e;(e=y?.remove)==null||e.call(y),Object.values(C).forEach(e=>{e.length=0}),g.forEach(e=>removeEventListener(`message`,e)),g.length=0,w&&c&&w.unobserve(c),m=!0},w;a===`lazy`&&`IntersectionObserver`in window&&(w=new IntersectionObserver((e,t)=>{e.forEach(async e=>{e.isIntersecting&&(await x(),t.unobserve(c))})},{rootMargin:`150px`}),w.observe(c));let ae=()=>(String(Math.random())+Date.now().toFixed()).replace(`0.`,``);return{load:()=>x(),run:()=>S(`run`),format:e=>S(`format`,[e]),getShareUrl:e=>S(`getShareUrl`,[e]),getConfig:e=>S(`getConfig`,[e]),setConfig:e=>S(`setConfig`,[e]),getCode:()=>S(`getCode`),show:(e,t)=>S(`show`,[e,t]),runTests:()=>S(`runTests`),onChange:e=>ne(`code`,e),watch:ne,exec:(e,...t)=>S(`exec`,[e,...t]),destroy:()=>m?Promise.reject(h):(ie(),Promise.resolve())}}function ee(e={}){let{appUrl:t=`https://livecodes.io`,params:n={},config:r={},headless:i,import:a,lite:o,view:s,...c}=e,l;try{l=new URL(t)}catch{throw Error(`${t} is not a valid URL.`)}let u=new URLSearchParams;Object.entries(c).forEach(([e,t])=>{t!==void 0&&l.searchParams.set(e,String(t))});let d=e.view===`headless`||i;if(o&&(console.warn(`Deprecation notice: "lite" option is deprecated. Use "config: { mode: 'lite' }" instead.`),typeof r==`object`&&r.mode==null?r.mode=`lite`:l.searchParams.set(`lite`,`true`)),s&&(console.warn(`Deprecation notice: The "view" option has been moved to "config.view". For headless mode use "headless: true".`),typeof r==`object`&&r.view==null&&s!==`headless`?r.view=s:l.searchParams.set(`view`,s)),typeof r==`string`)try{new URL(r),l.searchParams.set(`config`,encodeURIComponent(r))}catch{throw Error(`"config" is not a valid URL or configuration object.`)}else r&&typeof r==`object`&&Object.keys(r).length>0&&(r.title&&r.title!==`Untitled Project`&&l.searchParams.set(`title`,r.title),r.description&&r.description.length>0&&l.searchParams.set(`description`,r.description),u.set(`config`,`code/`+(0,T.compressToEncodedURIComponent)(JSON.stringify(r))));if(n&&typeof n==`object`&&Object.keys(n).length>0)try{u.set(`params`,(0,T.compressToEncodedURIComponent)(JSON.stringify(n)))}catch{Object.keys(n).forEach(e=>{l.searchParams.set(e,encodeURIComponent(String(n[e])))})}return a&&l.searchParams.set(`x`,encodeURIComponent(a)),d&&l.searchParams.set(`headless`,`true`),u.toString().length>0&&(l.hash=u.toString()),l.href}var S,C,te,ne,re,ie,w,ae,oe,T,se,ce,le,ue=e((()=>{S=Object.create,C=Object.defineProperty,te=Object.getOwnPropertyDescriptor,ne=Object.getOwnPropertyNames,re=Object.getPrototypeOf,ie=Object.prototype.hasOwnProperty,w=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),ae=(e,t,n,r)=>{if(t&&typeof t==`object`||typeof t==`function`)for(let i of ne(t))!ie.call(e,i)&&i!==n&&C(e,i,{get:()=>t[i],enumerable:!(r=te(t,i))||r.enumerable});return e},oe=(e,t,n)=>(n=e==null?{}:S(re(e)),ae(t||!e||!e.__esModule?C(n,`default`,{value:e,enumerable:!0}):n,e)),T=oe(w((e,t)=>{var n=function(){var e=String.fromCharCode,t=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=`,n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$`,r={};function i(e,t){if(!r[e]){r[e]={};for(var n=0;n<e.length;n++)r[e][e.charAt(n)]=n}return r[e][t]}var a={compressToBase64:function(e){if(e==null)return``;var n=a._compress(e,6,function(e){return t.charAt(e)});switch(n.length%4){default:case 0:return n;case 1:return n+`===`;case 2:return n+`==`;case 3:return n+`=`}},decompressFromBase64:function(e){return e==null?``:e==``?null:a._decompress(e.length,32,function(n){return i(t,e.charAt(n))})},compressToUTF16:function(t){return t==null?``:a._compress(t,15,function(t){return e(t+32)})+` `},decompressFromUTF16:function(e){return e==null?``:e==``?null:a._decompress(e.length,16384,function(t){return e.charCodeAt(t)-32})},compressToUint8Array:function(e){for(var t=a.compress(e),n=new Uint8Array(t.length*2),r=0,i=t.length;r<i;r++){var o=t.charCodeAt(r);n[r*2]=o>>>8,n[r*2+1]=o%256}return n},decompressFromUint8Array:function(t){if(t==null)return a.decompress(t);for(var n=Array(t.length/2),r=0,i=n.length;r<i;r++)n[r]=t[r*2]*256+t[r*2+1];var o=[];return n.forEach(function(t){o.push(e(t))}),a.decompress(o.join(``))},compressToEncodedURIComponent:function(e){return e==null?``:a._compress(e,6,function(e){return n.charAt(e)})},decompressFromEncodedURIComponent:function(e){return e==null?``:e==``?null:(e=e.replace(/ /g,`+`),a._decompress(e.length,32,function(t){return i(n,e.charAt(t))}))},compress:function(t){return a._compress(t,16,function(t){return e(t)})},_compress:function(e,t,n){if(e==null)return``;var r,i,a={},o={},s=``,c=``,l=``,u=2,d=3,f=2,p=[],m=0,h=0,g;for(g=0;g<e.length;g+=1)if(s=e.charAt(g),Object.prototype.hasOwnProperty.call(a,s)||(a[s]=d++,o[s]=!0),c=l+s,Object.prototype.hasOwnProperty.call(a,c))l=c;else{if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++),a[c]=d++,l=String(s)}if(l!==``){if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++)}for(i=2,r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;for(;;)if(m<<=1,h==t-1){p.push(n(m));break}else h++;return p.join(``)},decompress:function(e){return e==null?``:e==``?null:a._decompress(e.length,32768,function(t){return e.charCodeAt(t)})},_decompress:function(t,n,r){var i=[],a=4,o=4,s=3,c=``,l=[],u,d,f,p,m,h,g,_={val:r(0),position:n,index:1};for(u=0;u<3;u+=1)i[u]=u;for(f=0,m=2**2,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 2:return``}for(i[3]=g,d=g,l.push(g);;){if(_.index>t)return``;for(f=0,m=2**s,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(g=f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 2:return l.join(``)}if(a==0&&(a=2**s,s++),i[g])c=i[g];else if(g===o)c=d+d.charAt(0);else return null;l.push(c),i[o++]=d+c.charAt(0),a--,d=c,a==0&&(a=2**s,s++)}}};return a}();t!==void 0&&t!=null&&(t.exports=n)})()),se={chrome:[`accelerometer`,`bluetooth`,`camera`,`clipboard-read`,`clipboard-write`,`display-capture`,`encrypted-media`,`geolocation`,`gyroscope`,`language-detector`,`language-model`,`local-network-access`,`microphone`,`midi`,`proofreader`,`rewriter`,`serial`,`summarizer`,`translator`,`web-share`,`writer`,`window-placement`,`xr-spatial-tracking`],firefox:[`camera`,`display-capture`,`geolocation`,`microphone`,`web-share`],default:[`accelerometer`,`ambient-light-sensor`,`camera`,`display-capture`,`encrypted-media`,`geolocation`,`gyroscope`,`microphone`,`midi`,`payment`,`serial`,`vr`,`web-share`,`xr-spatial-tracking`]},ce=()=>{if(typeof navigator>`u`)return`default`;let e=navigator.userAgent;return/Firefox\//i.test(e)?`firefox`:/Chrome\//i.test(e)?`chrome`:`default`},le=()=>se[ce()].filter(e=>{var t;let n=((t=globalThis.document?.featurePolicy)?.features)?.call(t);return n?n.includes(e):!0}).join(`; `),T.compressToEncodedURIComponent,T.decompressFromEncodedURIComponent})),de,fe=e((()=>{b(),ue(),de=y(x)})),pe=e((()=>{fe()}));function me(e){return e&&e.constructor&&typeof e.constructor.isBuffer==`function`&&e.constructor.isBuffer(e)}function he(e){return e}function ge(e,t){t||={};let n=t.delimiter||`.`,r=t.maxDepth,i=t.transformKey||he,a={};function o(e,s,c){c||=1,Object.keys(e).forEach(function(l){let u=e[l],d=t.safe&&Array.isArray(u),f=Object.prototype.toString.call(u),p=me(u),m=f===`[object Object]`||f===`[object Array]`,h=s?s+n+i(l):i(l);if(!d&&!p&&m&&Object.keys(u).length&&(!t.maxDepth||c<r))return o(u,h,c+1);a[h]=u})}return o(e),a}function _e(e,t){t||={};let n=t.delimiter||`.`,r=t.overwrite||!1,i=t.transformKey||he,a={};if(me(e)||Object.prototype.toString.call(e)!==`[object Object]`)return e;function o(e){let n=Number(e);return isNaN(n)||e.indexOf(`.`)!==-1||t.object?e:n}function s(e,t,r){return Object.keys(r).reduce(function(t,i){return t[e+n+i]=r[i],t},t)}function c(e){let t=Object.prototype.toString.call(e),n=t===`[object Array]`,r=t===`[object Object]`;if(!e)return!0;if(n)return!e.length;if(r)return!Object.keys(e).length}return e=Object.keys(e).reduce(function(n,r){let i=Object.prototype.toString.call(e[r]);return!(i===`[object Object]`||i===`[object Array]`)||c(e[r])?(n[r]=e[r],n):s(r,n,ge(e[r],t))},{}),Object.keys(e).forEach(function(s){let c=s.split(n).map(i),l=o(c.shift()),u=o(c[0]),d=a;for(;u!==void 0;){if(l===`__proto__`)return;let e=Object.prototype.toString.call(d[l]),n=e===`[object Object]`||e===`[object Array]`;if(!r&&!n&&d[l]!==void 0)return;(r&&!n||!r&&d[l]==null)&&(d[l]=typeof u==`number`&&!t.object?[]:{}),d=d[l],c.length>0&&(l=o(c.shift()),u=o(c[0]))}d[l]=_e(e[s],t)}),a}var ve=e((()=>{})),ye,be,xe,E,Se,Ce,we,Te=e((()=>{ye=[`esm.sh`,`skypack`,`esm.run`,`jsdelivr.esm`,`fastly.jsdelivr.esm`,`gcore.jsdelivr.esm`,`testingcf.jsdelivr.esm`,`jsdelivr.b-cdn.esm`,`jspm`],be=[`jsdelivr`,`fastly.jsdelivr`,`unpkg`,`gcore.jsdelivr`,`testingcf.jsdelivr`,`jsdelivr.b-cdn`,`npmcdn`],xe=[`jsdelivr.gh`,`fastly.jsdelivr.gh`,`statically`,`gcore.jsdelivr.gh`,`testingcf.jsdelivr.gh`,`jsdelivr.b-cdn.gh`],E={getModuleUrl:(e,{isModule:t=!0,defaultCDN:n=`esm.sh`,external:r}={})=>{e=e.replace(/#nobundle/g,``);let i=e=>!r||!e.includes(`https://esm.sh`)?e:e.includes(`?`)?`${e}&external=${r}`:`${e}?external=${r}`,a=Ce(e,t,n);return a?i(a):t?i(`https://esm.sh/`+e):`https://cdn.jsdelivr.net/npm/`+e},getUrl:(e,t)=>e.startsWith(`http`)||e.startsWith(`data:`)?e:Ce(e,!1,t||Se())||e,cdnLists:{npm:be,module:ye,gh:xe},checkCDNs:async(e,t)=>{let n=[t,...E.cdnLists.npm].filter(Boolean);for(let t of n)try{if((await fetch(E.getUrl(e,t),{method:`HEAD`})).ok)return t}catch{}return E.cdnLists.npm[0]}},Se=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get(`appCDN`)||E.cdnLists.npm[0]}catch{return E.cdnLists.npm[0]}},Ce=(e,t,n)=>{let r=t&&e.startsWith(`unpkg:`)?`?module`:``;e.startsWith(`gh:`)?e=e.replace(`gh`,xe[0]):e.includes(`:`)||(e=(n||(t?ye[0]:be[0]))+`:`+e);for(let t of we){let[n,i]=t;if(n.test(e))return e.replace(n,i)+r}return null},we=[[/^(esm\.sh:)(.+)/i,`https://esm.sh/$2`],[/^(npm:)(.+)/i,`https://esm.sh/$2`],[/^(node:)(.+)/i,`https://esm.sh/$2`],[/^(jsr:)(.+)/i,`https://esm.sh/jsr/$2`],[/^(pr:)(.+)/i,`https://esm.sh/pr/$2`],[/^(pkg\.pr\.new:)(.+)/i,`https://esm.sh/pkg.pr.new/$2`],[/^(skypack:)(.+)/i,`https://cdn.skypack.dev/$2`],[/^(jsdelivr:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2`],[/^(fastly\.jsdelivr:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2`],[/^(gcore\.jsdelivr:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2`],[/^(testingcf\.jsdelivr:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2`],[/^(jsdelivr\.b-cdn:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2`],[/^(jsdelivr\.gh:)(.+)/i,`https://cdn.jsdelivr.net/gh/$2`],[/^(fastly\.jsdelivr\.gh:)(.+)/i,`https://fastly.jsdelivr.net/gh/$2`],[/^(gcore\.jsdelivr\.gh:)(.+)/i,`https://gcore.jsdelivr.net/gh/$2`],[/^(testingcf\.jsdelivr\.gh:)(.+)/i,`https://testingcf.jsdelivr.net/gh/$2`],[/^(jsdelivr\.b-cdn\.gh:)(.+)/i,`https://jsdelivr.b-cdn.net/gh/$2`],[/^(statically:)(.+)/i,`https://cdn.statically.io/gh/$2`],[/^(esm\.run:)(.+)/i,`https://esm.run/$2`],[/^(jsdelivr\.esm:)(.+)/i,`https://cdn.jsdelivr.net/npm/$2/+esm`],[/^(fastly\.jsdelivr\.esm:)(.+)/i,`https://fastly.jsdelivr.net/npm/$2/+esm`],[/^(gcore\.jsdelivr\.esm:)(.+)/i,`https://gcore.jsdelivr.net/npm/$2/+esm`],[/^(testingcf\.jsdelivr\.esm:)(.+)/i,`https://testingcf.jsdelivr.net/npm/$2/+esm`],[/^(jsdelivr\.b-cdn\.esm:)(.+)/i,`https://jsdelivr.b-cdn.net/npm/$2/+esm`],[/^(jspm:)(.+)/i,`https://jspm.dev/$2`],[/^(esbuild:)(.+)/i,`https://esbuild.vercel.app/$2`],[/^(bundle\.run:)(.+)/i,`https://bundle.run/$2`],[/^(unpkg:)(.+)/i,`https://unpkg.com/$2`],[/^(npmcdn:)(.+)/i,`https://npmcdn.com/$2`],[/^(bundlejs:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(bundle:)(.+)/i,`https://deno.bundlejs.com/?file&q=$2`],[/^(deno:)(.+)/i,`https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts`],[/^(https:\/\/deno\.land\/.+)/i,`https://deno.bundlejs.com/?file&q=$1`],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,`https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4`],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3`],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,`https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4`],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,`https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3`],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,`https://bb.githack.com/!api/2.0/snippets/$2/files/$3`],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,`https://gist.githack.com/$2`],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,`https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3`]]})),D,Ee,O,De,Oe,ke,Ae,je,Me,Ne,Pe,Fe,Ie,Le,k,Re,ze,Be,Ve,He,A,Ue,We,Ge,Ke,j,qe,Je,M,Ye,Xe,N,Ze,Qe,P,$e,et,tt,nt,rt,it,at,F,ot,st,I,L,ct,lt,ut,dt,ft,pt,mt,ht,gt,_t,R=e((()=>{Te(),{getUrl:D,getModuleUrl:Ee}=E,O=D(`@live-codes/browser-compilers@0.22.10/dist/`),De=D(`art-template@4.13.2/lib/template-web.js`),Oe=D(`@asciidoctor/core@2.2.8/dist/browser/asciidoctor.js`),ke=D(`@assemblyscript/loader@0.27.29/umd/index.js`),Ae=D(`@hatemhosny/astro-internal@0.0.4/`),je=D(`@babel/standalone@7.26.4/babel.js`),Me=D(`@bbob/html@4.3.1/dist/index.min.js`),Ne=D(`@bbob/preset-html5@4.3.1/dist/index.min.js`),Pe=D(`biwascheme@0.8.0/release/biwascheme.js`),Fe=D(`brython@3.12.4/`),Ie=D(`cherry-cljs@0.2.19/`),Le=D(`@live-codes/clio-browser-compiler@0.0.3/public/build/`),k=D(`@live-codes/codemirror@0.3.4/build/`),Re=D(`coffeescript@2.7.0/lib/coffeescript-browser-compiler-legacy/coffeescript.js`),ze=D(`dot@1.1.3/doT.js`),Be=D(`ejs@4.0.1/ejs.js`),Ve=D(`eta@3.4.0/dist/eta.umd.js`),He=D(`gh:live-codes/gleam-precompiled@v0.5.0/`),A=D(`@live-codes/go2js@0.5.0/build/`),Ue=D(`handlebars@4.7.8/dist/`),We=D(`imba@2.0.0-alpha.229/dist/`),Ge=D(`gh:jscl-project/jscl-project.github.io@058adc599f0d012718ef3ad28e704a92c4dd741e/jscl.js`),Ke=D(`liquidjs@10.14.0/dist/liquid.browser.min.js`),j=D(`fengari-web@0.1.4/dist/fengari-web.js`),qe=D(`malinajs@0.7.19/`),Je=D(`mjml-browser@4.15.3/lib/index.js`),M=D(`@live-codes/monaco-languages@0.2.0/dist/`),Ye=D(`mustache@4.2.0/mustache.js`),Xe=D(`nunjucks@3.2.4/browser/`),N=D(`https://cdn.opalrb.com/opal/1.8.2/`),Ze=D(`parinfer@3.13.1/parinfer.js`),Qe=D(`@live-codes/postcss-import-url@0.1.2/dist/postcss-import-url.js`),P=D(`prettier@3.3.2/`),$e=D(`@live-codes/prettier-plugin-minizinc@0.2.0/dist/standalone.js`),et=D(`@prettier/plugin-php@0.22.2/standalone.js`),tt=D(`requirejs@2.3.6/require.js`),nt=D(`riot@9.2.2/`),rt=D(`@ruby/wasm-wasi@2.7.2/dist/browser.umd.js`),it=D(`sql-formatter@12.2.1/dist/sql-formatter.min.js`),at=D(`sql.js@1.10.3/dist/`),F=D(`squint-cljs@0.4.81/`),ot=D(`@stencil/core@3.2.2/compiler/stencil.js`),st=D(`stylis@4.3.6/dist/umd/stylis.js`),I=D(`svelte@5.39.12/`),L=D(`tau-prolog@0.3.4/modules/`),ct=D(`twig@1.17.1/twig.min.js`),lt=`5.9.3`,ut=D(`typescript@${lt}/lib/typescript.js`),dt=D(`uniter@2.18.0/dist/uniter.js`),ft=D(`vue@2`),pt=D(`vue@3/dist/vue.runtime.esm-browser.prod.js`),mt=D(`livecodes@${{}.SDK_VERSION}/vue.js`),ht=D(`vue3-sfc-loader@0.9.5/dist/`),gt=D(`wabt@1.0.35/index.js`),_t=D(`wasmoon@1.16.0/dist/index.js`)})),z,B=e((()=>{R(),P+``,z={babel:P+`plugins/babel.js`,estree:P+`plugins/estree.js`,glimmer:P+`plugins/glimmer.js`,html:P+`plugins/html.js`,markdown:P+`plugins/markdown.js`,postcss:P+`plugins/postcss.js`,php:et,minizinc:$e,pug:O+`prettier/parser-pug.js`,java:O+`prettier/parser-java.js`}})),vt,yt=e((()=>{R(),B(),vt={name:`art-template`,title:`art`,longTitle:`art-template`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:De,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-art-template-compiler.js}}`),self.createArtTemplateCompiler())},extensions:[`art`,`art-template`],editor:`markup`,editorLanguage:`html`}})),bt=e((()=>{yt()})),xt,V,H=e((()=>{xt=(e,t=!0)=>e.replace(/\\/g,t?`\\\\`:`\\`).replace(/`/g,"\\`").replace(/<\/script>/g,`<\\/script>`),V=(e,t)=>({...t.customSettings[e]}),{}.VERSION,{}.SDK_VERSION,{}.GIT_COMMIT,{}.REPO_URL,{}.DOCS_BASE_URL})),U=e((()=>{H(),R()})),St,Ct=e((()=>{R(),U(),St={name:`asciidoc`,title:`AsciiDoc`,compiler:{url:Oe,factory:()=>{let e=window.Asciidoctor();return async(t,{config:n})=>e.convert(t,{standalone:!0,attributes:{nofooter:!0},...V(`asciidoc`,n)})}},extensions:[`adoc`,`asciidoc`,`asc`],editor:`markup`}})),wt=e((()=>{Ct()})),Tt,Et,Dt=e((()=>{R(),B(),Tt=O+`assemblyscript/assemblyscript.js`,Et={name:`assemblyscript`,title:`AS`,longTitle:`AssemblyScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel]}},compiler:{url:Tt,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-assemblyscript-compiler.js}}`),self.createAssemblyscriptCompiler()),scripts:({baseUrl:e})=>[ke,e+`{{hash:lang-assemblyscript-script.js}}`],scriptType:`application/wasm-uint8`,compiledCodeLanguage:`wat`,types:{assemblyscript:{url:O+`types/assemblyscript.d.ts`,declareAsModule:!1,autoload:!0}}},extensions:[`as`,`ts`],editor:`script`,editorLanguage:`typescript`}})),Ot=e((()=>{Dt()})),kt,At,jt=e((()=>{R(),B(),kt=Ae+`compiler.min.js`,At={name:`astro`,title:`Astro`,formatter:{prettier:{name:`html`,pluginUrls:[z.html,z.babel]}},compiler:{url:kt,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-astro-compiler.js}}`),self.createAstroCompiler())},extensions:[`astro`],editor:`markup`}})),Mt=e((()=>{jt()})),Nt=e((()=>{})),W=e((()=>{Nt(),H()})),Pt,Ft=e((()=>{W(),R(),B(),Pt={name:`babel`,title:`Babel`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{url:je,factory:()=>async(e,{config:t})=>{let n=V(`babel`,t),r=V(`@babel/preset-env`,t),i=V(`@babel/preset-typescript`,t),a=V(`@babel/preset-react`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...r}],[`typescript`,i],[`react`,a]],...n}).code}},extensions:[`es`,`babel`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),It=e((()=>{Ft()})),Lt,Rt=e((()=>{R(),Lt={name:`bbcode`,title:`BBCode`,compiler:{url:Me,factory:()=>(self.importScripts(Ne),async e=>self.BbobHtml.default(e,self.BbobPresetHTML5.default()))},extensions:[`bbcode`,`bb`],editor:`markup`}})),zt=e((()=>{Rt()})),Bt,Vt=e((()=>{Bt={name:`blockly`,title:`Blockly`,compiler:{factory:()=>async(e,{options:t})=>t?.blockly?.js||``},extensions:[`blockly.xml`,`xml`],editor:`script`,editorLanguage:`xml`}})),Ht=e((()=>{Vt()})),Ut,Wt,Gt=e((()=>{R(),Ut=O+`civet/civet.js`,Wt={name:`civet`,title:`Civet`,compiler:{url:Ut,factory:()=>async e=>window.civet.compile(e,{js:!0})},extensions:[`civet`],editor:`script`,editorLanguage:`coffeescript`}})),Kt=e((()=>{Gt()})),qt,Jt=e((()=>{R(),qt={name:`clio`,title:`Clio`,compiler:{url:Le+`compile.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-clio-compiler.js}}`),self.createClioCompiler()),scripts:[Le+`exec.js`]},extensions:[`clio`],editor:`script`,editorLanguage:`coffeescript`}})),Yt=e((()=>{Jt()})),Xt,Zt=e((()=>{Xt=e=>typeof e==`string`?{code:e,info:{}}:e})),Qt,$t=e((()=>{Zt(),Qt=async(e,t,n,r={},i=self)=>new Promise(a=>{if(!e||!t||!n)return a(Xt(``));let o=async function(n){let r=n.data.payload;n.data.trigger===`compileInCompiler`&&r?.content===e&&r?.language===t&&(i.removeEventListener(`message`,o),a(Xt(r.compiled)))};i.addEventListener(`message`,o),i.postMessage({type:`compileInCompiler`,payload:{content:e,language:t,config:n,options:r}})})})),en=e((()=>{H()})),tn=e((()=>{U(),H(),en()})),nn=e((()=>{R()})),rn,an,on,sn,cn,ln,un,dn=e((()=>{W(),R(),rn={name:`autoprefixer`,title:`Autoprefixer`,isPostcssPlugin:!0,compiler:{url:O+`autoprefixer/autoprefixer.js`,factory:e=>self.autoprefixer.autoprefixer({...V(`autoprefixer`,e)})},editor:`style`},an={name:`cssnano`,title:`cssnano`,isPostcssPlugin:!0,compiler:{url:O+`cssnano/cssnano.js`,factory:()=>{let e=self.cssnano.cssnanoPresetDefault().plugins,t=[];for(let n of e){let[e,r]=n;(r===void 0||typeof r==`object`&&!r.exclude||typeof r==`boolean`&&r===!0)&&t.push(e(r))}return t}},editor:`style`},on={name:`postcssImportUrl`,title:`Import Url`,isPostcssPlugin:!0,compiler:{url:Qe,factory:e=>self.postcssImportUrl({...V(`postcssImportUrl`,e)})},editor:`style`},sn={name:`postcssPresetEnv`,title:`Preset Env`,isPostcssPlugin:!0,compiler:{url:O+`postcss-preset-env/postcss-preset-env.js`,factory:e=>self.postcssPresetEnv.postcssPresetEnv({autoprefixer:!1,...V(`postcssPresetEnv`,e)})},editor:`style`},cn={name:`purgecss`,title:`PurgeCSS`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:O+`purgecss/purgecss.js`,factory:(e,t,n)=>self.purgecss.purgecss({...V(`purgecss`,e),content:[{raw:`<template>${n.html}\n<script>${e.script.content}<\/script></template>`,extension:`html`}]})},editor:`style`},ln={name:`tokencss`,title:`Token CSS`,isPostcssPlugin:!0,compiler:{url:O+`tokencss/tokencss.js`,factory:e=>{let t=V(`tokencss`,e);Object.keys(t).length===0&&(t.$schema=`https://tokencss.com/schema@0.0.1`,t.extends=`@tokencss/core/preset`);let n=t.extends?.includes(`@tokencss/core/preset`)?((e,t)=>{let n=JSON.parse(JSON.stringify(e));return Object.keys(t).forEach(e=>{n[e]=typeof t[e]!=`object`||Array.isArray(t[e])?t[e]:{...n[e],...t[e]}}),n})(self.tokencss.preset,t):t;return self.tokencss.tokencss({config:n})}},editor:`style`},un={name:`cssmodules`,title:`CSS Modules`,isPostcssPlugin:!0,needsHTML:!0,compiler:{url:O+`postcss-modules/postcss-modules.js`,factory:(e,t,n)=>{let r=V(`cssmodules`,e);return self.postcssModules.postcssModules({localsConvention:`camelCase`,...r,getJSON(e,t,i){let a=r.addClassesToHTML!==!1,o=r.removeOriginalClasses===!0;a&&(n.html=self.postcssModules.addClassesToHtml(n.html,t,o)),n.compileInfo={...n.compileInfo,cssModules:t,...a?{modifiedHTML:n.html}:{}}}})}},editor:`style`}})),fn,pn=e((()=>{R(),fn={name:`postcss`,title:`Processors:`,isPostcssPlugin:!1,compiler:{url:O+`postcss/postcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-postcss-compiler.js}}`),self.createPostcssCompiler())},editor:`style`,hidden:!0}})),mn=e((()=>{dn(),pn()})),hn,gn=e((()=>{R(),hn={name:`lightningcss`,title:`Lightning CSS`,isPostcssPlugin:!1,compiler:{url:O+`lightningcss/lightningcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-lightningcss-compiler.js}}`),self.createLightningcssCompiler())},editor:`style`}})),_n=e((()=>{gn()})),vn,yn=e((()=>{R(),vn={name:`tailwindcss`,title:`Tailwind CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:O+`tailwindcss/tailwindcss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-tailwindcss-compiler.js}}`),self.createTailwindcssCompiler())},editor:`style`}})),bn=e((()=>{yn()})),xn,Sn=e((()=>{R(),xn={name:`unocss`,title:`UnoCSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:O+`unocss/unocss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-unocss-compiler.js}}`),self.createUnocssCompiler())},editor:`style`}})),Cn=e((()=>{Sn()})),wn,Tn=e((()=>{R(),wn={name:`windicss`,title:`Windi CSS`,isPostcssPlugin:!1,needsHTML:!0,compiler:{url:O+`windicss/windicss.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:processor-windicss-compiler.js}}`),self.createWindicssCompiler())},editor:`style`}})),En=e((()=>{Tn()})),Dn,On=e((()=>{_n(),mn(),bn(),Cn(),En(),Dn=[...[vn,wn,xn,ln,cn,on,rn,sn,hn,an,un],fn]})),kn=e((()=>{nn(),zs(),mn(),B(),On(),U()})),An=e((()=>{kn(),W()})),jn,G,Mn,Nn=e((()=>{jn=e=>{try{return new URL(e).hostname}catch{return``}},G=(e,t)=>e===t||e.endsWith(`.`+t),Mn=(e=location.origin)=>{let t=jn(e);return!!(t&&(G(t,`livecodes.io`)||G(t,`livecodes.pages.dev`)||G(t,`localpen.pages.dev`)||G(t,`localhost`)||t===`127.0.0.1`||t.endsWith(`.test`)))}})),Pn=t(((e,t)=>{var n=(function(){var e=String.fromCharCode,t=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=`,n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$`,r={};function i(e,t){if(!r[e]){r[e]={};for(var n=0;n<e.length;n++)r[e][e.charAt(n)]=n}return r[e][t]}var a={compressToBase64:function(e){if(e==null)return``;var n=a._compress(e,6,function(e){return t.charAt(e)});switch(n.length%4){default:case 0:return n;case 1:return n+`===`;case 2:return n+`==`;case 3:return n+`=`}},decompressFromBase64:function(e){return e==null?``:e==``?null:a._decompress(e.length,32,function(n){return i(t,e.charAt(n))})},compressToUTF16:function(t){return t==null?``:a._compress(t,15,function(t){return e(t+32)})+` `},decompressFromUTF16:function(e){return e==null?``:e==``?null:a._decompress(e.length,16384,function(t){return e.charCodeAt(t)-32})},compressToUint8Array:function(e){for(var t=a.compress(e),n=new Uint8Array(t.length*2),r=0,i=t.length;r<i;r++){var o=t.charCodeAt(r);n[r*2]=o>>>8,n[r*2+1]=o%256}return n},decompressFromUint8Array:function(t){if(t==null)return a.decompress(t);for(var n=Array(t.length/2),r=0,i=n.length;r<i;r++)n[r]=t[r*2]*256+t[r*2+1];var o=[];return n.forEach(function(t){o.push(e(t))}),a.decompress(o.join(``))},compressToEncodedURIComponent:function(e){return e==null?``:a._compress(e,6,function(e){return n.charAt(e)})},decompressFromEncodedURIComponent:function(e){return e==null?``:e==``?null:(e=e.replace(/ /g,`+`),a._decompress(e.length,32,function(t){return i(n,e.charAt(t))}))},compress:function(t){return a._compress(t,16,function(t){return e(t)})},_compress:function(e,t,n){if(e==null)return``;var r,i,a={},o={},s=``,c=``,l=``,u=2,d=3,f=2,p=[],m=0,h=0,g;for(g=0;g<e.length;g+=1)if(s=e.charAt(g),Object.prototype.hasOwnProperty.call(a,s)||(a[s]=d++,o[s]=!0),c=l+s,Object.prototype.hasOwnProperty.call(a,c))l=c;else{if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++),a[c]=d++,l=String(s)}if(l!==``){if(Object.prototype.hasOwnProperty.call(o,l)){if(l.charCodeAt(0)<256){for(r=0;r<f;r++)m<<=1,h==t-1?(h=0,p.push(n(m)),m=0):h++;for(i=l.charCodeAt(0),r=0;r<8;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}else{for(i=1,r=0;r<f;r++)m=m<<1|i,h==t-1?(h=0,p.push(n(m)),m=0):h++,i=0;for(i=l.charCodeAt(0),r=0;r<16;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1}u--,u==0&&(u=2**f,f++),delete o[l]}else for(i=a[l],r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;u--,u==0&&(u=2**f,f++)}for(i=2,r=0;r<f;r++)m=m<<1|i&1,h==t-1?(h=0,p.push(n(m)),m=0):h++,i>>=1;for(;;)if(m<<=1,h==t-1){p.push(n(m));break}else h++;return p.join(``)},decompress:function(e){return e==null?``:e==``?null:a._decompress(e.length,32768,function(t){return e.charCodeAt(t)})},_decompress:function(t,n,r){var i=[],a=4,o=4,s=3,c=``,l=[],u,d,f,p,m,h,g,_={val:r(0),position:n,index:1};for(u=0;u<3;u+=1)i[u]=u;for(f=0,m=2**2,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;g=e(f);break;case 2:return``}for(i[3]=g,d=g,l.push(g);;){if(_.index>t)return``;for(f=0,m=2**s,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;switch(g=f){case 0:for(f=0,m=2**8,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 1:for(f=0,m=2**16,h=1;h!=m;)p=_.val&_.position,_.position>>=1,_.position==0&&(_.position=n,_.val=r(_.index++)),f|=(p>0?1:0)*h,h<<=1;i[o++]=e(f),g=o-1,a--;break;case 2:return l.join(``)}if(a==0&&(a=2**s,s++),i[g])c=i[g];else if(g===o)c=d+d.charAt(0);else return null;l.push(c),i[o++]=d+c.charAt(0),a--,d=c,a==0&&(a=2**s,s++)}}};return a})();typeof define==`function`&&define.amd?define(function(){return n}):t!==void 0&&t!=null&&(t.exports=n)})),Fn=e((()=>{Pn()})),In=e((()=>{})),Ln=e((()=>{})),Rn=e((()=>{})),zn=e((()=>{In(),Ln(),Rn()})),Bn=e((()=>{})),Vn=e((()=>{zn(),H(),R()})),Hn=e((()=>{Fn(),Vn()})),Un=e((()=>{Vn()})),Wn=e((()=>{zn()})),Gn=e((()=>{H(),Un(),Wn(),Vn()})),Kn=e((()=>{Hn(),Bn(),Un(),Wn(),Vn(),Gn()})),qn=e((()=>{Kn(),W()})),Jn=e((()=>{})),Yn=e((()=>{W()})),Xn=e((()=>{`${{}.SANDBOX_HOST_NAME}${{}.SANDBOX_PORT}`,location.hostname===`localhost`||location.hostname===`127.0.0.1`||{}.SELF_HOSTED===`true`||{}.CI})),Zn=e((()=>{Nn(),{}.SELF_HOSTED===`true`?{}.SELF_HOSTED_SHARE:Mn()})),Qn=e((()=>{en()})),$n=e((()=>{Nn(),qn(),Jn(),Yn(),Te(),Xn(),Zn(),Qn()})),er=e((()=>{kn(),$n(),W(),An(),en()})),tr=e((()=>{er()})),nr=e((()=>{tn(),$t(),An(),tr(),en(),Zt()})),K,q,J=e((()=>{n(),K=async e=>{let{LanguageSupport:t,StreamLanguage:n}=await r(async()=>{let{LanguageSupport:e,StreamLanguage:t}=await import(q.language);return{LanguageSupport:e,StreamLanguage:t}},[],import.meta.url);return new t(n.define(e))},q={html:`@codemirror/lang-html`,css:`@codemirror/lang-css`,javascript:`@codemirror/lang-javascript`,json:`@codemirror/lang-json`,language:`@codemirror/language`}})),Y,rr,ir=e((()=>{R(),Y=()=>{let e=Ze;return self.importScripts(e),async e=>({formatted:window.parinfer.parenMode(e).text,cursorOffset:0})},rr={name:`commonlisp`,title:`Lisp`,longTitle:`Common Lisp`,formatter:{factory:Y},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Ge,e+`{{hash:lang-commonlisp-script.js}}`],scriptType:`text/commonlisp`,compiledCodeLanguage:`commonlisp`},extensions:[`lisp`,`common-lisp`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`commonlisp.js`},codemirror:{language:`scheme`},codejar:{language:`scheme`}}}})),ar=e((()=>{ir()})),or,sr=e((()=>{nr(),J(),R(),ar(),n(),or={name:`clojurescript`,title:`CLJS (cherry)`,longTitle:`ClojureScript (cherry)`,formatter:{factory:Y},compiler:{url:Ie+`lib/cherry.umd.js`,factory:()=>async(e,{config:t,options:n})=>{let r=self.CherryCljs.compileString(e);return e.includes(`#jsx`)?(await Qt(r,`jsx`,t,n)).code:r},imports:{"cherry-cljs":Ie+`index.js`,"cherry-cljs/cljs.core.js":Ie+`cljs.core.js`,"cherry-cljs/lib/clojure.string.js":`lib/clojure.string.js`,"cherry-cljs/lib/clojure.set.js":`lib/clojure.set.js`,"cherry-cljs/lib/clojure.walk.js":`lib/clojure.walk.js`,"squint-cljs":F+`index.js`,"squint-cljs/core.js":F+`core.js`,"squint-cljs/string.js":F+`string.js`,"squint-cljs/src/squint/string.js":F+`src/squint/string.js`,"squint-cljs/src/squint/set.js":F+`src/squint/set.js`}},extensions:[`cljs`,`clj`,`cljc`,`edn`,`clojure`],editor:`script`,editorLanguage:`clojure`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{clojure:e}=await import(k+`codemirror-lang-clojure.js`);return{clojure:e}},[],import.meta.url)).clojure)}}}})),cr=e((()=>{sr()})),lr,ur=e((()=>{J(),W(),R(),n(),lr={name:`coffeescript`,title:`Coffee`,longTitle:`CoffeeScript`,compiler:{url:Re,factory:()=>async(e,{config:t})=>window.CoffeeScript.compile(e,{bare:!0,...V(`coffeescript`,t)})},extensions:[`coffee`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{coffeescript:e}=await import(k+`codemirror-lang-coffeescript.js`);return{coffeescript:e}},[],import.meta.url)).coffeescript)}}}})),dr=e((()=>{ur()})),fr,pr,mr=e((()=>{R(),n(),fr=O+`jscpp/JSCPP.es5.min.js`,pr={name:`cpp`,title:`C++`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[fr,e+`{{hash:lang-cpp-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`},extensions:[`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`cpp.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{cpp:e}=await import(k+`codemirror-lang-cpp.js`);return{cpp:e}},[],import.meta.url)).cpp()}}}})),hr=e((()=>{mr()})),gr,_r=e((()=>{gr={name:`cpp-wasm`,title:`C++ (Wasm)`,longTitle:`C/C++ (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-cpp-wasm-script.js}}`],scriptType:`text/cpp`,compiledCodeLanguage:`cpp`,liveReload:!0},extensions:[`wasm.cpp`,`cppwasm`,`cwasm`,`clang.cpp`,`clang`,`cpp`,`c`,`C`,`cp`,`cxx`,`c++`,`cppm`,`ixx`,`ii`,`hpp`,`h`],editor:`script`,editorLanguage:`cpp`,largeDownload:!0}})),vr=e((()=>{_r()})),yr,br=e((()=>{J(),R(),B(),n(),yr={name:`csharp-wasm`,title:`C# (Wasm)`,formatter:{prettier:{name:`java`,pluginUrls:[z.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-csharp-wasm-script.js}}`],scriptType:`text/csharp-wasm`,compiledCodeLanguage:`csharp-wasm`,liveReload:!0},extensions:[`cs`,`csharp`,`wasm.cs`,`cs-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`csharp.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{csharp:e}=await import(k+`codemirror-lang-clike.js`);return{csharp:e}},[],import.meta.url)).csharp)},codejar:{language:`csharp`}},largeDownload:!0}})),xr=e((()=>{br()})),Sr,Cr=e((()=>{J(),B(),n(),Sr={name:`css`,title:`CSS`,info:!1,formatter:{prettier:{name:`css`,pluginUrls:[z.postcss]}},compiler:{factory:()=>async e=>e},extensions:[`css`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>{let{css:e}=await r(async()=>{let{css:e}=await import(q.css);return{css:e}},[],import.meta.url);return e()}}}}})),wr=e((()=>{Cr()})),Tr,Er,Dr=e((()=>{B(),n(),Tr=async(e,{baseUrl:t,config:n})=>{let{diagramsCompiler:i}=await r(async()=>{let{diagramsCompiler:e}=await import(t+`{{hash:lang-diagrams-compiler-esm.js}}`);return{diagramsCompiler:e}},[],import.meta.url);return i(e,{config:n})},Er={name:`diagrams`,title:`Diagrams`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{factory:()=>async e=>e||``,runOutsideWorker:Tr},extensions:[`diagrams`,`diagram`,`graph`,`plt`],editor:`markup`,editorLanguage:`html`}})),Or=e((()=>{Dr()})),kr,Ar=e((()=>{R(),B(),kr={name:`dot`,title:`doT`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:ze,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-dot-compiler.js}}`),self.createDotCompiler())},extensions:[`dot`],editor:`markup`,editorLanguage:`html`}})),jr=e((()=>{Ar()})),Mr,Nr=e((()=>{R(),B(),Mr={name:`ejs`,title:`EJS`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:Be,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-ejs-compiler.js}}`),self.createEjsCompiler())},extensions:[`ejs`],editor:`markup`,editorLanguage:`html`}})),Pr=e((()=>{Nr()})),Fr,Ir=e((()=>{R(),B(),Fr={name:`eta`,title:`Eta`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:Ve,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-eta-compiler.js}}`),self.createEtaCompiler())},extensions:[`eta`],editor:`markup`,editorLanguage:`html`}})),Lr=e((()=>{Ir()})),Rr,zr=e((()=>{R(),ar(),Rr={name:`fennel`,title:`Fennel`,formatter:{factory:Y},compiler:{url:j,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-fennel-compiler.js}}`),self.createFennelCompiler()),scripts:[j],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`fnl`],editor:`script`,editorLanguage:`scheme`}})),Br=e((()=>{zr()})),Vr,Hr=e((()=>{W(),R(),B(),Vr={name:`flow`,title:`Flow`,formatter:{prettier:{name:`babel-flow`,pluginUrls:[z.babel,z.html]}},compiler:{url:O+`flow-remove-types/flow-remove-types.js`,factory:()=>async(e,{config:t})=>window.flowRemoveTypes.transpile(e,{all:!0,...V(`flow`,t)}).toString()},extensions:[`flow`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),Ur=e((()=>{Hr()})),Wr,Gr=e((()=>{J(),R(),n(),Wr={name:`gleam`,title:`Gleam`,compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-gleam-compiler.js}}`),self.createGleamCompiler()),loadAsExternalModule:!0,inlineModule:`(async() => {
      const main = (await import('./script')).main;
      if (typeof main === "function") main();
    })();
`},extensions:[`gleam`],editor:`script`,editorSupport:{monaco:{language:`swift`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{swift:e}=await import(k+`codemirror-lang-swift.js`);return{swift:e}},[],import.meta.url)).swift)},codejar:{language:`swift`}}}})),Kr=e((()=>{Gr()})),qr,Jr=e((()=>{R(),n(),qr={name:`go`,title:`Go`,formatter:{factory:()=>(importScripts(A+`go2js-format.js`),async e=>{if(!e)return{formatted:``,cursorOffset:0};let[t,n]=globalThis.go2jsFormat(e);return n?(console.error(n),{formatted:e,cursorOffset:0}):{formatted:t,cursorOffset:0}})},compiler:{url:A+`go2js-compile.js`,factory:()=>e=>new Promise(t=>{if(!e){t(``);return}let n=A.endsWith(`/`)?A.slice(0,-1):A;globalThis.go2jsCompile(e,n,(e,n)=>{e?(console.error(e),t(``)):t(n)})})},extensions:[`go`,`golang`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`go.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{go:e}=await import(k+`codemirror-lang-go.js`);return{go:e}},[],import.meta.url)).go()}}}})),Yr=e((()=>{Jr()})),Xr,Zr=e((()=>{Jr(),Xr={name:`go-wasm`,title:`Go (Wasm)`,formatter:qr.formatter,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-go-wasm-script.js}}`],liveReload:!0,scriptType:`text/go-wasm`,compiledCodeLanguage:`go`},extensions:[`wasm.go`,`go-wasm`,`gowasm`],editor:`script`,editorLanguage:`go`,largeDownload:!0}})),Qr=e((()=>{Zr()})),$r,ei=e((()=>{R(),$r={name:`haml`,title:`Haml`,compiler:{url:O+`clientside-haml-js/haml.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-haml-compiler.js}}`),self.createHamlCompiler())},extensions:[`haml`],editor:`markup`}})),ti=e((()=>{ei()})),ni,ri,ii=e((()=>{R(),B(),ni=Ue+`handlebars.min.js`,Ue+``,ri={name:`handlebars`,title:`Handlebars`,formatter:{prettier:{name:`glimmer`,pluginUrls:[z.glimmer]}},compiler:{url:ni,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-handlebars-compiler.js}}`),self.createHandlebarsCompiler())},extensions:[`hbs`,`handlebars`],editor:`markup`,editorLanguage:`html`}})),ai=e((()=>{ii()})),oi,si=e((()=>{J(),B(),n(),oi={name:`html`,title:`HTML`,info:!1,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{factory:()=>async e=>e},extensions:[`html`,`htm`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>{let{html:e}=await r(async()=>{let{html:e}=await import(q.html);return{html:e}},[],import.meta.url);return e()}}}}})),ci=e((()=>{si()})),li,ui=e((()=>{R(),li={name:`imba`,title:`Imba`,compiler:{url:We+`compiler.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-imba-compiler.js}}`),self.createImbaCompiler()),imports:{imba:We+`imba.mjs`}},extensions:[`imba`],editor:`script`}})),di=e((()=>{ui()})),fi,pi=e((()=>{R(),B(),n(),fi={name:`java`,title:`Java`,formatter:{prettier:{name:`java`,pluginUrls:[z.java]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-java-script.js}}`],scriptType:`text/java`,compiledCodeLanguage:`java`,liveReload:!0},extensions:[`java`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`java.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{java:e}=await import(k+`codemirror-lang-java.js`);return{java:e}},[],import.meta.url)).java()}},largeDownload:!0}})),mi=e((()=>{pi()})),hi,gi=e((()=>{J(),B(),n(),hi={name:`javascript`,title:`JS`,longTitle:`JavaScript`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{factory:()=>async e=>e},extensions:[`js`,`mjs`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e()}}}}})),_i=e((()=>{gi()})),vi,yi,bi=e((()=>{R(),vi=`${O}jinja/jinja.js`,yi={name:`jinja`,title:`Jinja`,formatter:{factory:()=>(self.importScripts(vi),async(e,t,n)=>({formatted:new self.Jinja.Template(e).format({indent:n?.tabSize||2}),cursorOffset:t}))},compiler:{url:vi,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-jinja-compiler.js}}`),self.createJinjaCompiler())},extensions:[`jinja`],editor:`markup`,editorLanguage:`html`}})),xi=e((()=>{bi()})),Si,Ci=e((()=>{J(),B(),n(),Si={name:`jsx`,title:`JSX`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:`typescript`,extensions:[`jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0})}},compilerOptions:{jsx:4}}}})),wi,Ti=e((()=>{J(),B(),n(),wi={name:`tsx`,title:`TSX`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:`typescript`,extensions:[`tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({jsx:!0,typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),Ei=e((()=>{Ci(),Ti()})),Di,Oi=e((()=>{J(),R(),n(),Di={name:`julia`,title:`Julia`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-julia-script.js}}`],liveReload:!0,scriptType:`text/julia`,compiledCodeLanguage:`julia`},extensions:[`jl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{julia:e}=await import(k+`codemirror-lang-julia.js`);return{julia:e}},[],import.meta.url)).julia)}},largeDownload:!0}})),ki=e((()=>{Oi()})),Ai,ji=e((()=>{J(),W(),R(),B(),n(),Ai={name:`less`,title:`Less`,formatter:{prettier:{name:`less`,pluginUrls:[z.postcss]}},compiler:{url:O+`less/less.js`,factory:()=>async(e,{config:t})=>(await window.less.render(e,{...V(`less`,t)})).css},extensions:[`less`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{less:e}=await import(k+`codemirror-lang-less.js`);return{less:e}},[],import.meta.url)).less)}}}})),Mi=e((()=>{ji()})),Ni,Pi=e((()=>{R(),B(),n(),Ni={name:`liquid`,title:`Liquid`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:Ke,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-liquid-compiler.js}}`),self.createLiquidCompiler())},extensions:[`liquid`,`liquidjs`],editor:`markup`,editorLanguage:`html`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{liquid:e}=await import(k+`codemirror-lang-liquid.js`);return{liquid:e}},[],import.meta.url)).liquid()}}}})),Fi=e((()=>{Pi()})),Ii,Li=e((()=>{J(),W(),R(),n(),Ii={name:`livescript`,title:`LiveScript`,compiler:{url:O+`livescript/livescript-min.js`,factory:()=>async(e,{config:t})=>window.require(`livescript`).compile(e,{bare:!0,...V(`livescript`,t)}),scripts:[O+`livescript/prelude-browser-min.js`]},extensions:[`ls`],editor:`script`,editorSupport:{monaco:{language:`coffeescript`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{livescript:e}=await import(k+`codemirror-lang-livescript.js`);return{livescript:e}},[],import.meta.url)).livescript)}}}})),Ri=e((()=>{Li()})),zi,Bi,Vi,Hi=e((()=>{J(),R(),n(),zi=O+`lua-fmt/lua-fmt.js`,Bi={factory:()=>(self.importScripts(zi),async(e,t)=>({formatted:self.luaFmt.formatText(e),cursorOffset:t}))},Vi={name:`lua`,title:`Lua`,formatter:Bi,compiler:{factory:()=>async e=>e,scripts:[j],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`lua`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`lua.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{lua:e}=await import(k+`codemirror-lang-lua.js`);return{lua:e}},[],import.meta.url)).lua)}}}})),Ui=e((()=>{Hi()})),Wi,Gi=e((()=>{R(),Hi(),Wi={name:`lua-wasm`,title:`Lua (Wasm)`,formatter:Bi,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[_t,e+`{{hash:lang-lua-wasm-script.js}}`],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`wasm.lua`,`luawasm`],editor:`script`,editorLanguage:`lua`}})),Ki=e((()=>{Gi()})),qi,Ji=e((()=>{R(),B(),qi={name:`malina`,title:`Malina.js`,formatter:{prettier:{name:`html`,pluginUrls:[z.html,z.babel]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-malina-compiler.js}}`),self.createMalinaCompiler()),imports:{"malinajs/runtime.js":`${qe}runtime.js`}},extensions:[`xht`],editor:`script`,editorLanguage:`html`}})),Yi=e((()=>{Ji()})),Xi,Zi=e((()=>{R(),B(),n(),Xi={name:`markdown`,title:`Markdown`,formatter:{prettier:{name:`markdown`,pluginUrls:[z.markdown,z.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-markdown-compiler.js}}`),self.createMarkdownCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-markdown-script.js}}`]},extensions:[`md`,`markdown`,`mdown`,`mkdn`],editor:`markup`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{markdown:e}=await import(k+`codemirror-lang-markdown.js`);return{markdown:e}},[],import.meta.url)).markdown()}}}})),Qi=e((()=>{Zi()})),$i,ea,ta=e((()=>{$t(),W(),R(),B(),n(),$i=async(e,{config:t,worker:n})=>new Promise(async i=>{if(!e)return i(``);let[a,{default:o}]=await Promise.all([r(()=>import(O+`mdx/mdx.js`),[],import.meta.url),r(()=>import(O+`remark-gfm/remark-gfm.js`),[],import.meta.url)]),s=(await a.compile(e,{remarkPlugins:[o],...V(`mdx`,t)})).value,c=(await Qt(`import React from "react";
import { createRoot } from "react-dom/client";
${xt((e=>e.replace(/, {[^}]*} = _components/g,``).replace(/const {[^:]*} = props.components[^;]*;/g,``))(s),!1)}
createRoot(document.querySelector('#__livecodes_mdx_root__')).render(<MDXContent />,);
`,`jsx`,t,{},n)).code;i(`<div id="__livecodes_mdx_root__"></div><script type="module">${c}<\/script>`)}),ea={name:`mdx`,title:`MDX`,formatter:{prettier:{name:`markdown`,pluginUrls:[z.markdown,z.html]}},compiler:{factory:()=>async e=>e,runOutsideWorker:$i,compiledCodeLanguage:`javascript`},extensions:[`mdx`],editor:`markup`,editorLanguage:`markdown`}})),na=e((()=>{ta()})),ra,ia=e((()=>{R(),B(),n(),ra={name:`minizinc`,title:`MiniZinc`,formatter:{prettier:{name:`minizinc`,pluginUrls:[z.minizinc]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-minizinc-script.js}}`],scriptType:`text/minizinc`,compiledCodeLanguage:`minizinc`},extensions:[`mzn`,`dzn`,`minizinc`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`minizinc.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{MiniZinc:e}=await import(k+`codemirror-lang-minizinc.js`);return{MiniZinc:e}},[],import.meta.url)).MiniZinc()}}}})),aa=e((()=>{ia()})),oa,sa=e((()=>{W(),R(),B(),oa={name:`mjml`,title:`MJML`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:Je,factory:()=>async(e,{config:t})=>{if(!e.trim())return``;let{html:n,errors:r}=self.mjml(e,V(`mjml`,t));return r?.forEach(e=>{console.warn(e.formattedMessage)}),n}},extensions:[`mjml`],editor:`markup`,editorLanguage:`xml`}})),ca=e((()=>{sa()})),la,ua=e((()=>{R(),B(),la={name:`mustache`,title:`Mustache`,formatter:{prettier:{name:`glimmer`,pluginUrls:[z.glimmer]}},compiler:{url:Ye,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-mustache-compiler.js}}`),self.createMustacheCompiler())},extensions:[`mustache`],editor:`markup`,editorLanguage:`html`}})),da=e((()=>{ua()})),fa,pa,ma=e((()=>{R(),B(),fa=Xe+`nunjucks.min.js`,Xe+``,pa={name:`nunjucks`,title:`Nunjucks`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:fa,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-nunjucks-compiler.js}}`),self.createNunjucksCompiler())},extensions:[`njk`,`nunjucks`],editor:`markup`,editorLanguage:`html`}})),ha=e((()=>{ma()})),ga,_a=e((()=>{J(),R(),n(),ga={name:`ocaml`,title:`OCaml`,compiler:`rescript`,extensions:[`ml`,`mli`],editor:`script`,editorSupport:{monaco:{language:`csharp`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{oCaml:e}=await import(k+`codemirror-lang-mllike.js`);return{oCaml:e}},[],import.meta.url)).oCaml)}}}})),va=e((()=>{_a()})),ya,ba=e((()=>{J(),R(),n(),ya={name:`perl`,title:`Perl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[O+`perlito/perlito5.min.js`,e+`{{hash:lang-perl-script.js}}`],scriptType:`text/perl`},extensions:[`pl`,`pm`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{perl:e}=await import(k+`codemirror-lang-perl.js`);return{perl:e}},[],import.meta.url)).perl)}}}})),xa=e((()=>{ba()})),Sa,Ca=e((()=>{R(),B(),n(),Sa={name:`php`,title:`PHP`,formatter:{prettier:{name:`php`,pluginUrls:[z.php]}},compiler:{factory:()=>async e=>(e=e.trim(),e.startsWith(`<?php`)&&(e=e.replace(`<?php`,`/* <?php */`),e.endsWith(`?>`)&&(e=e.replace(`?>`,`/* ?> */`))),e),scripts:[dt],deferScripts:!0,scriptType:`text/x-uniter-php`,compiledCodeLanguage:`php`},extensions:[`php`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`php.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{php:e}=await import(k+`codemirror-lang-php.js`);return{php:e}},[],import.meta.url)).php()}}}})),wa=e((()=>{Ca()})),Ta,Ea=e((()=>{R(),B(),Ta={name:`php-wasm`,title:`PHP (Wasm)`,formatter:{prettier:{name:`php`,pluginUrls:[z.php]}},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[O+`php-wasm/php-wasm.js`,e+`{{hash:lang-php-wasm-script.js}}`],scriptType:`text/php-wasm`,compiledCodeLanguage:`php`},extensions:[`wasm.php`,`phpwasm`],editor:`script`,editorLanguage:`php`}})),Da=e((()=>{Ea()})),Oa,ka,Aa=e((()=>{R(),n(),Oa=async(e,{baseUrl:t,config:n})=>{let{pgSqlCompiler:i}=await r(async()=>{let{pgSqlCompiler:e}=await import(t+`{{hash:lang-postgresql-compiler-esm.js}}`);return{pgSqlCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,config:n})},ka={name:`postgresql`,title:`PostgreSQL`,formatter:{factory:()=>(importScripts(it),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{factory:()=>async e=>e,runOutsideWorker:Oa,scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:`application/json`,compiledCodeLanguage:`json`},extensions:[`pg.sql`,`pgsql`,`pgsql.sql`,`pgsql`,`pg`,`pglite`,`pglite.sql`,`postgresql`,`postgres`,`postgre.sql`,`postgresql.sql`],editor:`script`,editorLanguage:`sql`}})),ja=e((()=>{Aa()})),Ma,Na=e((()=>{R(),n(),Ma={name:`prolog`,title:`Prolog`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[L+`core.js`,L+`charsio.js`,L+`dom.js`,L+`format.js`,L+`js.js`,L+`lists.js`,L+`os.js`,L+`promises.js`,L+`random.js`,L+`statistics.js`,e+`{{hash:lang-prolog-script.js}}`],scriptType:`text/prolog`,compiledCodeLanguage:`prolog`},extensions:[`prolog.pl`,`prolog`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`prolog.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{prolog:e}=await import(k+`codemirror-lang-prolog.js`);return{prolog:e}},[],import.meta.url)).prolog()}}}})),Pa=e((()=>{Na()})),Fa,Ia=e((()=>{R(),Fa={name:`pug`,title:`Pug`,compiler:{url:O+`pug/pug.min.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-pug-compiler.js}}`),self.createPugCompiler())},extensions:[`pug`,`jade`],editor:`markup`}})),La=e((()=>{Ia()})),Ra,za,Ba,Va=e((()=>{H(),R(),n(),Ra=Fe+`brython.min.js`,za=Fe+`brython_stdlib.js`,Ba={name:`python`,title:`Python`,compiler:{factory:()=>async e=>e,scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n}=V(`python`,t);return[Ra,...n!==!1&&e.match(/^(?:from[ ]+(\S+)[ ]+)?import[ ]+(\S+)(?:[ ]+as[ ]+\S+)?[ ]*$/gm)?[za]:[]]},scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`py`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`python.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{python:e}=await import(k+`codemirror-lang-python.js`);return{python:e}},[],import.meta.url)).python()}}}})),Ha=e((()=>{Va()})),Ua,Wa=e((()=>{Ua={name:`python-wasm`,title:`Py (Wasm)`,longTitle:`Python (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-python-wasm-script.js}}`],liveReload:!0,scriptType:`text/python`,compiledCodeLanguage:`python`},extensions:[`wasm.py`,`py3`,`pyodide`,`py-wasm`,`pythonwasm`,`pywasm`],editor:`script`,editorLanguage:`python`,largeDownload:!0}})),Ga=e((()=>{Wa()})),Ka,qa=e((()=>{J(),R(),n(),Ka={name:`r`,title:`R`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[e+`{{hash:lang-r-script-esm.js}}`],inlineScript:`
    ...
    `,liveReload:!0,scriptType:`text/r`,compiledCodeLanguage:`r`},extensions:[`r`,`rlang`,`rstats`,`r-wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`r.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{r:e}=await import(k+`codemirror-lang-r.js`);return{r:e}},[],import.meta.url)).r)}},largeDownload:!0}})),Ja=e((()=>{qa()})),Ya,Xa=e((()=>{R(),B(),U(),Ya={name:`react`,title:`React`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{dependencies:[`babel`],url:O+`babel-plugin-react-compiler/babel-plugin-react-compiler.js`,factory:()=>async(e,{config:t,language:n})=>{let r=V(`babel`,t),i=V(`@babel/preset-env`,t),a=V(`@babel/preset-typescript`,t),o=V(`@babel/preset-react`,t),s=V(`babel-plugin-react-compiler`,t);return window.Babel.transform(e,{filename:`script.tsx`,presets:[[`env`,{modules:!1,...i}],...n===`react-tsx`?[`typescript`,a]:[],[`react`,{runtime:`automatic`,...o}]],plugins:[[window.reactCompiler.reactCompiler,s]],...r}).code}},extensions:[`react.jsx`,`react-jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),Za,Qa=e((()=>{B(),Za={name:`react-tsx`,title:`React (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:`react`,extensions:[`react.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),$a=e((()=>{Xa(),Qa()})),eo,to,no,ro=e((()=>{J(),W(),R(),B(),n(),eo=(e,t)=>{let n={...V(`typescript`,t),...V(t.script.language,t)};return!!(n.jsx||n.jsxFactory||new RegExp(/\/\*\*[\s\*]*((@jsx)|(@jsxImportSource))\s/g).test(e))},to={target:`es2020`,jsx:`react`,allowUmdGlobalAccess:!0,esModuleInterop:!0},no={name:`typescript`,title:`TS`,longTitle:`TypeScript`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:{url:ut,factory:()=>async(e,{config:t})=>window.ts.transpile(e,{...to,...[`jsx`,`tsx`].includes(t.script.language)&&!eo(e,t)?{jsx:`react-jsx`}:{},...V(`typescript`,t),...V(t.script.language,t)})},extensions:[`ts`,`mts`,`typescript`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>{let{javascript:e}=await r(async()=>{let{javascript:e}=await import(q.javascript);return{javascript:e}},[],import.meta.url);return e({typescript:!0})}},compilerOptions:{checkJs:!0,strictNullChecks:!0}}}})),io=e((()=>{ro()})),ao,oo,so=e((()=>{R(),B(),io(),U(),ao=O+`react-native-web/react-native-web.js`,oo={name:`react-native`,title:`RN`,longTitle:`React Native`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{dependencies:[`typescript`],factory:()=>async(e,{config:t,language:n})=>window.ts.transpile(e,{...to,jsx:`react-jsx`,...V(`typescript`,t),...V(n,t)}),imports:{react:ao,"react-native":ao}},extensions:[`react-native.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:4}}}})),co,lo=e((()=>{B(),co={name:`react-native-tsx`,title:`RN (TSX)`,longTitle:`React Native (TSX)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:`react-native`,extensions:[`react-native.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:4}}}})),uo=e((()=>{so(),lo()})),fo,po,mo,ho=e((()=>{n(),fo=async(e,{baseUrl:t,language:n})=>{let{rescriptCompiler:i}=await r(async()=>{let{rescriptCompiler:e}=await import(t+`{{hash:lang-rescript-compiler-esm.js}}`);return{rescriptCompiler:e}},[],import.meta.url);return i(e,{baseUrl:t,language:n})},po=(e,t)=>(importScripts(e+`{{hash:lang-rescript-formatter.js}}`),self.createRescriptFormatter(e,t)),mo={name:`rescript`,title:`ReScript`,formatter:{factory:po},compiler:{factory:()=>async e=>e,runOutsideWorker:fo,scriptType:`module`},extensions:[`res`,`resi`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),go=e((()=>{ho()})),_o,vo=e((()=>{go(),_o={name:`reason`,title:`Reason`,formatter:{factory:po},compiler:`rescript`,extensions:[`re`,`rei`],editor:`script`,editorLanguage:`javascript`,editorSupport:{monaco:{language:`csharp`}}}})),yo=e((()=>{vo()})),bo,xo=e((()=>{bo={name:`richtext`,title:`Rich Text`,longTitle:`Rich Text Editor`,compiler:{factory:()=>async(e,{config:t})=>t.markup.content||``,styles:[`{{hash:quill.css}}`]},extensions:[`rte`,`rte.html`,`rich`],editor:`markup`,editorLanguage:`html`}})),So=e((()=>{xo()})),Co,wo,To,Eo=e((()=>{R(),B(),Co=nt+`riot+compiler.min.js`,wo=nt+`riot.min.js`,To={name:`riot`,title:`Riot.js`,formatter:{prettier:{name:`html`,pluginUrls:[z.html,z.babel]}},compiler:{url:Co,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-riot-compiler.js}}`),self.createRiotCompiler()),scripts:[wo],scriptType:`module`},extensions:[`riot`,`riotjs`],editor:`script`,editorLanguage:`html`}})),Do=e((()=>{Eo()})),Oo,ko,Ao=e((()=>{J(),W(),R(),n(),Oo=(e,t={})=>Array.from(new Set([...e.matchAll(new RegExp(/^\s*self\.\$require\("(\S+)"\);/gm))].map(e=>e[1]).map(e=>e.split(`/`)[0]).filter(e=>t.hasOwnProperty(e)||e!==`opal`).map(e=>t[e]||`${N+e}.min.js`))),ko={name:`ruby`,title:`Ruby`,compiler:{url:N+`opal.min.js`,factory:()=>(importScripts(N+`opal-parser.min.js`),self.Opal.config.unsupported_features_severity=`ignore`,self.Opal.load(`opal-parser`),async(e,{config:t})=>{let{autoloadStdlib:n,requireMap:r,...i}=V(`ruby`,t),a=e.includes(`$0`)?`$0 = __FILE__
`:``;return self.Opal.compile(a+e,i)}),scripts:({compiled:e,config:t})=>{let{autoloadStdlib:n,requireMap:r}=V(`ruby`,t),i=Oo(e,r),a=n===!1?[]:i;return[N+`opal.min.js`,...a]}},extensions:[`rb`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`ruby.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{ruby:e}=await import(k+`codemirror-lang-ruby.js`);return{ruby:e}},[],import.meta.url)).ruby)}}}})),jo=e((()=>{Ao()})),Mo,No=e((()=>{R(),Mo={name:`ruby-wasm`,title:`Ruby (Wasm)`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[rt,e+`{{hash:lang-ruby-wasm-script.js}}`],liveReload:!0,scriptType:`text/ruby-wasm`,compiledCodeLanguage:`ruby`},extensions:[`wasm.rb`,`rubywasm`],editor:`script`,editorLanguage:`ruby`,largeDownload:!0}})),Po=e((()=>{No()})),Fo,Io=e((()=>{J(),R(),ar(),n(),Fo={name:`scheme`,title:`Scheme`,formatter:{factory:Y},compiler:{factory:()=>async e=>e,scripts:[Pe],scriptType:`text/biwascheme`,compiledCodeLanguage:`scheme`},extensions:[`scm`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`scheme.js`},codemirror:{languageSupport:async()=>K((await r(async()=>{let{scheme:e}=await import(k+`codemirror-lang-scheme.js`);return{scheme:e}},[],import.meta.url)).scheme)}}}})),Lo=e((()=>{Io()})),Ro,zo=e((()=>{R(),n(),Ro={name:`sass`,title:`Sass`,compiler:`scss`,extensions:[`sass`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(k+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass({indented:!0})}}}})),Bo,Vo=e((()=>{R(),B(),n(),Bo={name:`scss`,title:`SCSS`,formatter:{prettier:{name:`scss`,pluginUrls:[z.postcss]}},compiler:{url:O+`sass/sass.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-scss-compiler.js}}`),self.createScssCompiler())},extensions:[`scss`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>(await r(async()=>{let{sass:e}=await import(k+`codemirror-lang-scss.js`);return{sass:e}},[],import.meta.url)).sass()}}}})),Ho=e((()=>{zo(),Vo()})),Uo,Wo=e((()=>{Te(),R(),B(),Uo={name:`solid`,title:`Solid`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{dependencies:[`babel`],url:O+`babel-preset-solid/babel-preset-solid.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-solid-compiler.js}}`),self.createSolidCompiler()),imports:{"solid-js":E.getModuleUrl(`solid-js`),"solid-js/web":E.getModuleUrl(`solid-js/web`)}},extensions:[`solid.jsx`],editor:`script`,editorLanguage:`javascript`,editorSupport:{compilerOptions:{jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),Go,Ko=e((()=>{B(),Go={name:`solid.tsx`,title:`Solid (TS)`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:`solid`,extensions:[`solid.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{checkJs:!0,strictNullChecks:!0,jsx:1,jsxImportSource:`solid-js`,jsxFactory:`JSX`,jsxFragmentFactory:`Fragment`}}}})),qo=e((()=>{Wo(),Ko()})),Jo,Yo,Xo=e((()=>{R(),n(),Jo=`application/json`,Yo={name:`sql`,title:`SQL`,formatter:{factory:()=>(importScripts(it),async e=>({formatted:await self.sqlFormatter.format(e,{linesBetweenQueries:2}),cursorOffset:0}))},compiler:{url:at+`sql-wasm.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-sql-compiler.js}}`),self.createSqlCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-sql-script.js}}`],scriptType:Jo,compiledCodeLanguage:`json`},extensions:[`sql`,`sqlite`,`sqlite3`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`sql.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{sql:e}=await import(k+`codemirror-lang-sql.js`);return{sql:e}},[],import.meta.url)).sql()}}}})),Zo=e((()=>{Xo()})),Qo,$o=e((()=>{W(),R(),B(),Qo={name:`stencil`,title:`Stencil`,formatter:{prettier:{name:`babel-ts`,pluginUrls:[z.babel,z.html]}},compiler:{url:ot,factory:()=>async(e,{config:t})=>(await window.stencil.transpile(e,{sourceMap:!1,target:`es2019`,...V(`stencil`,t)})).code,types:{"@stencil/core":{url:O+`types/stencil-core.d.ts`,declareAsModule:!1}}},extensions:[`stencil.tsx`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}}})),es=e((()=>{$o()})),ts,ns=e((()=>{R(),ts={name:`stylis`,title:`Stylis`,compiler:{url:st,factory:()=>async e=>{let{compile:t,serialize:n,stringify:r,middleware:i,prefixer:a}=window.stylis;return n(t(e),i([a,r]))}},extensions:[`stylis`],editor:`style`,editorLanguage:`scss`}})),rs=e((()=>{ns()})),is,as=e((()=>{J(),R(),n(),is={name:`stylus`,title:`Stylus`,compiler:{url:O+`stylus/stylus.min.js`,factory:()=>async e=>window.stylus.render(e)},extensions:[`styl`],editor:`style`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{stylus:e}=await import(k+`codemirror-lang-stylus.js`);return{stylus:e}},[],import.meta.url)).stylus)}}}})),os=e((()=>{as()})),ss,cs=e((()=>{W(),R(),B(),ss={name:`sucrase`,title:`Sucrase`,formatter:{prettier:{name:`babel`,pluginUrls:[z.babel,z.html]}},compiler:{url:O+`sucrase/sucrase.js`,factory:()=>async(e,{config:t})=>window.sucrase.transform(e,{transforms:[`jsx`,`typescript`],...V(`sucrase`,t)}).code},extensions:[`sucrase`],editor:`script`,editorLanguage:`typescript`,editorSupport:{compilerOptions:{jsx:4}}}})),ls=e((()=>{cs()})),us,X,ds,fs=e((()=>{R(),B(),n(),us=O+`vue-compiler-sfc/vue-compiler-sfc.js`,X={name:`vue`,title:`Vue`,longTitle:`Vue SFC`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:us,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue-compiler.js}}`),self.createVueCompiler()),imports:{vue:pt,"livecodes/vue":mt}},extensions:[`vue`,`vue3`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`vue.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{vue:e}=await import(k+`codemirror-lang-vue.js`);return{vue:e}},[],import.meta.url)).vue()},codejar:{language:`html`},compilerOptions:{jsx:1,jsxFactory:`h`,jsxFragmentFactory:`Fragment`}}},ds={...X,name:`vue-app`,compiler:`vue`,extensions:[`app.vue`],editor:`markup`,editorSupport:{...X.editorSupport,monaco:{language:`vue`}}}})),ps,ms,hs=e((()=>{$n(),R(),B(),fs(),n(),ps={name:`svelte`,title:`Svelte`,formatter:{prettier:{name:`html`,pluginUrls:[z.html,z.babel]}},compiler:{url:I+`compiler/index.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-svelte-compiler.js}}`),self.createSvelteCompiler()),imports:{"#client/constants":I+`src/internal/client/constants.js`,"#compiler/builders":I+`src/compiler/utils/builders.js`,svelte:I+`src/index-client.js`,"svelte/animate":I+`src/animate/index.js`,"svelte/attachments":I+`src/attachments/index.js`,"svelte/easing":I+`src/easing/index.js`,"svelte/internal":I+`src/internal/index.js`,"svelte/internal/client":I+`src/internal/client/index.js`,"svelte/internal/disclose-version":I+`src/internal/disclose-version.js`,"svelte/internal/flags/legacy":I+`src/internal/flags/legacy.js`,"svelte/internal/flags/tracing":I+`src/internal/flags/tracing.js`,"svelte/internal/server":I+`src/internal/server/index.js`,"svelte/legacy":I+`src/legacy/legacy-client.js`,"svelte/motion":I+`src/motion/index.js`,"svelte/reactivity":I+`src/reactivity/index-client.js`,"svelte/reactivity/window":I+`src/reactivity/window/index.js`,"svelte/server":I+`src/server/index.js`,"svelte/store":I+`src/store/index-client.js`,"svelte/transition":I+`src/transition/index.js`,"svelte/events":I+`src/events/index.js`,clsx:E.getModuleUrl(`clsx`),"esm-env":E.getModuleUrl(`esm-env`)},inlineScript:`globalThis.process = { env: { NODE_ENV: "production" } };`},extensions:[`svelte`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`svelte.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{svelte:e}=await import(k+`codemirror-lang-svelte.js`);return{svelte:e}},[],import.meta.url)).svelte()},codejar:{language:`html`}}},ms={...ps,name:`svelte-app`,compiler:`svelte`,extensions:[`app.svelte`],editor:`markup`,editorSupport:{...X.editorSupport,monaco:{language:`svelte`}}}})),gs=e((()=>{hs()})),_s,vs=e((()=>{J(),R(),n(),_s={name:`tcl`,title:`Tcl`,compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[tt,e+`{{hash:lang-tcl-script.js}}`],scriptType:`text/tcl`,compiledCodeLanguage:`tcl`},extensions:[`tcl`],editor:`script`,editorSupport:{codemirror:{languageSupport:async()=>K((await r(async()=>{let{tcl:e}=await import(k+`codemirror-lang-tcl.js`);return{tcl:e}},[],import.meta.url)).tcl)}}}})),ys=e((()=>{vs()})),bs,xs=e((()=>{R(),Ui(),bs={name:`teal`,title:`Teal`,formatter:Bi,compiler:{url:j,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-teal-compiler.js}}`),self.createTealCompiler()),scripts:[j],scriptType:`application/lua`,compiledCodeLanguage:`lua`},extensions:[`tl`],editor:`script`,editorLanguage:`lua`}})),Ss=e((()=>{xs()})),Cs,ws=e((()=>{R(),B(),Cs={name:`twig`,title:`Twig`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:ct,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-twig-compiler.js}}`),self.createTwigCompiler())},extensions:[`twig`],editor:`markup`,editorLanguage:`html`}})),Ts=e((()=>{ws()})),Es,Ds=e((()=>{R(),B(),Es={name:`vento`,title:`Vento`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{url:O+`vento/vento.js`,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vento-compiler.js}}`),self.createVentoCompiler())},extensions:[`vto`,`vento`],editor:`markup`,editorLanguage:`html`}})),Os=e((()=>{Ds()})),ks=e((()=>{fs()})),As,js,Ms=e((()=>{R(),B(),As=ht+`vue2-sfc-loader.js`,js={name:`vue2`,title:`Vue 2`,longTitle:`Vue 2 SFC`,formatter:{prettier:{name:`html`,pluginUrls:[z.html]}},compiler:{factory:(e,t)=>(self.importScripts(t+`{{hash:lang-vue2-compiler.js}}`),self.createVue2Compiler()),scripts:[ft,As],imports:{vue:ft+`/dist/vue.runtime.esm-browser.prod.js`}},extensions:[`vue2`],editor:`script`,editorLanguage:`html`}})),Ns=e((()=>{Ms()})),Ps,Fs,Is,Ls=e((()=>{R(),n(),Ps=O+`wast-refmt/wast-refmt.js`,Fs=`application/wasm-uint8`,Is={name:`wat`,title:`WAT`,longTitle:`WebAssembly Text`,formatter:{factory:()=>(importScripts(Ps),async e=>{let t=e;try{t=self.wastRefmt.format(e)}catch(e){console.warn(`failed parsing WAT`,e)}return{formatted:t,cursorOffset:0}})},compiler:{url:gt,factory:(e,t)=>(self.importScripts(t+`{{hash:lang-wat-compiler.js}}`),self.createWatCompiler()),scripts:({baseUrl:e})=>[e+`{{hash:lang-wat-script.js}}`],scriptType:Fs,compiledCodeLanguage:`Binary`},extensions:[`wat`,`wast`,`webassembly`,`wasm`],editor:`script`,editorSupport:{monaco:{languageSupport:M+`wat.js`},codemirror:{languageSupport:async()=>(await r(async()=>{let{wast:e}=await import(k+`codemirror-lang-wast.js`);return{wast:e}},[],import.meta.url)).wast()},codejar:{language:`wasm`}}}})),Rs=e((()=>{Ls()})),Z,zs=e((()=>{bt(),wt(),Ot(),Mt(),It(),zt(),Ht(),Kt(),Yt(),cr(),dr(),ar(),hr(),vr(),xr(),wr(),Or(),jr(),Pr(),Lr(),Br(),Ur(),Kr(),Yr(),Qr(),ti(),ai(),ci(),di(),mi(),_i(),xi(),Ei(),ki(),Mi(),Fi(),Ri(),Ui(),Ki(),Yi(),Qi(),na(),aa(),ca(),da(),ha(),va(),xa(),wa(),Da(),ja(),Pa(),La(),Ha(),Ga(),Ja(),$a(),uo(),yo(),go(),So(),Do(),jo(),Po(),Lo(),Ho(),qo(),Zo(),es(),rs(),os(),ls(),gs(),ys(),Ss(),Ts(),io(),Os(),ks(),Ns(),Rs(),Z=[oi,Xi,ea,At,Fa,St,$r,la,ri,Mr,Fr,pa,Ni,kr,Cs,Es,vt,yi,Lt,oa,Er,bo,Sr,Bo,Ro,Ai,is,ts,hi,no,Vr,Pt,ss,Si,wi,Ya,Za,oo,co,X,js,ds,ps,ms,Qo,Uo,Go,To,qi,lr,Ii,Wt,qt,li,mo,_o,ga,Ba,Ua,Ka,ko,Mo,qr,Xr,Sa,Ta,pr,gr,fi,yr,ya,Vi,Wi,bs,Rr,Di,Fo,rr,or,Wr,_s,Et,Is,Yo,ka,Ma,ra,Bt]})),Bs=e((()=>{zs(),On(),window.deps={translateString:(e,t)=>t,languages:Z,processors:Dn}})),Vs,Hs=e((()=>{Vs={title:`Untitled Project`,description:``,head:`<meta charset="UTF-8" />
...
`}}})),kc,Ac,jc,Mc=e((()=>{R(),kc=He+`build/packages/plinth/src/plinth/`,Ac=He+`build/dev/javascript/plinth/plinth/`,jc={name:`gleam`,title:window.deps.translateString(`templates.starter.gleam`,`Gleam Starter`),thumbnail:`assets/templates/gleam.svg`,activeEditor:`script`,markup:{language:`html`,content:`<div class="container">
  <h1 id="title">Hello, World!</h1>
