...
`.trimStart()}};var j={name:"preact",title:"Preact Starter",thumbnail:"assets/templates/preact.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app"></div>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var R={name:"reason",title:"Reason Starter",thumbnail:"assets/templates/reason.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var $={name:"riot",title:"Riot.js Starter",thumbnail:"assets/templates/riot.svg",activeEditor:"script",markup:{language:"html",content:`
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`.trimStart()}};var ft=["esm.sh","skypack","jspm"],vt=["jsdelivr","fastly.jsdelivr","unpkg"],yt=["jsdelivr.gh","fastly.jsdelivr.gh","statically"],o={getModuleUrl:(t,{isModule:e=!0,defaultCDN:n="esm.sh"}={})=>{t=t.replace(/#nobundle/g,"");let s=bt(t,e,n);return s||(e?"https://esm.sh/"+t:"https://cdn.jsdelivr.net/npm/"+t)},getUrl:(t,e)=>t.startsWith("http")||t.startsWith("data:")?t:bt(t,!1,e||wt())||t,cdnLists:{npm:vt,module:ft,gh:yt},checkCDNs:async(t,e)=>{let n=[e,...o.cdnLists.npm].filter(Boolean);for(let s of n)try{if((await fetch(o.getUrl(t,s),{method:"HEAD"})).ok)return s}catch{}return o.cdnLists.npm[0]}},wt=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get("appCDN")||o.cdnLists.npm[0]}catch{return o.cdnLists.npm[0]}},bt=(t,e,n)=>{let s=e&&t.startsWith("unpkg:")?"?module":"";t.startsWith("gh:")?t=t.replace("gh",yt[0]):t.includes(":")||(t=(n||(e?ft[0]:vt[0]))+":"+t);for(let a of _t){let[c,kt]=a;if(c.test(t))return t.replace(c,kt)+s}return null},_t=[[/^(jspm:)(.+)/i,"https://jspm.dev/$2"],[/^(npm:)(.+)/i,"https://esm.sh/$2"],[/^(node:)(.+)/i,"https://esm.sh/$2"],[/^(jsr:)(.+)/i,"https://esm.sh/jsr/$2"],[/^(skypack:)(.+)/i,"https://cdn.skypack.dev/$2"],[/^(jsdelivr:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2"],[/^(fastly.jsdelivr:)(.+)/i,"https://fastly.jsdelivr.net/npm/$2"],[/^(jsdelivr.gh:)(.+)/i,"https://cdn.jsdelivr.net/gh/$2"],[/^(fastly.jsdelivr.gh:)(.+)/i,"https://fastly.jsdelivr.net/gh/$2"],[/^(statically:)(.+)/i,"https://cdn.statically.io/gh/$2"],[/^(esm.run:)(.+)/i,"https://esm.run/$2"],[/^(esm.sh:)(.+)/i,"https://esm.sh/$2"],[/^(esbuild:)(.+)/i,"https://esbuild.vercel.app/$2"],[/^(bundle.run:)(.+)/i,"https://bundle.run/$2"],[/^(unpkg:)(.+)/i,"https://unpkg.com/$2"],[/^(bundlejs:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(bundle:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(deno:)(.+)/i,"https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts"],[/^(https:\/\/deno\.land\/.+)/i,"https://deno.bundlejs.com/?file&q=$1"],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,"https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4"],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3"],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3"],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,"https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3"]];var{getUrl:xt,getModuleUrl:Be}=o;var r=xt("gh:live-codes/gleam-precompiled@v0.2.0/");var Tt="0.6.64",$e=xt(`malinajs@${Tt}/malina.js`);var i=r+"build/packages/plinth/src/plinth/",l=r+"build/dev/javascript/plinth/plinth/",St={name:"gleam",title:"Gleam Starter",thumbnail:"assets/templates/gleam.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},customSettings:{imports:{"my_pkg/greet.js":r+"demo/greet.js"},gleam:{modules:{"plinth/browser/document":{srcUrl:i+"browser/document.gleam",compiledUrl:l+"browser/document.mjs"},"plinth/browser/element":{srcUrl:i+"browser/element.gleam",compiledUrl:l+"browser/element.mjs"},"plinth/browser/event":{srcUrl:i+"browser/event.gleam",compiledUrl:l+"browser/event.mjs"}}}}};var Xs=[g,rt,A,q,E,I,z,m,j,W,N,gt,D,w,u,$,V,y,d,x,ot,nt,b,O,f,S,it,tt,st,M,R,B,U,C,at,H,pt,v,T,dt,F,Z,_,k,ut,ct,lt,J,P,G,mt,St,K,L,p,X,Y,ht,Q,h,et];export{Xs as starterTemplates};
