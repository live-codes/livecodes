var m={name:"angular",title:"Angular Starter",thumbnail:"assets/templates/angular.svg",activeEditor:"script",markup:{language:"html",content:`<app>Loading...</app>
...
`.trimStart()},customSettings:{typescript:{experimentalDecorators:!0}}};var p={name:"assemblyscript",title:"AssemblyScript Starter",thumbnail:"assets/templates/assemblyscript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var u={name:"astro",title:"Astro Starter",thumbnail:"assets/templates/astro.svg",activeEditor:"markup",markup:{language:"astro",content:`
---
...
`.trimStart()},style:{language:"css",content:""},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var d={name:"backbone",title:"Backbone Starter",thumbnail:"assets/templates/backbone.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:["https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js","https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js","https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.3.3/backbone-min.js"],cssPreset:"",imports:{},types:{}};var g={name:"blank",title:"Blank Project",thumbnail:"assets/templates/blank.svg",activeEditor:"markup",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var h={name:"blockly",title:"Blockly Starter",thumbnail:"assets/templates/blockly.svg",activeEditor:"script",markup:{language:"html",content:`
<xml
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var b={name:"bootstrap",title:"Bootstrap Starter",thumbnail:"assets/templates/bootstrap.svg",activeEditor:"markup",markup:{language:"html",content:`
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/css/bootstrap.min.css"],scripts:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"],cssPreset:"",imports:{},types:{}};var f={name:"coffeescript",title:"CoffeeScript Starter",thumbnail:"assets/templates/coffeescript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var v={name:"go",title:"Go Starter",thumbnail:"assets/templates/go.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var y={name:"jquery",title:"jQuery Starter",thumbnail:"assets/templates/jquery.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var x={name:"knockout",title:"Knockout Starter",thumbnail:"assets/templates/knockout.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var S={name:"livescript",title:"LiveScript Starter",thumbnail:"assets/templates/livescript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var k={name:"lua",title:"Lua Starter",thumbnail:"assets/templates/lua.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var w={name:"mdx",title:"MDX Starter",thumbnail:"assets/templates/mdx.svg",activeEditor:"markup",markup:{language:"mdx",content:`
...
`.trimStart()}};var _={name:"perl",title:"Perl Starter",thumbnail:"assets/templates/perl.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var j={name:"php",title:"PHP Starter",thumbnail:"assets/templates/php.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">world</span>!</h1>
...
`.trimStart()}};var T={name:"preact",title:"Preact Starter",thumbnail:"assets/templates/preact.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app"></div>
...
`.trimStart()}};var U={name:"python",title:"Python Starter",thumbnail:"assets/templates/python.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
if current_time < 12 :
      ...
      print('Good evening')
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var E={name:"react-native",title:"React Native Starter",thumbnail:"assets/templates/react.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"react-native",content:`
import { useState } from "react";
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var q={name:"react",title:"React Starter",thumbnail:"assets/templates/react.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var L={name:"markdown",title:"Markdown Starter",thumbnail:"assets/templates/markdown.svg",activeEditor:"markup",markup:{language:"markdown",content:`
# Project Title
...
`},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var $={name:"rescript",title:"ReScript Starter",thumbnail:"assets/templates/rescript.png",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var M={name:"reason",title:"Reason Starter",thumbnail:"assets/templates/reason.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
Js.log("Hello, Reason!");
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var B={name:"ocaml",title:"Ocaml Starter",thumbnail:"assets/templates/ocaml.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var R={name:"riot",title:"Riot.js Starter",thumbnail:"assets/templates/riot.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var H={name:"ruby",title:"Ruby Starter",thumbnail:"assets/templates/ruby.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var P={name:"scheme",title:"Scheme Starter",thumbnail:"assets/templates/scheme.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
(let ((time-now (date-hour (current-date))))
  (console-log
    (cond ((< time-now 12) "Good morning")
          ...
          (else "Good evening"))))
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var N={name:"solid",title:"Solid Starter",thumbnail:"assets/templates/solid.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var Y={name:"sql",title:"SQL Starter",thumbnail:"assets/templates/sqlite.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="output">
  <details open>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`.trimStart()}};var D={name:"stencil",title:"Stencil Starter",thumbnail:"assets/templates/stencil.png",activeEditor:"script",markup:{language:"html",content:`<my-app title="Stencil"></my-app>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var W={name:"svelte",title:"Svelte Starter",thumbnail:"assets/templates/svelte.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"svelte",content:`
<script>
  let title = "Svelte";
  let counter = 0;
  function increment() {
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var O={name:"tailwindcss",title:"Tailwind CSS Starter",thumbnail:"assets/templates/tailwindcss.svg",activeEditor:"markup",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var I={name:"vue",title:"Vue 3 SFC Starter",thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"vue",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var z={name:"vue2",title:"Vue 2 Starter",thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="app">
  <h1>Hello, Vue!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/vue.svg" />
  <p>You clicked {{ counter }} times.</p>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var V={name:"malina",title:"Malina.js Starter",thumbnail:"assets/templates/malina.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"malina",content:`
<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var G={name:"commonlisp",title:"Common Lisp Starter",thumbnail:"assets/templates/commonlisp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var F={name:"cpp",title:"C++ Starter",thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var J={name:"julia",title:"Julia Starter",thumbnail:"assets/templates/julia.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`.trimStart()}};var K={name:"tcl",title:"Tcl Starter",thumbnail:"assets/templates/tcl.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
puts $count
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var Q={name:"prolog",title:"Prolog Starter",thumbnail:"assets/templates/tau-prolog.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
ancestor(X, Y):- parent(X, Z),
    ancestor(Z, Y).
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var tt={name:"clio",title:"Clio Starter",thumbnail:"assets/templates/clio.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var et={name:"diagrams",title:"Diagrams Starter",thumbnail:"assets/templates/diagrams.svg",activeEditor:"markup",markup:{language:"diagrams",contentUrl:"{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html"},style:{language:"css",content:`
.container {
  display: flex;
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var st={name:"imba",title:"Imba Starter",thumbnail:"assets/templates/imba.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"imba",content:`
tag app-counter
	prop name = "Imba"
	prop count = 0
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var ot={name:"jest",title:"Jest Starter",thumbnail:"assets/templates/jest.svg",autotest:!0,activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var nt={name:"jest-react",title:"Jest/React Starter",thumbnail:"assets/templates/jest.svg",activeEditor:"script",autotest:!0,markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var rt={name:"javascript",title:"JavaScript Starter",thumbnail:"assets/templates/javascript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var at={name:"r",title:"R Starter",thumbnail:"assets/templates/r.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var it={name:"civet",title:"Civet Starter",thumbnail:"assets/templates/civet.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var lt={name:"fennel",title:"Fennel Starter",thumbnail:"assets/templates/fennel.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var ct={name:"teal",title:"Teal Starter",thumbnail:"assets/templates/teal.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var mt={name:"clojurescript",title:"ClojureScript Starter",thumbnail:"assets/templates/cljs.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()}};var pt={name:"ruby-wasm",title:"Ruby (Wasm) Starter",thumbnail:"assets/templates/ruby.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/ruby.svg" />
  <p id="counter">You clicked 0 times.</p>
...
`.trimStart()}};var ut={name:"lua-wasm",title:"Lua (Wasm) Starter",thumbnail:"assets/templates/lua.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/lua.svg" />
  <p id="counter">You clicked 0 times.</p>
...
`.trimStart()}};var dt={name:"php-wasm",title:"PHP (Wasm) Starter",thumbnail:"assets/templates/php.svg",activeEditor:"script",markup:{language:"html",content:`
<p>
  <h1>Hello, <span id="title">world</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/php.svg" />
</p>
...
`.trimStart()}};var gt={name:"lit",title:"Lit Starter",thumbnail:"assets/templates/lit.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},customSettings:{typescript:{experimentalDecorators:!0,useDefineForClassFields:!1}}};var ht={name:"postgresql",title:"PostgreSQL Starter",thumbnail:"assets/templates/postgresql.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="output">
  <details open>
    <summary>Tables</summary>
    <div id="tables"></div>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`.trimStart()}};var ft=["esm.sh","skypack","esm.run","jsdelivr.esm","fastly.jsdelivr.esm","gcore.jsdelivr.esm","testingcf.jsdelivr.esm","jsdelivr.b-cdn.esm","jspm"],vt=["jsdelivr","fastly.jsdelivr","unpkg","gcore.jsdelivr","testingcf.jsdelivr","jsdelivr.b-cdn","npmcdn"],yt=["jsdelivr.gh","fastly.jsdelivr.gh","statically","gcore.jsdelivr.gh","testingcf.jsdelivr.gh","jsdelivr.b-cdn.gh"],o={getModuleUrl:(t,{isModule:e=!0,defaultCDN:n="esm.sh"}={})=>{t=t.replace(/#nobundle/g,"");let s=bt(t,e,n);return s||(e?"https://esm.sh/"+t:"https://cdn.jsdelivr.net/npm/"+t)},getUrl:(t,e)=>t.startsWith("http")||t.startsWith("data:")?t:bt(t,!1,e||kt())||t,cdnLists:{npm:vt,module:ft,gh:yt},checkCDNs:async(t,e)=>{let n=[e,...o.cdnLists.npm].filter(Boolean);for(let s of n)try{if((await fetch(o.getUrl(t,s),{method:"HEAD"})).ok)return s}catch{}return o.cdnLists.npm[0]}},kt=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get("appCDN")||o.cdnLists.npm[0]}catch{return o.cdnLists.npm[0]}},bt=(t,e,n)=>{let s=e&&t.startsWith("unpkg:")?"?module":"";t.startsWith("gh:")?t=t.replace("gh",yt[0]):t.includes(":")||(t=(n||(e?ft[0]:vt[0]))+":"+t);for(let a of wt){let[c,St]=a;if(c.test(t))return t.replace(c,St)+s}return null},wt=[[/^(esm\.sh:)(.+)/i,"https://esm.sh/$2"],[/^(npm:)(.+)/i,"https://esm.sh/$2"],[/^(node:)(.+)/i,"https://esm.sh/$2"],[/^(jsr:)(.+)/i,"https://esm.sh/jsr/$2"],[/^(skypack:)(.+)/i,"https://cdn.skypack.dev/$2"],[/^(jsdelivr:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2"],[/^(fastly\.jsdelivr:)(.+)/i,"https://fastly.jsdelivr.net/npm/$2"],[/^(gcore\.jsdelivr:)(.+)/i,"https://gcore.jsdelivr.net/npm/$2"],[/^(testingcf\.jsdelivr:)(.+)/i,"https://testingcf.jsdelivr.net/npm/$2"],[/^(jsdelivr\.b-cdn:)(.+)/i,"https://jsdelivr.b-cdn.net/npm/$2"],[/^(jsdelivr\.gh:)(.+)/i,"https://cdn.jsdelivr.net/gh/$2"],[/^(fastly\.jsdelivr\.gh:)(.+)/i,"https://fastly.jsdelivr.net/gh/$2"],[/^(gcore\.jsdelivr\.gh:)(.+)/i,"https://gcore.jsdelivr.net/gh/$2"],[/^(testingcf\.jsdelivr\.gh:)(.+)/i,"https://testingcf.jsdelivr.net/gh/$2"],[/^(jsdelivr\.b-cdn\.gh:)(.+)/i,"https://jsdelivr.b-cdn.net/gh/$2"],[/^(statically:)(.+)/i,"https://cdn.statically.io/gh/$2"],[/^(esm\.run:)(.+)/i,"https://esm.run/$2"],[/^(jsdelivr\.esm:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2/+esm"],[/^(fastly\.jsdelivr\.esm:)(.+)/i,"https://fastly.jsdelivr.net/npm/$2/+esm"],[/^(gcore\.jsdelivr\.esm:)(.+)/i,"https://gcore.jsdelivr.net/npm/$2/+esm"],[/^(testingcf\.jsdelivr\.esm:)(.+)/i,"https://testingcf.jsdelivr.net/npm/$2/+esm"],[/^(jsdelivr\.b-cdn\.esm:)(.+)/i,"https://jsdelivr.b-cdn.net/npm/$2/+esm"],[/^(jspm:)(.+)/i,"https://jspm.dev/$2"],[/^(esbuild:)(.+)/i,"https://esbuild.vercel.app/$2"],[/^(bundle\.run:)(.+)/i,"https://bundle.run/$2"],[/^(unpkg:)(.+)/i,"https://unpkg.com/$2"],[/^(npmcdn:)(.+)/i,"https://npmcdn.com/$2"],[/^(bundlejs:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(bundle:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(deno:)(.+)/i,"https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts"],[/^(https:\/\/deno\.land\/.+)/i,"https://deno.bundlejs.com/?file&q=$1"],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,"https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4"],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3"],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3"],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,"https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3"]];var{getUrl:_t,getModuleUrl:Me}=o;var r=_t("gh:live-codes/gleam-precompiled@v0.5.0/");var i=r+"build/packages/plinth/src/plinth/",l=r+"build/dev/javascript/plinth/plinth/",xt={name:"gleam",title:"Gleam Starter",thumbnail:"assets/templates/gleam.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},customSettings:{imports:{"my_pkg/greet.js":r+"demo/greet.js"},gleam:{modules:{"plinth/browser/document":{srcUrl:i+"browser/document.gleam",compiledUrl:l+"browser/document.mjs"},"plinth/browser/element":{srcUrl:i+"browser/element.gleam",compiledUrl:l+"browser/element.mjs"},"plinth/browser/event":{srcUrl:i+"browser/event.gleam",compiledUrl:l+"browser/event.mjs"}}}}};var Is=[g,rt,A,q,E,I,z,m,T,W,N,gt,D,w,u,R,V,y,d,x,ot,nt,b,O,f,S,it,tt,st,$,M,B,U,C,at,H,pt,v,j,dt,F,Z,_,k,ut,ct,lt,J,P,G,mt,xt,K,L,p,X,Y,ht,Q,h,et];export{Is as starterTemplates};
