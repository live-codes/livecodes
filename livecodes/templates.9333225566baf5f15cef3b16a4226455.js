...
`.trimStart()},stylesheets:[],scripts:["{{ __CDN_URL__ }}vue@2"],cssPreset:"",imports:{},types:{}};var A={name:"wat",title:"WebAssembly Text Starter",thumbnail:"assets/templates/webassembly.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var B={name:"malina",title:"Malina.js Starter",thumbnail:"assets/templates/malina.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"malina",content:`
<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var $={name:"commonlisp",title:"Common Lisp Starter",thumbnail:"assets/templates/commonlisp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var W={name:"cpp",title:"C++ Starter",thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
ancestor(X, Y):- parent(X, Z),
    ancestor(Z, Y).
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var X={name:"clio",title:"Clio Starter",thumbnail:"assets/templates/clio.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var z={name:"diagrams",title:"Diagrams Starter",thumbnail:"assets/templates/diagrams.svg",activeEditor:"markup",markup:{language:"diagrams",contentUrl:"{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html"},style:{language:"css",content:`
.container {
  display: flex;
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var D={name:"imba",title:"Imba Starter",thumbnail:"assets/templates/imba.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"imba",content:`
tag app-counter
	prop name = "Imba"
	prop count = 0
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var J={name:"javascript",title:"JavaScript Starter",thumbnail:"assets/templates/javascript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var F={name:"r",title:"R Starter",thumbnail:"assets/templates/r.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()}};var dn=[s,J,P,S,v,M,Y,t,b,H,q,j,d,n,T,B,c,o,m,V,G,a,R,i,p,Z,X,D,k,_,w,y,f,F,C,et,l,h,ot,W,I,g,u,nt,Q,K,U,E,$,tt,N,x,e,A,L,O,r,z];export{dn as starterTemplates};
