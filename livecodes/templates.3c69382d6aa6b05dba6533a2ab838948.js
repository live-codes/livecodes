var m={name:"angular",title:window.deps.translateString("templates.starter.angular","Angular Starter"),thumbnail:"assets/templates/angular.svg",activeEditor:"script",markup:{language:"html",content:`<app>Loading...</app>
...
`.trimStart()},customSettings:{typescript:{experimentalDecorators:!0}}};var p={name:"assemblyscript",title:window.deps.translateString("templates.starter.assemblyscript","AssemblyScript Starter"),thumbnail:"assets/templates/assemblyscript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var d={name:"astro",title:window.deps.translateString("templates.starter.astro","Astro Starter"),thumbnail:"assets/templates/astro.svg",activeEditor:"markup",markup:{language:"astro",content:`
---
...
`.trimStart()},style:{language:"css",content:""},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var u={name:"backbone",title:window.deps.translateString("templates.starter.backbone","Backbone Starter"),thumbnail:"assets/templates/backbone.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:["https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js","https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js","https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.3.3/backbone-min.js"],cssPreset:"",imports:{},types:{}};var g={name:"blank",title:window.deps.translateString("templates.starter.blank","Blank Project"),thumbnail:"assets/templates/blank.svg",activeEditor:"markup",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var h={name:"blockly",title:window.deps.translateString("templates.starter.blockly","Blockly Starter"),thumbnail:"assets/templates/blockly.svg",activeEditor:"script",markup:{language:"html",content:`
<xml
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var b={name:"bootstrap",title:window.deps.translateString("templates.starter.bootstrap","Bootstrap Starter"),thumbnail:"assets/templates/bootstrap.svg",activeEditor:"markup",markup:{language:"html",content:`
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/css/bootstrap.min.css"],scripts:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"],cssPreset:"",imports:{},types:{}};var f={name:"coffeescript",title:window.deps.translateString("templates.starter.coffeescript","CoffeeScript Starter"),thumbnail:"assets/templates/coffeescript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var v={name:"go",title:window.deps.translateString("templates.starter.go","Go Starter"),thumbnail:"assets/templates/go.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var y={name:"jquery",title:window.deps.translateString("templates.starter.jquery","jQuery Starter"),thumbnail:"assets/templates/jquery.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var x={name:"knockout",title:window.deps.translateString("templates.starter.knockout","Knockout Starter"),thumbnail:"assets/templates/knockout.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var S={name:"livescript",title:window.deps.translateString("templates.starter.livescript","LiveScript Starter"),thumbnail:"assets/templates/livescript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var w={name:"lua",title:window.deps.translateString("templates.starter.lua","Lua Starter"),thumbnail:"assets/templates/lua.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var k={name:"mdx",title:window.deps.translateString("templates.starter.mdx","MDX Starter"),thumbnail:"assets/templates/mdx.svg",activeEditor:"markup",markup:{language:"mdx",content:`
...
`.trimStart()}};var _={name:"perl",title:window.deps.translateString("templates.starter.perl","Perl Starter"),thumbnail:"assets/templates/perl.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var j={name:"php",title:window.deps.translateString("templates.starter.php","PHP Starter"),thumbnail:"assets/templates/php.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">world</span>!</h1>
...
`.trimStart()}};var T={name:"preact",title:window.deps.translateString("templates.starter.preact","Preact Starter"),thumbnail:"assets/templates/preact.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app"></div>
...
`.trimStart()}};var C={name:"python-wasm",aliases:["pyodide"],title:"Python (Wasm) Starter",thumbnail:"assets/templates/python.svg",activeEditor:"script",markup:{language:"html",content:`
...
plt.close("all")
`.trimStart()}};var U={name:"python",title:window.deps.translateString("templates.starter.python","Python Starter"),thumbnail:"assets/templates/python.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
if current_time < 12 :
      ...
      print('Good evening')
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var E={name:"react-native",title:window.deps.translateString("templates.starter.react-native","React Native Starter"),thumbnail:"assets/templates/react.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"react-native",content:`
...
`.trimStart()},customSettings:{imports:{react:"https://esm.sh/react@18.3.1","react/":"https://esm.sh/react@18.3.1/","react-dom":"https://esm.sh/react-dom@18.3.1"}}};var q={name:"react",title:window.deps.translateString("templates.starter.react","React Starter"),thumbnail:"assets/templates/react.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var L={name:"markdown",title:window.deps.translateString("templates.starter.markdown","Markdown Starter"),thumbnail:"assets/templates/markdown.svg",activeEditor:"markup",markup:{language:"markdown",content:`
# Project Title
...
`},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var M={name:"rescript",title:window.deps.translateString("templates.starter.rescript","ReScript Starter"),thumbnail:"assets/templates/rescript.png",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var B={name:"reason",title:window.deps.translateString("templates.starter.reason","Reason Starter"),thumbnail:"assets/templates/reason.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
Js.log("Hello, Reason!");
`.trimStart()},customSettings:{imports:{react:"https://esm.sh/react@18.3.1","react/":"https://esm.sh/react@18.3.1/","react-dom":"https://esm.sh/react-dom@18.3.1"}}};var $={name:"ocaml",title:window.deps.translateString("templates.starter.ocaml","Ocaml Starter"),thumbnail:"assets/templates/ocaml.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
...
`.trimStart()},customSettings:{imports:{react:"https://esm.sh/react@18.3.1","react/":"https://esm.sh/react@18.3.1/","react-dom":"https://esm.sh/react-dom@18.3.1"}}};var R={name:"riot",title:window.deps.translateString("templates.starter.riot","Riot.js Starter"),thumbnail:"assets/templates/riot.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var P={name:"ruby",title:window.deps.translateString("templates.starter.ruby","Ruby Starter"),thumbnail:"assets/templates/ruby.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var H={name:"scheme",title:window.deps.translateString("templates.starter.scheme","Scheme Starter"),thumbnail:"assets/templates/scheme.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
(let ((time-now (date-hour (current-date))))
  (console-log
    (cond ((< time-now 12) "Good morning")
          ...
          (else "Good evening"))))
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var N={name:"solid",title:window.deps.translateString("templates.starter.solid","Solid Starter"),thumbnail:"assets/templates/solid.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var Y={name:"sql",title:window.deps.translateString("templates.starter.sql","SQL Starter"),thumbnail:"assets/templates/sqlite.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="output">
  <details open>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`.trimStart()}};var D={name:"stencil",title:window.deps.translateString("templates.starter.stencil","Stencil Starter"),thumbnail:"assets/templates/stencil.png",activeEditor:"script",markup:{language:"html",content:`<my-app title="Stencil"></my-app>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var O={name:"svelte",title:window.deps.translateString("templates.starter.svelte","Svelte Starter"),thumbnail:"assets/templates/svelte.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"svelte",content:`
<script>
  let title = "Svelte";
  let counter = $state(0);
  function increment() {
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var W={name:"tailwindcss",title:window.deps.translateString("templates.starter.tailwindcss","Tailwind CSS Starter"),thumbnail:"assets/templates/tailwindcss.svg",activeEditor:"markup",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var I={name:"vue",title:window.deps.translateString("templates.starter.vue","Vue 3 SFC Starter"),thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"vue",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var z={name:"vue2",title:window.deps.translateString("templates.starter.vue2","Vue 2 Starter"),thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="app">
  <h1>Hello, Vue!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/vue.svg" />
  <p>You clicked {{ counter }} times.</p>
...
`.trimStart()},stylesheets:[],scripts:["{{ __CDN_URL__ }}vue@2"],cssPreset:"",imports:{},types:{}};var G={name:"wat",title:window.deps.translateString("templates.starter.wat","WebAssembly Text Starter"),thumbnail:"assets/templates/webassembly.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var X={name:"malina",title:window.deps.translateString("templates.starter.malina","Malina.js Starter"),thumbnail:"assets/templates/malina.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"malina",content:`
<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var V={name:"commonlisp",title:window.deps.translateString("templates.starter.commonlisp","Common Lisp Starter"),thumbnail:"assets/templates/commonlisp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var F={name:"cpp",title:window.deps.translateString("templates.starter.cpp","C++ Starter"),thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var J={name:"julia",title:window.deps.translateString("templates.starter.julia","Julia Starter"),thumbnail:"assets/templates/julia.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var Z={name:"cpp-wasm",aliases:["clang"],title:"C++ (Wasm) Starter",thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/cpp.svg" />
  <p>You clicked <span id="counter">0</span> times.</p>
...
`.trimStart()}};var K={name:"tcl",title:window.deps.translateString("templates.starter.tcl","Tcl Starter"),thumbnail:"assets/templates/tcl.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
puts $count
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var Q={name:"prolog",title:window.deps.translateString("templates.starter.prolog","Prolog Starter"),thumbnail:"assets/templates/tau-prolog.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
ancestor(X, Y):- parent(X, Z),
    ancestor(Z, Y).
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var tt={name:"clio",title:window.deps.translateString("templates.starter.clio","Clio Starter"),thumbnail:"assets/templates/clio.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var et={name:"diagrams",title:window.deps.translateString("templates.starter.diagrams","Diagrams Starter"),thumbnail:"assets/templates/diagrams.svg",activeEditor:"markup",markup:{language:"diagrams",contentUrl:"{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html"},style:{language:"css",content:`
.container {
  display: flex;
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var st={name:"imba",title:window.deps.translateString("templates.starter.imba","Imba Starter"),thumbnail:"assets/templates/imba.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"imba",content:`
tag app-counter
	prop name = "Imba"
	prop count = 0
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var ot={name:"jest",title:window.deps.translateString("templates.starter.jest","Jest Starter"),thumbnail:"assets/templates/jest.svg",autotest:!0,activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var rt={name:"jest-react",title:window.deps.translateString("templates.starter.jest-react","Jest/React Starter"),thumbnail:"assets/templates/jest.svg",activeEditor:"script",autotest:!0,markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  text-align: center;
  font: 1em sans-serif;
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var nt={name:"javascript",title:window.deps.translateString("templates.starter.javascript","JavaScript Starter"),thumbnail:"assets/templates/javascript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var at={name:"r",title:window.deps.translateString("templates.starter.r","R Starter"),thumbnail:"assets/templates/r.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var it={name:"civet",title:window.deps.translateString("templates.starter.civet","Civet Starter"),thumbnail:"assets/templates/civet.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var lt={name:"fennel",title:window.deps.translateString("templates.starter.fennel","Fennel Starter"),thumbnail:"assets/templates/fennel.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var ct={name:"teal",title:window.deps.translateString("templates.starter.teal","Teal Starter"),thumbnail:"assets/templates/teal.png",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var mt={name:"clojurescript",title:window.deps.translateString("templates.starter.clojurescript","ClojureScript Starter"),thumbnail:"assets/templates/cljs.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()}};var pt={name:"ruby-wasm",title:window.deps.translateString("templates.starter.ruby-wasm","Ruby (Wasm) Starter"),thumbnail:"assets/templates/ruby.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/ruby.svg" />
  <p id="counter">You clicked 0 times.</p>
...
`.trimStart()}};var dt={name:"lua-wasm",title:window.deps.translateString("templates.starter.lua-wasm","Lua (Wasm) Starter"),thumbnail:"assets/templates/lua.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/lua.svg" />
  <p id="counter">You clicked 0 times.</p>
...
`.trimStart()}};var ut={name:"php-wasm",title:window.deps.translateString("templates.starter.php-wasm","PHP (Wasm) Starter"),thumbnail:"assets/templates/php.svg",activeEditor:"script",markup:{language:"html",content:`
<p>
  <h1>Hello, <span id="title">world</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/php.svg" />
</p>
...
`.trimStart()}};var gt={name:"lit",title:window.deps.translateString("templates.starter.lit","Lit Starter"),thumbnail:"assets/templates/lit.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},customSettings:{typescript:{experimentalDecorators:!0,useDefineForClassFields:!1}}};var ht={name:"postgresql",title:window.deps.translateString("templates.starter.postgresql","PostgreSQL Starter"),thumbnail:"assets/templates/postgresql.svg",activeEditor:"script",markup:{language:"html",content:`
<div id="output">
  <details open>
    <summary>Tables</summary>
    <div id="tables"></div>
...
SELECT a.id, a.rev, a.quote
  FROM (SELECT id, rev, quote,
          ...
          FROM quotes) a
  WHERE a.rank = 1;
`.trimStart()}};var ft=["esm.sh","skypack","esm.run","jsdelivr.esm","fastly.jsdelivr.esm","gcore.jsdelivr.esm","testingcf.jsdelivr.esm","jsdelivr.b-cdn.esm","jspm"],vt=["jsdelivr","fastly.jsdelivr","unpkg","gcore.jsdelivr","testingcf.jsdelivr","jsdelivr.b-cdn","npmcdn"],yt=["jsdelivr.gh","fastly.jsdelivr.gh","statically","gcore.jsdelivr.gh","testingcf.jsdelivr.gh","jsdelivr.b-cdn.gh"],o={getModuleUrl:(t,{isModule:e=!0,defaultCDN:r="esm.sh"}={})=>{t=t.replace(/#nobundle/g,"");let s=bt(t,e,r);return s||(e?"https://esm.sh/"+t:"https://cdn.jsdelivr.net/npm/"+t)},getUrl:(t,e)=>t.startsWith("http")||t.startsWith("data:")?t:bt(t,!1,e||_t())||t,cdnLists:{npm:vt,module:ft,gh:yt},checkCDNs:async(t,e)=>{let r=[e,...o.cdnLists.npm].filter(Boolean);for(let s of r)try{if((await fetch(o.getUrl(t,s),{method:"HEAD"})).ok)return s}catch{}return o.cdnLists.npm[0]}},_t=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get("appCDN")||o.cdnLists.npm[0]}catch{return o.cdnLists.npm[0]}},bt=(t,e,r)=>{let s=e&&t.startsWith("unpkg:")?"?module":"";t.startsWith("gh:")?t=t.replace("gh",yt[0]):t.includes(":")||(t=(r||(e?ft[0]:vt[0]))+":"+t);for(let a of jt){let[c,kt]=a;if(c.test(t))return t.replace(c,kt)+s}return null},jt=[[/^(esm\.sh:)(.+)/i,"https://esm.sh/$2"],[/^(npm:)(.+)/i,"https://esm.sh/$2"],[/^(node:)(.+)/i,"https://esm.sh/$2"],[/^(jsr:)(.+)/i,"https://esm.sh/jsr/$2"],[/^(skypack:)(.+)/i,"https://cdn.skypack.dev/$2"],[/^(jsdelivr:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2"],[/^(fastly\.jsdelivr:)(.+)/i,"https://fastly.jsdelivr.net/npm/$2"],[/^(gcore\.jsdelivr:)(.+)/i,"https://gcore.jsdelivr.net/npm/$2"],[/^(testingcf\.jsdelivr:)(.+)/i,"https://testingcf.jsdelivr.net/npm/$2"],[/^(jsdelivr\.b-cdn:)(.+)/i,"https://jsdelivr.b-cdn.net/npm/$2"],[/^(jsdelivr\.gh:)(.+)/i,"https://cdn.jsdelivr.net/gh/$2"],[/^(fastly\.jsdelivr\.gh:)(.+)/i,"https://fastly.jsdelivr.net/gh/$2"],[/^(gcore\.jsdelivr\.gh:)(.+)/i,"https://gcore.jsdelivr.net/gh/$2"],[/^(testingcf\.jsdelivr\.gh:)(.+)/i,"https://testingcf.jsdelivr.net/gh/$2"],[/^(jsdelivr\.b-cdn\.gh:)(.+)/i,"https://jsdelivr.b-cdn.net/gh/$2"],[/^(statically:)(.+)/i,"https://cdn.statically.io/gh/$2"],[/^(esm\.run:)(.+)/i,"https://esm.run/$2"],[/^(jsdelivr\.esm:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2/+esm"],[/^(fastly\.jsdelivr\.esm:)(.+)/i,"https://fastly.jsdelivr.net/npm/$2/+esm"],[/^(gcore\.jsdelivr\.esm:)(.+)/i,"https://gcore.jsdelivr.net/npm/$2/+esm"],[/^(testingcf\.jsdelivr\.esm:)(.+)/i,"https://testingcf.jsdelivr.net/npm/$2/+esm"],[/^(jsdelivr\.b-cdn\.esm:)(.+)/i,"https://jsdelivr.b-cdn.net/npm/$2/+esm"],[/^(jspm:)(.+)/i,"https://jspm.dev/$2"],[/^(esbuild:)(.+)/i,"https://esbuild.vercel.app/$2"],[/^(bundle\.run:)(.+)/i,"https://bundle.run/$2"],[/^(unpkg:)(.+)/i,"https://unpkg.com/$2"],[/^(npmcdn:)(.+)/i,"https://npmcdn.com/$2"],[/^(bundlejs:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(bundle:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(deno:)(.+)/i,"https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts"],[/^(https:\/\/deno\.land\/.+)/i,"https://deno.bundlejs.com/?file&q=$1"],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,"https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4"],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3"],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3"],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,"https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3"]];var{getUrl:Tt,getModuleUrl:Re}=o;var n=Tt("gh:live-codes/gleam-precompiled@v0.5.0/");var i=n+"build/packages/plinth/src/plinth/",l=n+"build/dev/javascript/plinth/plinth/",xt={name:"gleam",title:window.deps.translateString("templates.starter.gleam","Gleam Starter"),thumbnail:"assets/templates/gleam.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1 id="title">Hello, World!</h1>
...
`.trimStart()},customSettings:{imports:{"my_pkg/greet.js":n+"demo/greet.js"},gleam:{modules:{"plinth/browser/document":{srcUrl:i+"browser/document.gleam",compiledUrl:l+"browser/document.mjs"},"plinth/browser/element":{srcUrl:i+"browser/element.gleam",compiledUrl:l+"browser/element.mjs"},"plinth/browser/event":{srcUrl:i+"browser/event.gleam",compiledUrl:l+"browser/event.mjs"}}}}};var St={name:"phaser",title:"Phaser Starter",thumbnail:"assets/templates/phaser.png",activeEditor:"script",markup:{language:"html",content:`
<div id="app">
...
`.trimStart()}};var wt={name:"d3",title:"D3 Starter",thumbnail:"assets/templates/d3.svg",activeEditor:"script",markup:{language:"html",content:`<div id="chart">Loading...</div>
`},style:{language:"css",content:`
.bar {
  fill: steelblue;
}
...
svg
  ...
  .attr("y", (d, i) => i * 50 + 10)
  .attr("x", 10);
`.trimStart()}};var Js=[g,nt,A,q,E,I,z,m,T,O,N,gt,D,k,d,R,X,y,u,x,ot,rt,b,W,wt,St,f,S,it,tt,st,M,B,$,U,C,at,P,pt,v,j,ut,F,Z,_,w,dt,ct,lt,J,H,V,mt,xt,K,L,p,G,Y,ht,Q,h,et];export{Js as starterTemplates};
