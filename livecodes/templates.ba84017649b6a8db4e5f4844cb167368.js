...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var M={name:"vue",title:"Vue 3 Starter",thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"vue",content:`
<template>
  <div class="container">
    <h1>Hello, Vue!</h1>
...
`.trimStart()}};var on=[s,J,P,S,v,Y,M,t,b,H,q,j,d,n,T,B,c,o,m,V,G,a,R,i,p,Z,X,z,k,_,w,y,f,F,C,l,h,N,$,g,u,Q,K,I,E,U,tt,W,x,e,A,L,O,r,D];export{on as starterTemplates};
