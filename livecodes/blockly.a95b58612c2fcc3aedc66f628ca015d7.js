...
`,m=await N(p,"jsx",t,{},r);c(`<div id="__livecodes_mdx_root__"></div><script type="module">${m}<\/script>`)}),et={name:"mdx",title:"MDX",parser:{name:"markdown",pluginUrls:[o.markdown,o.html]},compiler:{factory:()=>async e=>e,runOutsideWorker:No,compiledCodeLanguage:"javascript"},extensions:["mdx"],editor:"markup",editorLanguage:"markdown"};var tt={name:"pug",title:"Pug",parser:{name:"pug",pluginUrls:[o.pug]},compiler:{url:l+"pug/pug.min.js",factory:(e,t)=>(self.importScripts(t+"lang-pug-compiler.6b93c9c73ccadec5e38caa8ec77d3900.js"),self.createPugCompiler())},extensions:["pug","jade"],editor:"markup"};var ot={name:"scss",title:"SCSS",parser:{name:"scss",pluginUrls:[o.postcss]},compiler:{url:l+"sass/sass.js",factory:(e,t)=>(self.importScripts(t+"lang-scss-compiler.691dcbb2ec0289773457b79cbe789cf6.js"),self.createScssCompiler())},extensions:["scss"],editor:"style"};var rt={name:"sass",title:"Sass",compiler:"scss",extensions:["sass"],editor:"style"};var st={name:"svelte",title:"Svelte",parser:{name:"html",pluginUrls:[o.html,o.babel]},compiler:{url:l+"svelte/svelte-compiler.min.js",factory:(e,t)=>(self.importScripts(t+"lang-svelte-compiler.31371c240b8ea240090385e9e762b719.js"),self.createSvelteCompiler())},extensions:["svelte"],editor:"script",editorLanguage:"html"};var nt={name:"stylus",title:"Stylus",compiler:{url:l+"stylus/stylus.min.js",factory:()=>async e=>window.stylus.render(e)},extensions:["styl"],editor:"style"};var q={target:"es2015",jsx:"react",allowUmdGlobalAccess:!0,esModuleInterop:!0},at={name:"typescript",title:"TS",longTitle:"TypeScript",parser:{name:"babel-ts",pluginUrls:[o.babel,o.html]},compiler:{url:qe,factory:()=>async(e,{config:t,language:r})=>window.ts.transpile(e,{...q,...g("typescript",t),...g(r,t)})},extensions:["ts","typescript"],editor:"script"};var qo=H+"vue3-sfc-loader.js",it={name:"vue",title:"Vue 3",longTitle:"Vue 3 SFC",parser:{name:"html",pluginUrls:[o.html]},compiler:{factory:(e,t)=>(self.importScripts(t+"lang-vue-compiler.fb9bec4a89e6304a3a2dfd6a5d0400a2.js"),self.createVueCompiler()),scripts:[ee,qo],imports:{vue:ee+"/dist/vue.runtime.esm-browser.prod.js"}},extensions:["vue","vue3"],editor:"script",editorLanguage:"html"};var Do=H+"vue2-sfc-loader.js",lt={name:"vue2",title:"Vue 2",longTitle:"Vue 2 SFC",parser:{name:"html",pluginUrls:[o.html]},compiler:{factory:(e,t)=>(self.importScripts(t+"lang-vue-compiler.fb9bec4a89e6304a3a2dfd6a5d0400a2.js"),self.createVue2Compiler()),scripts:[te,Do],imports:{vue:te+"/dist/vue.runtime.esm-browser.prod.js"}},extensions:["vue2"],editor:"script",editorLanguage:"html"};var ct={name:"stencil",title:"Stencil",parser:{name:"babel-ts",pluginUrls:[o.babel,o.html]},compiler:{url:Ie,factory:()=>async(e,{config:t})=>(await window.stencil.transpile(e,{sourceMap:!1,target:"es2019",...g("stencil",t)})).code,types:{"@stencil/core":{url:l+"types/stencil-core.d.ts",declareAsModule:!1}}},extensions:["stencil.tsx"],editor:"script",editorLanguage:"typescript"};var pt={name:"coffeescript",title:"Coffee",longTitle:"CoffeeScript",compiler:{url:Se,factory:()=>async(e,{config:t})=>window.CoffeeScript.compile(e,{bare:!0,...g("coffeescript",t)})},extensions:["coffee"],editor:"script"};var mt={name:"livescript",title:"LiveScript",compiler:{url:l+"livescript/livescript-min.js",factory:()=>async(e,{config:t})=>window.require("livescript").compile(e,{bare:!0,...g("livescript",t)}),scripts:[l+"livescript/prelude-browser-min.js"]},extensions:["ls"],editor:"script"};var Fo=l+"assemblyscript/assemblyscript.js",dt={name:"assemblyscript",title:"AS",longTitle:"AssemblyScript",parser:{name:"babel-ts",pluginUrls:[o.babel]},compiler:{url:Fo,factory:(e,t)=>(self.importScripts(t+"lang-assemblyscript-compiler.8caa06a4a75b2f2d32150d1c4cd03b95.js"),self.createAssemblyscriptCompiler()),scripts:({baseUrl:e})=>[he,e+"lang-assemblyscript-script.a8afe51d73d1fa349c7874dce9f2108f.js"],scriptType:"application/wasm-uint8",compiledCodeLanguage:"wat",types:{assemblyscript:{url:l+"types/assemblyscript.d.ts",declareAsModule:!1,autoload:!0}}},extensions:["as","ts"],editor:"script",editorLanguage:"typescript"};var $o=X+"brython.min.js",Wo=X+"brython_stdlib.js",ut={name:"python",title:"Python",compiler:{factory:()=>async e=>e,scripts:({compiled:e,config:t})=>{let{autoloadStdlib:r,...c}=g("python",t),u=/^(?:from[ ]+(\S+)[ ]+)?import[ ]+(\S+)(?:[ ]+as[ ]+\S+)?[ ]*$/gm,h=r!==!1&&e.match(u)?[Wo]:[],s=`window.addEventListener("load", () => {brython(${JSON.stringify(c)})})`,n="data:text/plain;base64,"+btoa(s);return[$o,...h,n]},scriptType:"text/python",compiledCodeLanguage:"python"},extensions:["py"],editor:"script"};var Ho=(e,t={})=>Array.from(new Set([...e.matchAll(new RegExp(/^\s*self\.\$require\("(\S+)"\);/gm))].map(r=>r[1]).map(r=>r.split("/")[0]).filter(r=>t.hasOwnProperty(r)||r!=="opal").map(r=>t[r]||`${I+r}.min.js`))),ft={name:"ruby",title:"Ruby",compiler:{url:I+"opal.min.js",factory:()=>(importScripts(I+"opal-parser.min.js"),self.Opal.config.unsupported_features_severity="ignore",self.Opal.load("opal-parser"),async(e,{config:t})=>{let{autoloadStdlib:r,requireMap:c,...u}=g("ruby",t);return self.Opal.compile(e,u)}),scripts:({compiled:e,config:t})=>{let{autoloadStdlib:r,requireMap:c}=g("ruby",t),u=Ho(e,c),h=r!==!1?u:[];return[I+"opal.min.js",...h]}},extensions:["rb"],editor:"script"};var gt={name:"php",title:"PHP",parser:{name:"php",pluginUrls:[o.php]},compiler:{factory:()=>async e=>(e=e.trim(),e.startsWith("<?php")&&(e=e.replace("<?php","/* <?php */"),e.endsWith("?>")&&(e=e.replace("?>","/* ?> */"))),e),scripts:[De],deferScripts:!0,scriptType:"text/x-uniter-php",compiledCodeLanguage:"php"},extensions:["php"],editor:"script"};var yt={name:"perl",title:"Perl",compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[l+"perlito/perlito5.min.js",e+"lang-perl-script.1f606d886aeb724510a595d45cbaf555.js"],scriptType:"text/perl"},extensions:["pl","pm"],editor:"script"};var zo=l+"lua-fmt/lua-fmt.js",ne={factory:()=>(self.importScripts(zo),async(e,t)=>({formatted:self.luaFmt.formatText(e),cursorOffset:t}))},ht={name:"lua",title:"Lua",formatter:ne,compiler:{factory:()=>async e=>e,scripts:[E],scriptType:"application/lua",compiledCodeLanguage:"lua"},extensions:["lua"],editor:"script"};var A=()=>{let e=Ee;return self.importScripts(e),async t=>({formatted:window.parinfer.parenMode(t).text,cursorOffset:0})},xt={name:"commonlisp",title:"Lisp",longTitle:"Common Lisp",formatter:{factory:A},compiler:{factory:()=>async e=>e,scripts:({baseUrl:e})=>[Ce,e+"lang-commonlisp-script.0c86dfce5f8509928ccf51ff666c7b4b.js"],scriptType:"text/commonlisp",compiledCodeLanguage:"commonlisp",inlineScript:`
    ...
    `,liveReload:!0,scriptType:"text/r",compiledCodeLanguage:"r"},extensions:["r","rlang","rstats"],editor:"script",largeDownload:!0};var rr=l+"civet/civet.js",Qt={name:"civet",title:"Civet",compiler:{url:rr,factory:()=>async e=>window.civet.compile(e,{js:!0})},extensions:["civet"],editor:"script",editorLanguage:"coffeescript"};var eo={name:"fennel",title:"Fennel",formatter:{factory:A},compiler:{url:E,factory:(e,t)=>(self.importScripts(t+"lang-fennel-compiler.5e9f03822da6c70e27963aa7cbdaf2a6.js"),self.createFennelCompiler()),scripts:[E],scriptType:"application/lua",compiledCodeLanguage:"lua"},extensions:["fnl"],editor:"script",editorLanguage:"scheme"};var to={name:"teal",title:"Teal",formatter:ne,compiler:{url:E,factory:(e,t)=>(self.importScripts(t+"lang-teal-compiler.260290c1e3edf2a728108dd6fe515078.js"),self.createTealCompiler()),scripts:[E],scriptType:"application/lua",compiledCodeLanguage:"lua"},extensions:["tl"],editor:"script",editorLanguage:"lua"};var oo={name:"stylis",title:"Stylis",compiler:{url:Be,factory:()=>async e=>{let{compile:t,serialize:r,stringify:c,middleware:u,prefixer:h}=window.stylis;return r(t(e),u([h,c]))}},extensions:["stylis"],editor:"style",editorLanguage:"scss"};var ro={name:"flow",title:"Flow",parser:{name:"babel-flow",pluginUrls:[o.babel,o.html]},compiler:{url:l+"flow-remove-types/flow-remove-types.js",factory:()=>async(e,{config:t})=>window.flowRemoveTypes.transpile(e,{all:!0,...g("flow",t)}).toString()},extensions:["flow"],editor:"script",editorLanguage:"typescript"};var so={name:"mjml",title:"MJML",parser:{name:"html",pluginUrls:[o.html]},compiler:{url:Te,factory:()=>async(e,{config:t})=>{if(!e.trim())return"";let{html:r,errors:c}=self.mjml(e,g("mjml",t));return c?.forEach(u=>{console.warn(u.formattedMessage)}),r}},extensions:["mjml"],editor:"markup",editorLanguage:"xml"};var no={name:"sucrase",title:"Sucrase",parser:{name:"babel",pluginUrls:[o.babel,o.html]},compiler:{url:l+"sucrase/sucrase.js",factory:()=>async(e,{config:t})=>window.sucrase.transform(e,{transforms:["jsx","typescript"],...g("sucrase",t)}).code},extensions:["sucrase"],editor:"script",editorLanguage:"typescript"};var ao={name:"eta",title:"Eta",parser:{name:"html",pluginUrls:[o.html]},compiler:{url:ke,factory:(e,t)=>(self.importScripts(t+"lang-eta-compiler.69548fd65136adbd68202b8b40f034ed.js"),self.createEtaCompiler())},extensions:["eta"],editor:"markup",editorLanguage:"html"};var R=(e=location.origin)=>!!(e&&(e.endsWith("livecodes.io")||e.endsWith("livecodes.pages.dev")||e.endsWith("localpen.io")||e.endsWith("localpen.pages.dev")||e.startsWith("http://127.0.0.1")||e.startsWith("http://localhost")));var ie=Co(co());var ar="https://livecodes-sandbox.pages.dev";var le=ar,po="v6",F={getResultUrl:()=>`${le}/${po}/result`,getCompilerUrl:()=>`${le}/${po}/compiler`,getOrigin:()=>new URL(le).origin};var mo="https://dpaste.com/",ir="https://dpaste.com/api/v2/",uo="https://api2.livecodes.io/share",fo={getProject:async e=>{try{let t=await fetch(mo+e+".txt");return t.ok?JSON.parse(await t.text()):{}}catch{return{}}},shareProject:async e=>{try{let t=await fetch(ir,{method:"POST",mode:"cors",headers:{"Content-Type":"application/x-www-form-urlencoded","User-Agent":"LiveCodes / https://livecodes.io/"},body:`content=${encodeURIComponent(JSON.stringify(e))}&title=${encodeURIComponent(e.title||"")}&syntax=json&expiry_days=365`});return t.ok?(await t.text()).replace(mo,""):""}catch{return""}}},lr={getProject:async e=>{if(e.length<11)return fo.getProject(e);if(!R())return{};try{let t=await fetch(uo+"?id="+e);return t.ok?JSON.parse(await t.text()):{}}catch{return{}}},shareProject:async e=>{if(!R())return"";try{let t=await fetch(uo,{method:"POST",mode:"cors",body:JSON.stringify(e)});return t.ok?t.text():""}catch{return""}}},Mm=R()?lr:fo;var go={name:"clojurescript",title:"CLJS (cherry)",longTitle:"ClojureScript (cherry)",formatter:{factory:A},compiler:{url:W+"lib/cherry.umd.js",factory:()=>async(e,{config:t,options:r})=>{let c=self.CherryCljs.compileString(e);return e.includes("#jsx")?N(c,"jsx",t,r):c},imports:{"cherry-cljs":W+"index.js","cherry-cljs/cljs.core.js":W+"cljs.core.js"}},extensions:["cljs","clj","cljc","edn","clojure"],editor:"script",editorLanguage:"clojure"};var B=[Ke,Qe,et,qt,tt,He,Xe,Gt,kt,jt,ao,Ut,Lt,Ct,Nt,Zt,so,Kt,Xt,Je,ot,rt,Ye,nt,oo,Ve,at,ro,ze,no,Ge,Ze,Rt,It,it,lt,st,ct,wt,vt,At,Dt,pt,mt,Qt,Jt,Vt,Tt,Pt,Et,ut,St,Yt,ft,_t,gt,Ft,Wt,yt,ht,to,eo,$t,bt,xt,go,Ht,dt,Mt,Ot,zt,Bt];var yo=`<!DOCTYPE html>\r
<html lang="en">\r
  <head>\r
...
`;var J=!1,_={src:"",customScripts:[],customXml:[]},$=()=>document.querySelector("#blockly-frame"),ho=e=>"..."+JSON.stringify({...se("blockly",e),...e.readonly?{readOnly:!0}:{}})+",",xo=async(e,t)=>{let c=new DOMParser().parseFromString(e,"text/html"),u=Array.from(c.querySelectorAll('script[type="blockly/script"], script[data-type="blockly/script"]')),h=Array.from(c.querySelectorAll('xml[type="blockly/xml"], xml[data-type="blockly/xml"]')),s=u.map(v=>v.src||v.dataset.src||v.innerHTML),n=h.map(v=>v.src||v.dataset.src||v.innerHTML),d=ho(t),p=JSON.stringify([s,n,d]);if(_.src===p)return[_.customScripts,_.customXml];J=!1;let m=async v=>Promise.all(v.map(async k=>{let S=k.src||k.dataset.src;return S?fetch(S).then(j=>j.text()):k.innerHTML})),[b,L]=await Promise.all([m(u),m(h)]);return _={src:p,customScripts:b,customXml:L},[b,L]},dr=async({baseUrl:e,editors:t,config:r,html:c,eventsManager:u})=>{let[h,s]=await xo(c,r);if(J)return;let n=()=>yo.replace(/{{CDN_URL}}/g,ve).replace("{{theme}}",r.theme).replace("// {{custom_config}}",ho(r)).replace("<!-- startBlocks placeholder -->",`<div id="startBlocksContainer" style="display:none;">${t.script.getValue()}</div>
    ...
    `);await new Promise(d=>{let p=document.querySelector("#blockly"),m=$(),b=()=>{u.addEventListener(window,"message",L=>{if(L.source!==$()?.contentWindow||!["blocklyCode","blocklyLoaded"].includes(L.data.type))return;if(L.data.type==="blocklyLoaded"){J=!0,u.removeEventListener(m,"load",b),ur(r.theme),fr(),d("loaded");return}let{xml:v,js:k}=L.data.payload;_.xml=v,_.js=k,t.script.setValue(v)}),$()?.contentWindow?.postMessage({result:n()},"*")};m?b():(m=document.createElement("iframe"),m.name="blockly",m.id="blockly-frame",m.setAttribute("sandbox","allow-same-origin allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-presentation allow-scripts"),u.addEventListener(m,"load",b),m.src=F.getResultUrl(),p.appendChild(m))})},df=async({baseUrl:e,editors:t,config:r,html:c,eventsManager:u})=>r.script.language!=="blockly"?{}:(await xo(c,r),(!J||_.js==null)&&await dr({baseUrl:e,config:r,editors:t,html:c,eventsManager:u}),{xml:_.xml,js:_.js}),ur=e=>{$()?.contentWindow?.postMessage({type:"setTheme",payload:e},F.getOrigin())},fr=()=>{$()?.contentWindow?.postMessage({type:"updateCode"},F.getOrigin())};export{df as getBlocklyContent,ur as setBlocklyTheme,dr as showBlockly};
