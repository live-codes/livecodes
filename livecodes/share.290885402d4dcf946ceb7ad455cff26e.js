var je=Object.create;var B=Object.defineProperty;var Ue=Object.getOwnPropertyDescriptor;var Ce=Object.getOwnPropertyNames;var He=Object.getPrototypeOf,Re=Object.prototype.hasOwnProperty;var Ae=(e,o)=>()=>(o||e((o={exports:{}}).exports,o),o.exports);var qe=(e,o,m,x)=>{if(o&&typeof o=="object"||typeof o=="function")for(let v of Ce(o))!Re.call(e,v)&&v!==m&&B(e,v,{get:()=>o[v],enumerable:!(x=Ue(o,v))||x.enumerable});return e};var Pe=(e,o,m)=>(m=e!=null?je(He(e)):{},qe(o||!e||!e.__esModule?B(m,"default",{value:e,enumerable:!0}):m,e));var Le=Ae((Ia,A)=>{var ke=function(){var e=String.fromCharCode,o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$",x={};function v(t,n){if(!x[t]){x[t]={};for(var d=0;d<t.length;d++)x[t][t.charAt(d)]=d}return x[t][n]}var k={compressToBase64:function(t){if(t==null)return"";var n=k._compress(t,6,function(d){return o.charAt(d)});switch(n.length%4){default:case 0:return n;case 1:return n+"===";case 2:return n+"==";case 3:return n+"="}},decompressFromBase64:function(t){return t==null?"":t==""?null:k._decompress(t.length,32,function(n){return v(o,t.charAt(n))})},compressToUTF16:function(t){return t==null?"":k._compress(t,15,function(n){return e(n+32)})+" "},decompressFromUTF16:function(t){return t==null?"":t==""?null:k._decompress(t.length,16384,function(n){return t.charCodeAt(n)-32})},compressToUint8Array:function(t){for(var n=k.compress(t),d=new Uint8Array(n.length*2),s=0,i=n.length;s<i;s++){var g=n.charCodeAt(s);d[s*2]=g>>>8,d[s*2+1]=g%256}return d},decompressFromUint8Array:function(t){if(t==null)return k.decompress(t);for(var n=new Array(t.length/2),d=0,s=n.length;d<s;d++)n[d]=t[d*2]*256+t[d*2+1];var i=[];return n.forEach(function(g){i.push(e(g))}),k.decompress(i.join(""))},compressToEncodedURIComponent:function(t){return t==null?"":k._compress(t,6,function(n){return m.charAt(n)})},decompressFromEncodedURIComponent:function(t){return t==null?"":t==""?null:(t=t.replace(/ /g,"+"),k._decompress(t.length,32,function(n){return v(m,t.charAt(n))}))},compress:function(t){return k._compress(t,16,function(n){return e(n)})},_compress:function(t,n,d){if(t==null)return"";var s,i,g={},_={},T="",L="",f="",y=2,E=3,p=2,u=[],a=0,r=0,w;for(w=0;w<t.length;w+=1)if(T=t.charAt(w),Object.prototype.hasOwnProperty.call(g,T)||(g[T]=E++,_[T]=!0),L=f+T,Object.prototype.hasOwnProperty.call(g,L))f=L;else{if(Object.prototype.hasOwnProperty.call(_,f)){if(f.charCodeAt(0)<256){for(s=0;s<p;s++)a=a<<1,r==n-1?(r=0,u.push(d(a)),a=0):r++;for(i=f.charCodeAt(0),s=0;s<8;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1}else{for(i=1,s=0;s<p;s++)a=a<<1|i,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=0;for(i=f.charCodeAt(0),s=0;s<16;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1}y--,y==0&&(y=Math.pow(2,p),p++),delete _[f]}else for(i=g[f],s=0;s<p;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1;y--,y==0&&(y=Math.pow(2,p),p++),g[L]=E++,f=String(T)}if(f!==""){if(Object.prototype.hasOwnProperty.call(_,f)){if(f.charCodeAt(0)<256){for(s=0;s<p;s++)a=a<<1,r==n-1?(r=0,u.push(d(a)),a=0):r++;for(i=f.charCodeAt(0),s=0;s<8;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1}else{for(i=1,s=0;s<p;s++)a=a<<1|i,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=0;for(i=f.charCodeAt(0),s=0;s<16;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1}y--,y==0&&(y=Math.pow(2,p),p++),delete _[f]}else for(i=g[f],s=0;s<p;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1;y--,y==0&&(y=Math.pow(2,p),p++)}for(i=2,s=0;s<p;s++)a=a<<1|i&1,r==n-1?(r=0,u.push(d(a)),a=0):r++,i=i>>1;for(;;)if(a=a<<1,r==n-1){u.push(d(a));break}else r++;return u.join("")},decompress:function(t){return t==null?"":t==""?null:k._decompress(t.length,32768,function(n){return t.charCodeAt(n)})},_decompress:function(t,n,d){var s=[],i,g=4,_=4,T=3,L="",f=[],y,E,p,u,a,r,w,l={val:d(0),position:n,index:1};for(y=0;y<3;y+=1)s[y]=y;for(p=0,a=Math.pow(2,2),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;switch(i=p){case 0:for(p=0,a=Math.pow(2,8),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;w=e(p);break;case 1:for(p=0,a=Math.pow(2,16),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;w=e(p);break;case 2:return""}for(s[3]=w,E=w,f.push(w);;){if(l.index>t)return"";for(p=0,a=Math.pow(2,T),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;switch(w=p){case 0:for(p=0,a=Math.pow(2,8),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;s[_++]=e(p),w=_-1,g--;break;case 1:for(p=0,a=Math.pow(2,16),r=1;r!=a;)u=l.val&l.position,l.position>>=1,l.position==0&&(l.position=n,l.val=d(l.index++)),p|=(u>0?1:0)*r,r<<=1;s[_++]=e(p),w=_-1,g--;break;case 2:return f.join("")}if(g==0&&(g=Math.pow(2,T),T++),s[w])L=s[w];else if(w===_)L=E+E.charAt(0);else return null;f.push(L),s[_++]=E+L.charAt(0),g--,E=L,g==0&&(g=Math.pow(2,T),T++)}}};return k}();typeof define=="function"&&define.amd?define(function(){return ke}):typeof A<"u"&&A!=null&&(A.exports=ke)});var D=`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
`;var N=`<ul id="settings-menu" class="dropdown-menu">\r
  <li>\r
...
`;var F=`<div id="test-editor-container" class="modal-container">
...
`;var $=`<div id="import-container" class="modal-container">
...
`;var X=`<div id="deploy-container" class="modal-container">
...
`;var G=`<div id="sync-container" class="modal-container">
...
`;var z=`<div id="backup-container" class="modal-container">
...
`;var Y=`<div id="broadcast-container" class="modal-container">
...
`;var K=`<div id="welcome-container" class="modal-container">\r
...
`;var V=`<div id="about-container" class="modal-container">\r
...
`;var Q=`<div id="info-container" class="modal-container">
...
`;var Z=`<div id="resources-container" class="modal-container">
...
`;var ee=`<div id="login-screen" class="modal-container">\r
...
`;var oe=`<div id="prompt-recover-screen">
...
`;var ae=`<div id="templates-container" class="modal-container">
...
`;var re=`<div id="list-container" class="list-container">
...
`;var ne=`<div id="assets-list-container" class="list-container">
...
`;var se=`<div id="add-asset-container" class="modal-container">
...
`;var ie=`<div id="snippets-list-container" class="list-container">
...
`;var le=`<div id="add-snippet-container" class="modal-container">
...
`;var ce=`<div id="share-screen" class="modal-container">\r
...
`;var de=`<div id="editor-settings-container" class="modal-container">
...
`;var b=e=>e.replace(/{{APP_VERSION}}/g,"4").replace(/{{SDK_VERSION}}/g,"0.0.2").replace(/{{COMMIT_SHA}}/g,"fe430fb").replace(/{{REPO_URL}}/g,"https://github.com/live-codes/livecodes").replace(/{{DOCS_BASE_URL}}/g,"/livecodes/docs/"),xo=b(D),ko=b(O),Lo=b(N),_o=b(J),To=b(W),Eo=b(F),Mo=b($),jo=b(X),Uo=b(G),Co=b(z),Ho=b(Y),Ro=b(K),Ao=b(V),qo=b(Q),Po=b(Z),Io=b(ee),Bo=b(te),Do=b(oe),Oo=b(ae),No=b(re),Jo=b(ne),Wo=b(se),Fo=b(ie),$o=b(le),me=b(ce),Xo=b(pe),Go=b(de),zo=b(ue);var j=(e=location.origin)=>!!(e&&(e.endsWith("livecodes.io")||e.endsWith("livecodes.pages.dev")||e.endsWith("localpen.io")||e.endsWith("localpen.pages.dev")||e.startsWith("http://127.0.0.1")||e.startsWith("http://localhost")));var dt=e=>!e?.startsWith("http")&&!e?.startsWith("data:"),ge=(e,o=document.baseURI)=>dt(e)?new URL(e,o).href:e;var he=e=>{if(document.queryCommandSupported&&document.queryCommandSupported("copy")){let o=document.createElement("textarea");o.textContent=e,o.style.position="fixed",document.body.appendChild(o),o.select();try{return document.execCommand("copy")}catch(m){return console.warn("Copy to clipboard failed.",m),!1}finally{document.body.removeChild(o)}}return!1};var q=(e,o)=>new Promise((m,x)=>{if(o&&globalThis[o])return m(globalThis[o]);if(typeof globalThis.importScripts=="function")return globalThis.importScripts(e),o&&globalThis[o]?m(globalThis[o]):m(globalThis);let v=document.createElement("script");v.src=e,v.async=!0;let k=()=>{v.removeEventListener("load",t),v.removeEventListener("error",n)},t=()=>{if(k(),!o)return m("loaded: "+e);let d=setInterval(()=>{if(window[o])return clearInterval(d),m(window[o])},5)},n=()=>{k(),x("failed to load: "+e)};v.addEventListener("load",t),v.addEventListener("error",n),document.head.appendChild(v)});var fe=["jspm","skypack"],ve=["unpkg","jsdelivr"],ye=["jsdelivr.gh","statically"],C={getModuleUrl:(e,{isModule:o=!0,defaultCDN:m="jspm"}={})=>{e=e.replace(/#nobundle/g,"");let x=be(e,o,m);return x||(o?"https://jspm.dev/"+e:"https://cdn.jsdelivr.net/npm/"+e)},getUrl:(e,o)=>e.startsWith("http")?e:be(e,!1,o||ut())||e,cdnLists:{npm:ve,module:fe,gh:ye},checkCDNs:async(e,o)=>{let m=[o,...C.cdnLists.npm].filter(Boolean);for(let x of m)try{if((await fetch(C.getUrl(e,x),{method:"HEAD"})).ok)return x}catch{}return C.cdnLists.npm[0]}},ut=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get("appCDN")||C.cdnLists.npm[0]}catch{return C.cdnLists.npm[0]}},be=(e,o,m)=>{let x=o&&e.startsWith("unpkg:")?"?module":"";e.startsWith("gh:")?e=e.replace("gh",ye[0]):e.includes(":")||(e=(m||(o?fe[0]:ve[0]))+":"+e);for(let v of mt){let[k,t]=v;if(k.test(e))return e.replace(k,t)+x}return null},mt=[[/^(jspm:)(.+)/i,"https://jspm.dev/$2"],[/^(npm:)(.+)/i,"https://jspm.dev/$2"],[/^(node:)(.+)/i,"https://jspm.dev/$2"],[/^(skypack:)(.+)/i,"https://cdn.skypack.dev/$2"],[/^(jsdelivr:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2"],[/^(jsdelivr.gh:)(.+)/i,"https://cdn.jsdelivr.net/gh/$2"],[/^(statically:)(.+)/i,"https://cdn.statically.io/gh/$2"],[/^(esm.run:)(.+)/i,"https://esm.run/$2"],[/^(esm.sh:)(.+)/i,"https://esm.sh/$2"],[/^(esbuild:)(.+)/i,"https://esbuild.vercel.app/$2"],[/^(bundle.run:)(.+)/i,"https://bundle.run/$2"],[/^(unpkg:)(.+)/i,"https://unpkg.com/$2"],[/^(bundlejs:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(bundle:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(deno:)(.+)/i,"https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts"],[/^(https:\/\/deno\.land\/.+)/i,"https://deno.bundlejs.com/?file&q=$1"],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,"https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4"],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3"],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3"],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,"https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3"]];var{getUrl:we,getModuleUrl:ra}=C;var gt="0.6.64",na=we(`malinajs@${gt}/malina.js`);var Se=we("qrcode-generator@1.4.4/qrcode.js");var P=Pe(Le());var _e="https://dpaste.com/",bt="https://dpaste.com/api/v2/",Te="https://api2.livecodes.io/share",Ee={getProject:async e=>{try{let o=await fetch(_e+e+".txt");return o.ok?JSON.parse(await o.text()):{}}catch{return{}}},shareProject:async e=>{try{let o=await fetch(bt,{method:"POST",mode:"cors",headers:{"Content-Type":"application/x-www-form-urlencoded","User-Agent":"LiveCodes / https://livecodes.io/"},body:`content=${encodeURIComponent(JSON.stringify(e))}&title=${encodeURIComponent(e.title||"")}&syntax=json&expiry_days=365`});return o.ok?(await o.text()).replace(_e,""):""}catch{return""}}},ft={getProject:async e=>{if(e.length<11)return Ee.getProject(e);if(!j())return{};try{let o=await fetch(Te+"?id="+e);return o.ok?JSON.parse(await o.text()):{}}catch{return{}}},shareProject:async e=>{if(!j())return"";try{let o=await fetch(Te,{method:"POST",mode:"cors",body:JSON.stringify(e)});return o.ok?o.text():""}catch{return""}}},ur=j()?ft:Ee;var I=()=>document.querySelector("#qrcode-container");var S=encodeURIComponent,Cr=async(e,o,m)=>{let x,v=c=>{(!c||!he(c))&&w("Copy to clipboard failed!"),w("URL copied to clipboard"),x=setTimeout(()=>{w("Click to copy")},5e3)},k=async()=>{let c=I();if(f.style.visibility="hidden",c.style.display="flex",_){u?.classList.add("short-url"),p&&g&&(p.value=g.url);return}await l();let U=(await q(Se,"qrcode"))(0,"L");U.addData(g.url),U.make(),_=U.createImgTag(6,10),c.innerHTML=_},t=(c,h,R)=>{R&&(R.innerHTML="",h.forEach(M=>{let U=document.createElement("li"),H=document.createElement("a");H.href=M.createShareUrl?.(c)||"#",H.target="blank",H.rel="noopener noreferrer",H.innerHTML=`
        <span class="share-image-container">
          <img
            src="${ge(o)+"assets/icons/"+M.icon}"
            alt="${M.name}"
          />
        </span>
        ${M.name}
      `,M.onClick&&m.addEventListener(H,"click",async Me=>{Me.preventDefault(),M.onClick?.(c)}),U.appendChild(H),R.appendChild(U),M.name==="Share via \u2026"&&!navigator.share&&U.remove()}),p&&(p.value=c.url),w("Click to copy"))},n=[{name:"Facebook",icon:"facebook.svg",createShareUrl:({url:c})=>`https://www.facebook.com/sharer.php?u=${S(c)}`},{name:"Twitter",icon:"twitter.svg",createShareUrl:({url:c,title:h})=>`https://twitter.com/intent/tweet?url=${S(c)}&text=${S(h)}`},{name:"Hacker News",icon:"hacker-news.svg",createShareUrl:({url:c,title:h})=>`https://news.ycombinator.com/submitlink?u=${S(c)}&t=${S(h)}`},{name:"Reddit",icon:"reddit.svg",createShareUrl:({url:c,title:h})=>`https://www.reddit.com/submit?url=${S(c)}&title=${S(h)}`},{name:"LinkedIn",icon:"linkedin.svg",createShareUrl:({url:c,title:h})=>`https://www.linkedin.com/shareArticle?url=${S(c)}&title=${S(h)}&mini=true&source=LiveCodes`},{name:"Dev.to",icon:"dev.svg",createShareUrl:({url:c,title:h})=>`https://dev.to/new?prefill=${S(`---
title: `+h+`
published: true
tags: livecodes
---
...
`+c)}`},{name:"Tumblr",icon:"tumblr.svg",createShareUrl:({url:c,title:h})=>`
      https://www.tumblr.com/share/link?url=${S(c)}&name=${S(h)}`},{name:"Pinterest",icon:"pinterest.svg",createShareUrl:({url:c,title:h})=>`https://pinterest.com/pin/create/bookmarklet/?url=${S(c)}&description=${S(h)}`},{name:"WhatsApp",icon:"whatsapp.svg",createShareUrl:({url:c,title:h})=>`https://api.whatsapp.com/send?text=${S(h)} ${S(c)}`},{name:"Telegram",icon:"telegram.svg",createShareUrl:({url:c,title:h})=>`https://t.me/share/url?url=${S(c)}&text=${S(h)}`},{name:"Pocket",icon:"pocket.svg",createShareUrl:({url:c,title:h})=>`https://getpocket.com/save?url=${S(c)}&title=${S(h)}`},{name:"Email",icon:"email.svg",createShareUrl:({url:c,title:h})=>`mailto:?subject=${S(h)}&body=${S(c)}`},{name:"Copy URL",icon:"copy.svg",onClick:({url:c})=>v(c)},{name:"QR code",icon:"qr-code.svg",onClick:k},{name:"Share via \u2026",icon:"share.svg",onClick:({url:c,title:h})=>navigator.share({url:c,title:h})}],d=!j(),s=document.createElement("div"),i=await e(!1,!1),g,_,T=i.url.length;s.innerHTML=me.replace(/{{urlLength}}/g,String(T)).replace(/{{warnClass}}/g,T>2048?"danger":"warn");let L=s.firstChild;d?L.querySelector("#share-expiry").outerHTML="":L.querySelector("#share-expiry-self-hosted").outerHTML="";let f=L.querySelector("#share-links"),y=L.querySelector("#share-permanent-url-checkbox"),E=L.querySelector("#share-click-to-copy"),p=L.querySelector("#share-url-input"),u=L.querySelector(".share-expiry"),a=u?.querySelector(".share-encoded-url-expiry a"),r=u?.querySelector(".share-short-url-expiry a"),w=c=>{E&&(clearTimeout(x),E.innerHTML=c)};t(i,n,f);let l=async c=>{c?.preventDefault(),w("Generating URL \u2026");try{g=g||await e(!0,y.checked),t(g,n,f),u?.classList.add("short-url")}catch{w("Failed to generate short URL!")}};return m.addEventListener(a,"click",l),m.addEventListener(r,"click",c=>{c.preventDefault(),t(i,n,f),u?.classList.remove("short-url");let h=I();h.style.display="none",f.style.visibility="visible"}),m.addEventListener(y,"change",async()=>{i=await e(!1,y.checked),g&&(g=await e(!0,y.checked));let c=u?.classList.contains("short-url")?g:i;t(c,n,f)}),m.addEventListener(p,"click",function(){v(p?.value),p?.select()}),m.addEventListener(E,"click",function(){v(p?.value),p?.select()}),L};export{Cr as createShareContainer};
