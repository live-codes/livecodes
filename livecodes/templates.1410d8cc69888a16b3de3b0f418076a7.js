...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var B={name:"riot",title:"Riot.js Starter",thumbnail:"assets/templates/riot.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var A={name:"vue",title:"Vue 3 SFC Starter",thumbnail:"assets/templates/vue.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"vue",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var X={name:"malina",title:"Malina.js Starter",thumbnail:"assets/templates/malina.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"malina",content:`
<script>
  let title = "Malina.js";
  let counter = 0;
  function increment() {
...
`.trimStart()},customSettings:{imports:{"my_pkg/greet.js":r+"demo/greet.js"},gleam:{modules:{"plinth/browser/document":{srcUrl:i+"browser/document.gleam",compiledUrl:l+"browser/document.mjs"},"plinth/browser/element":{srcUrl:i+"browser/element.gleam",compiledUrl:l+"browser/element.mjs"},"plinth/browser/event":{srcUrl:i+"browser/event.gleam",compiledUrl:l+"browser/event.mjs"}}}}};var As=[g,rt,I,q,E,A,z,m,T,W,N,gt,D,w,u,B,X,y,d,x,ot,nt,b,O,f,S,it,tt,st,$,M,R,U,C,at,H,pt,v,j,dt,F,Z,_,k,ut,ct,lt,J,P,G,mt,xt,K,L,p,V,Y,ht,Q,h,et];export{As as starterTemplates};
