...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var j={name:"lua",title:window.deps.translateString("templates.starter.lua","Lua Starter"),thumbnail:"assets/templates/lua.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var _={name:"mdx",title:window.deps.translateString("templates.starter.mdx","MDX Starter"),thumbnail:"assets/templates/mdx.svg",activeEditor:"markup",markup:{language:"mdx",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var B={name:"markdown",title:window.deps.translateString("templates.starter.markdown","Markdown Starter"),thumbnail:"assets/templates/markdown.svg",activeEditor:"markup",markup:{language:"markdown",content:`
# Project Title
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var nt={name:"imba",title:window.deps.translateString("templates.starter.imba","Imba Starter"),thumbnail:"assets/templates/imba.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:""},script:{language:"imba",content:`
tag app-counter
	prop name = "Imba"
	prop count = 0
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var rt={name:"jest",title:window.deps.translateString("templates.starter.jest","Jest Starter"),thumbnail:"assets/templates/jest.svg",autotest:!0,activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()}};var jt={name:"d3",title:"D3 Starter",thumbnail:"assets/templates/d3.svg",activeEditor:"script",markup:{language:"html",content:`<div id="chart">Loading...</div>
`},style:{language:"css",content:`
.bar {
  fill: steelblue;
}
...
svg
  ...
  .attr("y", (d, i) => i * 50 + 10)
  .attr("x", 10);
`.trimStart()}};var t="https://cdn.jsdelivr.net/npm/@hatemhosny/shadcdn@0.0.14/build/",_t={name:"shadcn-ui",title:window.deps.translateString("templates.starter.shadcnui","shadcn/ui Starter"),thumbnail:"assets/templates/shadcn-ui.svg",activeEditor:"script",markup:{language:"html",content:`
