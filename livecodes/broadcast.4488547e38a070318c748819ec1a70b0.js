...
`;var y=`<ul id="settings-menu" class="dropdown-menu">\r
  <li>\r
...
`;var S=`<section data-lang="art-template">\r
...
`;var k=`<div id="custom-settings-container" class="modal-container">
...
`;var L=`<div id="import-container" class="modal-container">
...
`;var _=`<div id="sync-container" class="modal-container">
...
`;var T=`<div id="backup-container" class="modal-container">
...
`;var E=`<div id="broadcast-container" class="modal-container">
...
`;var M=`<div id="welcome-container" class="modal-container">\r
...
`;var H=`<div id="about-container" class="modal-container">\r
...
`;var R=`<div id="info-container" class="modal-container">
...
`;var C=`<div id="resources-container" class="modal-container">
...
`;var A=`<div id="login-screen" class="modal-container">\r
...
`;var q=`<div id="prompt-recover-screen">
...
`;var B=`<div id="templates-container" class="modal-container">
...
`;var U=`<div id="list-container" class="list-container">
...
`;var D=`<div id="assets-list-container" class="list-container">
...
`;var I=`<div id="snippets-list-container" class="list-container">
...
`;var O=`<div id="add-snippet-container" class="modal-container">
...
`;var J=`<div id="share-screen" class="modal-container">\r
...
`;var X=`<div id="embed-container" class="modal-container">
...
`;var N=`<div id="editor-settings-container" class="modal-container">
...
`;var e=t=>t.replace(/{{APP_VERSION}}/g,"4").replace(/{{SDK_VERSION}}/g,"0.0.2").replace(/{{COMMIT_SHA}}/g,"fe430fb").replace(/{{REPO_URL}}/g,"https://github.com/live-codes/livecodes").replace(/{{DOCS_BASE_URL}}/g,"/livecodes/docs/"),jt=e(v),qt=e(f),Bt=e(y),Ut=e(S),Dt=e(k),Pt=e(w),It=e(L),Ot=e(x),Jt=e(_),Xt=e(T),G=e(E),Nt=e(M),Ft=e(H),Gt=e(R),Wt=e(C),Yt=e(A),zt=e(j),Vt=e(q),Kt=e(B),Qt=e(U),Zt=e(D),$t=e(P),ea=e(I),ta=e(O),aa=e(J),oa=e(X),la=e(N),ra=e(F);var W={getUrl:()=>"https://livecodes-broadcast.onrender.com/"};var Y=t=>t.querySelector("#broadcast-status"),z=t=>t.querySelector("#broadcast-form"),V=t=>t.querySelector("#broadcast-server-url"),K=t=>t.querySelector("#broadcast-source"),Q=t=>t.querySelector("#broadcast-btn"),Z=t=>t.querySelector("#broadcast-channel-url-section"),$=t=>t.querySelector("#broadcast-channel-url");var ua=async({modal:t,notifications:d,eventsManager:ee,deps:l})=>{let u=document.createElement("div");u.innerHTML=G;let o=u.firstChild;t.show(o);let m=Y(o),te=z(o),r=V(o),n=K(o),i=Q(o),h=Z(o),g=$(o),a=l.getBroadcastData(),c=()=>{i.disabled=!1,a=l.getBroadcastData(),a?.isBroadcasting?(m.innerText="Broadcasting...",r.disabled=!0,n.disabled=!0,i.innerText="Stop broadcast",n.checked=a?.broadcastSource===!0,a?.channelUrl&&(h.style.display="unset",g.innerText=a.channelUrl,g.href=a.channelUrl)):(m.innerText="",r.disabled=!1,n.disabled=!1,i.innerText="Broadcast",h.style.display="none"),r.value=r.value.trim()||a?.serverUrl||W.getUrl()};c(),ee.addEventListener(te,"submit",async ae=>{if(ae.preventDefault(),a=l.getBroadcastData(),a?.isBroadcasting){let b=a.serverUrl;fetch(b,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({channel:a.channel,channelToken:a.channelToken,stop:!0})}).catch(()=>{}),l.setBroadcastData({isBroadcasting:!1,channel:"",channelUrl:"",channelToken:"",broadcastSource:!1,serverUrl:b}),c();return}let p=r.value.trim();if(!p){d.error("Server URL is required!");return}i.disabled=!0,i.innerText="Connecting...";let s=await l.broadcast({serverUrl:p,channel:"",channelToken:"",broadcastSource:n.checked});if(!s||"error"in s){d.error("Broadcast failed!"),c();return}l.setBroadcastData({isBroadcasting:!0,serverUrl:p,channel:s.channel,channelUrl:s.channelUrl,channelToken:s.channelToken||"",broadcastSource:n.checked}),c(),d.success("Broadcasting...")})};export{ua as createBroadcastUI};
