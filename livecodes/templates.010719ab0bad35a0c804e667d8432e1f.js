...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var d={name:"mdx",title:"MDX Starter",thumbnail:"assets/templates/mdx.svg",activeEditor:"markup",markup:{language:"mdx",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var b={name:"preact",title:"Preact Starter",thumbnail:"assets/templates/preact.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app"></div>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var f={name:"pyodide",title:"Python (pyodide) Starter",thumbnail:"assets/templates/python.svg",activeEditor:"script",markup:{language:"html",content:`
<h1 id="title">Hello, World!</h1>
<div id="plot">Loading...</div>
`.trimStart()},style:{language:"css",content:`h1 {
  text-align: center;
}
`.trimStart()},script:{language:"pyodide",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var y={name:"python",title:"Python Starter",thumbnail:"assets/templates/python.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var N={name:"cpp",title:"C++ Starter",thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var I={name:"julia",title:"Julia Starter",thumbnail:"assets/templates/julia.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var $={name:"clang",title:"C++ (Clang) Starter",thumbnail:"assets/templates/cpp.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
  <img class="logo" alt="logo" src="{{ __livecodes_baseUrl__ }}assets/templates/cpp.svg" />
  <p>You clicked <span id="counter">0</span> times.</p>
...
`.trimStart()},script:{language:"clang",content:`
#include <iostream>
using namespace std;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var W={name:"tcl",title:"Tcl Starter",thumbnail:"assets/templates/tcl.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="name">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var D={name:"diagrams",title:"Diagrams Starter",thumbnail:"assets/templates/diagrams.svg",activeEditor:"markup",markup:{language:"diagrams",contentUrl:"{{ __livecodes_baseUrl__ }}assets/templates/diagrams-starter.html"},style:{language:"css",content:`
.container {
  display: flex;
...
`.trimStart()}};var on=[s,J,P,S,v,M,Y,t,b,H,q,j,d,n,T,B,c,o,m,V,G,a,R,i,p,Z,X,z,k,_,w,y,f,F,C,l,h,N,$,g,u,Q,K,I,E,U,tt,W,x,e,A,L,O,r,D];export{on as starterTemplates};
