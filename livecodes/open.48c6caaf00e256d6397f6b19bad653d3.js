...
`;var F=`<div id="custom-settings-container" class="modal-container">
...
`;var W=`<div id="test-editor-container" class="modal-container">
...
`;var G=`<div id="deploy-container" class="modal-container">
...
`;var $=`<div id="sync-container" class="modal-container">
...
`;var Y=`<div id="backup-container" class="modal-container">
...
`;var Q=`<div id="about-container" class="modal-container">\r
...
`;var Z=`<div id="info-container" class="modal-container">
...
`;var ee=`<div id="resources-container" class="modal-container">
...
`;var te=`<div id="login-screen" class="modal-container">\r
...
`;var se=`<div id="assets-list-container" class="list-container">
...
`;var ie=`<div id="add-asset-container" class="modal-container">
...
`;var le=`<div id="snippets-list-container" class="list-container">
...
`;var ce=`<div id="add-snippet-container" class="modal-container">
...
`;var ue=`<div id="editor-settings-container" class="modal-container">
...
`;var i=e=>e.replace(/{{APP_VERSION}}/g,"4").replace(/{{SDK_VERSION}}/g,"0.0.2").replace(/{{COMMIT_SHA}}/g,"fe430fb").replace(/{{REPO_URL}}/g,"https://github.com/live-codes/livecodes").replace(/{{DOCS_BASE_URL}}/g,"/livecodes/docs/"),ba=i(O),va=i(z),ya=i(N),Sa=i(J),wa=i(F),xa=i(W),La=i(X),ka=i(G),Ea=i($),Ta=i(Y),Ma=i(V),_a=i(K),ja=i(Q),at=i(Z),Ca=i(ee),ot=i(te),Ha=i(ae),Ua=i(oe),nt=i(ne),ge=i(re),Ra=i(se),qa=i(ie),Aa=i(le),Ba=i(ce),Da=i(de),Ia=i(pe),Pa=i(ue),Oa=i(me);var rt=(e,t="_")=>e.replace(/[\W]+/g,t),R=()=>{let e=!1,t=navigator.userAgent.toLowerCase();(function(s){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(s)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(s.substr(0,4)))&&(e=!0)})(t||navigator.vendor||window.opera);let n=t.indexOf("safari")>-1&&t.indexOf("chrome")===-1;return e||n};var st=()=>String(Math.random())+"-"+Date.now().toFixed(),he=(e,t,n)=>{let s=document.createElement("a");s.style.display="none",s.href=n,s.download=rt(e)+"."+t,s.click(),s.remove()},q=(e,t)=>new Promise((n,s)=>{if(t&&globalThis[t])return n(globalThis[t]);if(typeof globalThis.importScripts=="function")return globalThis.importScripts(e),t&&globalThis[t]?n(globalThis[t]):n(globalThis);let r=document.createElement("script");r.src=e,r.async=!0;let c=()=>{r.removeEventListener("load",d),r.removeEventListener("error",b)},d=()=>{if(c(),!t)return n("loaded: "+e);let p=setInterval(()=>{if(window[t])return clearInterval(p),n(window[t])},5)},b=()=>{c(),s("failed to load: "+e)};r.addEventListener("load",d),r.addEventListener("error",b),document.head.appendChild(r)}),B=(e,t,n)=>{if(t&&document.getElementById(t))return;let s=document.createElement("link");s.rel="stylesheet",s.href=e,s.id=t||"styles-"+st(),document.head.insertBefore(s,n?document.querySelector(n):null)};var fe=()=>{let e=new Date,t=e.getTimezoneOffset();return e=new Date(e.getTime()-t*60*1e3),e.toISOString().split("T")[0]};var ve=["jspm","skypack"],ye=["unpkg","jsdelivr"],Se=["jsdelivr.gh","statically"],j={getModuleUrl:(e,{isModule:t=!0,defaultCDN:n="jspm"}={})=>{e=e.replace(/#nobundle/g,"");let s=be(e,t,n);return s||(t?"https://jspm.dev/"+e:"https://cdn.jsdelivr.net/npm/"+e)},getUrl:(e,t)=>e.startsWith("http")?e:be(e,!1,t||it())||e,cdnLists:{npm:ye,module:ve,gh:Se},checkCDNs:async(e,t)=>{let n=[t,...j.cdnLists.npm].filter(Boolean);for(let s of n)try{if((await fetch(j.getUrl(e,s),{method:"HEAD"})).ok)return s}catch{}return j.cdnLists.npm[0]}},it=()=>{if(globalThis.appCDN)return globalThis.appCDN;try{return new URL(location.href).searchParams.get("appCDN")||j.cdnLists.npm[0]}catch{return j.cdnLists.npm[0]}},be=(e,t,n)=>{let s=t&&e.startsWith("unpkg:")?"?module":"";e.startsWith("gh:")?e=e.replace("gh",Se[0]):e.includes(":")||(e=(n||(t?ve[0]:ye[0]))+":"+e);for(let r of lt){let[c,d]=r;if(c.test(e))return e.replace(c,d)+s}return null},lt=[[/^(jspm:)(.+)/i,"https://jspm.dev/$2"],[/^(npm:)(.+)/i,"https://jspm.dev/$2"],[/^(node:)(.+)/i,"https://jspm.dev/$2"],[/^(skypack:)(.+)/i,"https://cdn.skypack.dev/$2"],[/^(jsdelivr:)(.+)/i,"https://cdn.jsdelivr.net/npm/$2"],[/^(jsdelivr.gh:)(.+)/i,"https://cdn.jsdelivr.net/gh/$2"],[/^(statically:)(.+)/i,"https://cdn.statically.io/gh/$2"],[/^(esm.run:)(.+)/i,"https://esm.run/$2"],[/^(esm.sh:)(.+)/i,"https://esm.sh/$2"],[/^(esbuild:)(.+)/i,"https://esbuild.vercel.app/$2"],[/^(bundle.run:)(.+)/i,"https://bundle.run/$2"],[/^(unpkg:)(.+)/i,"https://unpkg.com/$2"],[/^(bundlejs:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(bundle:)(.+)/i,"https://deno.bundlejs.com/?file&q=$2"],[/^(deno:)(.+)/i,"https://deno.bundlejs.com/?file&q=https://deno.land/x/$2/mod.ts"],[/^(https:\/\/deno\.land\/.+)/i,"https://deno.bundlejs.com/?file&q=$1"],[/^(github:|https:\/\/github\.com\/)(.[^\/]+?)\/(.[^\/]+?)\/(?!releases\/)(?:(?:blob|raw)\/)?(.+?\/.+)/i,"https://deno.bundlejs.com/?file&q=https://cdn.jsdelivr.net/gh/$2/$3@$4"],[/^(gist\.github:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(gitlab:|https:\/\/gitlab\.com\/)([^\/]+.*\/[^\/]+)\/(?:raw|blob)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://gl.githack.com/$2/raw/$3"],[/^(bitbucket:|https:\/\/bitbucket\.org\/)([^\/]+\/[^\/]+)\/(?:raw|src)\/(.+?)(?:\?.*)?$/i,"https://deno.bundlejs.com/?file&q=https://bb.githack.com/$2/raw/$3"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/]+)\/revisions\/([^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/$3/files/$4"],[/^(bitbucket:)snippets\/([^\/]+\/[^\/\#\?]+)(?:\?[^#]*)?(?:\#file-(.+?))$/i,"https://bb.githack.com/!api/2.0/snippets/$2/HEAD/files/$3"],[/^(bitbucket:)\!api\/2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(api\.bitbucket:)2.0\/snippets\/([^\/]+\/[^\/]+\/[^\/]+)\/files\/(.+?)(?:\?.*)?$/i,"https://bb.githack.com/!api/2.0/snippets/$2/files/$3"],[/^(rawgit:)(.+?\/[0-9a-f]+\/raw\/(?:[0-9a-f]+\/)?.+)$/i,"https://gist.githack.com/$2"],[/^(rawgit:|https:\/\/raw\.githubusercontent\.com)(\/[^\/]+\/[^\/]+|[0-9A-Za-z-]+\/[0-9a-f]+\/raw)\/(.+)/i,"https://deno.bundlejs.com/?file&q=https://raw.githack.com/$2/$3"]];var{getUrl:D,getModuleUrl:Ya}=j;var we=D("flexsearch@0.7.21/dist/flexsearch.bundle.js");var ct="0.6.64",Va=D(`malinajs@${ct}/malina.js`);var A=D("@yaireo/tagify@4.9.6/dist/");var xe=e=>e.querySelector("#bulk-import-button"),Le=e=>e.querySelector("#export-all-button"),ke=e=>e.querySelector("#delete-all-button");var Ee=typeof window<"u"?window:null,Te=Ee===null,dt=Te?void 0:Ee.document;var ro=Te?"calc":["","-webkit-","-moz-","-o-"].filter(function(e){var t=dt.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length}).shift()+"calc";var Me=e=>{try{return JSON.parse(e).map(t=>t.value)}catch{return e.split(",").map(t=>t.trim())}};var ut=(e,t,n,s,r=!1)=>{let c=document.createElement("li");t.appendChild(c);let d=document.createElement("a");d.href="#",d.dataset.id=e.id,d.classList.add("open-project-link");let b=R()?new Date(e.lastModified).toLocaleDateString():new Date(e.lastModified).toLocaleString(),p=[];R()||e.languages.forEach(m=>{let l=document.createElement("span");l.classList.add("language-tag"),l.dataset.lang=s(m),r?l.classList.add("template-tag"):l.title="filter by language",l.textContent=n(m),p.push(l)});let E=[];e.tags=[...new Set(e.tags)].filter(Boolean),!R()&&e.tags.length>0&&e.tags.forEach(m=>{let l=document.createElement("span");l.classList.add("user-tag"),l.dataset.tag=m,r?l.classList.add("template-tag"):l.title="filter by tag",l.textContent=m,E.push(l)});let x=document.createElement("div");x.classList.add("open-title","overflow-text"),x.textContent=e.title,d.appendChild(x);let L=document.createElement("div");L.classList.add("light"),L.textContent="Last modified: "+b,d.appendChild(L);let v=document.createElement("div");v.classList.add("project-tags"),p.forEach(m=>v.append(m)),v.innerHTML+=E.length>0?' <span class="light">|</span> ':"",E.forEach(m=>v.append(m)),d.appendChild(v);let u=document.createElement("div");u.classList.add("template-default");let g=document.createElement("span");g.innerText="Set as default",g.classList.add("template-default-link"),u.appendChild(g);let h=document.createElement("span");h.classList.add("default-template-label"),h.innerText="Default template ",u.appendChild(h);let S=document.createElement("span");S.innerText="(unset)",S.classList.add("template-remove-default-link"),h.appendChild(S),r&&d.appendChild(u),c.appendChild(d);let y=document.createElement("button");return y.classList.add("delete-button"),c.appendChild(y),{link:d,deleteButton:y,setAsDefaultLink:g,removeDefaultLink:S}},mt=e=>{let t=document.createElement("div");return t.innerHTML=`
    <div class="modal-message">Loading...</div>
    <div class="modal-message">${e.title}</div>
    `,t},gt=(e,t,n,s)=>{let r="lastModified",c="desc",d,b=[],p,E=[],x=document.querySelector("#list-container #sort-by-last-modified"),L=document.querySelector("#list-container #sort-by-title"),v=document.querySelector("#list-container #sorted-asc"),u=document.querySelector("#list-container #sorted-desc"),g=document.querySelector("#list-container #language-filter"),h=document.querySelector("#list-container #filter-tags"),S=document.querySelector("#list-container #search-projects"),y=document.querySelector("#list-container #reset-filters");s.map(a=>({name:a.name,title:a.longTitle||a.title})).sort((a,o)=>a.title.toLowerCase()<o.title.toLowerCase()?-1:a.title.toLowerCase()>o.title.toLowerCase()?1:0).forEach(a=>{let o=document.createElement("option");o.text=a.title,o.value=a.name,g.appendChild(o)});let m=async()=>(await e()).filter(a=>d?a.languages.includes(d):!0).filter(a=>b.length>0?b.map(o=>a.tags.includes(o)).every(o=>o===!0):!0).filter(a=>S.value.trim()!==""?E.includes(a.id):!0).sort((a,o)=>r==="lastModified"&&c==="asc"?a.lastModified-o.lastModified:r==="lastModified"&&c==="desc"?o.lastModified-a.lastModified:r==="title"&&c==="asc"&&a.title<o.title?-1:r==="title"&&c==="asc"&&a.title>o.title||r==="title"&&c==="desc"&&a.title<o.title?1:r==="title"&&c==="desc"&&a.title>o.title?-1:0),l=()=>{document.querySelectorAll(".project-tags span").forEach(o=>{o.dataset.lang?n.addEventListener(o,"click",async f=>{f.stopPropagation(),g.value=o.dataset.lang||"",await H()},!1):o.dataset.tag&&n.addEventListener(o,"click",async f=>{f.stopPropagation(),p&&(p.removeAllTags(),p.addTags(o.dataset.tag),await _())},!1)})},k=async()=>{t(await m()),l()},M=()=>{c="asc",v.style.display="unset",u.style.display="none"},T=()=>{c="desc",v.style.display="none",u.style.display="unset"},_=async(a=h.value)=>{b=Me(a).filter(o=>o!==""),await k()},H=async(a=g.value)=>{d=a,await k()};n.addEventListener(x,"click",async a=>{a.preventDefault(),r!=="lastModified"||c==="asc"?T():M(),r="lastModified",x.classList.add("active"),L.classList.remove("active"),await k()},!1),n.addEventListener(L,"click",async a=>{a.preventDefault(),r!=="title"?M():c==="asc"?T():M(),r="title",x.classList.remove("active"),L.classList.add("active"),await k()},!1),n.addEventListener(v,"click",async a=>{a.preventDefault(),T(),await k()},!1),n.addEventListener(u,"click",async a=>{a.preventDefault(),M(),await k()},!1),n.addEventListener(h,"keyup",()=>_(h.value),!1),n.addEventListener(g,"change",async()=>{await H()},!1),l(),B(A+"tagify.css","tagify-styles"),q(A+"tagify.min.js","Tagify").then(async a=>{a&&(p=new a(h,{whitelist:Array.from(new Set((await e()).map(o=>o.tags).flat())).sort((o,f)=>f>o?-1:1),dropdown:{maxItems:40,enabled:0,closeOnSelect:!1,highlightFirst:!0}}),p.on("change",()=>_(JSON.stringify(p?.value||""))))}),q(we,"FlexSearch").then(async a=>{let o=new a.Document({index:["title","description","tags","languages"],tokenize:"full",worker:!0});await Promise.all((await e()).map(f=>o.add(f))),n.addEventListener(S,"keyup",async()=>{E=(await o.searchAsync(S.value)).map(w=>w.result).flat(),await k()},!1)}),n.addEventListener(y,"click",async a=>{a.preventDefault(),r="lastModified",c="desc",d="",b=[],E=[],x.classList.add("active"),L.classList.remove("active"),T(),g.value="",p?.removeAllTags(),S.value="",await k()},!1)},Fo=async({projectStorage:e,eventsManager:t,showScreen:n,getContentConfig:s,notifications:r,modal:c,loadConfig:d,getProjectId:b,setProjectId:p,languages:E,getLanguageTitle:x,getLanguageByAlias:L})=>{let v=document.createElement("div");v.innerHTML=ge;let u=v.firstChild,g=u.querySelector(".no-data"),h=u.querySelector("#no-match.no-data"),S=u.querySelector("#projects-container"),y=document.createElement("ul");y.classList.add("open-list");let m=await e.getList(),l=m,k=xe(u),M=Le(u),T=ke(u);t.addEventListener(k,"click",()=>{n("import")},!1),t.addEventListener(M,"click",async()=>{let a=(await e.getAllData()).filter(w=>l.find(C=>C.id===w.id)).map(w=>({...w,config:s(w.config)})).sort((w,C)=>w.lastModified-C.lastModified),o="livecodes_export_"+fe(),f="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(a));he(o,"json",f)},!1),t.addEventListener(T,"click",async()=>{r.confirm(`Delete ${l.length} projects?`,async()=>{for(let a of l)await e.deleteItem(a.id),b()===a.id&&p("");l=[],m=await e.getList(),await _(l)})},!1),S.appendChild(y);let _=async a=>{l=a,y.innerHTML="",a.forEach(o=>{let{link:f,deleteButton:w}=ut(o,y,x,L);t.addEventListener(f,"click",async C=>{C.preventDefault();let U=mt(o);c.show(U,{size:"small"});let I=f.dataset.id||"",P=(await e.getItem(I))?.config;P&&(await d(P),p(I)),c.close(),U.remove()},!1),t.addEventListener(w,"click",()=>{r.confirm(`Delete project: ${o.title}?`,async()=>{o.id===b()&&p(""),await e.deleteItem(o.id),l=l.filter(U=>U.id!==o.id),w.parentElement.classList.add("hidden"),setTimeout(()=>{_(l)},500)})},!1)}),a.length===0?(y.classList.add("hidden"),T.classList.add("hidden"),M.classList.add("hidden"),(await e.getList()).length===0?(g.classList.remove("hidden"),h.classList.add("hidden")):(g.classList.add("hidden"),h.classList.remove("hidden"))):(y.classList.remove("hidden"),T.classList.remove("hidden"),M.classList.remove("hidden"),g.classList.add("hidden"),h.classList.add("hidden"))};await _(m);let H=()=>e.getList();c.show(u,{isAsync:!0}),gt(H,_,t,E)};export{ut as createOpenItem,Fo as createSavedProjectsList};
