...
`;var z=`<ul id="settings-menu" class="dropdown-menu">\r
  <li>\r
...
`;var q=`<section data-lang="art-template">\r
...
`;var $=`<div id="test-editor-container" class="modal-container">
...
`;var Y=`<div id="import-container" class="modal-container">
...
`;var V=`<div id="deploy-container" class="modal-container">
...
`;var K=`<div id="sync-container" class="modal-container">
...
`;var Q=`<div id="backup-container" class="modal-container">
...
`;var ee=`<div id="welcome-container" class="modal-container">\r
...
`;var te=`<div id="about-container" class="modal-container">\r
...
`;var ae=`<div id="info-container" class="modal-container">
...
`;var ie=`<div id="resources-container" class="modal-container">
...
`;var le=`<div id="login-screen" class="modal-container">\r
...
`;var ce=`<div id="assets-list-container" class="list-container">
...
`;var de=`<div id="add-asset-container" class="modal-container">
...
`;var pe=`<div id="snippets-list-container" class="list-container">
...
`;var me=`<div id="add-snippet-container" class="modal-container">
...
`;var ue=`<div id="share-screen" class="modal-container">\r
...
`;var he=`<div id="embed-container" class="modal-container">
...
`;var ge=`<div id="editor-settings-container" class="modal-container">
...
`;var l=n=>n.replace(/{{APP_VERSION}}/g,"4").replace(/{{SDK_VERSION}}/g,"0.0.2").replace(/{{COMMIT_SHA}}/g,"fe430fb").replace(/{{REPO_URL}}/g,"https://github.com/live-codes/livecodes").replace(/{{DOCS_BASE_URL}}/g,"/livecodes/docs/"),la=l(X),ra=l(G),oa=l(z),na=l(q),sa=l(W),ca=l($),da=l(Y),pa=l(V),ma=l(K),ua=l(Q),ha=l(Z),ga=l(ee),ba=l(te),va=l(ae),fa=l(ie),wa=l(le),ya=l(re),ka=l(oe),Sa=l(ne),_a=l(se),La=l(ce),xa=l(de),Ca=l(pe),Ra=l(me),ja=l(ue),ve=l(he),Ea=l(ge),Ua=l(be);var x=n=>n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/'/g,"&#39;").replace(/"/g,"&#34;");var S=(n,o=!0)=>n.replace(/\\/g,o?"\\\\":"\\").replace(/`/g,"\\`").replace(/<\/script>/g,"<\\/script>");var fe=n=>JSON.parse(JSON.stringify(n));var we=n=>{if(document.queryCommandSupported&&document.queryCommandSupported("copy")){let o=document.createElement("textarea");o.textContent=n,o.style.position="fixed",document.body.appendChild(o),o.select();try{return document.execCommand("copy")}catch(m){return console.warn("Copy to clipboard failed.",m),!1}finally{document.body.removeChild(o)}}return!1};var _=(n,o,m=!0)=>(m?"":" ".repeat(o))+n.split(`
`).join(`
`+" ".repeat(o));var Ze={esm:"livecodes.js",umd:"livecodes.umd.js",react:"react.js",vue:"vue.js",types:"index.d.ts"},ye={getAppUrl:()=>"https://v4.livecodes.io/",getSDKUrl:(n="esm")=>`https://cdn.jsdelivr.net/npm/livecodes@0.0.2/${Ze[n]}`};var Ja=async({baseUrl:n,config:o,editorLanguages:m,modal:ke,notifications:U,eventsManager:A,createEditorFn:Se,getUrlFn:T})=>{let C=o.title,u=o.activeEditor||"markup",P=document.createElement("div");P.innerHTML=ve;let v=P.firstChild;ke.show(v,{isAsync:!0});let R=v.querySelector("#embed-preview-container"),f=v.querySelector("#embed-form"),D=v.querySelector("#embed-code"),O=v.querySelector("#embed-copy-btn");if(!R||!f||!D||!O)return;[{title:"Theme",name:"theme",options:[{label:"Dark",value:"dark",checked:!0},{label:"Light",value:"light"}]},{title:"Loading",name:"loading",options:[{label:"Lazy",value:"lazy",checked:!0},{label:"On-click",value:"click"},{label:"Eager",value:"eager"}]},{title:"Show Result Preview",name:"preview",options:[{value:"true",checked:!1}],help:"/livecodes/docs/features/embeds#result-page-preview"},{title:"Lite Mode",name:"lite",options:[{value:"true",checked:!1}],help:"/livecodes/docs/features/lite"},{title:"Read only",name:"readonly",options:[{value:"true",checked:!1}]},{title:"Display Mode",name:"mode",options:[{label:"Full",value:"full",checked:!0},{label:"Editor",value:"editor"},{label:"Code Block",value:"codeblock"},{label:"Result",value:"result"}],help:"/livecodes/docs/features/display-modes"},{title:"Default View",name:"view",options:[{label:"Split",value:"split",checked:!0},{label:"Editor",value:"editor"},{label:"Result",value:"result"}],help:"/livecodes/docs/features/default-view"},{title:"Active Editor",name:"activeEditor",options:[{label:m.markup,value:"markup",checked:u==="markup"},{label:m.style,value:"style",checked:u==="style"},{label:m.script,value:"script",checked:u==="script"}]},{title:"Tools",name:"tools",options:[{label:"Closed",value:"closed",checked:!0},{label:"Open",value:"open"},{label:"Full",value:"full"},{label:"None",value:"none"}],help:"/livecodes/docs/features/tools-pane"},{title:"Active Tool",name:"activeTool",options:[{label:"Console",value:"console",checked:!0},{label:"Compiled",value:"compiled"},{label:"Tests",value:"tests"}].filter(e=>!(e.value==="tests"&&!o.tests?.content)),help:"/livecodes/docs/features/tools-pane"},{title:"Permanent URL",name:"permanentUrl",options:[{value:"true",checked:!0}],help:"/livecodes/docs/features/permanent-url"},{title:"Embed Type",name:"type",options:[{label:"Script (CDN)",value:"cdn",checked:!0},{label:"Script (npm)",value:"npm"},{label:"React",value:"react"},{label:"Vue",value:"vue"},{label:"Iframe",value:"iframe"},{label:"HTML",value:"html"}]}].forEach(e=>{let a=document.createElement("label");if(a.innerHTML=e.title,f.appendChild(a),e.help){let i=document.createElement("a");i.href=e.help,i.target="_blank",i.classList.add("help-link"),i.title="Click for info...",a.appendChild(i);let s=document.createElement("img");s.src=n+"assets/icons/info.svg",i.appendChild(s)}let r=document.createElement("div");r.classList.add("input-container"),f.appendChild(r),e.options.forEach(i=>{let s=`embed-${e.name}`,c=`${s}-${i.value}`,k=!i.label&&i.value==="true",g=document.createElement("span");r.appendChild(g);let d=document.createElement("input");if(d.type=k?"checkbox":"radio",d.name=s,d.id=c,d.value=i.value,d.checked=i.checked||!1,g.appendChild(d),k)d.classList.add("switch");else{let t=document.createElement("label");t.classList.add("radio-label"),t.htmlFor=c,t.innerHTML=i.label||"",g.appendChild(t)}})});let L=await Se(D),M="https://livecodes.io",B=ye.getSDKUrl("umd"),w=await T(!0),h=new URL(w),j=h.origin+h.pathname,E=document.createElement("iframe");E.id="embed-preview-iframe",R.innerHTML="",R.appendChild(E);let J=()=>"livecodes-"+(Math.random()+1).toString(36).substring(2),H=e=>`
<div id="${e}">
  <span>Open the project <a href="${w}" target="_blank">${C}</a> in <a href="${M}" target="_blank">LiveCodes</a>.</span>
</div>
`.trimStart(),y=e=>{let a={...e.mode!==b.mode?{mode:e.mode}:{},...e.theme!==b.theme?{theme:e.theme}:{},...e.tools!=="closed"||e.activeTool!=="console"?{tools:{enabled:e.tools==="none"?[]:"all",status:e.tools,active:e.activeTool}}:{},...e.readonly?{readonly:e.readonly}:{},...e.mode!=="result"&&e.activeEditor!==u?{activeEditor:e.activeEditor}:{}},r=h.searchParams.get("x");return{...j!=="https://livecodes.io/"?{appUrl:j}:{},...Object.keys(a).length>0?{config:a}:{},...r?{import:r}:{},...e.lite?{lite:e.lite}:{},...e.loading!=="lazy"?{loading:e.loading}:{},...e.loading==="click"&&e.preview?{params:{preview:!0}}:{},...e.view&&e.view!=="split"?{view:e.view}:{}}},I=e=>{let a=new URL(w);return a.searchParams.set(e.lite?"lite":"embed","true"),e.loading&&e.loading!=="lazy"&&a.searchParams.set("loading",String(e.loading)),e.loading==="click"&&e.preview&&a.searchParams.set("preview","true"),e.view&&e.view!=="split"&&a.searchParams.set("view",String(e.view)),e.mode!=="result"&&e.activeEditor&&e.activeEditor!==u&&a.searchParams.set("activeEditor",String(e.activeEditor)),e.mode&&e.mode!==b.mode&&a.searchParams.set("mode",String(e.mode)),e.theme&&e.theme!==b.theme&&a.searchParams.set("theme",String(e.theme)),e.tools&&(e.tools!=="closed"||e.activeTool!=="console")&&a.searchParams.set(e.tools==="none"?"tools":String(e.activeTool),String(e.tools)),e.readonly!==void 0&&a.searchParams.set("readonly",String(e.readonly)),decodeURIComponent(a.href)},_e={cdn:e=>{let a=J(),r=H(a),i=y(e),s=JSON.stringify(i,null,2),c=_(s,2);return`
${r}
<script src="${B}"><\/script>
<script>
  const options = ${c};
  livecodes.createPlayground("#${a}", options);
<\/script>
`.trimStart()},npm(e){let a=J(),r=H(a),i=y(e),s=JSON.stringify(i,null,2),c=_(s,2);return`
${r}
<script type="module">
  import { createPlayground } from "livecodes";
  const options = ${c};
  createPlayground("#${a}", options);
<\/script>
`.trimStart()},react(e){let a=y(e),r=JSON.stringify(a,null,2);return`
import LiveCodes from "livecodes/react";
export default function App() {
  const options = ${_(r,2)};
  return <LiveCodes {...options}></LiveCodes>;
}
`.trimStart()},vue(e){let a=y(e),r=JSON.stringify(a,null,2);return`
<script setup>
...
`.trimStart()},iframe:e=>{let a=I(e),r=new URL(a);r.searchParams.delete("embed"),r.searchParams.delete("lite");let i=decodeURIComponent(r.href);return`
<iframe title="${C}" scrolling="no" loading="lazy" style="height:300px; width: 100%; border:1px solid black; border-radius:5px;" src="${a}">
  See the project <a href="${i}" target="_blank">${C}</a> on <a href="${M}" target="_blank">LiveCodes</a>.
</iframe>
`.trimStart()},html:e=>{let{import:a,...r}=y(e),i={...fe(o),...r.config};return Object.keys(i).forEach(c=>{(JSON.stringify(i[c])===JSON.stringify(b[c])||c==="activeEditor"&&i.activeEditor==="markup"||["markup","style","script"].includes(c))&&delete i[c]}),Object.keys(i).length>0&&(r.config=i),`
<div class="livecodes" style="height: 300px;" data-options='${S(JSON.stringify(r).replace(/'/g,"&#39;"))}'>
<pre data-lang="${o.markup.language}">${S(x(o.markup.content||""))}</pre>
<pre data-lang="${o.style.language}">${S(x(o.style.content||""))}</pre>
<pre data-lang="${o.script.language}">${S(x(o.script.content||""))}</pre>
</div>
<script defer src="${B}" data-prefill><\/script>
`.trimStart()}},p={preview:!1,view:"split",tools:"closed",activeTool:"console"},F=async()=>{let e=Array.from(new FormData(f)).reduce((t,[Le,N])=>({...t,[Le.replace("embed-","")]:N==="true"?!0:N}),{});w=await T(!!e.permanentUrl),h=new URL(w),j=h.origin+h.pathname;let a=document.querySelector('input[name="embed-preview"]');e.loading!=="click"?(a.checked=!1,a.disabled=!0,e.preview=!1):a.disabled=!1;let r=document.querySelectorAll('input[name="embed-view"]');e.mode!=="full"?(p.view=e.view||p.view,delete e.view,r.forEach(t=>{t.checked=!1,t.disabled=!0})):r.forEach(t=>{t.value===(e.view||p.view)&&(t.checked=!0),t.disabled=!1,t.checked&&(e.view=t.value)});let i=document.querySelectorAll('input[name="embed-tools"]'),s=document.querySelectorAll('input[name="embed-activeTool"]');e.lite?(p.tools=e.tools||p.tools,delete e.tools,i.forEach(t=>{t.checked=!1,t.disabled=!0})):i.forEach(t=>{t.value===(e.tools||p.tools)&&(t.checked=!0),t.disabled=!1,t.checked&&(e.tools=t.value)}),e.lite||e.tools==="none"?(p.activeTool=e.activeTool||p.activeTool,delete e.activeTool,s.forEach(t=>{t.checked=!1,t.disabled=!0})):s.forEach(t=>{t.value===(e.activeTool||p.activeTool)&&(t.checked=!0),t.disabled=!1,t.checked&&(e.activeTool=t.value)}),document.querySelectorAll('input[name="embed-activeEditor"]').forEach(t=>{e.mode==="result"?(t.checked=t.value===u,t.disabled=!0,delete e.activeEditor):t.disabled=!1}),E.src=I(e);let k=e.type,g=_e[k]?.(e),d=k==="react"?"jsx":"html";L.getLanguage()!==d?L.setLanguage(d,g):L.setValue(g)};A.addEventListener(f,"change",F),A.addEventListener(O,"click",async()=>{we(L.getValue())?U.success("Code copied to clipboard"):U.error("Failed to copy to clipboard")}),F()};export{Ja as createEmbedUI};
