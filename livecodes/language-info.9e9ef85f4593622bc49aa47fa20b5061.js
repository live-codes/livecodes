...
`;var i=`<ul id="settings-menu" class="dropdown-menu">\r
  <li>\r
...
`;var l=`<section data-lang="art-template">\r
...
`;var r=`<div id="custom-settings-container" class="modal-container">
...
`;var s=`<div id="test-editor-container" class="modal-container">
...
`;var o=`<div id="import-container" class="modal-container">
...
`;var n=`<div id="deploy-container" class="modal-container">
...
`;var d=`<div id="sync-container" class="modal-container">
...
`;var c=`<div id="backup-container" class="modal-container">
...
`;var h=`<div id="welcome-container" class="modal-container">\r
...
`;var m=`<div id="about-container" class="modal-container">\r
...
`;var u=`<div id="info-container" class="modal-container">
...
`;var g=`<div id="resources-container" class="modal-container">
...
`;var b=`<div id="login-screen" class="modal-container">\r
...
`;var f=`<div id="prompt-recover-screen">
...
`;var k=`<div id="list-container" class="list-container">
...
`;var y=`<div id="assets-list-container" class="list-container">
...
`;var _=`<div id="add-asset-container" class="modal-container">
...
`;var S=`<div id="snippets-list-container" class="list-container">
...
`;var x=`<div id="add-snippet-container" class="modal-container">
...
`;var L=`<div id="share-screen" class="modal-container">\r
...
`;var R=`<div id="embed-container" class="modal-container">
...
`;var C=`<div id="editor-settings-container" class="modal-container">
...
`;var e=A=>A.replace(/{{APP_VERSION}}/g,"4").replace(/{{SDK_VERSION}}/g,"0.0.2").replace(/{{COMMIT_SHA}}/g,"fe430fb").replace(/{{REPO_URL}}/g,"https://github.com/live-codes/livecodes").replace(/{{DOCS_BASE_URL}}/g,"/livecodes/docs/"),ot=e(t),nt=e(a),dt=e(i),le=e(l),ct=e(r),pt=e(s),ht=e(o),mt=e(n),ut=e(d),gt=e(c),bt=e(p),vt=e(h),ft=e(m),wt=e(u),kt=e(g),yt=e(b),_t=e(v),St=e(f),xt=e(w),Lt=e(k),Rt=e(y),Ct=e(_),jt=e(S),At=e(x),Ut=e(L),Pt=e(R),Dt=e(C),Ot=e(j);export{le as languageInfo};
