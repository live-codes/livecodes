...
* **result:** `config.modules` has been replaced by `config.imports`
* **config:** use config option `activeEditor` instead of `language`
(automatically changed in config upgrade)
* **UI:** `autoprefixer` config option moved to `processors.postcss`
...
* **app:** format on save ([e0fd603](https://github.com/live-codes/livecodes/commit/e0fd603032302dce1521463a3b258654487d227e))
