...
const prepareFiles = ({
  ...
  if (commitSource) {
    ...
    files.push(
      ...
      { path: 'src/localpen.json', content: JSON.stringify(config, null, 2) },
    );
  }
  return files;
};
  ...
  const linkToSource = !sourcePublished
    ...
    <div class="description">
      ...
      <p>
        Permanent link:
        <a
          href="https://localpen.io/?config=https://raw.githubusercontent.com/${username}/${repo}/${commit}/src/localpen.json"
          target="_blank"
        >
          Edit in LocalPen
        </a>
