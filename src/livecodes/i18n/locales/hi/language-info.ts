...
const languageInfo: I18nLangInfoTranslation = {
  ...
  cWasm: {
    desc: 'C को <1>Clang</1> द्वारा WebAssembly में संकलित किया गया है, जो पूरी तरह से ब्राउज़र में चलता है।',
    link: '<1> <2>C भाषा संदर्भ</2> </1> <3> <4>Clang आधिकारिक वेबसाइट</4> </3> <5> <6>X को Y मिनटों में सीखें, जहां X=C</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'C (Wasm)',
  },
  civet: {
  ...
  cpp: {
    ...
    desc2:
      'यह C++ का पूर्ण कार्यान्वयन नहीं है। कृपया विवरण के लिए <1>JSCPP दस्तावेज़ीकरण</1> देखें।',
    link: '<1> <2>मानक C++ फाउंडेशन</2> </1> <3> <4>JSCPP</4> </3> <5> <6>X को Y मिनटों में सीखें, जहां X=C++</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'C++',
  },
  cppWasm: {
    desc: 'C++ को <1>Clang</1> द्वारा WebAssembly में संकलित किया गया है, जो पूरी तरह से ब्राउज़र में चलता है। यह एक वास्तविक C++ कंपाइलर प्रदान करता है, <2>JSCPP-आधारित C++</2> इंटरप्रेटर के विपरीत।',
    link: '<1> <2>मानक C++ फाउंडेशन</2> </1> <3> <4>Clang आधिकारिक वेबसाइट</4> </3> <5> <6>X को Y मिनटों में सीखें, जहां X=C++</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'C++ (Wasm)',
  },
  csharpWasm: {
    desc: 'C# कंपाइलर WebAssembly पर चल रहा है, का उपयोग करके <1>ब्लेज़र</1>',
    link: '<1> <2>सी# भाषा दस्तावेज़ीकरण</2> </1> <3> <4>एक्स को वाई मिनटों में सीखें, जहां एक्स=सी#</4> </3> <5> <6>लाइवकोड दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'C# (Wasm)',
  },
  diagrams: {
    desc1: '(प्रायोगिक)',
    ...
    desc3:
      '<1> <2>Cytoscape</2> </1> <3> <4>ELK</4> (<5>elkjs</5> का उपयोग करके) </3> <6> <7>Gnuplot</7> (<8>gnuplot-JS</8> का उपयोग करके) </6> <9> <10>Graphviz</10> (<11>@hpcc-js/wasm</11> का उपयोग करके) </9> <12> <13>Mermaid</13> </12> <14> <15>Nomnoml</15> </14> <16> <17>Pintora</17> </16> <18> <19>Plotly</19> </18> <20> <21>Svgbob</21> </20> <22> <23>Vega</23> </22> <24> <25>VegaLite</25> </24> <26> <27>WaveDrom</27> </26>',
  ...
  elm: {
    desc: 'एल्म को ब्राउज़र में एल्म कंपाइलर के एक वेबअसेंबली (WebAssembly) बिल्ड द्वारा जावास्क्रिप्ट में कंपाइल किया जाता है।',
    link: '<1><2>Elm आधिकारिक वेबसाइट</2></1> <3><4>Elm गाइड</4></3> <5> <6>LiveCodes दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'Elm',
  },
  eta: {
  ...
  fsharp: {
    desc1:
      'F# एक क्रॉस-प्लेटफ़ॉर्म, ओपन-सोर्स फ़ंक्शनल प्रोग्रामिंग भाषा है जो .NET प्लेटफ़ॉर्म पर चलती है।',
    desc2: 'यहां, इसे फेबल का उपयोग करके जावास्क्रिप्ट में संकलित किया जाता है।',
    link: '<1><2>एफ# आधिकारिक वेबसाइट</2></1> <3> <4>एफ# दस्तावेज</4> </3> <5> <6>कल्पित आधिकारिक वेबसाइट</6> </5> <7> <8>लाइवकोड दस्तावेज</8> </7> <9> <10>स्टार्टर लोड करें टेम्पलेट</10> </9>',
    name: 'F#',
  },
  fsharpWasm: {
    desc: 'वेबअसेंबली पर चलने वाला असली F# कंपाइलर और .NET रनटाइम। <1></1> यह आधिकारिक F# कंपाइलर के व्यवहार से मेल खाता है। हालाँकि, .NET वेबअसेंबली रनटाइम को परिणाम पृष्ठ में डाउनलोड करने की आवश्यकता होती है, जिसमें पहली बार चलाने पर कुछ समय लग सकता है।',
    link: '<1><2>एफ# आधिकारिक वेबसाइट</2></1> <3> <4>एफ# दस्तावेज</4> </3> <5> <6>लाइवकोड दस्तावेजीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'F# (Wasm)',
  },
  gleam: {
  ...
  go: {
    ...
    link: '<1><2>Go वेबसाइट</2></1> <3><4>Go दस्तावेज़ीकरण</4></3> <5> <6>GopherJS रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=Go</8> </7> <9> <10>LiveCodes दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'Go',
  },
  goWasm: {
    desc: 'Yaegi का उपयोग करके WebAssembly पर चलने वाले दुभाषिया पर जाएं',
    link: '<1><2>आधिकारिक वेबसाइट पर जाएं</2></1> <3><4>यागी</4></3> <5> <6>Y मिनट में X जानें, जहां X=Go</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Go (Wasm)',
  },
  haml: {
  ...
  haskell: {
    desc: 'माइक्रोएचएस का उपयोग करके ब्राउज़र में हास्केल चलाना।',
    link: ' <1> <2>हैस्केल (Haskell) आधिकारिक वेबसाइट</2> </1> <3> <4>गिटहब (GitHub) पर MicroHs</4> </3> <5> <6>लाइवकोड्स (LiveCodes) दस्तावेज़</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7> ',
    name: 'Haskell',
  },
  haskellWasm: {
    desc: 'Haskell को ब्राउज़र में <1>GHC in the browser</1> द्वारा संकलित और चलाया जाता है, जो GHC का एक WebAssembly बिल्ड है, जो पूरी तरह से क्लाइंट-साइड पर चलता है।',
    link: '<1> <2>हैस्केल (Haskell) आधिकारिक वेबसाइट</2> </1> <3> <4>GHC दस्तावेज़ (documentation)</4> </3> <5> <6>ब्राउज़र में GHC</6> </5> <7> <8>LiveCodes दस्तावेज़</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Haskell (Wasm)',
  },
  imba: {
  ...
  java: {
    ...
    link: '<1> <2>जावा आधिकारिक वेबसाइट</2> </1> <3> <4>DoppioJVM</4> </3> <5> <6>वाई मिनटों में एक्स सीखें, जहां एक्स=जावा</6> </5> <7> <8>LiveCodes दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Java',
  },
  javascript: {
    desc: 'वेब की स्क्रिप्टिंग भाषा।',
    link: '<1> <2>MDN पर जावास्क्रिप्ट</2> </1> <3> <4>X को Y मिनट में सीखें, जहाँ X = जावास्क्रिप्ट है।</4> </3> <5> <6>लाइवकोड दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'JavaScript',
  },
  jinja: {
    desc: 'जिंजा एक तेज, अभिव्यंजक, विस्तारयोग्य टेम्प्लेटिंग इंजन है।',
    link: '<1> <2>आधिकारिक वेबसाइट</2> </1> <3> <4>टेम्पलेट दस्तावेज</4> </3> <5> <6>जावास्क्रिप्ट कार्यान्वयन</6> </5> <7> <8>लाइवकोड दस्तावेज</8> </7>',
    name: 'Jinja',
  },
  jsx: {
  ...
  minizinc: {
    desc: 'MiniZinc एक उच्च-स्तरीय बाधा मॉडलिंग भाषा है जो आपको असतत अनुकूलन समस्याओं को आसानी से व्यक्त करने और हल करने की अनुमति देती है।',
    link: '<1> <2>मिनीजिंक की आधिकारिक वेबसाइट</2> </1> <3> <4>मिनीजिंक दस्तावेज़ीकरण</4> </3> <5> <6>मिनीजिंक ट्यूटोरियल</6> </5> <7> <8>लाइवकोड दस्तावेज़</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'MiniZinc',
  },
  mjml: {
  ...
  objcWasm: {
    desc: 'Objective-C को <1>Clang</1> द्वारा WebAssembly में संकलित किया गया है, जो <2>GNUstep</2> Objective-C रनटाइम का उपयोग करता है। यह एक रनटाइम है, क्लास लाइब्रेरी नहीं, इसलिए Foundation उपलब्ध नहीं है।',
    link: '<1> <2>Objective-C दस्तावेज़ीकरण</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>X को Y मिनटों में सीखें, जहां X=Objective-C</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Objective-C (Wasm)',
  },
  objcppWasm: {
    desc: 'Objective-C++ को <1>Clang</1> द्वारा WebAssembly में संकलित किया गया है, जो <2>GNUstep</2> Objective-C रनटाइम का उपयोग करता है। यह एक रनटाइम है, क्लास लाइब्रेरी नहीं, इसलिए Foundation उपलब्ध नहीं है।',
    link: '<1> <2>Objective-C दस्तावेज़ीकरण</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>X को Y मिनटों में सीखें, जहां X=Objective-C</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7>',
    name: 'Objective-C++ (Wasm)',
  },
  ocaml: {
    desc1:
  ...
  rustWasm: {
    desc: 'रस्ट को <1>Miri</1> (रस्ट मिड-लेवल आईआर इंटरप्रेटर) द्वारा व्याख्यायित किया जाता है, जिसे वेबअसेंबली में संकलित किया जाता है और यह पूरी तरह से ब्राउज़र में चलता है।',
    link: '<1> <2>रस्ट आधिकारिक वेबसाइट</2> </1> <3> <4>द रस्ट बुक</4> </3> <5> <6>Y मिनट में X सीखें, जहाँ X=रस्ट</6> </5> <7> <8>लाइवकोड्स दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Rust (Wasm)',
  },
  sass: {
  ...
  vbWasm: {
    desc: 'VB.NET कंपाइलर WebAssembly पर चल रहा है, <1>Roslyn</1> और <2>.NET वेबअसेंबली रनटाइम</2> का उपयोग करके',
    link: '<1> <2>Visual Basic भाषा दस्तावेज़ीकरण</2> </1> <3> <4>एक्स को वाई मिनटों में सीखें, जहां एक्स=Visual Basic</4> </3> <5> <6>लाइवकोड दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'VB.NET (Wasm)',
  },
  vue: {
  ...
  zigWasm: {
    desc: 'वेबअसेंबली पर चल रहा ज़िग कंपाइलर।',
    link: '<1> <2>ज़िग वेबसाइट</2> </1> <3> <4>ज़िग भाषा दस्तावेज़ीकरण</4> </3> <5> <6>वाई मिनटों में एक्स सीखें, जहां एक्स=ज़िग</6> </5> <7> <8>लाइवकोड दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Zig (Wasm)',
  },
};
