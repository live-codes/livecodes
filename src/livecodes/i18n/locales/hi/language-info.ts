...
const languageInfo: I18nLangInfoTranslation = {
  ...
  zigWasm: {
    ...
    link: '<टैग-1> <टैग-2>ज़िग वेबसाइट</टैग-2> </टैग-1> <टैग-3> <टैग-4>ज़िग भाषा दस्तावेज़ीकरण</टैग-4> </टैग-3> <टैग-5> <टैग-6>वाई मिनटों में एक्स सीखें, जहां एक्स=ज़िग</टैग-6> </टैग-5> <टैग-7> <टैग-8>लाइवकोड दस्तावेज़ीकरण</टैग-8> </टैग-7> <टैग-9> <टैग-10>स्टार्टर टेम्पलेट लोड करें</टैग-10> </टैग-9>',
    name: 'Zig (Wasm)',
  },
};
