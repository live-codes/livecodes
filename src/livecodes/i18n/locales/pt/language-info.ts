...
const languageInfo: I18nLangInfoTranslation = {
  ...
  go: {
    ...
    link: '<1><2>Ir para o site</2></1> <3><4>Documentação do Go</4></3> <5> <6>Repositório do GopherJS</6> </5> <7> <8>Aprenda X em Y minutos, onde X = Go</8> </7> <9> <10>Documentação do LiveCodes</10> </9> <11> <12>Carregar modelo inicial</12> </11>',
    name: 'Go',
  },
  goWasm: {
