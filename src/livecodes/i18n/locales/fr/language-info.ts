...
const languageInfo: I18nLangInfoTranslation = {
  ...
  cpp: {
    ...
    desc2:
      "Ce n'est pas une implémentation complète de C++. Veuillez vous référer à la <1>documentation JSCPP</1> pour plus de détails.",
  ...
  go: {
    ...
    link: '<1><2>Site web de Go</2></1> <3><4>Documentation Go</4></3> <5> <6>Dépôt GopherJS</6> </5> <7> <8>Apprenez X en Y minutes, où X = Go</8> </7> <9> <10>Documentations LiveCodes</10> </9> <11> <12>Charger un modèle de démarrage</12> </11>',
    name: 'Go',
  },
  goWasm: {
    desc: 'Interpréteur Go fonctionnant sur WebAssembly, utilisant Yaegi',
    link: '<1><2>Site officiel de Go</2></1> <3><4>Yaegi</4></3> <5> <6>Apprendre X en Y minutes, où X=Go</6> </5> <7> <8>LiveCodes Documentations</8> </7> <9> <10>Charger un modèle de démarrage</10> </9>',
    name: 'Go (Wasm)',
  },
  haml: {
