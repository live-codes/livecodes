...
const languageInfo: I18nLangInfoTranslation = {
  ...
  cWasm: {
    desc: 'C کو <1>Clang</1> کے ذریعے WebAssembly میں مرتب کیا گیا ہے اور یہ مکمل طور پر براؤزر میں چلتا ہے۔',
    link: '<1> <2>سی زبان کا حوالہ</2> </1> <3> <4>کلینگ کی سرکاری ویب سائٹ</4> </3> <5> <6>X کو Y منٹ میں سیکھیں، جہاں X=C</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7> <9> <10>ابتدائی سانچہ لوڈ کریں</10> </9>',
    name: 'C (Wasm)',
  },
  civet: {
  ...
  cpp: {
    ...
    desc2:
      'یہ سی++ کا مکمل نفاذ نہیں ہے۔ تفصیلات کے لیے براہ کرم <1>جے ایس سی پی پی دستاویزات</1> سے رجوع کریں۔',
  ...
  cppWasm: {
    desc: 'C++ کو <1>Clang</1> کے ذریعے WebAssembly میں مرتب کیا گیا ہے اور یہ مکمل طور پر براؤزر میں چلتا ہے۔ یہ ایک حقیقی C++ کمپائلر فراہم کرتا ہے، برخلاف <2>JSCPP پر مبنی C++</2> ترجمان کے۔',
    link: '<1> <2>معیاری سی++ فاؤنڈیشن</2> </1> <3> <4>کلینگ کی سرکاری ویب سائٹ</4> </3> <5> <6>X کو Y منٹ میں سیکھیں، جہاں X=سی++</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7> <9> <10>ابتدائی سانچہ لوڈ کریں</10> </9>',
    name: 'C++ (Wasm)',
  },
  csharpWasm: {
    desc: 'سی # کمپائلر ویب اسمبلی پر چل رہا ہے، استعمال کر رہا ہے <1>Blazor</1>',
    link: '<1> <2> C# زبان کی دستاویزات </2> </1> <3> <4> Y منٹوں میں X سیکھیں، جہاں X=C# </4> </3> <5> <6> LiveCodes ڈاکومینٹیشن </6> </5> <7> <8> </8> شروع کریں </7>',
    name: 'C# (Wasm)',
  },
  diagrams: {
    desc1: '(تجرباتی)',
  ...
  elm: {
    desc: 'ایلم (Elm) کو براؤزر میں ایلم کمپائلر کے ویب اسمبلی (WebAssembly) بلڈ کے ذریعے جاوا اسکرپٹ میں کمپائل کیا جاتا ہے۔',
    link: '<1><2>Elm کی سرکاری ویب سائٹ</2></1> <3><4>Elm گائیڈ</4></3> <5> <6>LiveCodes دستاویزی مواد</6> </5> <7> <8>سٹارٹر ٹیمپلیٹ لوڈ کریں</8> </7>',
    name: 'ایلم',
  },
  eta: {
  ...
  fsharp: {
    desc1:
      'F# ایک کراس پلیٹ فارم، اوپن سورس فنکشنل پروگرامنگ لینگویج ہے جو .NET پلیٹ فارم پر چلتی ہے۔',
    desc2: 'یہاں، اسے Fable کا استعمال کرتے ہوئے JavaScript پر مرتب کیا گیا ہے۔',
    link: '<1><2>F# آفیشل ویب سائٹ</2></1> <3> <4>F# دستاویزات</4> </3> <5> <6>Fable آفیشل ویب سائٹ</6> </5> <7> <8>LiveCodes Documentations</8> </7> <9> <10>لوڈ اسٹارٹر ٹیمپلیٹ</10> </9>',
    name: 'F#',
  },
  fsharpWasm: {
    desc: 'حقیقی F# کمپائلر اور .NET رن ٹائم WebAssembly پر چل رہا ہے۔ <1></1>یہ آفیشل F# کمپائلر کے رویے سے میل کھاتا ہے۔ تاہم، .NET WebAssembly رن ٹائم کو رزلٹ پیج میں ڈاؤن لوڈ کرنے کی ضرورت ہے، جس میں پہلے رن پر کچھ وقت لگ سکتا ہے۔',
    link: '<1><2>F# آفیشل ویب سائٹ</2></1> <3> <4>F# دستاویزات</4> </3> <5> <6>LiveCodes دستاویزی</6> </5> <7> <8>لوڈ اسٹارٹر ٹیمپلیٹ</8> </7>',
    name: 'F# (Wasm)',
  },
  gleam: {
  ...
  go: {
    ...
    link: '<1><2>گو ویب سائٹ</2></1> <3><4>گو دستاویزات</4></3> <5> <6>گوفر جے ایس ریپو</6> </5> <7> <8>X کو Y منٹ میں سیکھیں، جہاں X=گو</8> </7> <9> <10>LiveCodes دستاویزات</10> </9> <11> <12>ابتدائی سانچہ لوڈ کریں</12> </11>',
    name: 'گو',
  },
  goWasm: {
    desc: 'Yaegi کا استعمال کرتے ہوئے WebAssembly پر چلنے والے مترجم پر جائیں۔',
    link: '<1><2>سرکاری ویب سائٹ پر جائیں</2></1> <3><4>یگی</4></3> <5> <6>Y منٹ میں X سیکھیں ، جہاں X = Go</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7> <9> <10>لوڈ اسٹارٹر سانچہ</10> </9>',
    name: 'Go (Wasm)',
  },
  haml: {
  ...
  haskell: {
    desc: 'مائیکرو ایچ کا استعمال کرتے ہوئے براؤزر میں ہاسکل چل رہا ہے۔',
    link: '<1> <2>ہاسکل کی سرکاری ویب سائٹ</2> </1> <3> <4>گٹ ہب پر مائیکرو ہاسکل</4> </3> <5> <6>لائیو کوڈز دستاویزات</6> </5> <7> <8>اسٹارٹر ٹیمپلیٹ لوڈ کریں</8> </7>',
    name: 'Haskell',
  },
  haskellWasm: {
    desc: 'ہاسکل کو <1>براؤزر میں GHC</1> کے ذریعے براؤزر میں مرتب اور چلایا جاتا ہے، جو کہ GHC کی ایک WebAssembly تعمیر ہے، جو مکمل طور پر کلائنٹ سائیڈ پر چل رہا ہے۔',
    link: '<1> <2>ہاسکل کی سرکاری ویب سائٹ</2> </1> <3> <4>GHC دستاویزات</4> </3> <5> <6>براؤزر میں GHC</6> </5> <7> <8>LiveCodes دستاویزات</8> </7> <9> <10>اسٹارٹر ٹیمپلیٹ لوڈ کریں</10> </9>',
    name: 'Haskell (Wasm)',
  },
  imba: {
  ...
  java: {
    ...
    link: '<1> <2>Java آفیشل ویب سائٹ</2> </1> <3> <4>DoppioJVM</4> </3> <5> <6>Y منٹ میں X سیکھیں، جہاں X=java</6> </5> <7> <8>LiveCodes دستاویزات</8> </7> <9> <10>ابتدائی سانچہ لوڈ کریں</10> </9>',
    name: 'Java',
  },
  javascript: {
    desc: 'ویب کی سکرپٹ کی زبان۔',
    link: '<1> <2>MDN پر جاوا اسکرپٹ</2> </1> <3> <4>Y منٹ میں X سیکھیں، جہاں X=JavaScript</4> </3> <5> <6>LiveCodes دستاویزی</6> </5> <7> <8>اسٹارٹر ٹیمپلیٹ لوڈ کریں۔</8> </7>',
    name: 'JavaScript',
  },
  jinja: {
    desc: 'جنجا ایک تیز، اظہار خیال، توسیع پذیر ٹیمپلیٹنگ انجن ہے.',
    link: '<1> <2>آفیشل ویب سائٹ</2> </1> <3> <4>ٹیمپلیٹ دستاویزات</4> </3> <5> <6>JavaScript کا نفاذ</6> </5> <7> <8>LiveCodes دستاویزات</8> </7>',
    name: 'Jinja',
  },
  jsx: {
  ...
  julia: {
    ...
    desc2:
      'ڈبلیو اے ایس ایم پر چلنے والا جولیا کمپائلر اور جولیا بیس، <1>جولیا-ڈبلیو اے ایس ایم</1> کا استعمال کرتے ہوئے جسے <2>پولی لینگ.آئی او</2> نے اپنایا ہے۔',
  ...
  minizinc: {
    desc: 'MiniZinc ایک اعلی سطحی رکاوٹ ماڈلنگ زبان ہے جو آپ کو آسانی سے ظاہر کرنے اور مجرد اصلاحی مسائل کو حل کرنے کی اجازت دیتی ہے۔',
    link: '<1> <2>MiniZinc آفیشل ویب سائٹ</2> </1> <3> <4>MiniZinc دستاویزات</4> </3> <5> <6>MiniZinc ٹیوٹوریل</6> </5> <7> <8>LiveCodes دستاویزات</8> </7> <9> <10>اسٹارٹر ٹیمپلیٹ لوڈ کریں۔</10> </9>',
    name: 'MiniZinc',
  },
  mjml: {
  ...
  objcWasm: {
    desc: 'Objective-C کو <1>Clang</1> کے ذریعے WebAssembly میں مرتب کیا گیا ہے، جو <2>GNUstep</2> Objective-C رن ٹائم استعمال کرتا ہے۔ یہ ایک رن ٹائم ہے، کلاس لائبریری نہیں، لہٰذا Foundation دستیاب نہیں ہے۔',
    link: '<1> <2>Objective-C دستاویزات</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>X کو Y منٹ میں سیکھیں، جہاں X=Objective-C</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7> <9> <10>ابتدائی سانچہ لوڈ کریں</10> </9>',
    name: 'Objective-C (Wasm)',
  },
  objcppWasm: {
    desc: 'Objective-C++ کو <1>Clang</1> کے ذریعے WebAssembly میں مرتب کیا گیا ہے، جو <2>GNUstep</2> Objective-C رن ٹائم استعمال کرتا ہے۔ یہ ایک رن ٹائم ہے، کلاس لائبریری نہیں، لہٰذا Foundation دستیاب نہیں ہے۔',
    link: '<1> <2>Objective-C دستاویزات</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>X کو Y منٹ میں سیکھیں، جہاں X=Objective-C</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7>',
    name: 'Objective-C++ (Wasm)',
  },
  ocaml: {
    desc1:
  ...
  rustWasm: {
    desc: 'زنگ کی تشریح <1>Miri</1> (زنگ کے درمیانی درجے کے IR ترجمان) کے ذریعے کی جاتی ہے جسے WebAssembly میں مرتب کیا گیا ہے، جو مکمل طور پر براؤزر میں چل رہا ہے۔',
    link: '<1> <2>رست آفیشل ویب سائٹ</2> </1> <3> <4>دی رست بک</4> </3> <5> <6>Y منٹ میں X سیکھیں، جہاں X=رست</6> </5> <7> <8>لائیو کوڈز دستاویزات</8> </7> <9> <10>اسٹارٹر ٹیمپلیٹ لوڈ کریں</10> </9>',
    name: 'Rust (Wasm)',
  },
  sass: {
  ...
  vbWasm: {
    desc: 'VB.NET کمپائلر ویب اسمبلی پر چل رہا ہے، <1>Roslyn</1> اور <2>.NET WebAssembly رن ٹائم</2> استعمال کر رہا ہے',
    link: '<1> <2> Visual Basic زبان کی دستاویزات </2> </1> <3> <4> Y منٹوں میں X سیکھیں، جہاں X=Visual Basic </4> </3> <5> <6> LiveCodes ڈاکومینٹیشن </6> </5> <7> <8> اسٹارٹر ٹیمپلیٹ لوڈ کریں </8> </7>',
    name: 'VB.NET (Wasm)',
  },
  vue: {
  ...
  zigWasm: {
    desc: 'Zig کمپائلر WebAssembly پر چل رہا ہے۔',
    link: '<1> <2>زیگ ویب سائٹ</2> </1> <3> <4>زیگ زبان کی دستاویزات</4> </3> <5> <6>X=Zig — زیگ کو چند منٹوں میں سیکھیں</6> </5> <7> <8>LiveCodes دستاویزات</8> </7> <9> <10>اسٹارٹر ٹیمپلیٹ لوڈ کریں</10> </9>',
    name: 'Zig (Wasm)',
  },
};
