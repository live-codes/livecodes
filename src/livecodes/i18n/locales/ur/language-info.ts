...
const languageInfo: I18nLangInfoTranslation = {
  ...
  haskell: {
    desc: '<1>Haskell ایک مستحکم ٹائپ والی، خالص فنکشنل پروگرامنگ زبان ہے جس میں lazy evaluation ہوتی ہے۔</1> <2>LiveCodes، WebAssembly استعمال کرتے ہوئے براؤزر میں GHC چلاتا ہے۔</2>',
    link: '<1><2>Haskell</2></1> <3> <4>براؤزر میں GHC</4> </3> <5> <6>LiveCodes میں Haskell</6> </5> <7> <8>اسٹارٹر ٹیمپلیٹ</8> </7>',
    name: 'Haskell',
  },
  imba: {
