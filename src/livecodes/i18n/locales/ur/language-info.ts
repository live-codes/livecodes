...
const languageInfo: I18nLangInfoTranslation = {
  ...
  java: {
    ...
    link: '<1> <2> Java آفیشل ویب سائٹ </2> </1> <3> <4> DoppioJVM </4> </3> <5> <6> Y منٹ میں X سیکھیں، جہاں X=java </6> </5> <7> <8> </8> </7> شروع کریں',
    name: 'Java',
  },
  javascript: {
  ...
  jinja: {
    ...
    link: '<1> <2> آفیشل ویب سائٹ </2> </1> <3> <4> ٹیمپلیٹ دستاویزات </4> </3> <5> <6> JavaScript کا نفاذ </6> </5> <7> <8> LiveCodes Dog- </7> > </8>',
    name: 'Jinja',
  },
  jsx: {
