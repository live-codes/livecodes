...
const languageInfo: I18nLangInfoTranslation = {
  ...
  fsharp: {
    ...
    link: '<1><2>F# آفیشل ویب سائٹ</2></1> <3> <4>F# دستاویزات</4> </3> <5> <6>Fable آفیشل ویب سائٹ</6> </5> <7> <8>LiveCodes Documentations</8> <8> <8> <8> <9> لائیو کوڈ دستاویزات شروع کریں ٹیمپلیٹ</10> </9>',
    name: 'F#',
  },
  fsharpWasm: {
    ...
    link: '<1><2>F# آفیشل ویب سائٹ</2></1> <3> <4>F# دستاویزات</4> </3> <5> <6>LiveCodes دستاویزی</6> </5> <7> <8>لوڈ اسٹارٹر ٹیمپلیٹ</tag> </tag> </tag>',
    name: 'F# (Wasm)',
  },
  gleam: {
