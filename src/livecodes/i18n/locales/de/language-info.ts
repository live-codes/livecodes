...
const languageInfo: I18nLangInfoTranslation = {
  ...
  go: {
    ...
    link: '<1><2>Zur Go-Website</2></1> <3><4>Go-Dokumentation</4></3> <5> <6>GopherJS-Repo</6> </5> <7> <8>Lerne X in Y Minuten, wobei X = Go</8> </7> <9> <10>LiveCodes-Dokumentationen</10> </9> <11> <12>Starter-Vorlage laden</12> </11>',
    name: 'Go',
  },
  goWasm: {
