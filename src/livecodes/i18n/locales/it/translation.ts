...
const translation: I18nTranslation = {
  about: {
    ...
    credits: {
      ...
      para2: '© 2024 Hatem Hosny. LiveCodes è concesso in licenza con licenza MIT.',
    },
    documentations: {
  ...
  commandMenu: {
    ...
    disableAI: "Disattivare l'Assistente codice AI",
    ...
    enableAI: 'Abilita Assistente AI per il Codice',
