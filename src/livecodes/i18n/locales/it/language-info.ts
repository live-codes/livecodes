...
const languageInfo: I18nLangInfoTranslation = {
  ...
  go: {
    ...
    link: '<1><2>Vai al sito web</2></1> <3><4>Documentazione di Go</4></3> <5> <6>Repository di GopherJS</6> </5> <7> <8>Impara X in Y minuti, dove X = Go</8> </7> <9> <10>Documentazione LiveCodes</10> </9> <11> <12>Carica il modello di partenza</12> </11>',
    name: 'Go',
  },
  goWasm: {
