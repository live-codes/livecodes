...
const languageInfo: I18nLangInfoTranslation = {
  ...
  go: {
    ...
    link: '<1><2>Перейти на сайт</2></1> <3><4>Документация по Go</4></3> <5> <6>Репозиторий GopherJS</6> </5> <7> <8>«Изучите X за Y минут», где X = Go</8> </7> <9> <10>Документация LiveCodes</10> </9> <11> <12>Загрузить шаблон проекта</12> </11>',
    name: 'Go',
  },
  goWasm: {
