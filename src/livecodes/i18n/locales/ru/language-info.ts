...
const languageInfo: I18nLangInfoTranslation = {
  ...
  cWasm: {
    desc: 'C компилируется в WebAssembly с помощью <1>Clang</1> и выполняется полностью в браузере.',
    link: '<1> <2>Справочник по языку C</2> </1> <3> <4>Официальный сайт Clang</4> </3> <5> <6>Изучите X за Y минут, где X=C</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'C (Wasm)',
  },
  civet: {
  ...
  cpp: {
    ...
    desc2:
      'Это не полная реализация C++. Пожалуйста, обратитесь к <1>документации JSCPP</1> для подробностей.',
    link: '<1> <2>Фонд стандартного C++</2> </1> <3> <4>JSCPP</4> </3> <5> <6>Изучите X за Y минут, где X=C++</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
    name: 'C++',
  },
  cppWasm: {
    desc: 'C++ компилируется в WebAssembly с помощью <1>Clang</1> и выполняется полностью в браузере. Это настоящий компилятор C++, в отличие от интерпретатора <2>C++ на основе JSCPP</2>.',
    link: '<1> <2>Фонд стандартного C++</2> </1> <3> <4>Официальный сайт Clang</4> </3> <5> <6>Изучите X за Y минут, где X=C++</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'C++ (Wasm)',
  },
  csharpWasm: {
    desc: 'Компилятор C#, работающий на WebAssembly, с использованием <1>Blazor</1>',
    link: '<1> <2>Документация по языку C#</2> </1> <3> <4> Узнайте X за Y минут, где X=C#</4> </3> <5> <6> Документация LiveCodes</6> </5> <7> <8> Загрузите стартовый шаблон</8> </7>',
    name: 'C# (Wasm)',
  },
  diagrams: {
    ...
    desc3:
      '<1> <2>Cytoscape</2> </1> <3> <4>ELK</4> (использует <5>elkjs</5>) </3> <6> <7>Gnuplot</7> (использует <8>gnuplot-JS</8>) </6> <9> <10>Graphviz</10> (использует <11>@hpcc-js/wasm</11>) </9> <12> <13>Mermaid</13> </12> <14> <15>Nomnoml</15> </14> <16> <17>Pintora</17> </16> <18> <19>Plotly</19> </18> <20> <21>Svgbob</21> </20> <22> <23>Vega</23> </22> <24> <25>VegaLite</25> </24> <26> <27>WaveDrom</27> </26>',
  ...
  elm: {
    desc: 'Elm компилируется в JavaScript в браузере с помощью версии компилятора Elm, оптимизированной для WebAssembly.',
    link: '<1><2>Официальный сайт Elm</2></1> <3><4>Руководство по Elm</4></3> <5> <6>Документация по LiveCodes</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
    name: 'Elm',
  },
  eta: {
  ...
  fsharp: {
    desc1:
      'F# — это кроссплатформенный язык функционального программирования с открытым исходным кодом, работающий на платформе .NET.',
    desc2: 'Здесь код компилируется в JavaScript с помощью Fable.',
    link: '<1><2>Официальный сайт F#</2></1> <3> <4>Документация по F#</4> </3> <5> <6>Официальный сайт Fable</6> </5> <7> <8>Документация по LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'F#',
  },
  fsharpWasm: {
    desc: 'Настоящий компилятор F# и среда выполнения .NET, работающие на WebAssembly. <1></1>Это соответствует поведению официального компилятора F#. Однако на странице результатов необходимо загрузить среду выполнения .NET для WebAssembly, что при первом запуске может занять некоторое время.',
    link: '<1><2>Официальный сайт F#</2></1> <3> <4>Документация по F#</4> </3> <5> <6>Документация LiveCodes</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
    name: 'F# (Wasm)',
  },
  gleam: {
    desc1:
  ...
  go: {
    ...
    link: '<1><2>Сайт Go</2></1> <3><4>Документация Go</4></3> <5> <6>Репозиторий GopherJS</6> </5> <7> <8>Изучите X за Y минут, где X=Go</8> </7> <9> <10>Документация LiveCodes</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'Go',
  },
  goWasm: {
    desc: 'Интерпретатор Go, работающий на WebAssembly, с использованием Yaegi',
    link: '<1><2>Официальный сайт Go</2></1> <3><4>Yaegi</4></3> <5> <6>Узнайте X за Y минут, где X=Go</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузите стартовый шаблон</10> </9>',
    name: 'Go (Wasm)',
  },
  haml: {
  ...
  haskellWasm: {
    desc: 'Haskell компилируется и выполняется в браузере с помощью <1>GHC in the browser</1> — версии GHC для WebAssembly, работающей полностью на стороне клиента.',
    link: '<1> <2>Официальный сайт Haskell</2> </1> <3> <4>Документация по GHC</4> </3> <5> <6>GHC в браузере</6> </5> <7> <8>Документация по LiveCodes</8> </7> <9> <10>Загрузить шаблон для начала работы</10> </9>',
    name: 'Haskell (Wasm)',
  },
  imba: {
  ...
  java: {
    ...
    link: '<1> <2>Официальный сайт Java</2> </1> <3> <4> DoppioJVM</4> </3> <5> <6> Узнай X за Y минут, где X=java</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10> Загрузи стартовый шаблон</10> </9>',
    name: 'Java',
  },
  javascript: {
    desc: 'Язык сценариев в Интернете.',
    link: '<1> <2>JavaScript на MDN</2> </1> <3> <4>Выучите X за Y минут, где X=JavaScript</4> </3> <5> <6>Документация LiveCodes</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
    name: 'JavaScript',
  },
  jinja: {
    desc: 'Jinja - это быстрый, выразительный и расширяемый шаблонизатор.',
    link: '<1> <2>Официальный сайт</2> </1> <3> <4> Документация по шаблонам</4> </3> <5> <6> Реализация JavaScript</6> </5> <7> <8> Документация LiveCodes</8> </7>',
    name: 'Jinja',
  },
  jsx: {
  ...
  minizinc: {
    desc: 'MiniZinc - это высокоуровневый язык моделирования ограничений, который позволяет легко выражать и решать дискретные оптимизационные задачи.',
    link: '<1> <2>Официальный сайт MiniZinc</2> </1> <3> <4>Документация MiniZinc</4> </3> <5> <6>Учебник MiniZinc</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Стартовый шаблон Load</10> </9>',
    name: 'MiniZinc',
  },
  mjml: {
  ...
  objcWasm: {
    desc: 'Objective-C компилируется в WebAssembly с помощью <1>Clang</1> с использованием среды выполнения Objective-C <2>GNUstep</2>. Это среда выполнения, а не библиотека классов, поэтому Foundation недоступен.',
    link: '<1> <2>Документация по Objective-C</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>Изучите X за Y минут, где X=Objective-C</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'Objective-C (Wasm)',
  },
  objcppWasm: {
    desc: 'Objective-C++ компилируется в WebAssembly с помощью <1>Clang</1> с использованием среды выполнения Objective-C <2>GNUstep</2>. Это среда выполнения, а не библиотека классов, поэтому Foundation недоступен.',
    link: '<1> <2>Документация по Objective-C</2> </1> <3> <4>GNUstep libobjc2</4> </3> <5> <6>Изучите X за Y минут, где X=Objective-C</6> </5> <7> <8>Документация LiveCodes</8> </7>',
    name: 'Objective-C++ (Wasm)',
  },
  ocaml: {
    desc1:
  ...
  rustWasm: {
    desc: 'Rust интерпретируется с помощью <1>Miri</1> (интерпретатора промежуточного представления среднего уровня для Rust), скомпилированного в WebAssembly, и выполняется полностью в браузере.',
    link: '<1> <2>Официальный сайт Rust</2> </1> <3> <4>Книга по Rust</4> </3> <5> <6>«Изучите X за Y минут», где X = Rust</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'Rust (Wasm)',
  },
  sass: {
  ...
  vbWasm: {
    desc: 'Компилятор VB.NET, работающий на WebAssembly, с использованием <1>Roslyn</1> и <2>среды выполнения .NET для WebAssembly</2>',
    link: '<1> <2>Документация по языку Visual Basic</2> </1> <3> <4> Узнайте X за Y минут, где X=Visual Basic</4> </3> <5> <6> Документация LiveCodes</6> </5> <7> <8> Загрузите стартовый шаблон</8> </7>',
    name: 'VB.NET (Wasm)',
  },
  vue: {
  ...
  zigWasm: {
    desc: 'Компилятор Zig, работающий на WebAssembly.',
    link: '<1> <2>Сайт Zig</2> </1> <3> <4>Документация по языку Zig</4> </3> <5> <6>Изучите X за Y минут, где X = Zig</6> </5> <7> <8>Документация LiveCodes</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'Zig (Wasm)',
  },
};
