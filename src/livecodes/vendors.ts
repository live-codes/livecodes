export const vendorsBaseUrl =
  'https://cdn.jsdelivr.net/npm/@live-codes/browser-compilers@0.4.8/dist/';
...
export const esModuleShimsUrl =
  'https://cdn.jsdelivr.net/npm/es-module-shims@1.3.2/dist/es-module-shims.min.js';
...
export const quillEditorCdnBaseUrl = 'https://cdn.jsdelivr.net/npm/quill@1.3.7/dist';
