...
export const cherryCljsBaseUrl = 'https://cdn.jsdelivr.net/npm/cherry-cljs@0.0.4/';
...
export const cytoscapeUrl = 'https://cdn.jsdelivr.net/npm/cytoscape@3.25.0/dist/cytoscape.min.js';
...
export const elkjsBaseUrl = 'https://cdn.jsdelivr.net/npm/elkjs@0.8.2/lib/';
...
export const mermaidCdnUrl = 'https://cdn.jsdelivr.net/npm/mermaid@10.2.2/dist/mermaid.esm.min.mjs';
...
export const wabtjsUrl = 'https://cdn.jsdelivr.net/npm/wabt@1.0.32/index.js';

export const waveDromBaseUrl = 'https://cdn.jsdelivr.net/npm/wavedrom@3.2.0/';
