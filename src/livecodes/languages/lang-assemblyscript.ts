...
const sdkUrl = 'https://cdn.jsdelivr.net/npm/assemblyscript@0.19.22/dist/sdk.js';
const loaderUrl = 'https://cdn.jsdelivr.net/npm/@assemblyscript/loader@0.19.22/umd/index.js';
