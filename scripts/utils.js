...
const getEnvVars = (/** @type {boolean} */ devMode) => {
  ...
  return {
    ...
    'process.env.DOCS_BASE_URL': JSON.stringify(docsBaseUrl),
    'process.env.CI': JSON.stringify(CI),
    'process.env.SELF_HOSTED': JSON.stringify(selfHosted),
    'process.env.SELF_HOSTED_SHARE': JSON.stringify(selfHostedShare),
    'process.env.SELF_HOSTED_BROADCAST': JSON.stringify(selfHostedBroadcast),
    'process.env.BROADCAST_PORT': JSON.stringify(selfHostedBroadcastPort),
    'process.env.SANDBOX_HOST_NAME': JSON.stringify(selfHostedSandboxHostName),
    'process.env.SANDBOX_PORT': JSON.stringify(selfHostedSandboxPort),
